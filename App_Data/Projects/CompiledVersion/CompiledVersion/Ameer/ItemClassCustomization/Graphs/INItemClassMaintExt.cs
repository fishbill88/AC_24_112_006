...
namespace ItemClassCustomization
{
    ...
    public class INItemClassMaintExt : PXGraphExtension<INItemClassMaint>
    {
        ...
        protected virtual void _(Events.FieldVerifying<INItemClass, INItemClass.parentItemClassID> e)
        {
            ...
            {
                throw new PXSetPropertyException(Messages.CircularReferenceError, PXErrorLevel.Error);
            }
            ...
            {
                throw new PXSetPropertyException(Messages.MaxHierarchyDepthError, PXErrorLevel.Error);
            }
            ...
            if (parentClass != null && parentClass.StkItem != e.Row.StkItem)
            {
                Base.itemclass.Cache.RaiseExceptionHandling<INItemClass.parentItemClassID>(
                    e.Row,
                    e.NewValue,
                    new PXSetPropertyException(Messages.DifferentStockItemWarning, PXErrorLevel.Warning));
            }
        }
            ...
            if (itemCount > 0)
            {
                Base.itemclass.Cache.RaiseExceptionHandling<INItemClass.parentItemClassID>(
                    ...
                    new PXSetPropertyException(
                        string.Format(Messages.ItemClassUsedByItemsWarning, itemCount),
        ...
        protected virtual void _(Events.RowPersisting<INItemClass> e)
        {
            ...
            if (e.Row.ParentItemClassID != null)
            {
                ...
                {
                    throw new PXException(Messages.CircularReferenceOnSaveError);
                }
            }
        }
        ...
        protected virtual void _(Events.RowDeleting<INItemClass> e)
        {
            ...
            if (ItemClassHierarchyHelper.HasChildClasses(Base, e.Row.ItemClassID))
            {
                ...
                if (Base.itemclass.Ask(
                    Messages.DeleteItemClassWithChildrenTitle,
                    string.Format(Messages.DeleteItemClassWithChildrenMessage, childCount),
        ...
        [PXUIField(DisplayName = "View Hierarchy", MapEnableRights = PXCacheRights.Select, Visible = false)]
        ...
        [PXButton(CommitChanges = true)]
        [PXUIField(DisplayName = "View Cascading Attributes", MapEnableRights = PXCacheRights.Select, Visible = false)]
        protected virtual void viewCascadingAttributes()
        {
            ...
            {
                throw new PXException(string.Format(Messages.NoAttributesFoundInHierarchy, current.ItemClassCD));
            }
        }
