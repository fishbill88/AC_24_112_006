...
namespace CompiledVersion.DAC
{
    ...
    public class InventoryRequest : PXBqlTable, IBqlTable
    {
        ...
        [LocationID(typeof(Where<Location.bAccountID, Equal<Current<vendorID>>>), DescriptionField = typeof(Location.descr), Visibility = PXUIVisibility.SelectorVisible)]
        ...
        #region VendorSiteID
        [PX.Objects.IN.Site(DisplayName = "Vendor Warehouse", DescriptionField = typeof(INSite.descr))]
        //[PXDBInt]
