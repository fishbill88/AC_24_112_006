...
namespace CompiledVersion.Graphs
{
    public class SOReleaseInvoice_Extension : PXGraphExtension<PX.Objects.SO.SOReleaseInvoice>
    {
        ...
        protected virtual void _(Events.RowSelected<PX.Objects.AR.ARInvoice> e)
        {
            PX.Objects.AR.ARInvoice invoice = e.Row;
        ...
        private string LoadCustomerEmail(int customerID)
        {
            try
            {
                ...
                Contact contact = PXSelectJoin<Contact,
                    InnerJoin<PX.Objects.AR.Customer, On<PX.Objects.AR.Customer.defContactID, Equal<Contact.contactID>>>
