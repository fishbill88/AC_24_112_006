...
namespace PX.Objects.FS
{
    ...
    public class FSPriceManagement : PXGraph<FSPriceManagement>
    {
		public static FSPriceManagement SingleFSPriceManagement
			=> PXContext.GetSlot<FSPriceManagement>()
			?? PXContext.SetSlot(CreateInstance<FSPriceManagement>());
                                                                            ...
                                                                            string taxCalcMode)
        {
            ...
            salesPrice = GetCustomerContractPrice(cache, currencyInfo, serviceContractID, billServiceContractID, billContractPeriodID, lineRelatedToContract, inventoryID, uom);
                    ...
                    && fsServiceContractRow.SourcePrice == ID.SourcePrice.CONTRACT)
            {
                FSSalesPrice fsSalesPriceRow = PXSelect<FSSalesPrice,
					Where<FSSalesPrice.serviceContractID, Equal<Required<FSSalesPrice.serviceContractID>>,
						And<FSSalesPrice.inventoryID, Equal<Required<FSSalesPrice.inventoryID>>,
						And<FSSalesPrice.uOM, Equal<Required<FSSalesPrice.uOM>>>>>>
					.Select(cache.Graph, serviceContractID, inventoryID, uom);
                    ...
                    && lineRelatedToContract == true)
            {
                FSContractPeriodDet fsContractPeriodDetRow = PXSelect<FSContractPeriodDet,
					Where<FSContractPeriodDet.serviceContractID, Equal<Required<FSContractPeriodDet.serviceContractID>>,
						...
						And<FSContractPeriodDet.inventoryID, Equal<Required<FSContractPeriodDet.inventoryID>>,
						And<FSContractPeriodDet.uOM, Equal<Required<FSContractPeriodDet.uOM>>>>>>>
					.Select(cache.Graph, billServiceContractID, billContractPeriodID, inventoryID, uom);
        ...
        private static decimal? GetCustomerContractPrice(
			...
			string uom)
        {
            decimal? contractSalesPrice = GetCustomerContractPrice(cache,
				serviceContractID,
				billServiceContractID,
				billContractPeriodID,
				lineRelatedToContract,
