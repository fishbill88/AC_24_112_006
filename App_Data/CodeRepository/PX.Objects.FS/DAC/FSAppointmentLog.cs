...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentLog : FSLog
    {
		...
		[PXForeignReference(typeof(Field<FSAppointmentLog.bAccountID>.IsRelatedTo<EPEmployee.bAccountID>))]
        ...
        [PXBool]
        [PXFormula(typeof(Switch<Case<Where<itemType, Equal<itemType.Values.travel>, Or<Current<FSAppointment.hold>, Equal<True>>>, True>, False>))]
        ...
        [PXFormula(typeof(Switch<
                                Case<
									...
									DateDiff<dateTimeBegin, dateTimeEnd, DateDiff.minute>>,
                                    Zero>))]
