...
namespace PX.Objects.FS
{
    ...
    public partial class FSAppointmentFSServiceOrder : FSAppointment
    {
        ...
        public new static class FK
        {
			...
			public class ServiceOrder : FSServiceOrder.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<srvOrdType, soRefNbr> { }
        }
        #endregion
		...
		[PXSelector(typeof(Search2<FSServiceOrder.refNbr,
				LeftJoin<Customer,
					On<Customer.bAccountID, Equal<FSServiceOrder.customerID>>>,
				Where<
					FSServiceOrder.srvOrdType, Equal<Current<FSAppointmentFSServiceOrder.srvOrdType>>,
					And<
						Where2<
							Where<Current<FSAppointmentFSServiceOrder.appointmentID>, Greater<Zero>,
