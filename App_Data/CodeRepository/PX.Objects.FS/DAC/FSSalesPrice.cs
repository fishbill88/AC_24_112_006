...
namespace PX.Objects.FS
{
    ...
    public class FSSalesPrice : PXBqlTable, PX.Data.IBqlTable
    {
        #region SalesPriceID
		...
		/// </summary>
		/// <value>
		/// Defaults to the <see cref="FSScheduleDet.UOM">UOM</see> associated with the <see cref="InventoryID">Inventory Item</see>.
