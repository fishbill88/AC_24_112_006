...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentDet : PXBqlTable, IBqlTable, IFSSODetBase, IDocLine, ISortOrder, ILSPrimary
    {
		...
		#region Status
		#region ListField_Status_AppointmentDet
		public abstract class ListField_Status_AppointmentDet : PX.Data.BQL.BqlString.Field<FSAppointmentDet.status>
		{
