...
namespace PX.Objects.FS
{
    ...
    public class FSSODet : PXBqlTable, IBqlTable, IFSSODetBase, IDocLine, ILSPrimary, ISortOrder
    {
        #region Keys
		...
		#region Status
		#region ListField_Status_SODet
		public abstract class ListField_Status_SODet : PX.Data.BQL.BqlString.Field<FSSODet.status>
		{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<FSSODetAlias>.By<srvOrdType, refNbr, lineNbr>
		{
			public static FSSODetAlias Find(PXGraph graph, string srvOrdType, string refNbr, int? lineNbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, srvOrdType, refNbr, lineNbr, options);
		}

		public new class UK : PrimaryKeyOf<FSSODetAlias>.By<sODetID>
		{
			public static FSSODetAlias Find(PXGraph graph, int? sODetID, PKFindOptions options = PKFindOptions.None) => FindBy(graph, sODetID, options);
		}
		#endregion
		...
		public new abstract class status : ListField_Status_SODetAlias { }

		#region ListField_Status_SODet
		public abstract class ListField_Status_SODetAlias : PX.Data.BQL.BqlString.Field<FSSODetAlias.status>
		{
			public class ListAtrribute : PXStringListAttribute
			{
				public ListAtrribute()
