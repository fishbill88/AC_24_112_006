...
namespace PX.Objects.AR
{
    ...
    public partial class FSNotification : NotificationSetup
    {
        ...
        [PXSelector(typeof(Search<PX.SM.SiteMap.screenID,
            Where<PX.SM.SiteMap.screenID, Like<FSModule.fs_>, And<PX.SM.SiteMap.url, Like<PX.Objects.Common.urlReports>>>,
	...
	public partial class FSCTNotification : NotificationSetup
	{
		...
		[PXUIField(DisplayName = "Report")]
		[PXSelector(typeof(Search<PX.SM.SiteMap.screenID,
			Where<PX.SM.SiteMap.screenID, Like<FSModule.fs_>,
				Or<PX.SM.SiteMap.screenID, Like<FSModule.so_>,
