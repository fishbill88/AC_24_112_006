...
namespace PX.Objects.FS
{
    ...
    public class FSBillHistory : PXBqlTable, PX.Data.IBqlTable, IFSRelatedDoc
    {
        #region Keys
        ...
        {
            public class Appointment : FSAppointment.PK.ForeignKeyOf<ARTran>.By<srvOrdType, appointmentRefNbr> { }

            public class ServiceOrder : FSAppointment.PK.ForeignKeyOf<ARTran>.By<srvOrdType, serviceOrderRefNbr> { }

            public class ServiceContract : FSServiceContract.PK.ForeignKeyOf<ARTran>.By<serviceContractRefNbr> { }
        }
        #endregion
		...
		#region IsChildDocDeleted
		public abstract class isChildDocDeleted : PX.Data.BQL.BqlBool.Field<isChildDocDeleted> { }
