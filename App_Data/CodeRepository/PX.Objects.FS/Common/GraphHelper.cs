...
namespace PX.Objects.FS
{
    internal static class GraphHelper
    {
		...
		{
			var graphType = System.Web.Compilation.PXBuildManager.GetType(graphName, true);
			using (new PXPreserveScope())
			{
				PXGraph graph = PXGraph.CreateInstance(graphType, stateId ?? "");
				if (graphType == typeof(PXGraph))
