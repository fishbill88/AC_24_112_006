...
namespace PX.Objects.FS
{
    ...
    public class SharedClasses
    {
        ...
        public class SOPrepaymentBySO
        {
            ...
            {
                SrvOrdType = fsxARTran.SrvOrdType;
                ServiceOrderRefNbr = fsxARTran.ServiceOrderRefNbr;
                unpaidAmount = 0;
        ...
        public class SOPrepaymentHelper
        {
            ...
            public void Add(ARTran arTranRow, FSxARTran fsxARTranRow, decimal arTaxLine)
            {
                ...
                SOPrepaymentBySO row = SOPrepaymentList.Find(x => x.SrvOrdType.Equals(fsxARTranRow.SrvOrdType)
                                                                  && x.ServiceOrderRefNbr.Equals(fsxARTranRow.ServiceOrderRefNbr));
                ...
                {
                    SOPrepaymentBySO newRow = new SOPrepaymentBySO(arTranRow, fsxARTranRow, arTaxLine);
                    SOPrepaymentList.Add(newRow);
                }
            }
        }
