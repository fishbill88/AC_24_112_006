...
namespace PX.Objects.FS
{
	...
	#region EquipmentCalculateWarrantyType
	public static class EquipmentCalculateWarrantyType
	{
		...
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
					new string[] { SalesOrderDate, InstallationDate, Earliest, Latest },
					new string[] { TX.EquipmentCalculateWarrantyType.SalesOrderDate, TX.EquipmentCalculateWarrantyType.InstallationDate, TX.EquipmentCalculateWarrantyType.Earliest, TX.EquipmentCalculateWarrantyType.Latest })
			{ }
		}
	}
	#endregion
