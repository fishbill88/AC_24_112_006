...
namespace PX.Objects.FS
{
    public class RouteDocumentMaint : PXGraph<RouteDocumentMaint, FSRouteDocument>, IGraphWithInitialization
    {
        ...
        [PXUIField(DisplayName = "Unassign", MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select)]
        ...
        [PXButton(Category = CommonActionCategories.DisplayNames.Other, DisplayOnMainToolbar = true)]
