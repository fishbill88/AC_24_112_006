...
namespace PX.Objects.FS
{
    public static class ID
    {
        ...
        public class ScheduleType
        {
            ...
            public readonly string[] ID_LIST = { ID.ScheduleType.AVAILABILITY, ID.ScheduleType.UNAVAILABILITY };
            public readonly string[] TX_LIST = { TX.ScheduleType.AVAILABILITY, TX.ScheduleType.UNAVAILABILITY };
        }
        ...
        public class Billing_Cycle_Type
        {
            ...
            public readonly string[] ID_LIST = { ID.Billing_Cycle_Type.APPOINTMENT, ID.Billing_Cycle_Type.SERVICE_ORDER, ID.Billing_Cycle_Type.PURCHASE_ORDER, ID.Billing_Cycle_Type.WORK_ORDER, ID.Billing_Cycle_Type.TIME_FRAME };
            public readonly string[] TX_LIST = { TX.Billing_Cycle_Type.APPOINTMENT, TX.Billing_Cycle_Type.SERVICE_ORDER, TX.Billing_Cycle_Type.PURCHASE_ORDER, TX.Billing_Cycle_Type.WORK_ORDER, TX.Billing_Cycle_Type.TIME_FRAME };
        }
        ...
        public class Time_Cycle_Type
        {
            ...
            public readonly string[] ID_LIST = { ID.Time_Cycle_Type.DAY_OF_MONTH, ID.Time_Cycle_Type.WEEKDAY };
            public readonly string[] TX_LIST = { TX.Time_Cycle_Type.DAY_OF_MONTH, TX.Time_Cycle_Type.WEEKDAY };
        }
