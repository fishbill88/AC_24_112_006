...
namespace PX.Objects.FS
{
    public static class TX
    {
        ...
        public static class TableName
        {
			...
			public const string SchedulerAppointment            = "Appointment";
			public const string SchedulerServiceOrder           = "Service Order";
			public const string MainAppointmentFilter           = "Calendar Board Filter";
		}
        ...
        public static class Error
        {
            ...
            public const string APPOINTMENT_NOT_EDITABLE                                                       = "The appointment cannot be modified because its associated service order has been either closed or canceled.";
            public const string APPOINTMENT_NOT_DELETABLE                                                      = "The appointment cannot be deleted because either its status or the workflow stage prohibits deletion.";
			...
			public const string CannotDeleteLineBecausePOIsAlreadyCreated									   = "The line cannot be deleted because the purchase order has already been created for this line.";
			...
			public const string SOinvoiceWithFieldServiceLinesCannotBeDeleted								   = "The line cannot be deleted because it is linked to an appointment or a service order. To proceed, ensure that all lines of the related appointment or service order are added to the invoice.";
			public const string SOCreditMemoPartiallyReleasing												   = "The {0} credit memo cannot be released because it does not contain all lines of the related service order or appointment. Please delete the credit memo and create the new one by using the Reverse Service Invoice command in the original invoice.";
		}
        ...
        public static class CalendarMessages
        {
			...
			public const string INFO_MAP_API_ERROR_LOCATION = "The route cannot be displayed on the map due to the following incorrect address or addresses: {0}. Correct each incorrect address, so that the system can display the route on the map.";
			...
			public const string APPT_STATUS_SHORT = "Status";
			public const string APPT_DESCR = "Appointment Description";
			public const string APPT_DESCR_SHORT = "Description";
			public const string ADDRESS_SHORT = "Address";
			public const string APPT_START_SHORT = "Scheduled Start";
			public const string APPT_END_SHORT = "Scheduled End";
			public const string SO_REFNBR_SHORT = "Order Nbr.";
			public const string SO_STATUS_SHORT = "Status";
			public const string SO_DESCR = "Service Order Description";
			public const string SO_DESCR_SHORT = "Description";
			public const string SO_LOCATION = "Customer Location ID";
			public const string SO_PROJECT = "Project ID";
			public const string SO_WAITING_FOR_PARTS = "Waiting for Parts";
			public const string SODET_DESCR = "Service Order Detail Line Desc.";
			public const string EMPLOYEE_BRANCH = "Employee Branch ID";
			public const string EMPLOYEE_BRANCH_NAME = "Employee Branch Name";
			public const string GEOZONE_DESCR = "Service Area Description";
			public const string LOCATION_ACCID = "Customer";
		}
		...
		[PXLocalizable]
		public class EquipmentCalculateWarrantyType
		{
			public const string SalesOrderDate = "Sales Order Date";
			public const string InstallationDate = "Installation Date";
			public const string Earliest = "The Earliest of Both Dates";
			public const string Latest = "The Latest of Both Dates";
		}
	}
}
