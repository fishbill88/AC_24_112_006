...
namespace PX.Objects.FS
{
    public class SM_POOrderEntry : PXGraphExtension<POOrderEntry>
    {
		...
		public virtual void _(Events.CacheAttached<FSSODet.Tstamp> e)
		{ }

		[PXDBTimestamp(VerifyTimestamp = VerifyTimestampOptions.FromRecord)]
		public virtual void _(Events.CacheAttached<FSAppointmentDet.Tstamp> e)
		{ }
        ...
        protected virtual void _(Events.RowPersisted<POOrder> e)
        {
            ...
            if (e.TranStatus == PXTranStatus.Open && e.Operation == PXDBOperation.Update)
            {
				...
				if (poOrderRow.Status == POOrderStatus.Open && poOrderOldStatus != poOrderRow.Status)
					{
