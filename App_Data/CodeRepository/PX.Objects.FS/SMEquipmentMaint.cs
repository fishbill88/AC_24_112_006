...
namespace PX.Objects.FS
{
    public class SMEquipmentMaint : PXGraph<SMEquipmentMaint, FSEquipment>
    {
        ...
        public class RComponent : PXBqlTable, IBqlTable
        {
        ...
        public virtual void OpenEmployeeBoard()
        {
            ...
            {
				var customerID = EquipmentRecords.Current.CustomerID.Value.ToString();

				KeyValuePair<string, string>[] parameters = new KeyValuePair<string, string>[]
                {
                    new KeyValuePair<string, string>(typeof(FSEquipment.customerID).Name, customerID),
				...
				throw PXRedirectToBoardRequiredException.GenerateMultiEmployeeRedirect(
					SiteMapProvider,
					parameters,
					new MainAppointmentFilter() { InitialCustomerID = customerID });
            }
        }
        #endregion
