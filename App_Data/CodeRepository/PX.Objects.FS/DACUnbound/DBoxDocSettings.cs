...
{
    [Serializable]
    public class DBoxDocSettings : PXBqlTable, IBqlTable
    {
        ...
        [FSSelectorActive_AR_SO_ProjectTask(typeof(Where<PMTask.projectID, Equal<Current<projectID>>>), typeof(On<FSSrvOrdType.srvOrdType, Equal<Current<srvOrdType>>, Or<Current<srvOrdType>, IsNull>>))]
