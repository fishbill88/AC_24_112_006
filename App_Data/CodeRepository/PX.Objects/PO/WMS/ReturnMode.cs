		...
		public sealed class ReturnMode : ScanMode
		{
			...
			public sealed class ReleaseReturnCommand : ScanCommand
			{
				...
				public class Logic : ScanExtension
				{
					...
					{
						Basis.ApplyLinesQtyChanges(completePOLines: false);
						Basis.SaveChanges();
						...
						Basis
						.WaitFor<POReceipt>((basis, doc) => ReleaseReceiptImpl(doc))
					...
					private static void ReleaseReceiptImpl(POReceipt receipt)
					{
