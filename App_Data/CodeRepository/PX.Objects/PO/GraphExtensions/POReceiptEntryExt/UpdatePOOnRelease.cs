...
namespace PX.Objects.PO.GraphExtensions.POReceiptEntryExt
{
	public class UpdatePOOnRelease: BaseUpdatePOAccrual<POReceiptEntry.MultiCurrency, POReceiptEntry, POReceipt>
	{
		...
		/// <summary>
		/// Overrides <see cref="POReceiptEntry.ReleaseReceiptLine(POReceiptLine, POLine, POOrder)"/>
		/// </summary>
		[PXOverride]
		public virtual void ReleaseReceiptLine(POReceiptLine line, POLine poLine, POOrder poOrder, Action<POReceiptLine, POLine, POOrder> baseImpl)
		{
		...
		/// <summary>
		/// Extends <see cref="POReceiptEntry.UpdateReceiptLineOnRelease(PXResult{POReceiptLine}, POLine)"/>
		/// </summary>
		[PXOverride]
		public virtual void UpdateReceiptLineOnRelease(PXResult<POReceiptLine> row, POLine pOLine)
		{
		...
		public virtual POLine UpdatePOLineOnReceipt(PXResult<POReceiptLine> res, POLine poLine)
		{
			...
			poLine = PXCache<POLine>.CreateCopy(poLine);
			...
			return Base.poline.Update(poLine);
		}
		...
		/// <summary>
		/// Overrides <see cref="POReceiptEntry.ReleaseReturnLine(POReceiptLine, POLine, POReceiptLine2)"/>
		/// </summary>
		[PXOverride]
		public virtual void ReleaseReturnLine(POReceiptLine line, POLine poLine, POReceiptLine2 origLine, Action<POReceiptLine, POLine, POReceiptLine2> baseImpl)
		{
			POAccrualStatus poAccrual = POAccrualStatus.PK.FindDirty(Base, line.POAccrualRefNoteID, line.POAccrualLineNbr, line.POAccrualType);
		...
		/// <summary>
		/// Extends <see cref="POReceiptEntry.UpdateReturnLineOnRelease(PXResult{POReceiptLine}, POLine)"/>
		/// </summary>
		[PXOverride]
		public virtual void UpdateReturnLineOnRelease(PXResult<POReceiptLine> row, POLine pOLine)
		{
		...
		public virtual POLine UpdatePOLineOnReturn(POReceiptLine line, POLine poLine)
		{
			if (poLine == null || string.IsNullOrEmpty(poLine.OrderType) || string.IsNullOrEmpty(poLine.OrderNbr) || poLine.LineNbr == null)
			{
				return poLine;
		...
		public virtual POAccrualStatus UpdatePOAccrualStatus(POAccrualStatus origRow, POLine poLine, POReceiptLine rctLine, POOrder order, POReceipt rct)
		{
