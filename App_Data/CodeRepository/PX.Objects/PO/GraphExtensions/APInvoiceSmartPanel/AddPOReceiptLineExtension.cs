        ...
        public virtual IEnumerable POReceiptLinesSelection()
		{
			...
			PXSelectBase<LinkLineReceipt> cmd = new PXSelect<LinkLineReceipt,
				Where<LinkLineReceipt.receiptType, Equal<Required<POReceipt.receiptType>>,
					And2<Where<LinkLineReceipt.orderNbr, Equal<Current<POReceiptFilter.orderNbr>>,
						Or<Current<POReceiptFilter.orderNbr>, IsNull>>,
					And2<Where<LinkLineReceipt.receiptLineNbr, Equal<Current<POReceiptFilter.receiptLineNbr>>,
						Or<Current<POReceiptFilter.receiptLineNbr>, IsNull>>,
					And<Where<LinkLineReceipt.receiptNbr, Equal<Current<POReceiptFilter.receiptNbr>>,
						Or<Current<POReceiptFilter.receiptNbr>, IsNull>>>>>>>(Base);
