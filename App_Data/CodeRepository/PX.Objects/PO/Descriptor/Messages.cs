...
namespace PX.Objects.PO
{
	...
	public static class Messages
	{
		...
		public const string PrepaidAmtCantBeLessThanNegativePOLine = "The prepaid amount cannot be less than the negative amount in the corresponding line of the purchase order.";
		...
		public const string PrepaidAmtMayBeLessThanNegativePOLine = "The {0} purchase order line corresponding to this line already has a partial prepayment. The sum of amounts in the existing prepayments and current prepayment for purchase order line ({0}, {1}, {2}) cannot be less than the negative amount in the purchase order line.";
		...
		public const string CannotChangeItemForLineWithExistingAPDoc = "The {0} item cannot be changed because it has been added to at least one related prepayment request, AP bill, or purchase receipt.";
		...
		public const string BlanketPOLineCannotBeDeleted = "The line cannot be deleted because it is associated with a line in the {0} purchase order.";
		public const string BlanketPurchaseOrderCannotBeDeleted = "The {0} blanket purchase order cannot be deleted because at least one normal or drop-ship purchase order is linked to this order.";
		public const string InventoryIDCannotBeChangedInBlanketPOLine = "The {0} item cannot be changed because it is specified in a line of the {1} purchase order associated with this blanket order.";
		
		public const string UomConversionModified = "The conversion rule from the {0} purchase unit to the {1} base unit has been modified for the {2} item. The base quantity of the item in the purchase return will not match the base quantity in the {3} purchase receipt. To process the item return using the current conversion rule, you can include the item in a purchase return that is not linked to the original purchase receipt.";
		...
		public const string POBlanketOrderPOOrder = "Purchase Blanket Order to Purchase Order Link";
		public const string POBlanketOrderPOReceipt = "Purchase Blanket Order to Purchase Receipt Link";
		...
		public const string SiteInfo = "Site Info";
		#endregion
		...
		public const string StatusTotalOrderedReceived = "Total Ordered Qty. {0}, Total Received Qty. {1}";
		...
		public const string PrepayPOLineMoreThanAllowed = "The prepayment cannot be released because the sum of amounts in the released prepayments and current prepayment for purchase order line ({0}, {1}, {2}) exceeds the order amount {3}.";
		public const string PrepayPOLineLessThanAllowed = "The prepayment cannot be released because the sum of the amounts in the released prepayments and current prepayment for purchase order line ({0}, {1}, {2}) is less than the negative amount in order line {3}.";
