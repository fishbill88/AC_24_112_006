...
namespace PX.Objects.PO
{
	...
	public class POCreateProjectionAttribute : TM.OwnedFilter.ProjectionAttribute
	{
		...
		typeof(Select2<,,>),
			...
			LeftJoin<SOOrder, On<SOLineSplit.FK.Order>,
	...
	public partial class POFixedDemand : INItemPlan
	{
		...
		[Vendor(typeof(Search2<BAccountR.bAccountID,
				LeftJoin<GL.BranchAlias,
					On<BAccountR.isBranch, Equal<True>, And<GL.BranchAlias.bAccountID, Equal<BAccountR.bAccountID>>>>,
		...
		[PXRestrictor(
			typeof(Where2<Where<Current<POFixedDemand.salesCustomerID>, IsNull,
					Or<Vendor.bAccountID, NotEqual<Current<POFixedDemand.salesCustomerID>>>>,
				And<Where<GL.BranchAlias.branchID, IsNull, Or<Current<POFixedDemand.salesBranchID>, IsNull,
					Or<GL.BranchAlias.branchID, NotEqual<Current<POFixedDemand.salesBranchID>>>>>>>),
			SO.Messages.IntercompanyInvalidPOtoSOVendor)]
		...
		#region SalesBranchID
		/// <inheritdoc cref="SOOrder.BranchID"/>
		[PXDBInt(BqlField = typeof(SOOrder.branchID))]
		public virtual Int32? SalesBranchID { get; set; }
		public abstract class salesBranchID : PX.Data.BQL.BqlInt.Field<salesBranchID> { }
		#endregion

		#region SalesCustomerID
		/// <inheritdoc cref="SOOrder.CustomerID"/>
		[PXDBInt(BqlField = typeof(SOOrder.customerID))]
		public virtual Int32? SalesCustomerID { get; set; }
		public abstract class salesCustomerID : PX.Data.BQL.BqlInt.Field<salesCustomerID> { }
		#endregion
