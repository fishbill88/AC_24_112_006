...
namespace PX.Objects.PO
{
    ...
    public class POAccrualInquiryResult : PXBqlTable, IBqlTable
    {
        ...
        public abstract class documentNoteID : BqlGuid.Field<documentNoteID>
		{
			public class NoteAttribute : ProjectionNoteAttribute
			{
				...
				{
					IsKey = true;
					BqlField = typeof(POAccrualDetail.documentNoteID);
				}

				protected override string GetEntityType(PXCache cache, Guid? noteId)
				{
					var inqResult = cache.Current as POAccrualInquiryResult;
					if (inqResult?.DocumentNoteID == noteId && inqResult?.APDocType != null)
