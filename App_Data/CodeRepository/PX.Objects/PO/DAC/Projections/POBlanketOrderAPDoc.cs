...
namespace PX.Objects.PO.DAC.Projections
{
	...
	[PXProjection(typeof(Select5<POLine,
		...
		InnerJoin<APRegister, On<APRegister.docType, Equal<APTranSigned.tranType>, And<APRegister.refNbr, Equal<APTranSigned.refNbr>>>>>,
	...
	public partial class POBlanketOrderAPDoc : PXBqlTable, IBqlTable
	{
		#region Keys
		public class PK : PrimaryKeyOf<POOrderAPDoc>.By<docType, refNbr, pOType, pONbr>
		{
			public static POOrderAPDoc Find(PXGraph graph, string docType, string refNbr, string pOType, string pONbr, PKFindOptions options = PKFindOptions.None) => FindBy(graph, docType, refNbr, pOType, pONbr, options);
		}
		public static class FK
		{
			public class APInvoice : AP.APInvoice.PK.ForeignKeyOf<POOrderAPDoc>.By<docType, refNbr> { }
			public class Order : POOrder.PK.ForeignKeyOf<POOrderAPDoc>.By<pOType, pONbr> { }
		...
		[PXSelector(typeof(Search<APRegister.refNbr, Where<APRegister.docType, Equal<Optional<docType>>>>), Filterable = true)]
