...
namespace PX.Objects.PO
{
	...
	public partial class POLine : PXBqlTable, PX.Data.IBqlTable, ISortOrder, ITaxableDetail, IMatrixItemLine, ICommitmentSource, IItemPlanPOSource
	{
		#region Keys
		...
		[PXUnboundFormula(typeof(Switch<Case<Where<lineType, In3<POLineType.goodsForDropShip, POLineType.nonStockForDropShip>, And<completed, Equal<False>>>, int1>, int0>), typeof(SumCalc<POOrder.dropShipOpenLinesCntr>), ValidateAggregateCalculation = true)]
		...
		[PXDependsOnFields(typeof(lineType))]
		...
		[PXUnboundFormula(
			...
			typeof(SumCalc<POOrder.linesToCompleteCntr>), ValidateAggregateCalculation = true)]
		...
		[PXUnboundFormula(
			...
			typeof(SumCalc<POOrder.linesToCloseCntr>), ValidateAggregateCalculation = true)]
	...
	public class POReceiptQtyAction
	{
		...
		public sealed class accept : BqlString.Constant<accept> { public accept() : base(POReceiptQtyAction.Accept) { } }
		public sealed class acceptButWarn : BqlString.Constant<acceptButWarn> { public acceptButWarn() : base(POReceiptQtyAction.AcceptButWarn) { } }
		public sealed class reject : BqlString.Constant<reject> { public reject() : base(POReceiptQtyAction.Reject) { } }
	}

	//This class is used for reports
    [System.SerializableAttribute()]
    [PXHidden]
	public partial class POLineFilter : PXBqlTable, PX.Data.IBqlTable 
	{
		#region InventoryID
		public abstract class inventoryID : PX.Data.BQL.BqlInt.Field<inventoryID> { }
		protected Int32? _InventoryID;
