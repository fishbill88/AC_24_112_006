...
namespace PX.Objects.PO
{
	...
	public class POLandedCostDocEntry : PXGraph<POLandedCostDocEntry, POLandedCostDoc>
	{
		...
		[PXUIField(DisplayName = Messages.AddPOReceipt, MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select)]
		[PXLookupButton]
		...
		[PXUIField(DisplayName = Messages.AddPOReceiptLine, MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select)]
		[PXLookupButton]
			...
			IEnumerable<POLandedCostSplit> splits, IEnumerable<POLandedCostTaxTran> taxes)
		{
			...
			apGraph.Document.SetValueExt<APInvoice.curyOrigDiscAmt>(currentBill, billHeader.CuryOrigDiscAmt);
