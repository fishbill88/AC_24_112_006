...
namespace PX.Objects.SO
{
	...
	public static class Messages
	{
		...
		public const string SOSetupInvoiceApproval = "SO Invoice Approval";
		...
		public const string AddInvoiceFilter = "Add Invoice Filter";
		public const string InvoiceSplit = "Invoice Split";
		public const string SOOrderRelatedReturnsSPFilter = "Return Documents Related to Sales Order Filter";
		public const string SOOrderRelatedReturnsSPResultLine = "Return Documents by Line";
		public const string SOOrderRelatedReturnsSPResultDoc = "Related Return Documents";
		public const string InventoryLookupFilter = "Inventory Lookup Filter";
		public const string OrderInventoryLookupRow = "Sales Order Inventory Lookup Row";
		public const string InvoiceInventoryLookupRow = "Invoice Inventory Lookup Row";
		#endregion
		...
		public const string CannotShipComplete_Order = "The shipment cannot be confirmed because it does not include the {2} item from the {0} {1} sales order that has the Ship Complete order-level shipping rule on the Shipping tab of the Sales Orders (SO301000) form.";
		public const string CannotSaveComplete_Line = "The shipment cannot be saved because the quantity of the {0} item in the shipment is less than its quantity in the {1} {2} sales order, and the line has the Ship Complete rule selected.";
		public const string CannotSaveComplete_Order = "The shipment cannot be saved because it does not include the {2} item from the {0} {1} sales order that has the Ship Complete order-level shipping rule on the Shipping tab of the Sales Orders (SO301000) form.";
		public const string CannotShipCompleteTraced = "Order {0} {1} cannot be shipped in full. Check Trace for more details.";
		public const string CannotShipCompleteMarkForPOItemsTraced = "The {0} sales order with the {1} type cannot be shipped in full. For details, see the trace log: Click Tools > Trace on the form title bar.";
		public const string MarkForPOItemsNotFullyReceivedTrace = "The {0} item in line {1} that has the Marked for PO check box selected has not yet been fully received in the {2} warehouse.";
		...
		public const string AutoCreateIssuePreCheckFail = "The order cannot be saved because entering a lot or serial number is required in the settings of this order's type for a line with a lot- or serial-tracked item, and the system cannot insert this number for the automatically generated replacement line with the Issue operation. To save the order, clear the Auto Create Issue check box in the line with the {0} item.";
		...
		public const string IncorrectConfigPackageOptionAndPackSeparately = "The {0} item has By Quantity selected in the Packaging Option box and the Pack Separately check box cleared. Contact your system administrator.";
		...
		public const string OrderHasRejectedInvoice = "The {0} invoice has been rejected.";
		...
		public const string CantReverseInvoiceWithPayment = "The {0} invoice cannot be reversed because the {1} payment has been applied. Reverse the payment application before reversing the invoice.";
		...
		public const string InvoicePostProcessingFailed = "The {0} invoice has been created with the Incomplete status because the external tax provider failed to calculate the taxes. To finish processing, click Complete Processing on the Invoices (SO303000) form or use the Complete Processing action on the Process Invoices and Memos (SO505000) form.";
		public const string InvoicesPostProcessingFailed = "Some invoices have been created with the Incomplete status because the external tax provider failed to calculate the taxes. To finish processing, click Complete Processing on the Invoices (SO303000) form or use the Complete Processing action on the Process Invoices and Memos (SO505000) form.";
		public const string QtyToReturnGreaterQtyAvail = "The quantity to return cannot exceed the quantity that is available for return.";
		public const string TheItemHasBeenFullyReturned = "The {0} item has been fully returned.";
		public const string SerialNumberIsAlreadyOnHand = "The {0} item with the {1} serial number cannot be added because it has already been received.";
		...
		public const string CannotCreateInvoiceForSOWithUnpaidPPI = "An invoice cannot be created because the sales order is associated with the following unpaid prepayment invoice: {0}.";

		public const string NewTaxesCannotBeInserted = "Taxes cannot be added in the current state of the {0} document.";
		public const string ExistingTaxesCannotBeDeleted = "Taxes cannot be deleted in the current state of the {0} document.";
		public const string ExistingTaxCannotBeUpdated = "The {0} tax cannot be updated in the current state of the {1} document.";
		...
		public const string IntercompanyInvalidPOtoSOVendor = "The vendor cannot be specified because either it has been extended from the branch of the sales order or it coincides with the customer of this order.";
		...
		public const string ReverseInvoice = "Reverse Service Invoice";
		...
		public const string CreatePrepaymentInvoice = "Create Prepayment Invoice";

		public const string SOQuickPrepaymentInvoice = "SO Quick Prepayment Invoice";

		public const string ViewOrigOrder = "View Original Order";
