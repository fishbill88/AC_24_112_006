...
namespace PX.Objects.SO
{
	...
	public class SOPickerListEntry : PXBqlTable, IBqlTable
	{
		#region Keys
				...
				SOPickerListEntry unassigned = deltaQty > 0 && GetLotSerClass(cache.Graph, assigned.InventoryID).LotSerTrack == INLotSerTrack.SerialNumbered
					...
					:	SelectFrom<SOPickerListEntry>.
						Where<
							...
							And<shipmentNbr.IsEqual<shipmentNbr.FromCurrent>.
								Or<shipmentNbr.IsNull.And<shipmentNbr.FromCurrent.NoDefault.IsNull>>>>.
