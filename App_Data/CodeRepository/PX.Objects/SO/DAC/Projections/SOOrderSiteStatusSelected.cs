...
{
	/// <exclude />
	[PXCacheName(Messages.OrderInventoryLookupRow)]
	...
	public partial class SOOrderSiteStatusSelected : PXBqlTable, IQtySelectable, IPXSelectable, IBqlTable, IAlternateSelectable
	{
		#region Selected
		[PXBool]
	...
	[Obsolete("Use base class instead."), PXHidden]
	public class SOSiteStatusSelected : SOOrderSiteStatusSelected { }
}
