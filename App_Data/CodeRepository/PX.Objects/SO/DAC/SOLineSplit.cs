...
namespace PX.Objects.SO
{
	...
	public partial class SOLineSplit : PXBqlTable, PX.Data.IBqlTable, ILSDetail, IItemPlanSource
	{
		#region Keys
        ...
        [PXDBCalced(typeof(Switch<Case<Where<SOLineSplit.pOCreate, Equal<True>>, INReplenishmentSource.purchased,
			Case<Where<SOLineSplit.aMProdCreate, Equal<True>>, INReplenishmentSource.manufactured,
			Case<Where<SOLineSplit.siteID, NotEqual<SOLineSplit.toSiteID>>, INReplenishmentSource.transfer>>>,
