...
*/
	...
	public partial class SOOrderType : PXBqlTable, IBqlTable, PXNoteAttribute.IPXCopySettings
	{
		#region Keys
		...
		[PXSelector(typeof(Search<SOOrderTypeT.orderType, Where2<Where<SOOrderTypeT.requireAllocation, NotEqual<True>
				, Or2<FeatureInstalled<FeaturesSet.warehouseLocation>
					, Or2<FeatureInstalled<FeaturesSet.lotSerialTracking>
						...
						>
					>
				>>, And<Where<SOOrderTypeT.requireShipping, Equal<boolFalse>, And<SOOrderTypeT.behavior, NotEqual<SOBehavior.bL>, Or<FeatureInstalled<FeaturesSet.inventory>>>>>
			>
		>
		...
		#endregion
		#region RemoveCreditHoldByPayment
		public abstract class removeCreditHoldByPayment : PX.Data.BQL.BqlBool.Field<removeCreditHoldByPayment> { }
		/// <summary>
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIEnabled(typeof(Where<creditHoldEntry.IsEqual<True>>))]
		[PXFormula(typeof(creditHoldEntry))]
		[PXUIField(DisplayName = "Remove Credit Hold on Payment Application")]
		[PXUIVisible(typeof(Where<behavior.IsNotEqual<SOBehavior.bL>>))]
		public virtual Boolean? RemoveCreditHoldByPayment
		{
			get;
			set;
		}
	...
	[Serializable]
	[PXHidden]
	public partial class SOOrderTypeT : PXBqlTable, IBqlTable
	{
		#region Keys
