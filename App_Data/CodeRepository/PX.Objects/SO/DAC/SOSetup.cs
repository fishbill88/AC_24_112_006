...
namespace PX.Objects.SO
{
    ...
    public partial class SOSetup : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
		...
		[PXUIEnabled(typeof(addAllToShipment))]
		[PXFormula(typeof(False.When<addAllToShipment.IsEqual<False>>.Else<createZeroShipments>))]
		...
		[PXDefault(typeof(SOOrderTypeConstants.salesOrder.When<Where<FeatureInstalled<FeaturesSet.inventory>>>.Else<SOOrderTypeConstants.invoiceOrder>), PersistingCheck = PXPersistingCheck.Nothing)]
