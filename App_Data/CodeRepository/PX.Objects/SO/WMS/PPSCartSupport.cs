...
namespace PX.Objects.SO.WMS
{
	...
	public class PPSCartSupport : CartBase
	{
		...
		public class AlterPickModeLogic : PickPackShip.ScanExtension<PickPackShip.PickMode.Logic>
		{
			...
			public class AlterConfirmStateLogic : PickPackShip.ScanExtension<PickPackShip.PickMode.ConfirmState.Logic>
			{
				public static bool IsActive() => PPSCartSupport.IsActive();
				...
				protected virtual FlowStatus ConfirmPickedInCart()
				{
					...
					var pickedSplit = Mode.Picked
						.SelectMain()
						.Where(r => Target.IsSelectedSplit(r))
					...
					Target.EnsureShipmentUserLinkForPick();
