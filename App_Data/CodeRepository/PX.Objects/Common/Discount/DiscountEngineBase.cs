...
namespace PX.Objects.Common.Discount
{
	public abstract class DiscountEngine : PXGraph<DiscountEngine>
	{
		...
		[PXHidden]
		public class DiscountFeatures: PXBqlTable, IBqlTable
		{
		...
		/// </summary>
		[PXHidden]
		private class NoDiscountDetail : PXBqlTable, IBqlTable, IDiscountDetail
		{
		...
		public enum DiscountCalculationOptions
		{
			...
			[Obsolete("Flag will be removed in future versions")]
			...
			[Description("Set this flag to force formula recalculation when updating group or document discount rates. Default state: not set")]
			ForceFormulaRecalculation = 1024
		}
