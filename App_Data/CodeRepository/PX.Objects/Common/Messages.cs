...
namespace PX.Objects.Common
{
	...
	public static class Messages
	{
		...
		public const string CannotSaveLineWithZeroBaseQty = "The quantity in the {0} base UOM is 0. Change the quantity in the line to save the document.";
		...
		public const string ShowItems = "Add Items";
		...
		public const string MethodIsObsoleteAndWillBeRemoved2025R1 = "This method has been deprecated and will be removed in Acumatica ERP 2025 R1.";
		...
		public const string ClassIsObsoleteRemoveInAcumatica2025R1 = "This class has been deprecated and will be removed in Acumatica ERP 2025R1.";
		...
		public const string ReleasedDocumentCannotBeDeleted = "The {0} document with the {1} ref. number is released and cannot be deleted.";
