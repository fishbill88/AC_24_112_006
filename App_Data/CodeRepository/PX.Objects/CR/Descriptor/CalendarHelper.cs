    ...
    public class CalendarHelper
    {
		...
		private class CalendarDayInfo
		{
			...
			public int GetMinutesWorkedOnDay()
			{
				...
				double totalWorkingMinutes = (EndTime.Value - StartTime.Value).TotalMinutes;
				double totalUnpaidMinutes = (UnpaidTime ?? 0);

				return (int)(totalWorkingMinutes - totalUnpaidMinutes);
			}
		...
		{
			CalendarDayInfo calendarDayInfo = new CalendarDayInfo(calendar, dayOfWeek);
			return calendarDayInfo.GetMinutesWorkedOnDay();
		}
