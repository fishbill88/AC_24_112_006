...
namespace PX.Objects.CR
{
	...
	[Serializable]
	[PXHidden]
	public partial class OwnedFilter : PXBqlTable, IBqlTable, PX.TM.IOwnedFilter
	{
	...
	[PXHidden]
	[Obsolete]
	public partial class OwnedEscalatedFilter : PXBqlTable, IBqlTable
	{
		#region CurrentOwnerID
		public abstract class currentOwnerID : PX.Data.BQL.BqlInt.Field<currentOwnerID> { }
		...
		public EPEmployeePrimaryGraphAttribute() : base(
			...
			new[]
			{
				typeof (Select<EPEmployee,
					Where<
						EPEmployee.type, Equal<BAccountType.employeeType>,
						And<EPEmployee.bAccountID, Equal<Current<EPEmployee.bAccountID>>>>>),
				typeof (Select<EPEmployee>),
			})
		{ }
	...
	public sealed class MergableTypesSelectorAttribute : PXCustomSelectorAttribute
	{
		...
		[Serializable]
		[PXHidden]
		public class EntityInfo : PXBqlTable, IBqlTable
		{
			#region Key
