...
namespace PX.Objects.CR
{
    ...
    [Serializable]
    public partial class CROpportunityProducts : PXBqlTable, IBqlTable, IHasMinGrossProfit, ISortOrder, IMatrixItemLine
    {
		#region QuoteID
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
		[CM.PXDBCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(CROpportunityProducts.curyInfoID), typeof(CROpportunityProducts.unitPrice))]
