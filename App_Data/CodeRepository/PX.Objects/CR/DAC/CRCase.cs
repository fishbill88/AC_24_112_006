...
namespace PX.Objects.CR
{
	...
	public partial class CRCase : PXBqlTable, IBqlTable, IAssign, INotable, IPXSelectable
	{
		#region Keys
		...
		#region ReportedOnDateTime
		public abstract class reportedOnDateTime : BqlDateTime.Field<reportedOnDateTime> { }
		...
		#region InitialResponseDueDateTime
		public abstract class initialResponseDueDateTime : BqlDateTime.Field<initialResponseDueDateTime> { }

		/// <summary>
		/// The first outgoing activity deadline of the case.
		/// </summary>
		[PXDBDate(PreserveTime = true)]
		[PXUIField(DisplayName = "Initial Response Due", Enabled = false)]
		public DateTime? InitialResponseDueDateTime { get; set; }
		#endregion

		#region ResolutionDueDateTime
		public abstract class resolutionDueDateTime : BqlDateTime.Field<resolutionDueDateTime> { }

		/// <summary>
		/// The solution providing deadline of the case.
		/// </summary>
		[PXDBDate(PreserveTime = true)]
		[PXUIField(DisplayName = "Resolution Due", Enabled = false)]
		public DateTime? ResolutionDueDateTime { get; set; }
		#endregion

		#region ResponseDueDateTime
		public abstract class responseDueDateTime : BqlDateTime.Field<responseDueDateTime> { }

		/// <summary>
		/// The deadline from first unanswered incoming activity of the case to replying.
		/// </summary>
		[PXDBDate(PreserveTime = true)]
		...
		#region SolutionActivityNoteID
		public abstract class solutionActivityNoteID : BqlGuid.Field<solutionActivityNoteID> { }

		/// <summary>
		/// The activity identifier which contains the solution for the case.
		/// </summary>
		/// <value>
		/// Corresponds to the <see cref="CRActivity.NoteID"/> field.
		/// </value>
		[PXDBGuid]
		[PXUIField(DisplayName = "Solution Provided In")]
		[PXSelector(typeof(SelectFrom<
					CRActivity>
				.LeftJoin<EPActivityType>
					.On<CRActivity.FK.ActivityType>
				.Where<
					CRActivity.refNoteID.IsEqual<CRCase.noteID.FromCurrent>
					.And<CRActivity.providesCaseSolution.IsEqual<True>>>
				.OrderBy<
					CRActivity.createdDateTime.Desc>
				.SearchFor<CRActivity.noteID>),
				fieldList: new[]
				{
				...
				DescriptionField = typeof(CRActivity.selectorDescription),
		...
		[PXDBCalced(typeof(resolutionDueDateTime), typeof(DateTime))]
		...
		public virtual DateTime? ETA
		{
			get
			{
				if (ReportedOnDateTime == null || TimeEstimated == null)
					return null;
				return ((DateTime)ReportedOnDateTime).AddMinutes((int)TimeEstimated);
			}
		}
		#endregion
		...
		#region ClosureNotes
		public abstract class closureNotes : PX.Data.BQL.BqlString.Field<closureNotes> { }
		...
		public virtual int? TimeResolution
		{
			get
			{
				...
				var span = startTime.Value - ReportedOnDateTime.Value;
