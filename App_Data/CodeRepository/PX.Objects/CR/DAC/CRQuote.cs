...
namespace PX.Objects.CR
{
    ...
    [PXBreakInheritance]
    public partial class CRQuote : PXBqlTable, IBqlTable, IAssign, INotable, IPXSelectable
    {
        #region Keys
		...
		[PXSelector(typeof(Search<PMProject.contractID, Where<PMProject.baseType, Equal<CT.CTPRType.project>>>), SubstituteKey = typeof(PMProject.contractCD), DescriptionField = typeof(PMProject.description))]
