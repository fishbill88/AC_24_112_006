...
namespace PX.Objects.CR
{
	...
	public partial class CRCaseClass : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
		...
		public static class FK
		{
			...
			public class WorkCalendar : CSCalendar.PK.ForeignKeyOf<CRCaseClass>.By<calendarID> { }
		}
		#endregion
		...
		[PXDefault(typeof(SelectFrom<CSCalendar>.Where<CSCalendar.calendarID.IsEqual<CSCalendar.calendarID.defaultCalendarID>>))]
		...
		[PXForeignReference(typeof(FK.WorkCalendar))]
		...
		#endregion
		#region RequireClosureNotes
		public abstract class requireClosureNotes : PX.Data.BQL.BqlBool.Field<requireClosureNotes> { }
		...
		public virtual Boolean? RequireClosureNotes { get; set; }
		#endregion
		...
		#region TrackSolutionsInActivities
		public abstract class trackSolutionsInActivities : BqlBool.Field<trackSolutionsInActivities> { }
		...
		#region StopTimeCounterType

		public abstract class stopTimeCounterType : BqlInt.Field<stopTimeCounterType>
		{
			public const int CaseDeactivated = 0;
			public const int CaseSolutionProvidedInActivity = 1;

			public class caseDeactivated : BqlInt.Constant<caseDeactivated>
			{
				public caseDeactivated() : base(CaseDeactivated)
				{
				}
			}

			public class caseSolutionProvidedInActivity : BqlInt.Constant<caseSolutionProvidedInActivity>
			{
				public caseSolutionProvidedInActivity() : base(CaseSolutionProvidedInActivity)
				{
				}
			}
			...
			public class ListAttribute : PXIntListAttribute
			{
				public ListAttribute() : base(
					(CaseDeactivated, MessagesNoPrefix.IfCaseBecomesInactive),
					(CaseSolutionProvidedInActivity, MessagesNoPrefix.IfCaseSolutionIsProvidedInActivity))
				{
				}
			}
		...
		/// </summary>
		[PXDBInt]
		[PXUIField(DisplayName = "Stop Counting Time", FieldClass = nameof(FeaturesSet.CaseCommitmentsTracking))]
		[PXDefault(stopTimeCounterType.CaseDeactivated)]
		[stopTimeCounterType.List]
