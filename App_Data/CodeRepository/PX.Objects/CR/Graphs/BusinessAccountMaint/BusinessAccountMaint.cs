...
namespace PX.Objects.CR
{
	...
	public partial class BusinessAccountMaint : PXGraph<BusinessAccountMaint, BAccount>
	{
		...
		[PXViewDetailsButton(typeof(BAccount))]
		[PXViewDetailsButton(typeof(BAccount),
			typeof(Select<SOOrder,
				Where<SOOrder.orderType, Equal<Current<SOOrder.orderType>>,
				And<SOOrder.orderNbr, Equal<Current<SOOrder.orderNbr>>>>>), ActionName = "Orders_ViewDetails")]
		...
		public virtual void AddOpportunity()
		{
			...
			newOpportunity.CuryID = row.CuryID ?? newOpportunity.CuryID;
