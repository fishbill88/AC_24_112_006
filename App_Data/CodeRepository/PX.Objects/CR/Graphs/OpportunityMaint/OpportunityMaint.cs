...
namespace PX.Objects.CR
{
    public class OpportunityMaint : PXGraph<OpportunityMaint>, PXImportAttribute.IPXPrepareItems, IGraphWithInitialization
	{
        ...
        [Serializable]
	    public partial class CreateQuotesFilter : PXBqlTable, IBqlTable
	    {
            #region QuoteType
		...
		private void FillDefaultBAccountID(PXCache cache, CROpportunity row)
		{
			...
			if (row.ContactID != null)
			{
				...
				if (contact != null)
				{
					...
					cache.SetValueExt<CROpportunity.bAccountID>(row, contact.BAccountID);
				}
			}
		...
		{
			var quote = this.Quotes.Cache.Current;
			...
			this.Quotes.Cache.Current = quote;
		}
		...
		/// </summary>
		public class PerUnitTaxDisableExt : PX.Objects.Extensions.PerUnitTax.PerUnitTaxDataEntryGraphExtension<OpportunityMaint, CRTaxTran>
		{
