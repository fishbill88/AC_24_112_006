...
namespace PX.Objects.GL
{
	...
	public class MasterFinPeriodMaint : PXGraph<MasterFinPeriodMaint, MasterFinYear>, IFinPeriodMaintenanceGraph
	{
			...
			GLBudgetLine glBudgetLine = new SelectFrom<GLBudgetLine>
								.LeftJoin<GLBudgetLineDetail>
									.On<GLBudgetLineDetail.ledgerID.IsEqual<GLBudgetLine.ledgerID>
										...
										.And<GLBudgetLineDetail.groupID.IsEqual<GLBudgetLine.groupID>>>>
		...
		public void SynchronizeMasterAndOrganizationPeriods()
		{
			...
			PXSelectBase<Organization> organizationsSelect = new PXSelect<Organization, Where<Organization.organizationType.IsNotEqual<OrganizationTypes.group>>>(this);
	...
	[Serializable]
	public partial class FinPeriodSaveDialog : PXBqlTable, IBqlTable
	{
		#region Message
		[PXString()]
	...
	[Serializable]
	public partial class FinPeriodGenerateParameters : PXBqlTable, IBqlTable
	{
