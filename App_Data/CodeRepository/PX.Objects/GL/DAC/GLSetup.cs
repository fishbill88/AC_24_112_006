...
namespace PX.Objects.GL
{
    ...
    public partial class GLSetup : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
		...
		public abstract class cOAOrder : PX.Data.BQL.BqlShort.Field<cOAOrder>
		{
			public class ListAttribute : PXIntListAttribute
			{
				public ListAttribute()
					...
					new string[]
					{
						Messages.Assets_Liabilities_IncomeAndExpenses,
						Messages.Assets_Liabilities_Income_Expenses,
						Messages.Income_Expenses_Assets_Liabilities,
						Messages.IncomeAndExpenses_Assets_Liabilities,
						Messages.CustomChartOfAccountsOrder
					})
				{ }
