...
namespace PX.Objects.GL
{
	...
	public partial class GLTranDoc : PXBqlTable, IBqlTable, IInvoice
	{
		#region Keys
		...
		[Account(typeof(GLTranDoc.branchID),
			typeof(Search2<Account.accountID,
										LeftJoin<CashAccount, On<CashAccount.accountID, Equal<Account.accountID>,
											...
											And<Where<CashAccount.branchID, Equal<Current<GLTranDoc.branchID>>,
												Or<CashAccount.restrictVisibilityWithBranch, NotEqual<True>>>>>>>,
										LeftJoin<PaymentMethodAccount, On<PaymentMethodAccount.cashAccountID, Equal<CashAccount.cashAccountID>,
											And<PaymentMethodAccount.paymentMethodID, Equal<Optional<GLTranDoc.paymentMethodID>>>>,
										...
										Where2<Where<Optional<GLTranDoc.isARCustomerCashAccount>, NotEqual<True>,
												And<Where2<Where<Optional<GLTranDoc.tranModule>, Equal<GL.BatchModule.moduleCA>,
												...
												Or<Where<Optional<GLTranDoc.tranModule>, Equal<GL.BatchModule.moduleAR>,
													And<PaymentMethodAccount.useForAR, Equal<True>,
													And<Optional<GLTranDoc.paymentMethodID>, IsNotNull,
													And<Optional<GLTranDoc.isARCustomerCashAccount>, Equal<True>>>>>>>>),
		...
		#endregion
		#region IsARCustomerCashAccount
		public abstract class isARCustomerCashAccount : PX.Data.BQL.BqlBool.Field<isARCustomerCashAccount> { }
