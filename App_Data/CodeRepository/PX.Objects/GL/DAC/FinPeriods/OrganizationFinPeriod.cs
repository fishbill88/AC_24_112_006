...
namespace PX.Objects.GL.FinPeriods
{
	...
	[PXProjection(typeof(Select<FinPeriod, Where<FinPeriod.organizationID, NotEqual<FinPeriod.organizationID.masterValue>>>),
					Persistent = true)]
	public class OrganizationFinPeriod: PXBqlTable, IBqlTable, IFinPeriod
	{
		#region Keys
	...
	public class OrganizationFinPeriodExt : PXBqlTable, IBqlTable
	{
		#region OrganizationID
		public abstract class organizationID : PX.Data.BQL.BqlInt.Field<organizationID> { }
	...
	public class OrganizationFinPeriodCurrent : PXBqlTable, IBqlTable
	{
		#region OrganizationID
		public abstract class organizationID : PX.Data.BQL.BqlInt.Field<organizationID> { }
	...
	public class MasterPrevFinPeriodCurrent : PXBqlTable, IBqlTable
	{
		#region PrevFinPeriodID
		public abstract class prevFinPeriodID : PX.Data.BQL.BqlString.Field<prevFinPeriodID> { }
	...
	public class OrganizationFinPeriodMin : PXBqlTable, IBqlTable
	{
		#region OrganizationID
		public abstract class organizationID : PX.Data.BQL.BqlInt.Field<organizationID> { }
