...
namespace PX.Objects.GL
{
	...
	public class GLSetupApproval : PXBqlTable, IBqlTable, IAssignedMap
	{
		#region Keys
		/// <exclude/>
		...
		public class EPSetting : EPApprovalSettings<GLSetupApproval, batchType, BatchTypeCode, BatchStatus.hold, BatchStatus.pendingApproval, BatchStatus.rejected> { }
		#endregion
