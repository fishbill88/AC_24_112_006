...
namespace PX.Objects.DR
{
	...
	public class DRScheduleDetail : PXBqlTable, IBqlTable
	{
	...
	public static class DRScheduleDocumentType
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { Invoice, ARDocType.CreditMemo, ARDocType.DebitMemo, ARDocType.CashSale, ARDocType.CashReturn, Bill, APDocType.CreditAdj,
					APDocType.DebitAdj, APDocType.QuickCheck, APDocType.VoidQuickCheck, APDocType.CashReturn },
				new string[] { AR.Messages.Invoice, AR.Messages.CreditMemo, AR.Messages.DebitMemo, AR.Messages.CashSale, AR.Messages.CashReturn, AP.Messages.Invoice, AP.Messages.CreditAdj,
					AP.Messages.DebitAdj, AP.Messages.QuickCheck, AP.Messages.VoidQuickCheck, AP.Messages.CashReturn }) { ; }
		}
