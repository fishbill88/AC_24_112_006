...
namespace PX.Objects.TX
{
	...
	public class ProcessSVATBase : PXGraph<ProcessSVATBase>
	{
		...
		{
			PXSelectBase<SVATTaxTran> select = GetCommandForSVATTaxTrans(je);
		...
		{
			return new PXSelectJoin<SVATTaxTran,
				...
				Where<SVATTaxTran.module, Equal<Required<SVATConversionHistExt.module>>,
					And2<Where<SVATTaxTran.vendorID, Equal<Required<SVATConversionHistExt.vendorID>>,
						Or<SVATTaxTran.vendorID, IsNull,
						And<Required<SVATConversionHistExt.vendorID>, IsNull>>>,
					And<SVATTaxTran.tranType, Equal<Required<SVATConversionHistExt.adjdDocType>>,
					And2<Where<SVATTaxTran.refNbr, Equal<Required<SVATConversionHistExt.adjdRefNbr>>, Or<SVATTaxTran.refNbr, Equal<Required<SVATTaxTran.refNbr>>>>,
					And<SVATTaxTran.taxID, Equal<Required<SVATConversionHistExt.taxID>>>>>>>>(je);
		}
	}
    ...
    [Serializable]
	public partial class SVATTaxFilter : PXBqlTable, IBqlTable
	{
		#region Date
