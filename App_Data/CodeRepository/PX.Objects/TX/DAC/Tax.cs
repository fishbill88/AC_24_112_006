...
namespace PX.Objects.TX
{
	...
	public partial class Tax : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
		...
		public static class FK
		{
			...
			public class OnARPrepaymentTaxAccount : GL.Account.PK.ForeignKeyOf<Tax>.By<onARPrepaymentTaxAcctID> { }
			public class OnARPrepaymentTaxSubaccount : GL.Sub.PK.ForeignKeyOf<Tax>.By<onARPrepaymentTaxSubID> { }
		...
		#region OnARPrepaymentTaxAcctID
		public abstract class onARPrepaymentTaxAcctID : PX.Data.BQL.BqlInt.Field<onARPrepaymentTaxAcctID> { }

		/// <summary>
		/// The foreign key to <see cref="Account"/>, which specifies liability or asset account
		/// that keeps VAT collected on prepayment invoices for which final invoice is not issued yet.
		/// Uses when the feature <see cref="FeaturesSet.VATRecognitionOnPrepayments"/> is activated.
		/// </summary>
		[Account(DisplayName = "Tax on AR Prepayment Account", DescriptionField = typeof(Account.description), ControlAccountForModule = ControlAccountModule.TX)]
		[PXForeignReference(typeof(Field<Tax.onARPrepaymentTaxAcctID>.IsRelatedTo<Account.accountID>))]
		public virtual int? OnARPrepaymentTaxAcctID { get; set; }

		#endregion
		#region OnARPrepaymentTaxSubID
		public abstract class onARPrepaymentTaxSubID : PX.Data.BQL.BqlInt.Field<onARPrepaymentTaxSubID> { }

		/// <summary>
		/// The foreign key to <see cref="Sub"/>, which specifies the corresponding tax on AR prepayments subaccount.
		/// Uses when the feature <see cref="FeaturesSet.VATRecognitionOnPrepayments"/> is activated.
		/// </summary>
