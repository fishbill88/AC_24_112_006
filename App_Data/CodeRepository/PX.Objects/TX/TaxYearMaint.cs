...
namespace PX.Objects.TX
{
	public class TaxYearMaint: PXGraph<TaxYearMaint>
	{
		...
		public class TaxYearFilter : PXBqlTable, PX.Data.IBqlTable
		{
				...
				else
				{
						...
						|| oldTaxYearFilter.StartDate != taxYearFilter.StartDate)
					{
						...
						if (taxYearFilter.TaxPeriodType == VendorTaxPeriodType.FiscalPeriod && taxYearFilter.StartDate != null)
						{
							...
							if (finYear == null)
							{
								cache.RaiseExceptionHandling<TaxYearFilter.taxPeriodType>(taxYearFilter, taxYearFilter.TaxPeriodType, new PXSetPropertyException(Messages.TaxYearStartDateDoesNotMatch));
								SetIsDirty(false);
								return;
							}
						}
		...
		/// <summary>
		/// Set IsDirty value of the graph
		/// </summary>
		protected virtual void SetIsDirty(bool value)
		{
			TaxPeriodExSelectView.Cache.IsDirty = value;
			TaxYearExSelectView.Cache.IsDirty = value;
		}
		#endregion
		...
		[PXButton(ImageSet = PX.Web.UI.Sprite.AliasMain, ImageKey = PX.Web.UI.Sprite.Main.RecordDel)]
		[PXUIField(DisplayName = ActionsMessages.Delete, MapEnableRights = PXCacheRights.Delete, MapViewRights = PXCacheRights.Delete)]
		...
		[PXButton(ImageSet = PX.Web.UI.Sprite.AliasMain, ImageKey = PX.Web.UI.Sprite.Main.AddNew)]
