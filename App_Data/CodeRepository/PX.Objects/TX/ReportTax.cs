...
namespace PX.Objects.TX
{
	...
	public partial class TaxPeriodFilter : PXBqlTable, IBqlTable
	{
	...
	[Serializable]
	public partial class TaxHistoryMaster : PXBqlTable, IBqlTable
	{
		#region OrganizationID
		public abstract class organizationID : PX.Data.BQL.BqlInt.Field<organizationID> { }
	...
	[PXHidden]
	public partial class TaxPeriodPlusOpen : PXBqlTable, PX.Data.IBqlTable
	{
		#region OrganizationID
		public abstract class organizationID : PX.Data.BQL.BqlInt.Field<organizationID> { }
	...
	public partial class TaxPeriodForReportShowing : PXBqlTable, PX.Data.IBqlTable
	{
		#region OrganizationID
		public abstract class organizationID : PX.Data.BQL.BqlInt.Field<organizationID> { }
	...
	public partial class TaxPeriodEffective : PXBqlTable, PX.Data.IBqlTable
	{
		#region OrganizationID
		public abstract class organizationID : PX.Data.BQL.BqlInt.Field<organizationID> { }
	...
	[PXProjection(typeof(Select2<TaxTran,
			...
			>>>>>>>>>>>>>>))]
	[PXHidden]
	public partial class TaxTranRevReport : PXBqlTable, PX.Data.IBqlTable
	{
		#region BranchID
		public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
	...
	public partial class TaxDetailReport : PXBqlTable, PX.Data.IBqlTable
	{
		#region LineNbr
		public abstract class lineNbr : PX.Data.BQL.BqlInt.Field<lineNbr> { }
		protected Int32? _LineNbr;
	...
	public partial class TaxReportSummary : PXBqlTable, PX.Data.IBqlTable
	{
		#region LineNbr
		public abstract class lineNbr : PX.Data.BQL.BqlInt.Field<lineNbr> { }
		protected Int32? _LineNbr;
...
>>>>>>>>>>>>))]
	...
	public partial class TaxDetailReportCurrency : PXBqlTable, PX.Data.IBqlTable
	{
		#region LineNbr
		public abstract class lineNbr : PX.Data.BQL.BqlInt.Field<lineNbr> { }
		protected Int32? _LineNbr;
	...
	[PXHidden]
	public partial class TaxDetailByGLReportCurrency : PXBqlTable, PX.Data.IBqlTable
	{
		#region Module
		public abstract class module : PX.Data.BQL.BqlString.Field<module> { }
		protected String _Module;
		...
		LeftJoin<TaxPeriodEffective,
				...
				And<Where<TaxTran.taxPeriodID, IsNull,
								...
								And<TaxPeriodEffective.status, Equal<TaxPeriodStatus.open>,
													Or<TaxTran.taxPeriodID, Equal<TaxPeriodEffective.taxPeriodID>>>>>>>>>>>>>>>>>))]
	[PXCacheName(Messages.TaxDetailReport)]
	public partial class TaxDetailByGLReport : PXBqlTable, PX.Data.IBqlTable
	{
		#region Module
		public abstract class module : PX.Data.BQL.BqlString.Field<module> { }
		protected String _Module;
...
#pragma warning disable PX1015
	...
	public class ReportTax : PXGraph<ReportTax>
	{
			...
			if (allowProcess)
			{
				...
				switch (taxper.Status)
				{
					case TaxPeriodStatus.Dummy:
						allowProcess = CheckProcessAllowableOnDummyStatus(filter, taxper, vendor, filterCache, allowProcess, _branches, taxPeriodIDForMessage);
						break;
					case TaxPeriodStatus.Closed:
						{
							allowProcess = CheckProcessAllowableOnClosedStatus(filter, taxper, vendor, filterCache, allowProcess, _branches, taxPeriodIDForMessage);
						}
						break;
					case TaxPeriodStatus.Prepared:
						{
							allowProcess = CheckProcessAllowableOnPreparedStatus(filter, taxper, vendor, filterCache, allowProcess, _branches, taxPeriodIDForMessage);
						}
						break;
					default:
						{
							allowProcess = CheckProcessAllowableOnOpenStatus(filter, taxper, vendor, filterCache, allowProcess, _branches, taxPeriodIDForMessage);
						}
						break;
				}
			}
		...
		protected virtual bool CheckProcessAllowableOnDummyStatus(TaxPeriodFilter filter, TaxPeriod taxPeriod, Vendor vendor, PXCache filterCache, bool allowProcess, int?[] _branches, string taxPeriodIDForMessage)
		{
			filterCache.RaiseExceptionHandling<TaxPeriodFilter.vendorID>(filter, taxPeriod.VendorID,
										new PXSetPropertyException<TaxPeriodFilter.vendorID>(Messages.TaxAgencyWithoutTran, PXErrorLevel.Warning));
			return allowProcess;
		}

		protected virtual bool CheckProcessAllowableOnOpenStatus(TaxPeriodFilter filter, TaxPeriod taxPeriod, Vendor vendor, PXCache filterCache, bool allowProcess, int?[] _branches, string taxPeriodIDForMessage)
		{
			...
			if (period != null && vendor.UpdClosedTaxPeriods != true &&
				(vendor.TaxReportFinPeriod != true && taxPeriod.StartDate > tran.TranDate ||
					vendor.TaxReportFinPeriod == true && taxPeriod.StartDate > tran.FinDate))
			{
		...
		protected virtual bool CheckProcessAllowableOnPreparedStatus(TaxPeriodFilter filter, TaxPeriod taxPeriod, Vendor vendor, PXCache filterCache, bool allowProcess, int?[] _branches, string taxPeriodIDForMessage)
		{
			TaxTran tran = GetEarliestNotReportedTaxTran(this, vendor, filter.OrganizationID, _branches, filter.TaxPeriodID);
		...
		protected virtual bool CheckProcessAllowableOnClosedStatus(TaxPeriodFilter filter, TaxPeriod taxPeriod, Vendor vendor, PXCache filterCache, bool allowProcess, int?[] _branches, string taxPeriodIDForMessage)
		{
			TaxTran tran = GetEarliestNotReportedTaxTran(this, vendor, filter.OrganizationID, _branches, filter.TaxPeriodID);
			...
			if (tran == null || tran.TranDate == null ||
				(vendor.TaxReportFinPeriod != true && taxPeriod.EndDate <= tran.TranDate ||
					vendor.TaxReportFinPeriod == true && taxPeriod.EndDate <= tran.FinDate))
			{
				var exception = new PXSetPropertyException<TaxPeriodFilter.taxPeriodID>(
