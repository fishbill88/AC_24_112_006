...
namespace PX.Objects.AR
{
	...
	public partial class CustSalesPeople : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
    ...
    [Serializable]
    [PXHidden]
    public partial class CustDefSalesPeople : PXBqlTable, IBqlTable
    {
        #region SalesPersonID
        public abstract class salesPersonID : PX.Data.BQL.BqlInt.Field<salesPersonID> { }
        protected Int32? _SalesPersonID;
		...
		[PXHidden]
        [Serializable]
        public class Location : PXBqlTable, IBqlTable
        {
            #region BAccountID
            public abstract class bAccountID : PX.Data.BQL.BqlInt.Field<bAccountID> { }
            protected Int32? _BAccountID;
