...
namespace PX.Objects.AR
{
    ...
    public class ARTranPostGL : PXBqlTable, IBqlTable
    {
        #region Keys
        ...
        [PXBaseCury]
        [PXDBCalced(typeof(ARTranPost.glSign.Multiply<ARTranPost.amt>), typeof(decimal))]
		...
		/// <inheritdoc cref="ARTranPost.GLSign"/>
