...
namespace PX.Objects.AR
{
	...
	public class ARTranPost : PXBqlTable, IBqlTable
	{
		#region Keys
		...
		[PXFormula(typeof(Switch<
			Case<Where<docType.IsIn<ARDocType.refund, ARDocType.voidRefund, ARDocType.invoice, ARDocType.debitMemo,
		...
		public abstract class tranClass : PX.Data.BQL.BqlString.Field<tranClass>
		{
			...
			public class PPIN : PX.Data.BQL.BqlString.Constant<PPIN> { public PPIN() : base(nameof(PPIN)) { } }
			public class PPIP : PX.Data.BQL.BqlString.Constant<PPIP> { public PPIP() : base(nameof(PPIP)) { } }
			public class PPIY : PX.Data.BQL.BqlString.Constant<PPIY> { public PPIY() : base(nameof(PPIY)) { } }
			public class CRMY : PX.Data.BQL.BqlString.Constant<CRMY> { public CRMY() : base(nameof(CRMY)) { } }
		}
		[PXDBString]
	...
	public partial class ARTranPostAlias : ARTranPost
	{
		...
		public new abstract class voidAdjNbr : PX.Data.BQL.BqlDecimal.Field<voidAdjNbr> { }
	}
}
