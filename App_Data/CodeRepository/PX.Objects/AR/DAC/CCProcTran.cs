...
namespace PX.Objects.AR
{
	...
	public partial class CCProcTran : PXBqlTable, PX.Data.IBqlTable, ICCPaymentTransaction 
	{
		#region Keys
	...
	public static class CVVVerificationStatusCode 
	{
		...
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
new string[] { CVVVerificationStatusCode.Matched, NotMatched, RequiredButNotVerified, RequiredButNotProvided, NotVerifiedDueToIssuer, SkippedDueToPriorVerification, NotApplicable, Empty, Unknown },
				new string[] { "Matched", "Not Matched", "Required but Not Verified", "Required but Not Provided", "Not Verified Due to Issuer", "Skipped Due to Prior Verification", "Not applicable", "Processing center response is empty", "Unknown" })
			{ }
		}
		...
		private static (CcvVerificationStatus, string)[] _statuses = new[] {
			...
			(CcvVerificationStatus.RelyOnPreviousVerification, SkippedDueToPriorVerification), (CcvVerificationStatus.NotApplicable, NotApplicable), (CcvVerificationStatus.Empty, Empty), (CcvVerificationStatus.Unknown, Unknown)
		};
	}
}
