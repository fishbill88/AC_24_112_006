...
namespace PX.Objects.AR
{
	[PXProjection(typeof(Select2<
		...
		Persistent = false)]
	[PXHidden]
	public class ARRegisterTranPostGL : PXBqlTable, IBqlTable
	{
		#region Keys
		...
		#region CalcCuryDebitARAmt
		public abstract class calcCuryDebitARAmt : PX.Data.BQL.BqlDecimal.Field<calcCuryDebitARAmt> { }

		[PXDecimal]
		[PXDBCalced(typeof(IIf<Where<ARTranPostGL.accountID.IsEqual<ARRegister.aRAccountID>>,
							ARTranPostGL.curyBalanceAmt.Multiply<ARTranPostGL.balanceSign>,
							decimal0>), typeof(decimal))]
		public virtual decimal? CalcCuryDebitARAmt { get; set; }
		#endregion
		#region CalcDebitARAmt
		public abstract class calcDebitARAmt : PX.Data.BQL.BqlDecimal.Field<calcDebitARAmt> { }

		[PXDecimal]
		[PXDBCalced(typeof(IIf<Where<ARTranPostGL.accountID.IsEqual<ARRegister.aRAccountID>>,
							ARTranPostGL.balanceAmt.Multiply<ARTranPostGL.balanceSign>,
							decimal0>), typeof(decimal))]
		public virtual decimal? CalcDebitARAmt { get; set; }
		#endregion
		#region CalcCuryCreditARAmt
		public abstract class calcCuryCreditARAmt : PX.Data.BQL.BqlDecimal.Field<calcCuryCreditARAmt> { }

		[PXDecimal]
		[PXDBCalced(typeof(IIf<Where<ARTranPostGL.accountID.IsNotEqual<ARRegister.aRAccountID>>,
							ARTranPostGL.curyBalanceAmt.Multiply<ARTranPostGL.balanceSign>,
							decimal0>), typeof(decimal))]
		public virtual decimal? CalcCuryCreditARAmt { get; set; }
		#endregion
		#region CalcDebitARAmt
		public abstract class calcCreditARAmt : PX.Data.BQL.BqlDecimal.Field<calcCreditARAmt> { }
	...
	[PXProjection(typeof(Select4<
		...
		Aggregate<
			...
			Sum<ARRegisterTranPostGL.calcCuryDebitARAmt,
			Sum<ARRegisterTranPostGL.calcDebitARAmt,
			Sum<ARRegisterTranPostGL.calcCuryCreditARAmt,
			Sum<ARRegisterTranPostGL.calcCreditARAmt,
		...
		>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>), Persistent = false)]
	[PXHidden]
	public class ARRegisterTranPostGLGrouped : PXBqlTable, IBqlTable
	{
		#region Keys
