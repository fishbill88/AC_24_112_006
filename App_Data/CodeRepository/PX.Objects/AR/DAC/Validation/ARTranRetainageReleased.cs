...
namespace PX.Objects.AR
{
	[PXProjection(typeof(Select2<
		...
		Where<ARRegister.paymentsByLinesAllowed, Equal<True>,
			...
			>>>>), Persistent = false)]
	[PXHidden]
	public class ARTranRetainageReleased : PXBqlTable, IBqlTable
	{
		#region Keys
		...
		[PXString(IsKey = true)]
		[PXDBCalced(typeof(
			IIf<ARRegister.isRetainageDocument.IsNotEqual<True>.And<ARRegister.isRetainageReversing.IsEqual<True>>,
			ARRegister.origDocType,
			ARTran.origDocType>), typeof(string))]
		...
		[PXDBCalced(typeof(
			...
			ARTran.origRefNbr>), typeof(string))]
	...
	[PXProjection(typeof(Select4<
		...
		Aggregate<
			...
			>>>>>>>), Persistent = false)]
	[PXHidden]
	public class ARTranRetainageReleasedTotal : PXBqlTable, IBqlTable
	{
		#region Keys
