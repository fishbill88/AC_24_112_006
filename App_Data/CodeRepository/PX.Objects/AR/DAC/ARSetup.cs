...
namespace PX.Objects.AR
{
	...
	public partial class ARSetup : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
		public static class FK
		{
			...
			public class PrepaymentInvoiceNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<prepaymentInvoiceNumberingID> { }
		...
		#endregion
		#region PrepaymentInvoiceNumberingID
		public abstract class prepaymentInvoiceNumberingID : PX.Data.BQL.BqlString.Field<prepaymentInvoiceNumberingID> { }
		// Acuminator disable once PX1007 NoXmlCommentForPublicEntityOrDacProperty to be documented later
		[PXDBString(10, IsUnicode = true)]
		[PXDefault("ARINVOICE")]
		[PXSelector(typeof(Numbering.numberingID), DescriptionField = typeof(Numbering.descr))]
		[PXUIField(DisplayName = "Prepayment Invoice Numbering Sequence", Visibility = PXUIVisibility.Visible, FieldClass = nameof(FeaturesSet.VATRecognitionOnPrepayments))]
		public virtual String PrepaymentInvoiceNumberingID
		{
			get;
			set;
		}
		...
		public virtual bool? AddUnpaidPPI
		{
			get
			{
				return this._AddUnpaidPPI;
			}
			set
			{
				this._AddUnpaidPPI = value;
			}
		}
		#endregion
		...
		[PXUIField(DisplayName = "Tax Adjustment Description", Visibility = PXUIVisibility.SelectorVisible)]
		...
		#endregion
		#region TermsInCreditMemos
		public abstract class termsInCreditMemos : PX.Data.BQL.BqlBool.Field<termsInCreditMemos> { }
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Use Credit Terms in Credit Memos", Visibility = PXUIVisibility.Visible)]
		public virtual bool? TermsInCreditMemos
		{
			get;
			set;
		}
