...
namespace PX.Objects.AR
{
	...
	public partial class CustomerPaymentMethod : PXBqlTable, PX.Data.IBqlTable, ICCPaymentProfile, INotable
	{
		#region Keys
		...
		[PXSelector(typeof(Search<PaymentMethod.paymentMethodID, Where<PaymentMethod.isActive,Equal<True>,
                            And<PaymentMethod.useForAR,Equal<True>, And<PaymentMethod.paymentType, NotEqual<PaymentMethodType.posTerminal>>>>>), DescriptionField = typeof(PaymentMethod.descr))]
	...
	public partial class CustomerPaymentMethodInputMode : PXBqlTable, IBqlTable
	{
		#region InputMode
