...
namespace PX.Objects.AR
{
    ...
    public class ARHistoryTran : PXBqlTable, IBqlTable
    {
        #region Keys
        ...
        [PXDBCalced(typeof(
            Switch<
                Case<Where<ARTranPostGL.tranClass.IsEqual<ARTranPost.tranClass.PPMB>>,
                    short2.Multiply<ARTranPostGL.creditARAmt.Subtract<ARTranPostGL.debitARAmt>>,
                Case<Where<ARTranPostGL.tranClass.IsIn<
                    ...
                    ARTranPostGL.creditARAmt.Subtract<ARTranPostGL.debitARAmt>,
                Case<Where<ARTranPostGL.tranClass.IsIn<
                        ARTranPost.tranClass.CRMY, ARTranPost.tranClass.PPIP,
