...
namespace PX.Objects.AR
{
	...
	public partial class ARAdjust 
		: PXBqlTable, IBqlTable, IAdjustment, IDocumentAdjustment, IAdjustmentAmount, Common.GraphExtensions.Abstract.DAC.IFinAdjust, ICreatePaymentAdjust
	{
		#region Keys
	...
	[PXDefault(typeof(ARPayment.adjCntr))]
		...
		/// </summary>
		/// <value>
		/// Corresponds to the <see cref="ARInvoice.docType"/> field.
		/// </value>
		...
		/// </summary>
		/// <value>
		/// Value is <see cref="ARAdjust.PPDVATAdjDocType"/> + <see cref="ARAdjust.PPDVATAdjRefNbr"/> field.
		/// </value>
		[PXString(40, InputMask = "")]
		[PXUIField(DisplayName = "Tax Adjustment", Enabled = false, Visible = false)]
		public virtual string PPDVATAdjDescription
		{
			get;
			set;
		}
...
namespace PX.Objects.AR.Standalone
{
	[PXHidden]
	[Serializable]
	public class ARAdjust : PXBqlTable, IBqlTable
	{
		#region AdjdDocType
		public abstract class adjdDocType : PX.Data.BQL.BqlString.Field<adjdDocType> { }
		[PXDBString(3, IsKey = true, IsFixed = true, InputMask = "")]
