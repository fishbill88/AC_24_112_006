...
namespace PX.Objects.AR
{
    ...
    [PXHidden]
    public class ARTranPostBal : PXBqlTable, IBqlTable
    {
        #region Keys
		...
		[PXDBCalced(typeof(
			Switch<
				Case<Where<Standalone.ARRegisterAlias.curyID.IsEqual<CM.CurrencyInfo2.curyID>>,
					Switch<
						Case<Where<Standalone.ARRegisterAlias.paymentsByLinesAllowed.IsEqual<True>>, ARTran.curyTranBal>,
						Standalone.ARRegisterAlias.curyDocBal>
				>,
				Data.Round<
					Mult<
						Switch<
							Case<Where<Standalone.ARRegisterAlias.paymentsByLinesAllowed.IsEqual<True>>, ARTran.tranBal>,
							Standalone.ARRegisterAlias.docBal>,
						Switch<
							Case<Where<CM.CurrencyInfo2.curyMultDiv.IsEqual<CuryMultDivType.mult>>, CM.CurrencyInfo2.recipRate>,
							CM.CurrencyInfo2.curyRate>
					>,
