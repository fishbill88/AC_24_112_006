...
{
	[Serializable]
	public partial class ARIntegrityCheckFilter : PXBqlTable, PX.Data.IBqlTable
	{
	...
	public class ARIntegrityCheck : PXGraph<ARIntegrityCheck>
	{
		...
		protected virtual void UpdateDocumentBalances(Customer cust, string finPeriod)
		{
			...
			PXUpdateJoin<
					Set<ARRegister.docBal,
						IIf<Where<ARRegisterTranPostGLGrouped.docType, Equal<ARDocType.prepaymentInvoice>>,
							IIf<Where<ARRegisterTranPostGLGrouped.calcDebitARAmt, NotEqual<Zero>>,
								ARRegisterTranPostGLGrouped.calcDebitARAmt,
								Minus<ARRegisterTranPostGLGrouped.calcCreditARAmt>>,
						ARRegisterTranPostGLGrouped.calcBalance>,

					Set<ARRegister.curyDocBal,
						IIf<Where<ARRegisterTranPostGLGrouped.docType, Equal<ARDocType.prepaymentInvoice>>,
							IIf<Where<ARRegisterTranPostGLGrouped.calcCuryDebitARAmt, NotEqual<Zero>>,
								ARRegisterTranPostGLGrouped.calcCuryDebitARAmt,
								Minus<ARRegisterTranPostGLGrouped.calcCuryCreditARAmt>>,
					...
					Set<ARRegister.status,
						Switch<
							...
							Case<Where<ARRegisterTranPostGLGrouped.pendingPayment, Equal<True>>,
							...
							Case<Where<ARRegisterTranPostGLGrouped.calcBalance, Equal<Zero>>,
								ARDocStatus.closed>>>>>,
								// Default
								IIf<Where<ARRegister.docType, Equal<ARDocType.prepaymentInvoice>>,
									ARDocStatus.unapplied, ARDocStatus.open>>,
				...
				InnerJoin<ARRegisterTranPostGLGrouped,
					...
					And<ARRegisterTranPostGLGrouped.customerID, Equal<Required<ARRegister.customerID>>>>>>,
				...
				.Update(this, userID, screenID, lastModified, cust.BAccountID, cust.BAccountID, finPeriod);
		}
		...
		private static void ReopenDocumentsHavingPendingApplications(PXGraph graph, Customer customer, string finPeriod)
		{
			...
			PXUpdate<Set<ARRegister.status,
				IIf<Where<ARRegister.docType, Equal<ARDocType.prepaymentInvoice>>,
