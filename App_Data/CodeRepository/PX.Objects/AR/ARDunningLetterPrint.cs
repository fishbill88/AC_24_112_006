...
namespace PX.Objects.AR
{
    public class ARDunningLetterPrint : PXGraph<ARDunningLetterPrint>
    {
		...
		[Serializable]
        public partial class PrintParameters : PXBqlTable, IBqlTable, PX.SM.IPrintable
		{
            #region Action
    ...
    public class ARDunningLetterUpdate : PXGraph<ARDunningLetterUpdate, Customer>
	{
		...
		public virtual void EMailDL(int dunningLetterID, bool markOnly, bool showAll)
        {
            ...
            else
            {
				...
				this.GetExtension<ARDunningLetterUpdate_ActivityDetailsExt>().SendNotification<ARDunningLetter>(ARNotificationSource.Customer, notificationCD, dunningLetter.BranchID, new Dictionary<string, string>() { { "DunningLetterID", dunningLetterID.ToString() } }, true);
