...
namespace PX.Objects.AR
{
	...
	public class ARDocumentEnq : PXGraph<ARDocumentEnq>
	{
		...
		[Serializable]
		public partial class ARDocumentFilter : PXBqlTable, IBqlTable
		{
		...
		[Serializable()]
		[PXHidden]
		public class ARRegister : PXBqlTable, IBqlTable
		{
			#region DocType
			public abstract class docType : PX.Data.BQL.BqlString.Field<docType>
			{
			...
			public abstract class refNbr : PX.Data.BQL.BqlString.Field<refNbr>
		{
			...
			[PXDBCalced(typeof(
				Switch<Case<Where<ARRegister.docType.IsIn<ARDocType.refund, ARDocType.voidRefund, ARDocType.invoice, ARDocType.debitMemo, ARDocType.finCharge, ARDocType.smallCreditWO, ARDocType.cashSale, ARDocType.prepaymentInvoice>>,
					decimal1>,
		...
		public partial class ARDocumentResult : PXBqlTable, IBqlTable
		{
			#region DocType
			public abstract class docType : PX.Data.BQL.BqlString.Field<docType>
			{
			...
			public abstract class refNbr : PX.Data.BQL.BqlString.Field<refNbr>
		{
			...
			[Account(typeof(branchID), DisplayName = "Account",
				BqlField = typeof(ARRegister.aRAccountID))]
			...
			[SubAccount(typeof(accountID), DescriptionField = typeof(Sub.description), DisplayName = "Subaccount", Visibility = PXUIVisibility.Visible,
				BqlField = typeof(ARRegister.aRSubID))]
			public virtual int? SubID { get; set; }
			#endregion
			#region PendingPayment
			public abstract class pendingPayment : PX.Data.BQL.BqlBool.Field<pendingPayment> { }

			///<inheritdoc cref="ARRegister.PendingPayment"/>.
			[PXDBBool(BqlTable = typeof(ARRegister))]
			public virtual bool? PendingPayment { get; set; }
			#endregion
		}
		...
		public partial class ARDocumentPeriodResult : PXBqlTable, IBqlTable
		{
			#region DocType
			public abstract class docType : PX.Data.BQL.BqlString.Field<docType>
			{
			...
			/// The counter of <see cref="TermsInstallment">installments</see> associated with the document.
			/// </summary>
			[PXDBShort(BqlTable = typeof(ARDocumentResult))]
			public virtual short? InstallmentCntr { get; set; }
			#endregion
			#region BatchNbr
			public abstract class batchNbr : PX.Data.BQL.BqlString.Field<batchNbr> { }
			...
			/// </summary>
			[PXDefault(TypeCode.Decimal, "0.0")]
			[PXCurrency(typeof(ARRegister.curyInfoID), typeof(ARRegister.origDocAmt), BqlTable=typeof(ARDocumentResult))]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.glSign.Multiply<ARDocumentResult.curyOrigDocAmt>,
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.curyOrigDocAmt>), typeof(decimal))]
			[PXUIField(DisplayName = "Currency Origin. Amount", Visibility = PXUIVisibility.SelectorVisible)]
			public virtual decimal? CuryOrigDocAmt
			{
				get;
			...
			/// Given in the <see cref="Company.BaseCuryID">base currency of the company</see>.
			/// </summary>
			[PXBaseCury(BqlTable=typeof(ARDocumentResult))]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.glSign.Multiply<ARDocumentResult.origDocAmt>,
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.origDocAmt>), typeof(decimal))]
			[PXDefault(TypeCode.Decimal, "0.0")]
			[PXUIField(DisplayName = "Origin. Amount", Visibility = PXUIVisibility.SelectorVisible)]
			public virtual decimal? OrigDocAmt
			{
			...
			/// </summary>
			[PXDefault(TypeCode.Decimal, "0.0")]
			[PXCurrency(typeof(curyInfoID), typeof(origDiscAmt),BqlTable=typeof(ARDocumentResult))]
			[PXUIField(DisplayName = "Cash Discount", Visibility = PXUIVisibility.SelectorVisible)]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.glSign.Multiply<ARDocumentResult.curyOrigDiscAmt>,
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.curyOrigDiscAmt>), typeof(decimal))]
			public virtual decimal? CuryOrigDiscAmt
			{
				get;
				set;
			...
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.glSign.Multiply<ARDocumentResult.origDiscAmt>,
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.origDiscAmt>), typeof(decimal))]
			public virtual decimal? OrigDiscAmt
			{
				get;
				set;
			...
			[CM.PXCury(typeof(curyID), BqlTable=typeof(ARDocumentResult))]
			[PXUIField(DisplayName = "Total Amount", FieldClass = nameof(FeaturesSet.Retainage))]
			[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.glSign.Multiply<ARDocumentResult.curyOrigDocAmtWithRetainageTotal>,
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.curyOrigDocAmtWithRetainageTotal>), typeof(decimal))]
			public virtual decimal? CuryOrigDocAmtWithRetainageTotal
			{
				get;
				set;
			...
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.glSign.Multiply<ARDocumentResult.origDocAmtWithRetainageTotal>,
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.origDocAmtWithRetainageTotal>), typeof(decimal))]
			public virtual decimal? OrigDocAmtWithRetainageTotal
			{
				get;
				set;
			...
			[PXCury(typeof(ARRegister.curyID))]
			[PXUIField(DisplayName = "Currency Cash Discount Taken")]
			[PXDBCalced(typeof(ARTranPostGL.curyTurnDiscAmt.Multiply<ARTranPostGL.glSign>.IfNullThen<decimal0>), typeof(decimal))]
			public virtual decimal? CuryDiscActTaken
			{
				get;
				set;
			...
			[PXBaseCury()]
			[PXUIField(DisplayName = "Cash Discount Taken")]
			[PXDBCalced(typeof(ARTranPostGL.turnDiscAmt.Multiply<ARTranPostGL.glSign>.IfNullThen<decimal0>), typeof(decimal))]
			public virtual decimal? DiscActTaken
			{
				get;
				set;
			...
			[PXUIField(DisplayName = "Unreleased Retainage", FieldClass = nameof(FeaturesSet.Retainage))]
			[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
			[PXDBCalced(typeof(ARTranPostGL.curyRetainageUnreleasedAmt.Multiply<ARTranPostGL.balanceSign>.IfNullThen<decimal0>), typeof(decimal))]
			public virtual decimal? CuryRetainageUnreleasedAmt
			{
				get;
				set;
			...
			[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
			[PXUIField(DisplayName = "Unreleased Retainage", FieldClass = nameof(FeaturesSet.Retainage))]
			[PXDBCalced(typeof(ARTranPostGL.retainageUnreleasedAmt.Multiply<ARTranPostGL.balanceSign>.IfNullThen<decimal0>), typeof(decimal))]
			public virtual decimal? RetainageUnreleasedAmt
			{
				get;
				set;
			...
			[Account(typeof(branchID), IsDBField = false, DisplayName = "Account",
				BqlTable = typeof(ARDocumentResult))]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>>,
					ARTranPostGL.accountID>,
					ARDocumentResult.aRAccountID>), typeof(int?))]
			public virtual int? AccountID { get; set; }
			#endregion
			#region SubID
			public abstract class subID : PX.Data.BQL.BqlInt.Field<subID> { }
			...
			[SubAccount(typeof(accountID), IsDBField = false, DescriptionField = typeof(Sub.description), DisplayName = "Subaccount", Visibility = PXUIVisibility.Visible,
				BqlTable = typeof(ARDocumentResult))]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>>,
					ARTranPostGL.subID>,
		...
		[PXProjection(typeof(Select2<ARDocumentResult,
			LeftJoin<ARTranPostGL,
				On<ARTranPostGL.docType, Equal<ARDocType.prepaymentInvoice>,
				And<ARTranPostGL.docType, Equal<ARDocumentResult.docType>,
				And<ARTranPostGL.refNbr, Equal<ARDocumentResult.refNbr>>>>>>))]
		[PXHidden]
		public partial class ARDocumentPPIPeriodResult : PXBqlTable, IBqlTable
		{
			#region DocType
			public abstract class docType : PX.Data.BQL.BqlString.Field<docType>
			{
			...
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.curyTurnAmt, //Retainage is not supported for PPI
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.curyOrigDocAmtWithRetainageTotal>), typeof(decimal))]
			...
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.origin>>>,
						ARTranPostGL.turnAmt, //Retainage is not supported for PPI
					Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						Null>>,
					ARDocumentResult.origDocAmtWithRetainageTotal>), typeof(decimal))]
			...
			[PXCury(typeof(ARRegister.curyID))]
			[PXUIField(DisplayName = "Currency Cash Discount Taken")]
			[PXDBCalced(typeof(ARTranPostGL.curyTurnDiscAmt.Multiply<ARTranPostGL.glSign>.IfNullThen<ARDocumentResult.curyDiscActTaken>), typeof(decimal))]
			...
			[PXBaseCury]
			[PXUIField(DisplayName = "Cash Discount Taken")]
			[PXDBCalced(typeof(ARTranPostGL.turnDiscAmt.Multiply<ARTranPostGL.glSign>.IfNullThen<ARDocumentResult.discActTaken>), typeof(decimal))]
			...
			[PXUIField(DisplayName = "RGOL Amount")]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARTranPostGL.type.IsEqual<ARTranPost.type.application>>>,
						Data.Minus<ARTranPostGL.rGOLAmt>>,
					IsNull<ARDocumentResult.rGOLAmt, decimal0>>), typeof(decimal))]
			...
			[PXUIField(DisplayName = "Currency Balance")]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
						ARTranPostGL.curyBalanceAmt>,
					ARDocumentResult.curyDocBal>), typeof(decimal))]
			...
			[PXCurrency(typeof(curyInfoID), typeof(retainageUnreleasedAmt), BqlTable = typeof(ARDocumentResult))]
			[PXUIField(DisplayName = "Unreleased Retainage", FieldClass = nameof(FeaturesSet.Retainage))]
			[PXDefault(TypeCode.Decimal, "0.0", PersistingCheck = PXPersistingCheck.Nothing)]
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
					ARTranPostGL.curyRetainageUnreleasedAmt.Multiply<ARTranPostGL.balanceSign>>,
					ARDocumentResult.curyRetainageUnreleasedAmt>), typeof(decimal))]
			...
			[PXDBCalced(typeof(
				Switch<Case<Where<ARDocumentResult.docType.IsEqual<ARDocType.prepaymentInvoice>.And<ARDocumentResult.released.IsEqual<True>>>,
					ARTranPostGL.retainageUnreleasedAmt.Multiply<ARTranPostGL.balanceSign>>,
					ARDocumentResult.retainageUnreleasedAmt>), typeof(decimal))]
        ...
        [PXHidden]
        public partial class GLDocumentPeriodResult : PXBqlTable, IBqlTable
        {
        	#region DocType
        	public abstract class docType : PX.Data.BQL.BqlString.Field<docType>
        	{
		...
		public virtual IEnumerable PayDocument(PXAdapter adapter)
		{
			if (Documents.Current != null)
			{
				if (this.Documents.Current.Status != ARDocStatus.Open && this.Documents.Current.Status != ARDocStatus.Unapplied
					&& this.Documents.Current.Status != ARDocStatus.PendingPayment)
		...
		protected virtual PXDelegateResult SelectDetails(bool summarize = false)
		{
			...
			if (header.ARAcctID != null)
			{
				...
				{
					sel = sel.WhereAnd<Where<ARDocumentResult.accountID, Equal<Current<ARDocumentFilter.aRAcctID>>>>();
				}
				else
					sel = sel.WhereAnd<Where<ARDocumentResult.aRAccountID, Equal<Current<ARDocumentFilter.aRAcctID>>>>();
			}

			if (PXAccess.FeatureInstalled<FeaturesSet.subAccount>() && header.ARSubID != null)
			{
				if (PXAccess.FeatureInstalled<FeaturesSet.vATRecognitionOnPrepayments>())
				{
					sel = sel.WhereAnd<Where<ARDocumentResult.subID, Equal<Current<ARDocumentFilter.aRSubID>>>>();
				}
				else
			...
			if (header.ShowAllDocs != true)
			{
				sel = sel.WhereAnd<Where<ARDocumentResult.installmentCntr, IsNull>>();
			}
			...
			if (byPeriod)
			{
				...
				ChangeQueryType(types, queryType);
				AddAggregate(types, aggregate);
				AdjustSelectAddAggregate(types);

				if (summarize)
				{
					RemoveOrderBy(types);
					AdjustSelectRemoveOrderby(types);
				}
			...
			{
				queryType = typeof(ARDocumentPPIPeriodResult);
				...
				var aggregate = summarize
				? typeof(Aggregate<
					GroupBy<ARDocumentPPIPeriodResult.released,
					Sum<ARDocumentPPIPeriodResult.curyDocBal,
					Sum<ARDocumentPPIPeriodResult.docBal,
					Sum<ARDocumentPPIPeriodResult.curyRetainageUnreleasedAmt,
					Sum<ARDocumentPPIPeriodResult.retainageUnreleasedAmt>>>>>>)
				: typeof(Aggregate<
					GroupBy<ARDocumentPPIPeriodResult.docType,
					GroupBy<ARDocumentPPIPeriodResult.refNbr,
					GroupBy<ARDocumentPPIPeriodResult.accountID,
					Sum<ARDocumentPPIPeriodResult.curyOrigDocAmt,
					Sum<ARDocumentPPIPeriodResult.origDocAmt,
					Sum<ARDocumentPPIPeriodResult.curyDocBal,
					Sum<ARDocumentPPIPeriodResult.docBal,
					Sum<ARDocumentPPIPeriodResult.curyRetainageUnreleasedAmt,
					Sum<ARDocumentPPIPeriodResult.retainageUnreleasedAmt,
					Sum<ARDocumentPPIPeriodResult.curyOrigDocAmtWithRetainageTotal,
					Sum<ARDocumentPPIPeriodResult.origDocAmtWithRetainageTotal,
					Sum<ARDocumentPPIPeriodResult.curyDiscActTaken,
					Sum<ARDocumentPPIPeriodResult.discActTaken,
					Sum<ARDocumentPPIPeriodResult.curyWOAmt,
					Sum<ARDocumentPPIPeriodResult.woAmt,
					Sum<ARDocumentPPIPeriodResult.rGOLAmt,
					Sum<ARDocumentPPIPeriodResult.aRTurnover>>>>>>>>>>>>>>>>>
				>);
			...
			else
			{
				...
				if (summarize)
				{
					...
					RemoveOrderBy(types);
					AddAggregate(types, aggregate);
					AdjustSelectRemoveOrderbyAddAggregate(types);
					sel = BqlCommand.CreateInstance(BqlCommand.Compose(types.ToArray()));
				}
			...
			using (new PXFieldScope(documentView, restrictedFields))
							...
							ref startRow, PXView.MaximumRows, ref totalRows))
				{
					...
					{
						ARDocumentResult item = (ARDocumentResult)rec;
						if (item != null && item.AccountID != null && item.SubID != null)
						{
							item.ARAccountID = item.AccountID;
							item.ARSubID = item.SubID;
						}
						list.Add(item);
					}
					else
		...
		protected virtual void AdjustSelectRemoveOrderbyAddAggregate(List<Type> types)
		{
			if (types[0] == typeof(Select<,,>)) types[0] = typeof(Select4<,,>);
			if (types[0] == typeof(Select2<,,,>)) types[0] = typeof(Select5<,,,>);
		}

		protected virtual void AdjustSelectRemoveOrderby(List<Type> types)
		{
			if (types[0] == typeof(Select4<,,,>)) types[0] = typeof(Select4<,,>);
			if (types[0] == typeof(Select5<,,,,>)) types[0] = typeof(Select5<,,,>);
		}

		protected virtual void AdjustSelectAddAggregate(List<Type> types)
		{
			if (types[0] == typeof(Select<,,>)) types[0] = typeof(Select4<,,,>);
			if (types[0] == typeof(Select2<,,,>)) types[0] = typeof(Select5<,,,,>);
		}

		protected virtual void AddAggregate(List<Type> types, Type aggregate)
		{
		...
		protected virtual void ChangeQueryType(List<Type> types, Type queryType)
		{
