...
namespace PX.Objects.AR
{
	...
	public partial class BaseARHistoryByPeriod : PXBqlTable, PX.Data.IBqlTable
	{
		#region BranchID
	...
	public partial class ARHistoryByPeriod : PXBqlTable, PX.Data.IBqlTable
	{
		#region BranchID
		public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
		protected Int32? _BranchID;
	...
	GroupBy<MasterFinPeriod.finPeriodID>>>>>>>>))]
	[PXCacheName(Messages.ARHistoryByPeriod)]
	public partial class ARHistory2ByPeriod : PXBqlTable, PX.Data.IBqlTable
	{
		#region BranchID
		public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
		protected Int32? _BranchID;
	...
	public class ARCustomerBalanceEnq : PXGraph<ARCustomerBalanceEnq>
	{
		...
		[Serializable]
		public partial class ARHistoryFilter : PXBqlTable, IBqlTable
		{
        ...
        public partial class ARHistorySummary : PXBqlTable, IBqlTable
	    {
            #region CuryBalanceSummary
            public abstract class curyBalanceSummary : PX.Data.BQL.BqlDecimal.Field<curyBalanceSummary> { }
		...
		[Serializable]
		public partial class ARHistoryResult : PXBqlTable, IBqlTable
		{
			#region CustomerID
			public abstract class customerID : PX.Data.BQL.BqlInt.Field<customerID> { }
		...
		public class ChildBAccount : PXBqlTable, IBqlTable
		{
			#region BAccountID
		...
		public class CuryARHistoryTran : PXBqlTable, IBqlTable
		{
			#region BranchID
			public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
        ...
        protected virtual IEnumerable RetrieveHistoryForPeriod(ARHistoryFilter header, ARHistorySummary summary = null) 
		{
			...
			{
				select = BqlCommand.AppendJoin(select, BqlCommand.Compose(typeof(InnerJoin<CA.Light.CustomerRLS, On<CA.Light.Customer.bAccountID, Equal<CA.Light.CustomerRLS.bAccountID>,
					And<Match<CA.Light.CustomerRLS, AccessInfo.userName.FromCurrent>>>>)));
			}
			...
			List<Type> restrictedFields = new List<Type>
				{
					typeof(ARHistoryResult),
					typeof(ARHistoryByPeriod),
					typeof(CA.Light.Customer),
					typeof(CuryARHistoryTran),
					typeof(CA.Light.CustomerRLS.bAccountID),
					typeof(CA.Light.CustomerRLS.groupMask)
			};

			using (new PXFieldScope(view, restrictedFields))
			{
