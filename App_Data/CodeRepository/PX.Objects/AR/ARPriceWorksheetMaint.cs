...
using PX.Objects.AR.GraphExtensions.ARPriceWorksheetMaintExt;
...
namespace PX.Objects.AR
{
    ...
    public class ARPriceWorksheetMaint : PXGraph<ARPriceWorksheetMaint, ARPriceWorksheet>, PXImportAttribute.IPXPrepareItems, PXImportAttribute.IPXProcess
	{
        ...
        {
			var addItemParameterCurrent = (AddItemParameters) Caches[typeof(AddItemParameters)].Current;
            ...
            if (viewname.Contains(typeof(AddItemParameters).Name) && addItemParameterCurrent != null)
                priceType = addItemParameterCurrent.PriceType;
		...
		{
			CheckForIncorrectPriceTypeDetails();
		...
		protected virtual object GetAcceptablePriceTypesParameter() => new[] { PriceTypeList.BasePrice, PriceTypeList.Customer, PriceTypeList.CustomerPriceClass };
		private void CheckForIncorrectPriceTypeDetails()
		{
			foreach (ARPriceWorksheetDetail det in Details.View.BqlSelect
				.WhereAnd<Where<ARPriceWorksheetDetail.priceType.IsNotIn<P.AsString>>>()
				.Select<ARPriceWorksheetDetail>(this, GetAcceptablePriceTypesParameter()))
			{
				Details.Cache.RaiseExceptionHandling<ARPriceWorksheetDetail.priceType>(
					det,
					det.PriceType,
					new PXSetPropertyException(ErrorMessages.ValueIsNotValid));
				Details.Cache.MarkUpdated(det);
			}
		}
		...
		protected decimal GetItemPrice(PXGraph graph, string priceType, string priceCode, int? inventoryID, string toCuryID, DateTime? curyEffectiveDate)
        {
		...
		protected virtual void ARPriceWorksheetDetail_RowPersisting(PXCache sender, PXRowPersistingEventArgs e)
        {
			...
			switch (det.PriceType)
            {
                ...
                det.CustPriceClassID = det.PriceCode;
					break;
				default:
					sender.RaiseExceptionHandling<ARPriceWorksheetDetail.priceType>(
					det,
					det.PriceType,
					new PXSetPropertyException(ErrorMessages.ValueIsNotValid));
					break;
		...
		#region PriceTypeName
		private string _priceTypeName = null;
		public string PriceTypeName
		{
			get
			{
				if (_priceTypeName == null)
					_priceTypeName = typeof(ARPriceWorksheetDetail.priceType).Name;
				return _priceTypeName;
			} 
		}
		#endregion
		...
		protected virtual void ImportAttributeRowImporting(object sender, PXImportAttribute.RowImportingEventArgs e)
		{
			if (e.Mode != PXImportAttribute.ImportMode.Value.InsertAllRecords)
			{
				...
				e.Values[PriceTypeName] = e.Values[PriceTypeName].ToString().ToUpper();
    ...
    [Serializable]
    public partial class AddItemParameters : PXBqlTable, IBqlTable
    {
        #region PriceType
	...
	public partial class ARAddItemSelected : PXBqlTable, IPXSelectable, IBqlTable
	{
        #region Selected
    ...
    [Serializable]
    public partial class CalculatePricesFilter : PXBqlTable, IBqlTable
    {
	    #region BaseCuryID
    ...
    [Serializable]
    public partial class CopyPricesFilter : PXBqlTable, IBqlTable
    {
