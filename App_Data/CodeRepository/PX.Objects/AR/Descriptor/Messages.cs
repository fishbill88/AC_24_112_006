...
namespace PX.Objects.AR
{
	...
	public static class Messages
	{
		...
		public const string ERR_ProcCenterOfTerminalNotSupportedUnlinkedRefunds = "The {0} terminal is associated with the {1} processing center that does not allow processing unlinked refunds. Select another terminal to process the unlinked refund.";
		...
		public const string TerminalCannotBeEmpty = "Terminal cannot be empty.";
		public const string EitherOrigTranOrTerminalMustBeSpecified = "Either the original transaction or the terminal must be specified.";
		...
		public const string PaymentDepositedConfirmation = "The payment has already been deposited. To proceed, click OK.";
		...
		public const string DiscountOutOfDate = "The application date is later than the cash discount date ({0}).";
		...
		public const string ReversingDocumentExists = "A reversing document ({0} {1}) already exists for the original document. Reverse the document?";
		public const string ReversingDocumentCaption = "Reverse Document";
		...
		public const string UnprocessedPPDExists = "The report cannot be generated. There are documents with unprocessed cash discounts. To proceed, make sure that all documents are processed on the Generate AR Tax Adjustments (AR504500) form and appropriate VAT credit memos are released on the Release AR Documents (AR501000) form.";
		public const string UnprocessedPPDExistsBeforeClosing = "There are documents with unprocessed cash discounts. Before you proceed, process these documents by generating and releasing credit memos on the Generate AR Tax Adjustments (AR.50.45.00) form.";
		public const string PartialPPD = "Cash discount can be applied only on final payment.";
		public const string PaidPPD = "This document has been paid in full. To close the document, apply the cash discount by generating a credit memo on the Generate AR Tax Adjustments (AR.50.45.00) form.";
		...
		public const string CannotReleasePrepaymentInvoiceWithEmptyPendingTaxPayableAccount = "The document cannot be released because the Tax on AR Prepayment Account box is empty for the {0} tax. To proceed, fill in this box on the Taxes (TX205000) form.";
		public const string CannotReleasePrepaymentInvoiceWithEmptyPendingTaxPayableSubaccount = "The document cannot be released because the Tax on AR Prepayment Subaccount box is empty for the {0} tax. To proceed, fill in this box on the Taxes (TX205000) form.";
		...
		public const string PrepaymentInvoiceCannotHaveRetainage = "A prepayment invoice cannot have retainage.";
		public const string PrepaymentInvoiceIsNotSupportedForMigrationMode = "The document of the Prepmt. Invoice type is not supported when migration mode is activated.";
		public const string ApplicationToPrepaymentInvoiceCannotBeReversed = "The application to the prepayment invoice cannot be reversed because the prepayment invoice has already been applied to the {0} document with the {1} ref. number. To reverse the application, reverse the application of the prepayment invoice to the {0} document.";
		public const string DocumentCannotBeVoidedDueToApplicationToPrepaymentInvoice = "The {0} document cannot be voided because it is applied to prepayment invoice {1} that has already been applied to the {2} document with the {3} ref. number. To void the document, reverse the application of the prepayment invoice to the {2} document.";
		public const string ApplicationDateCannotBeEarlierThanPayment = "The application date cannot be earlier than the date of the latest payment applied to the prepayment invoice ({0}).";
		public const string ApplicationPeriodCannotBeEarlierThanPayment = "The application period cannot be earlier than the period of the latest payment applied to the prepayment invoice ({0}).";
		public const string PrepaymentAmountCannotHaveDifferentSignThanLineUnpaidBalance = "The prepayment amount and the extended price minus the line discount amount (if any) must both be either negative or positive.";
		public const string PrepaymentAmountCannotBeGreaterThanLineUnpaidBalanceInAbsoluteValues = "The absolute value of the prepayment amount must be less than or equal to the absolute value of the extended price minus the amount of the line discount (if any).";
		public const string PrepaymentAmountCannotBeGreaterThanUnpaidBalance = "The prepayment amount must be less than or equal to the order unpaid balance ({0}).";
		public const string PrepaymentAmountCannotBeZeroOrLess = "The prepayment amount must be greater than zero.";
		public const string PrepaymentAmountCannotBeAdjusted = "The amount of the prepayment invoice ({0}) cannot be adjusted automatically to match the amount specified in the Create Prepayment Invoice dialog box ({1}). Review the document and amend it, if needed. Add group or document discounts manually if they are applicable.";
		public const string PrepaymentInvoiceWihtoutTransCannotBeCreated = "The sales order contains no lines for the creation of a prepayment invoice.";
		public const string CannotDeleteSalesOrderDueToLinkedPrepaymentInvoice = "The {0} sales order cannot be deleted because at least one payment or prepayment invoice is linked to this sales order. To delete the sales order, first remove the payment or prepayment invoice application.";
		public const string CannotCancelSalesOrderDueToLinkedPrepaymentInvoice = "The {0} sales order cannot be canceled because at least one payment or prepayment invoice has been applied to it. Remove the application before canceling the order.";
		public const string PrepaymentInvoicesAreNotSupportedForBlanketSalesOrders = "Prepayment invoices are not supported for blanket sales orders.";
		#endregion
		...
		public const string AddUnpaidPPI = "Add Unpaid Prepayment Invoices";
		...
		public const string PrepaymentInvoice = "Prepmt. Invoice";
		...
		public const string PrintPrepaymentInvoice = PrepaymentInvoice;
		public const string PrintPrepaymentInvoiceFullName = "Prepayment Invoice";
		#endregion
		...
		public const string PrepaymentInv = "Prepmt. Invoice";
		#endregion
		...
		#region ECM
		public const string CreateCustomerInECM = "Create Customer in ECM Provider";
		public const string UpdateCustomerInECM = "Update Customer in ECM Provider";
		public const string RetrieveCertificates = "Retrieve Certificates";
		public const string RequestCertificate = "Request Certificate";

		public const string ERR_NullOrEmptyField = "{0} cannot be empty.";
		public const string CustomerCreatedInECM = "The customer has been created successfully in the Avalara ECM provider.";
		public const string CustomerUpdatedInECM = "The customer has been updated successfully in the Avalara ECM provider.";
		public const string RequestCertificateInECM = "The certificate request has been completed successfully.";
		public const string WRN_CustomerExistsInECM = "The customer already exists in the Avalara ECM provider for the following company code or codes: {0}";
		public const string ERR_CertificateNotExist = "The certificate cannot be opened because no certificate file is attached.";
		#endregion
		...
		public const string ManualNumberingDisabled = "Manual Numbering is not allowed for generating fee documents.";
		...
		public const string PendingPPD = "Subject to Tax Adjustment";
		...
		public const string ProcessingCenterDoesNotAcceptPOS = "Payments from POS Terminals are disabled for the {0} processing center. To enable them, on the Processing Centers (CA205000) form, select the Accept Payments from POS Terminals check box.";
	}
