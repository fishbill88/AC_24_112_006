	...
	public class ARPaymentType : ARDocType
	{
		...
		public class NumberingAttribute : AutoNumberAttribute
		{
			...
			private static string[] _DocTypes
			{
				get
				{
					return new string[] { Payment, CreditMemo, Prepayment, Refund, VoidRefund, VoidPayment, SmallBalanceWO, PrepaymentInvoice };
				}
			}
			...
			private static Type[] _SetupFields
			{
				get
				{
					return new Type[]
					{
						typeof(ARSetup.paymentNumberingID), null, typeof(ARSetup.paymentNumberingID), typeof(ARSetup.paymentNumberingID), null, null, null, typeof(ARSetup.prepaymentInvoiceNumberingID)
					};
				}
			}
		...
		public new class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { Payment, CreditMemo, Prepayment, Refund, VoidRefund, VoidPayment, SmallBalanceWO, PrepaymentInvoice },
				new string[] { Messages.Payment, Messages.CreditMemo, Messages.Prepayment, Messages.Refund, Messages.VoidRefund, Messages.VoidPayment, Messages.SmallBalanceWO, Messages.PrepaymentInvoice })
			{ }
		}
		...
		public class ListExAttribute : PXStringListAttribute
		{
			public ListExAttribute()
				: base(
				new string[] { Payment, CreditMemo, Prepayment, Refund, VoidRefund, VoidPayment, SmallBalanceWO, CashSale, CashReturn, PrepaymentInvoice },
				new string[] { Messages.Payment, Messages.CreditMemo, Messages.Prepayment, Messages.Refund, Messages.VoidRefund, Messages.VoidPayment, Messages.SmallBalanceWO, Messages.CashSale, Messages.CashReturn, Messages.PrepaymentInvoice })
			{ }
		}
