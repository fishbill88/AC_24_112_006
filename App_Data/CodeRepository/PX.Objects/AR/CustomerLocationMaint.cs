...
{
	public class CustomerLocationMaint : LocationMaint, ICaptionable
	{
		#region Views
		...
		public string Caption()
		{
			...
			Customer customer = AR.Customer.PK.Find(this, location.BAccountID);
			if (customer == null) return "";

			if (location.BAccountID != null && location.LocationCD == null)
			{
				return $"{customer.AcctCD}";
			}
			else if (location.BAccountID != null && location.LocationCD != null)
			{
				return $"{customer.AcctCD} {location.LocationCD} - {location.Descr}";
			}
			else
			{
				return "";
