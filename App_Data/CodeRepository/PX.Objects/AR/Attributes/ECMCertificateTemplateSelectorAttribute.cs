...
namespace PX.Objects.AR
{
	public class ECMCertificateTemplateSelectorAttribute : PXCustomSelectorAttribute
	{
		public ECMCertificateTemplateSelectorAttribute()
			: base(typeof(CertificateTemplate.templateID), typeof(CertificateTemplate.templateName))
		{
		}
		...
		{
			foreach (CertificateTemplate template in _Graph.Caches[typeof(CertificateTemplate)].Cached)
			{
