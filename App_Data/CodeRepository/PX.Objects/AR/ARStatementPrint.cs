				...
				else 
				{
					if (statement.IsParentCustomerStatement)
					{
						...
						if (!sentStatements.Contains(statementKey))
						{
							...
							this.GetExtension<ARStatementUpdate_ActivityDetailsExt>().SendNotification<ARStatement>(ARNotificationSource.Customer, notificationCD, statement.BranchID, parameters, true);
