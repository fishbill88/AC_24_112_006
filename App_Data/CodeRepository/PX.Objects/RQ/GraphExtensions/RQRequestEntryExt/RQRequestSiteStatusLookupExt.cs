...
namespace PX.Objects.RQ.GraphExtensions.RQRequestEntryExt
{
	...
	public class RQRequestSiteStatusLookupExt : RQSiteStatusLookupBaseExt<RQRequestEntry, RQRequest, RQRequestLine>
	{
		...
		protected virtual void _(Events.RowSelected<RQRequest> e)
		{
			if (e.Row == null)
				return;

			showItems.SetEnabled(Base.Lines.AllowInsert);
		}
	}
}
