...
namespace PX.Objects.RQ
{
	public class RQRequestEntry : PXGraph<RQRequestEntry, RQRequest>, IGraphWithInitialization
	{
		...
		*/
		...
		[PXCustomizeBaseAttribute(typeof(PXRestrictorAttribute),nameof(PXRestrictorAttribute.ShowWarning),true)]
		...
		protected virtual IEnumerable<RQBudget> GetBudget()
		{
			...
			Budget.Cache.ForceExceptionHandling = true;
	...
	public partial class RQSiteStatusSelected : PXBqlTable, IQtySelectable, IPXSelectable, IBqlTable
	{
		#region Selected
