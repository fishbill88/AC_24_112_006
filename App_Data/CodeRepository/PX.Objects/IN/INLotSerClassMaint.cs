...
namespace PX.Objects.IN
{
	public class INLotSerClassMaint : PXGraph<INLotSerClassMaint, INLotSerClass>
	{
		...
		{
			var parent = PXParentAttribute.SelectParent<INLotSerClass>(sender, Row);
		...
		protected virtual void INLotSerClass_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			if (row != null)
			{
				...
				PXUIFieldAttribute.SetEnabled<INLotSerClass.lotSerTrackExpiration>(sender, row, classUse == null && itemUse == null && enable);
