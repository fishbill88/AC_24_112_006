...
namespace PX.Objects.IN
{
	...
	public static class Messages
	{
		...
		public const string ItemLotSerClassCannotChangeDocumentDocumentAllocated = "The lot/serial class of the {0} item cannot be changed because this item is allocated in the {1} {2} document.";
		public const string ItemLotSerClassCannotChangeDocumentNotFullyProcessed = "The lot/serial class of the {0} item cannot be changed because this item is included in the {1} {2} document that has not been processed completely.";
		...
		public const string UnreleasedStandardCostAdjustmentExists = "The document cannot be released because the {0} inventory item is included in the {1} unreleased standard cost inventory adjustment. To release the document, you need to release the {1} inventory adjustment by using the Adjustments (IN303000) or Release IN Documents (IN501000) form.";
		...
		public const string NonZeroBalanceOnTheInventoryAccount = "There is a non-zero balance on the {0} inventory account for the {1} stock item. A change in the inventory account can cause the issue of multiple inventory accounts being used in inventory transactions simultaneously. To change the inventory account, clear the account's balance for the {1} item first.";
		...
		public const string WipAccountOrSubAccountIsUndefined = "The document cannot be released because the work-in-progress account or subaccount is not specified on the Inventory Preferences (IN101000) form.";
		public const string TransitAccountOrSubAccountIsUndefined = "The document cannot be released because the in-transit account or subaccount is not specified on the Inventory Preferences (IN101000) form.";
		...
		public const string ItemClassCouldNotUpdateAttributeDescriptionGroup = "The matrix items could not be updated for some template items. For details, see the trace log: Click Tools > Trace on the form title bar.";
		public const string TemplateCouldNotUpdateAttributeDescriptionGroup = "The matrix items generated from the {0} template item could not be updated:";
		...
		public const string DocumentContainsNoLines = "The document cannot be released because it does not contain any lines on the Details tab.";
		#endregion
		...
		public const string ExternalSKU = "External SKU";
		#endregion
		...
		public const string KitAssembly = "Kit Assembly";
		#endregion
