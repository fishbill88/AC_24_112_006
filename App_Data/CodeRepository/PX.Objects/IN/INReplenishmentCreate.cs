...
namespace PX.Objects.IN
{
	...
	public partial class INReplenishmentFilter : PXBqlTable, IBqlTable
	{
	...
	public class INReplenishmentProjection : TM.OwnedFilter.ProjectionAttribute
	{
		...
		protected override Type GetSelect(PXCache sender)
		{
			...
			var where = BqlCommand.Compose(
				typeof(Where2<,>),
				TM.OwnedFilter.ProjectionAttribute.ComposeWhere(typeof(INReplenishmentFilter), typeof(S.INItemSite.productWorkgroupID), typeof(S.INItemSite.productManagerID)),
				typeof(And<>),
				typeof(Where<S.INItemSite.planningMethod, Equal<INPlanningMethod.inventoryReplenishment>>));
			commands.AddRange(new [] {
				typeof(
	...
	public class INReplenishmentItem : S.INItemSite
	{
		...
		#endregion
		#region QtyFixedSOPODiff
		public abstract class qtyFixedSOPODiff : BqlDecimal.Field<qtyFixedSOPODiff> { }
		// Acuminator disable once PX1007 NoXmlCommentForPublicEntityOrDacProperty to be documented later along with other fields in this DAC
		[PXQuantity]
		[PXDBCalced(typeof(Add<IsNull<INSiteStatusByCostCenter.qtyPOFixedPrepared, decimal0>,
			Add<IsNull<INSiteStatusByCostCenter.qtyPOFixedOrders, decimal0>,
			Sub<IsNull<INSiteStatusByCostCenter.qtyPOFixedReceipts, decimal0>,
				IsNull<INSiteStatusByCostCenter.qtySOFixed, decimal0>>>>), typeof(decimal))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		public virtual decimal? QtyFixedSOPODiff
		{
			get;
			set;
		}
		...
		[PXQuantity]
		[PXDBCalced(typeof(Add<IIf<Where<INAvailabilityScheme.inclQtyFixedSOPO, Equal<True>, And<qtyFixedSOPODiff, Greater<decimal0>>>, qtyFixedSOPODiff, decimal0>,
			IsNull<INSiteStatusByCostCenter.qtyPOOrders, decimal0>>), typeof(decimal))]
		[PXDefault(TypeCode.Decimal, "0.0")]
