...
namespace PX.Objects.IN
{
	public class KitAssemblyEntry : PXGraph<KitAssemblyEntry, INKitRegister>
	{
		...
		public class SortLineSplitting : SortExtensionsBy< // enforce the order of initialization
			ExtensionOrderFor<KitAssemblyEntry>.FilledWith<
				...
				INComponentItemAvailabilityExtension,
		...
		protected virtual void _(Events.FieldUpdated<INKitRegister, INKitRegister.kitRequestDate> e)
		{
	...
	public partial class INOverheadTran : PXBqlTable, IBqlTable
	{
		#region Keys
	...
	public partial class INKitTranSplit : PXBqlTable, IBqlTable, ILSDetail, IItemPlanINSource
	{
		#region Keys
	...
	public partial class INKitRegister : PXBqlTable, IBqlTable, ILSPrimary, IItemPlanRegister
	{
		#region Keys
		...
		#endregion
		#region KitRequestDate
		/// <inheritdoc cref="INRegister.KitRequestDate"/>
		...
		public abstract class kitRequestDate : BqlDateTime.Field<kitRequestDate> { }
		#endregion
		#region BatchNbr
		...
		[PXSelector(typeof(Search<ReasonCode.reasonCodeID, Where<ReasonCode.usage, Equal<ReasonCodeUsages.assemblyDisassembly>>>))]
		[PXUIField(DisplayName = "Reason Code")]
		[PXDefault(typeof(INSetup.assemblyDisassemblyReasonCode), PersistingCheck = PXPersistingCheck.Nothing)]
		public virtual String ReasonCode { get; set; }
		public abstract class reasonCode : BqlString.Field<reasonCode> { }
		#endregion
		#region LotSerialNbr
