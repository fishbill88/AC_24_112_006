...
namespace PX.Objects.IN.Services
{
                ...
                default:
                    {
                        ...
                        catch (NullReferenceException)
                        {
							...
							var fieldDesr = GetSubstFieldDesr<Field>(graph.Caches[typeof(NonStockItem)]);
							throw new PXMaskArgumentException(Messages.MaskItem, fieldDesr, keyval);
                        }
                    }
	...
	[PXHidden]
	public class NonStockItem : PXBqlTable, IBqlTable
	{
		#region InvtAcctID
