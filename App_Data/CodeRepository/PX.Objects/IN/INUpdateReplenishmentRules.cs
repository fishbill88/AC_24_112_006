...
namespace PX.Objects.IN
{
	...
	public class INUpdateReplenishmentRules : PXGraph<INUpdateReplenishmentRules>
	{
        ...
        [Serializable]
		public partial class Filter : PXBqlTable, IBqlTable
		{
			#region StartDate for ForecastDate based on DemandPeriodType
			public abstract class startDateForDemandPeriodMonth : PX.Data.BQL.BqlDateTime.Field<startDateForDemandPeriodMonth> { }
			/// <summary>
			/// A start date for the <see cref="Filter.ForecastDate">forecast date</see> based on the <see cref="DemandPeriodType.Month"/> value.
			/// </summary>
			[PXDate]
			public virtual DateTime? StartDateForDemandPeriodMonth { get; set; }

			public abstract class startDateForDemandPeriodQuarter : PX.Data.BQL.BqlDateTime.Field<startDateForDemandPeriodQuarter> { }
			/// <summary>
			/// A start date for the <see cref="Filter.ForecastDate">forecast date</see> based on the <see cref="DemandPeriodType.Quarter"/> value.
			/// </summary>
			[PXDate]
			public virtual DateTime? StartDateForDemandPeriodQuarter { get; set; }

			public abstract class startDateForDemandPeriodWeek : PX.Data.BQL.BqlDateTime.Field<startDateForDemandPeriodWeek> { }
			/// <summary>
			/// A start date for the <see cref="Filter.ForecastDate">forecast date</see> based on the <see cref="DemandPeriodType.Week"/> value.
			/// </summary>
			[PXDate]
			public virtual DateTime? StartDateForDemandPeriodWeek { get; set; }

			public abstract class startDateForDemandPeriodDay : PX.Data.BQL.BqlDateTime.Field<startDateForDemandPeriodDay> { }
			/// <summary>
			/// A start date for the <see cref="Filter.ForecastDate">forecast date</see> based on the <see cref="DemandPeriodType.Day"/> value.
			/// </summary>
			[PXDate]
        ...
        [Serializable]
        [PXHidden]
		public partial class InventoryItemRO : PXBqlTable, IBqlTable
		{
			#region Keys
        ...
        [Serializable]
        [PXHidden]
		public partial class INTranSrc : PXBqlTable, IBqlTable 
		{
			#region DocType
		...
		public IEnumerable records()
		{
			...
			{
				filt.StartDateForDemandPeriodMonth = PeriodInfo.CalcStartDate(DemandPeriodType.Month, filt.ForecastDate.Value);
				filt.StartDateForDemandPeriodQuarter = PeriodInfo.CalcStartDate(DemandPeriodType.Quarter, filt.ForecastDate.Value);
				filt.StartDateForDemandPeriodWeek = PeriodInfo.CalcStartDate(DemandPeriodType.Week, filt.ForecastDate.Value);
				filt.StartDateForDemandPeriodDay = PeriodInfo.CalcStartDate(DemandPeriodType.Day, filt.ForecastDate.Value);
				...
				PXSelectBase<INItemSiteRS> select = new PXSelectJoin<INItemSiteRS, InnerJoin<InventoryItemRO, On<InventoryItemRO.inventoryID, Equal<INItemSiteRS.inventoryID>,
															...
															Where<INItemSiteRS.planningMethod, Equal<INPlanningMethod.inventoryReplenishment>,
															And<INItemSiteRS.replenishmentPolicyID, IsNotNull,
															And<INItemSiteRS.replenishmentClassID, IsNotNull,
															...
															Or<INItemSiteRS.lastForecastDate, LessEqual<Switch<
																Case<Where<INItemRep.forecastPeriodType, Equal<DemandPeriodType.month>>, Current<Filter.startDateForDemandPeriodMonth>,
																Case<Where<INItemRep.forecastPeriodType, Equal<DemandPeriodType.quarter>>, Current<Filter.startDateForDemandPeriodQuarter>,
																Case<Where<INItemRep.forecastPeriodType, Equal<DemandPeriodType.week>>, Current<Filter.startDateForDemandPeriodWeek>,
																Case<Where<INItemRep.forecastPeriodType, Equal<DemandPeriodType.day>>, Current<Filter.startDateForDemandPeriodDay>>>>>,
																Current<Filter.forecastDate>>>>>>>>>>>>>>(this);
			...
			else if (filt.Action == Filter.Actions.Clear)
			{
				PXSelectBase<INItemSiteRS> select = new PXSelectJoin<INItemSiteRS, InnerJoin<InventoryItemRO, On<InventoryItemRO.inventoryID, Equal<INItemSiteRS.inventoryID>,
																And<InventoryItemRO.itemStatus, Equal<InventoryItemStatus.active>>>,
															InnerJoin<INSite, On<INItemSiteRS.siteID, Equal<INSite.siteID>>,
		...
		public class PeriodSalesStatInfo : IComparable<PeriodSalesStatInfo>//, DataPoint, DemandForecastModel.IDataPoint
		{
			...
			public void CalcSeasonalFactor(IEnumerable<INReplenishmentSeason> seasonality)
			{
				...
				{
					int overlap = 0;
					KeyValuePair<DateTime, DateTime> range1 = GetRange(startYear, iSeason);
					...
					if (startYear != endYear)
					{
						...
						KeyValuePair<DateTime, DateTime> range2 = GetRange(startYear, iSeason);
						if (!outOfRange2)
						{
			...
			protected virtual KeyValuePair<DateTime, DateTime> GetRange(int year, INReplenishmentSeason season)
			{
				return new KeyValuePair<DateTime, DateTime>(
					season.StartDate.Value.AddYears(year - season.StartDate.Value.Year),
					season.EndDate.Value.AddYears(year - season.EndDate.Value.Year));
			}
	...
	public class INRepForecastApplicationGraph : PXGraph<INRepForecastApplicationGraph>
	{
		...
		public PXFilteredProcessingJoin<INItemSite, Filter,
				...
				And<INItemSite.planningMethod, Equal<INPlanningMethod.inventoryReplenishment>,
				And2<Where<
