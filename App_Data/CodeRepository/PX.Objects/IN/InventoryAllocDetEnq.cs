...
namespace PX.Objects.IN
{
	...
	[Serializable]
	public partial class InventoryAllocDetEnqFilter : PXBqlTable, PX.Data.IBqlTable, IQtyAllocated
	{
...
*/
    ...
    [Serializable]
	public partial class InventoryAllocDetEnqResult : PXBqlTable, PX.Data.IBqlTable, IQtyPlanned
	{
	...
	public class InventoryAllocDetEnq : PXGraph<InventoryAllocDetEnq>
	{
		...
		[PXHidden]
		public partial class INLocation : PXBqlTable, IBqlTable
		{
			#region LocationID
			public abstract class locationID : PX.Data.BQL.BqlInt.Field<locationID> { }
		...
		[PXHidden]
		public class INRegister : PXBqlTable, IBqlTable
		{
			#region DocType
		...
		[PXHidden]
		public class SOOrderShipment : PXBqlTable, IBqlTable
		{
			#region OrderType
			[PXDBString(2, IsKey = true, IsFixed = true)]
			public virtual String OrderType { get; set; }
		...
		[PXHidden]
		public class SOShipment : PXBqlTable, IBqlTable
		{
			#region ShipmentNbr
			[PXDBString(15, IsKey = true, IsUnicode = true)]
			public virtual String ShipmentNbr { get; set; }
		...
		[PXHidden]
		public class POOrderReceipt : PXBqlTable, IBqlTable
		{
			#region ReceiptNbr
			[PXDBString(15, IsUnicode = true, IsKey = true)]
		...
		[PXHidden]
		public class POReceipt : PXBqlTable, IBqlTable
		{
			#region ReceiptType
		...
		[PXHidden]
		public partial class INTransitLine : PXBqlTable, IBqlTable
		{
			#region TransferNbr
