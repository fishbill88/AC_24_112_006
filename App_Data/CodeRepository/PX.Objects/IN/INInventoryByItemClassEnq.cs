...
namespace PX.Objects.IN
{
	public class INInventoryByItemClassEnq : PXGraph<INInventoryByItemClassEnq>
	{
		...
		#region DAC
		[Serializable]
		public class InventoryByClassFilter : PXBqlTable, IBqlTable
		{
			#region InventoryID
			[Inventory]
		...
		[Serializable]
		public class INItemClassFilter : PXBqlTable, IBqlTable
		{
			#region ItemClassID
		...
		public class ItemBuffer : PXBqlTable, IBqlTable
		{
			#region InventoryID
		...
		[PXButton, PXUIField(MapEnableRights = PXCacheRights.Select, Visible = false)]
