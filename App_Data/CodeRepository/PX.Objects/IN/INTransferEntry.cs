...
namespace PX.Objects.IN
{
	public class INTransferEntry : INRegisterEntryBase
	{
		...
		public class SiteStatusLookup : INSiteStatusLookupExt<INTransferEntry, SiteStatusLookup.INSiteStatusSelected>
		{
			...
			[PXHidden, PXProjection(typeof(
				...
				Persistent = false)]
			public class INSiteStatusSelected : PXBqlTable, IPXSelectable, IQtySelectable, IBqlTable
			{
				#region Selected
				[PXBool]
