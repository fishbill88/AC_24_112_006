...
namespace PX.Objects.IN
{
	...
	[Serializable]
	public partial class PIGeneratorSettings : PXBqlTable, PX.Data.IBqlTable
	{
		#region PIClassID
    ...
    [Serializable]
	public partial class PIPreliminaryResult : PXBqlTable, PX.Data.IBqlTable
	{
	...
	[Serializable]
	public partial class ExcludedLocation : PXBqlTable, PX.Data.IBqlTable
	{
		#region LocationID
		public abstract class locationID : PX.Data.BQL.BqlInt.Field<locationID> { }
	...
	[Serializable]
	public partial class ExcludedInventoryItem : PXBqlTable, PX.Data.IBqlTable
	{
		#region InventoryID
		public abstract class inventoryID : PX.Data.BQL.BqlInt.Field<inventoryID> { }
	...
	public class PIGenerator : PXGraph<PIGenerator>
	{
			...
			HashSet<int> excludedLocationIds)
		{
			...
			cmd.Command = JoinLotSerial(cmd.Command); // The Join should be after LastPICountDate, it affects SQL performance, see AC-313210
	...
	*/
    ...
    [Serializable]
    [PXHidden]
	public partial class LastPICountDate : PXBqlTable, PX.Data.IBqlTable
	{
		#region SiteID
		public abstract class siteID : PX.Data.BQL.BqlInt.Field<siteID> { }
		protected Int32? _SiteID;
