...
namespace PX.Objects.IN
{
    ...
    public partial class INSetup : PXBqlTable, PX.Data.IBqlTable
	{
		#region Keys
		public static class FK
		{
			...
			public class AssemblyDisassemblyReasonCode : ReasonCode.PK.ForeignKeyOf<INSetup>.By<assemblyDisassemblyReasonCode> { }
		...
		#endregion
		#region AssemblyDisassemblyReasonCode
		public abstract class assemblyDisassemblyReasonCode : PX.Data.BQL.BqlString.Field<assemblyDisassemblyReasonCode> { }
		...
		[PXForeignReference(typeof(FK.AssemblyDisassemblyReasonCode))]
		public virtual String AssemblyDisassemblyReasonCode
		{
			...
			set
			{
				this._AssemblyDisassemblyReasonCode = value;
			}
		}
		#endregion
