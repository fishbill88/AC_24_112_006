...
namespace PX.Objects.IN
{
	...
	public partial class INItemPlan : PXBqlTable, PX.Data.IBqlTable, IQtyPlanned
	{
		#region Keys
		...
		public abstract class inventoryID : PX.Data.BQL.BqlInt.Field<inventoryID>
		{
			...
			public class InventoryLotSerClassIDRule :
				PreventEditOf<InventoryItem.lotSerClassID>.On<InventoryItemMaint>.IfExists<
					...
					Where<inventoryID, Equal<Current<InventoryItem.inventoryID>>,
						...
						And<planType, NotIn3<INPlanConstants.planM1, INPlanConstants.planM2, INPlanConstants.planM5, INPlanConstants.planM6, INPlanConstants.planM8, 
						...
						And<planQty, NotEqual<decimal0>>>>>>>>
			{
				...
				{
					var iNItemPlan = (INItemPlan)firstPreventingEntity;
					
					if (iNItemPlan.PlanType.IsIn(INPlanConstants.Plan61, INPlanConstants.Plan62, INPlanConstants.Plan63))
					{
						var entityHelper = new EntityHelper(Base);
						var invenotryItem = InventoryItem.PK.Find(Base, iNItemPlan.InventoryID);

						return PXMessages.LocalizeFormat(Messages.ItemLotSerClassCannotChangeDocumentDocumentAllocated, invenotryItem.InventoryCD, EntityHelper.GetFriendlyEntityName(Type.GetType(iNItemPlan.RefEntityType)), entityHelper.GetEntityRowID(iNItemPlan.RefNoteID));
					}
					else
						return PXMessages.Localize(Messages.ItemLotSerClassVerifying);
				}
			}
