...
namespace PX.Objects.CS
{
	...
	public class FeaturesSet : PXBqlTable, IBqlTable
	{
		...
		[Feature(typeof(FeaturesSet.vATReporting), typeof(Select<AR.ARRegister, Where<AR.ARRegister.docType, Equal<AR.ARDocType.prepaymentInvoice>>>),
			DisplayName = "VAT Recognition on Prepayments", Visible = true)]
		...
		[FeatureRestrictor(typeof(SelectFrom<PR.Standalone.PRTaxCode>
			.Where<PR.Standalone.PRTaxCode.countryID.IsEqual<CountryCodes.us>
				.And<PR.Standalone.PRTaxCode.isDeleted.IsEqual<False>>>))]
		...
		#endregion
		#region PacejetCarrierIntegration
		public abstract class pacejetCarrierIntegration : PX.Data.BQL.BqlBool.Field<pacejetCarrierIntegration> { }
		...
		public virtual bool? PacejetCarrierIntegration
		{
			get;
			set;
		}
		...
		#endregion
		#region ECM
		public abstract class eCM : PX.Data.BQL.BqlBool.Field<eCM> { }
		/// <summary>
		...
		#region BankFeedAccountsMultipleMapping
		public abstract class bankFeedAccountsMultipleMapping : BqlBool.Field<bankFeedAccountsMultipleMapping> { }
		/// <summary>
		...
		#region CaseCommitmentsTracking

		public abstract class caseCommitmentsTracking : BqlBool.Field<caseCommitmentsTracking> { }
		/// <summary>
		/// Case Commitments
		/// </summary>
