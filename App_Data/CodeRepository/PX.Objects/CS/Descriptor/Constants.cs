...
namespace PX.Objects.CS
{
	...
	{
		public const string DocumentAmount = "DA";
		public const string DocumentAmountLessTaxes = "TA";

		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(new string[] { DocumentAmount, DocumentAmountLessTaxes }, new string[] { Messages.DocumentAmount, Messages.DocumentAmountLessTaxes }) { }
		}

		public class documentAmount : PX.Data.BQL.BqlString.Constant<documentAmount>
		{
			public documentAmount() : base(DocumentAmount) {; }
		}

		public class documentAmountLessTaxes : PX.Data.BQL.BqlString.Constant<documentAmountLessTaxes>
		{
			public documentAmountLessTaxes() : base(DocumentAmountLessTaxes) {; }
		}
	}
