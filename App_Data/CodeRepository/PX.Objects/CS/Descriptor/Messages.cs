...
namespace PX.Objects.CS
{
	...
	public static class Messages
	{
		...
		public const string ShouldSelectDocumentAmountLessTaxesForCA = "If Canada is selected in the Localization box on the current form, it is recommended to select Document Amount Less Taxes in the Cash Discount Base box.";
		...
		public const string NumberOfCharactersExceedMappedSegValueLength = "The number of characters cannot be fewer than {0}. To enter a new value, on the Segmented Values (CS203000) form, decrease the length of the strings in the Mapped Value column.";
		public const string EnableUSPayrollOrCanadaPayroll = "US Payroll or Canadian Payroll should be enabled.";
		public const string MultipleMappingForBankFeedsExists = "There are bank feeds that use the Mapping of Multiple Accounts for Bank Feeds feature. Clear the Map Multiple Bank Accounts to One Cash Account check box on the Bank Feeds (CA205500) form for all bank feeds and try again.";
	...
	#region Graph Names
		...
		public const string ConnectionCarrierAskSuccessHeader = "Connection";
		...
		public const string ConnectionAddressValidatorAskSuccessHeader = "Connection";
		...
		#region Cash Discount Bases
		public const string DocumentAmount = "Document Amount";
		public const string DocumentAmountLessTaxes = "Document Amount Less Taxes";
		#endregion
		...
		public const string NegativeWorkTime = "Negative working time";
		#endregion
