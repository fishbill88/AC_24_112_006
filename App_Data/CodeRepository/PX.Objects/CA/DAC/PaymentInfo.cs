...
{
	[Serializable]
	public partial class PaymentInfo : PXBqlTable, IBqlTable
	{
		...
		#endregion
		#region BAccountName
		public abstract class bAccountName : PX.Data.BQL.BqlString.Field<bAccountName> { }

		/// <exclude/>
		[PXDBString(60, IsUnicode = true)]
		[PXUIField(DisplayName = "Account Name", Enabled = true, Visible = true)]
		public virtual string BAccountName
		{
			get;
			set;
		}
