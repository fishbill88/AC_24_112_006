...
namespace PX.Objects.CA
{
	...
	public partial class CCProcessingCenter : PXBqlTable, IBqlTable
	{
		#region Keys
		...
		#endregion
		#region Accept POS payments
		public abstract class acceptPOSPayments : PX.Data.BQL.BqlBool.Field<acceptPOSPayments> { }

		/// <summary>Accept Payments from POS Terminals</summary>
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Accept Payments from POS Terminals")]
		public virtual bool? AcceptPOSPayments
		{
			get;
			set;
		}
