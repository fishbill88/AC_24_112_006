...
namespace PX.Objects.CA
{
	...
	public static class Messages
	{
		...
		public const string ExternalReferenceNumberOfTheBankTransactionIsEmpty = "The document could not be processed because the external reference number of the bank transaction is empty. Fill in the Ext. Ref. Nbr. box on the Import Bank Transactions (CA306500) form for the bank transaction.";
		public const string ExternalReferenceNumberOfTheBankTransactionCannotStartWithLeadingSpace = "The document could not be processed because the external reference number of the bank transaction cannot start with a leading space. Correct the Ext. Ref. Nbr. box on the Import Bank Transactions (CA306500) form for the bank transaction.";
		...
		public const string PaymentMethodDetailInconsistentFlags = "Only one of the following check boxes can be selected in one detail line: Card/Account Nbr., Exp. Date, CVV Code, Name on Card, and Payment Profile ID.";
		...
		public const string CashAccountCannotBeUsedAsReclassificationAccountBecauseItIsClearingAccount = "The {0} cash account cannot be used as a reclassification account because it is a clearing account. Clear the Clearing Account check box on the Cash Accounts (CA202000) form for the {0} account or select another cash account.";
		...
		public const string AnotherOptionChosenCreateCheckBoxIsSelected= "The Create check box is selected for the bank transaction on the Create Payment tab. To match the bank transaction to another document, go to the Create Payment tab and clear the Create check box.";
		public const string AnotherOptionChosenBankTransactionIsAlreadyMatchedToPayment = "The bank transaction is already matched to a payment. To match the bank transaction to another document, go to the Match to Payments tab and unmatch the transaction.";
		public const string AnotherOptionChosenBankTransactionIsAlreadyMatchedToInvoice = "The bank transaction is already matched to an invoice. To match the bank transaction to another document, go to the Match to Invoices tab and unmatch the transaction.";
		public const string AnotherOptionChosenBankTransactionIsAlreadyMatchedToExpenseReceipt = "The bank transaction is already matched to an expense receipt. To match the bank transaction to another document, open the Match to Expense Receipts tab and unmatch the transaction.";
		...
		public const string ClearingAccountCanNotBeConfiguredAsClearingAccount = "The {0} cash account cannot be configured as a clearing account because it is specified as a reclassification account in the {1} entry type. Clear the Clearing Account check box or select another reclassification account for the {1} entry type.";
		...
		public const string SomePaymentsCannotBeExported = "Some payments cannot be exported. Check errors on the payment detail lines.";
		...
		public const string AddendaCannotBeCalculated = "The {0} value cannot be calculated. Check the formula in the {1} box on the Plug-in Settings tab of the Payment Methods (CA204000) form. {2}";
		public const string BatchPaymentCannotBeCreated = "Batch payment cannot be created because {0}";
		#endregion
		...
		public const string PaymentRelatedInfoAddenda = "Payment-Related Info (Addenda)";
		#endregion
		...
		public const string CannotSetImportDateEarlier = "The date in the Import Transactions From box cannot be earlier than {0} because there are bank transactions loaded for the {1} cash account from this bank account via the bank feed or entered manually.";
