...
{
	[Serializable]
	public partial class AddTrxFilter : PXBqlTable, IBqlTable
	{
		#region OnlyExpense
		...
		#endregion
		#region DocumentCreationContext
		public abstract class documentCreationContext : PX.Data.BQL.BqlBool.Field<documentCreationContext> { }
		...
		/// </summary>
		[PXBool]
		public virtual bool? DocumentCreationContext
		{
			get;
			set;
		}
