...
namespace PX.Objects.CT
{
	public class ContractMaint : PXGraph<ContractMaint, Contract>
	{
	   ...
	   [PXCopyPasteHiddenView]
		...
		protected virtual void ContractDetail_RowInserted(PXCache sender, PXRowInsertedEventArgs e)
		{
			...
			if (row != null)
			{
				// Acuminator disable once PX1045 PXGraphCreateInstanceInEventHandlers - graph is used to call its methods only
		...
		#region Local Types
		[Serializable]
		public partial class SetupSettingsFilter : PXBqlTable, IBqlTable
			{
			#region StartDate
		...
		[Serializable]
		public partial class ActivationSettingsFilter : PXBqlTable, IBqlTable
		{
		...
		[Serializable]
		public partial class TerminationSettingsFilter : PXBqlTable, IBqlTable
		{
		...
		[Serializable]
		public partial class BillingOnDemandSettingsFilter : PXBqlTable, IBqlTable
		{
			#region BillingDate
		...
		[Serializable]
		public partial class RenewalSettingsFilter : PXBqlTable, IBqlTable
		{
			#region RenewalDate
	...
	[Serializable]
	public partial class RenewManualNumberingFilter : PXBqlTable, IBqlTable
	{
		#region ContractCD
