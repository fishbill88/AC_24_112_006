...
namespace PX.Objects.CT
{
	...
	public static class Messages
	{
		...
		public const string InactiveContract = "The {0} contract is inactive.";
		public const string CompleteContract = "The {0} contract is completed.";
		public const string CancelledContract = "The {0} contract is canceled.";
		public const string TemplateContract = "{0} is reserved for a project template or contract template. Specify the contract instead.";
		#endregion
		...
		public const string NotAContract = "{0} is reserved for a project. Specify the contract instead.";
