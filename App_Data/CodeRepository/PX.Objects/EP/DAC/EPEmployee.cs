...
namespace PX.Objects.EP
{
	...
	public partial class EPEmployee : Vendor
	{
		...
		/// <summary>
		/// The employee's base <see cref="System.Currency"/>, which is the base currency of the branch selected in the Branch box.
		/// </summary>
		/// <value>
		...
		/// </value>
		[PXDBInt()]
		[PXEPEPEmployeeSelector(SelectorMode = PXSelectorMode.DisplayModeText)]
		...
		[PXDefault(typeof(Select<EPEmployeeClass, Where<EPEmployeeClass.vendorClassID, Equal<Current<Vendor.vendorClassID>>>>), SourceField = typeof(EPEmployeeClass.curyID), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[PXDefault(typeof(Select<EPEmployeeClass, Where<EPEmployeeClass.vendorClassID, Equal<Current<Vendor.vendorClassID>>>>), SourceField = typeof(EPEmployeeClass.curyRateTypeID), PersistingCheck = PXPersistingCheck.Nothing)]
...
namespace PX.Objects.EP.Simple
{
	...
	[System.SerializableAttribute()]
    [PXHidden]
    public partial class EPEmployee : PXBqlTable, IBqlTable
    {
        #region BAccountID
