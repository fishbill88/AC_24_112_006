...
namespace PX.Objects.EP
{
	...
	public partial class EPSetup : PXBqlTable, PX.Data.IBqlTable, IAssignedMap
	{
		...
		[PXSelector(typeof(Search<EPAssignmentMap.assignmentMapID,
			Where<EPAssignmentMap.entityType, Equal<AssignmentMapType.AssignmentMapTypeTimeCard>>>), DescriptionField = typeof(EPAssignmentMap.name))]
        ...
        [PXDBInt]
        [PXSelector(typeof(Search<EPAssignmentMap.assignmentMapID,
            Where<EPAssignmentMap.entityType, Equal<AssignmentMapType.AssignmentMapTypeEquipmentTimeCard>>>), DescriptionField = typeof(EPAssignmentMap.name))]
		...
		[PXDBInt]
		[PXSelector(typeof(Search<EPAssignmentMap.assignmentMapID,
			Where<EPAssignmentMap.entityType, Equal<AssignmentMapType.AssignmentMapTypeExpenceClaimDetails>>>), DescriptionField = typeof(EPAssignmentMap.name))]
