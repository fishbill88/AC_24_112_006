...
namespace PX.Objects.EP
{
	...
	public partial class EPEquipment : PXBqlTable, PX.Data.IBqlTable
	{
		#region EquipmentID
		...
		[PXDefault(TypeCode.Decimal, "0.0", typeof(Search2<InventoryItemCurySettings.stdCost,
															InnerJoin<InventoryItem, On<InventoryItem.inventoryID, Equal<InventoryItemCurySettings.inventoryID>>>,
															Where<InventoryItemCurySettings.inventoryID, Equal<Current<EPEquipment.runRateItemID>>,
		...
		[PXDefault(TypeCode.Decimal, "0.0", typeof(Search2<InventoryItemCurySettings.stdCost,
															InnerJoin<InventoryItem, On<InventoryItem.inventoryID, Equal<InventoryItemCurySettings.inventoryID>>>,
															Where<InventoryItemCurySettings.inventoryID, Equal<Current<EPEquipment.setupRateItemID>>,
																And<InventoryItemCurySettings.curyID, Equal<Current<AccessInfo.baseCuryID>>>>>))]
		...
		[PXDefault(TypeCode.Decimal, "0.0", typeof(Search2<InventoryItemCurySettings.stdCost,
															InnerJoin<InventoryItem, On<InventoryItem.inventoryID, Equal<InventoryItemCurySettings.inventoryID>>>,
															Where<InventoryItemCurySettings.inventoryID, Equal<Current<EPEquipment.suspendRateItemID>>,
																And<InventoryItemCurySettings.curyID, Equal<Current<AccessInfo.baseCuryID>>>>>))]
