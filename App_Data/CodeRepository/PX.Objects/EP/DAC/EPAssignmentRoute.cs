...
namespace PX.Objects.EP
{
	...
	public partial class EPAssignmentRoute : PXBqlTable, PX.Data.IBqlTable
	{
		...
		[PXDefault]
		[PXSelector(typeof(Search<EPAssignmentRoute.assignmentRouteID, Where<EPAssignmentRoute.routerType, Equal<EPRouterType.group>, And<EPAssignmentRoute.assignmentMapID, Equal<Current<EPAssignmentMap.assignmentMapID>>>>>),
			fieldList: new[] { typeof(EPAssignmentRoute.name) },
			DescriptionField = typeof(EPAssignmentRoute.name))]
