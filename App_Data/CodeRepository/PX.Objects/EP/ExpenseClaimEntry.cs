...
namespace PX.Objects.EP
{
	public class ExpenseClaimEntry : PXGraph<ExpenseClaimEntry, EPExpenseClaim>, PXImportAttribute.IPXPrepareItems
	{
		...
		[Serializable]
		[PXHidden]
		public partial class EPCustomerUpdateAsk : PXBqlTable, IBqlTable
		{
		...
		[Serializable]
		[PXHidden]
		public partial class TaxZoneUpdateAsk : PXBqlTable, IBqlTable
		{
		}
		#endregion
		...
		[PXButton(SpecialType = PXSpecialButtonType.Report, Tooltip = Messages.AddReceiptToolTip)]
		...
		protected virtual void EPExpenseClaimDetails_CuryTipAmt_FieldVerifying(PXCache cache, PXFieldVerifyingEventArgs e)
		{
			...
			if (row != null && value != null && value != 0)
			{
				var item = (InventoryItem)PXSelect<InventoryItem,
					Where<InventoryItem.inventoryID, Equal<Required<InventoryItem.inventoryID>>>>.Select(this, epsetup.Current.NonTaxableTipItem);
				if (item == null)
				{
					throw new PXSetPropertyException(Messages.TipItemIsNotDefined);
				}
			}
		}
		protected virtual void EPExpenseClaimDetails_CuryTipAmt_FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
		{
			...
			if (row != null)
			{
				if (row.CuryTipAmt != 0)
				{
					...
					if(item == null)
					{
						throw new PXSetPropertyException<EPExpenseClaimDetails.curyTipAmt>(Messages.TipItemIsNotDefined);
					}
