...
namespace PX.Objects.EP
{
	public class EPWeeklyCrewTimeEntry : PXGraph<EPWeeklyCrewTimeEntry, EPWeeklyCrewTimeActivity>, PXImportAttribute.IPXPrepareItems
	{
		...
		protected virtual void _(Events.RowDeleting<EPActivityApprove> e)
		{
			...
			{
				TimeActivities.View.Ask((PXMessages.LocalizeFormatNoPrefix(Messages.ActivityIs, e.Cache.GetValueExt<PMTimeActivity.approvalStatus>(e.Row))), MessageButtons.OK);
				e.Cancel = true;
			}
			else if (e.Row.TimeCardCD != null)
			{
				TimeActivities.View.Ask(EP.Messages.ActivityAssignedToTimeCard, MessageButtons.OK);
				e.Cancel = true;
			}
		}
		...
		public virtual void RestoreCopy(EPActivityApprove copy, EPActivityApprove original)
		{
			...
			copy.ApprovalStatus = ActivityStatusAttribute.Open;
			copy.Released = false;
		}
	...
	public class PRWeekDaySelector : PXCustomSelectorAttribute
	{
		...
		[PXHidden]
		public class WeekDate : PXBqlTable, IBqlTable
		{
			#region Date
