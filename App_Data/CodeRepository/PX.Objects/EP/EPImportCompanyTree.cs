...
namespace PX.TM
{
    ...
    public class CompanyTreeMaint : PXGraph<CompanyTreeMaint>
    {
        [Serializable]
        [PXHidden]
        public partial class SelectedNode : PXBqlTable, IBqlTable
        {
            #region WorkGroupID
        ...
        [Serializable]
        [PXHidden]
        public partial class SelectedParentNode : PXBqlTable, IBqlTable
        {
            #region WorkGroupID
            public abstract class workGroupID : PX.Data.BQL.BqlInt.Field<workGroupID> { }
            protected int? _WorkGroupID;
        ...
        {
            Caches[typeof(EPCompanyTreeMember)].AllowInsert = Folders.Current != null && Folders.Current.ParentWGID != null;
            Caches[typeof(EPCompanyTreeMember)].AllowDelete = Folders.Current != null && Folders.Current.ParentWGID != null;
            Caches[typeof(EPCompanyTreeMember)].AllowUpdate = Folders.Current != null && Folders.Current.ParentWGID != null;
