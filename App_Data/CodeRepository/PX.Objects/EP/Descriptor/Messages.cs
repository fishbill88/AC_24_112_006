...
namespace PX.Objects.EP
{
	...
	public static class Messages
	{
		...
		public const string RequireCommentForApprove = "The document cannot be processed because a comment must be entered to approve the document. On the corresponding data entry form, click Approve on the form toolbar and enter a comment.";
		public const string RequireCommentForReject = "The document cannot be processed because a comment must be entered to reject the document. On the corresponding data entry form, click Reject on the form toolbar and enter a comment.";
		...
		public const string AllEmployeesInTableRequired = "Approval will be required from all employees specified in the following table.";
		...
		public const string ApprovalRuleReasonCannotBeEmpty = "The {0} approval rule requires that you enter a comment to complete this action for the selected document.";
		public const string ProbationEndDateUpdated = "The probation period end date was updated based on the start date and the probation period specified on the Employee Classes (EP202000) form. You can adjust it manually, if needed.";
		public const string ProbationEndDateEarlierThanStartDate = "The end date of the probation period cannot be earlier than its start date.";
		public const string ProbationPeriodMonthsChanged = "The new probation period will be used only for newly hired employees of the {0} employee class. For existing employees, the probation period end dates should be adjusted manually.";
		...
		public const string ActivityIsReleased = "The time activity cannot be deleted because it has been released.";
		...
		public const string RuleApprover = "Rule Approver";
