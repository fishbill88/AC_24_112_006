...
namespace PX.Objects.EP
{
	...
	{		
		...
		[PXButton(ImageKey = PX.Web.UI.Sprite.Main.ArrowUp, Tooltip = "Move Node Up")]
		...
		[PXUIField(MapEnableRights = PXCacheRights.Select, MapViewRights = PXCacheRights.Select, Enabled = true)]
		[PXButton(ImageKey = PX.Web.UI.Sprite.Main.ArrowDown, Tooltip = "Move Node Down")]
	...
	[PXHidden]
	public partial class Position : PXBqlTable, IBqlTable
	{
		#region MapID
