	...
	public class APQuickCheckEntry_Workflow : PXGraphExtension<APQuickCheckEntry>
	{
		...
		public class Conditions : Condition.Pack
		{
			...
			public Condition IsNotPrintable => GetOrCreate(b => b.FromBql<
				printCheck.IsEqual<False>.Or<printed.IsEqual<True>.Or<docType.IsEqual<APDocType.cashReturn>>>
			>());
			...
			public Condition IsCashReturn => GetOrCreate(b => b.FromBql<
				docType.IsEqual<APDocType.cashReturn>
			>());
				...
				screen
					...
					.WithActions(actions =>
					{
						...
						actions.Add(g => g.release, c => c
							.WithCategory(processingCategory));
						actions.Add(g => g.cashReturn, c => c
							.WithCategory(correctionsCategory)
							.IsHiddenWhen(conditions.IsNotQuickCheck));
						actions.Add(g => g.voidCheck, c => c
							.WithCategory(correctionsCategory)
							.IsHiddenWhen(conditions.IsVoided || conditions.IsCashReturn));
