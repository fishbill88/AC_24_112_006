...
namespace PX.Objects.AP
{
       ...
       protected virtual decimal AdjustByUOM(InventoryItem inventoryItem, APPriceWorksheetDetail worksheetDetail, decimal correctedAmtInBaseUnit)
		...
		protected virtual void ImportAttributeRowImporting(object sender, PXImportAttribute.RowImportingEventArgs e)
		{
			if (e.Mode != PXImportAttribute.ImportMode.Value.InsertAllRecords)
			{
				...
				if (duplicate != null)
				{
					if (e.Keys.Contains(nameof(APPriceWorksheetDetail.LineID)))
						e.Keys[nameof(APPriceWorksheetDetail.LineID)] = duplicate.LineID;
					else
						e.Keys.Add(nameof(APPriceWorksheetDetail.LineID), duplicate.LineID);
				}
			}
		}
	...
	public partial class APAddItemSelected : PXBqlTable, IPXSelectable, IBqlTable
	{
        #region Selected
