...
namespace PX.Objects.AP
{
        ...
        where WhereSelect : IBqlWhere, new()
	{
		...
		/// <returns/>
		protected override bool IsAllowedNegativeSign(APPaymentChargeTran charge) => APPaymentType.VoidAppl(charge.DocType) || charge.DocType == APDocType.CashReturn;
		#endregion
	}
