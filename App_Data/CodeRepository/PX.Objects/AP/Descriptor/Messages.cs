...
namespace PX.Objects.AP
{
	...
	public static class Messages
	{
		...
		public const string AP1099PaymentApplicationDateNotInOpenYear = "The payment application date must be within an open 1099 year.";
		public const string AP1099CashPurchaseDateNotInOpenYear = "The cash purchase date must be within an open 1099 year.";
		...
		public const string PaymentDepositedConfirmation = AR.Messages.PaymentDepositedConfirmation;
		...
		[Obsolete(Common.InternalMessages.FieldIsObsoleteAndWillBeRemoved2025R1)]
		public const string NextCheckNumberCanNotBeInc = "Next Check Number can't be incremented.";
		public const string NextCheckNumberLastReached = "The {0} value cannot be incremented because the last possible value of the sequence has been reached.";
		public const string NextCheckNumberMustEndDigit = "The value in the {0} box must end with a number.";
        ...
        public const string DoublePOReceiptBillReverse = "The quantity in line {0} of the {1} debit adjustment exceeds the billed quantity in the linked line of the {2} purchase receipt. Review the released billing documents on the Billing tab of the Purchase Receipts (PO302000) form.";
		public const string DoublePOReturnBilling = "The quantity in line {0} of the {1} debit adjustment exceeds the unbilled quantity in the linked line of the {2} purchase return. Review the released billing documents on the Billing tab of the Purchase Receipts (PO302000) form.";
		public const string POReceiptOverBilling = "The quantity in line {0} of the {1} bill exceeds the unbilled quantity in the linked line of the {2} purchase receipt. Review the released billing documents on the Billing tab of the Purchase Receipts (PO302000) form.";
		...
		public const string DocsDepositAsBatchSettingDoesNotMatchClearingAccountFlag = AR.Messages.DocsDepositAsBatchSettingDoesNotMatchClearingAccountFlag;
		#endregion
		...
		public const string PPDDebitAdjustmentDescr = "Tax Adjustment Description";
		...
		public const string UnprocessedPPDExists = "The report cannot be generated. There are documents with unprocessed cash discounts. To proceed, make sure that all documents are processed on the Generate AP Tax Adjustments (AP504500) form and appropriate VAT debit adjustments are released on the Release AP Documents (AP501000) form.";
		public const string UnprocessedPPDExistsClosing = "There are documents with unprocessed cash discounts. Before you proceed, process these documents by generating and releasing debit adjustments on the Generate AP Tax Adjustments (AP504500) form.";
		public const string PaidPPD = "This document has been paid in full. To close the document, apply the cash discount by generating a debit adjustment on the Generate AP Tax Adjustments (AP504500) form.";
