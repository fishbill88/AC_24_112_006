...
namespace PX.Objects.AP
{
	...
	public class APDocumentEnq : PXGraph<APDocumentEnq>
	{
		...
		[Serializable]
		public partial class APDocumentFilter : PXBqlTable, IBqlTable
		{
		...
		public partial class APDocumentResult : PXBqlTable, IBqlTable
		{
			#region DocType
			...
			public abstract class noteID : PX.Data.BQL.BqlGuid.Field<noteID>
			{
				public class NoteAttribute : PXNoteAttribute
				{
					...
					protected override string GetEntityType(PXCache cache, Guid? noteId)
					{
						...
						if (row != null)
						{
							string docType = cache.GetValue<APDocumentResult.docType>(row) as string;
							if (APDocType.DocClass(docType) != GLTran.tranClass.Normal)
							{
								return typeof(APPayment).FullName;
								
							}
						}
						return typeof(APInvoice).FullName;
					}
				}
			}
		...
		public partial class APDocumentPeriodResult : PXBqlTable, IBqlTable
		{
			#region DocType
		...
		public class Ref
		{
			...
			[PXHidden]
			public class APPayment : PXBqlTable, IBqlTable
			{
				#region DocType
