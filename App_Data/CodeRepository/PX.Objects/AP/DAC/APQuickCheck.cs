...
namespace PX.Objects.AP.Standalone
{
	[PXProjection(typeof(Select2<APRegister,
		...
		Where<APRegister.docType, Equal<APDocType.quickCheck>,
			Or<APRegister.docType, Equal<APDocType.cashReturn>,
	...
	public class APQuickCheck : APRegister, IPrintCheckControlable, IAssign, IApprovable, IApprovalDescription
	{
		...
		[CashAccount(typeof(APQuickCheck.branchID), typeof(Search2<CashAccount.cashAccountID,
						...
						Where2<Match<Current<AccessInfo.userName>>,
							And2<Where<CashAccount.clearingAccount, Equal<False>,Or<APQuickCheck.docType.FromCurrent,Equal<APQuickCheckType.cashReturn>>>,
		...
		[PXDefault(false, typeof(Search<CashAccount.clearingAccount, Where<CashAccount.cashAccountID, Equal<Current<APQuickCheck.cashAccountID>>>>))]
	...
	public class APQuickCheckType : APDocType
	{
		...
		public class NumberingAttribute : AutoNumberAttribute
		{
			...
			{
				get => new string[] { QuickCheck, CashReturn, VoidQuickCheck };
			}

			private static Type[] _SetupFields
			{
				get =>  new Type[] { typeof(APSetup.checkNumberingID), typeof(APSetup.checkNumberingID), null };
			}
		...
		public new class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { QuickCheck, CashReturn, VoidQuickCheck },
				new string[] { Messages.QuickCheck, Messages.CashReturn, Messages.VoidQuickCheck }) { ; }
		}
