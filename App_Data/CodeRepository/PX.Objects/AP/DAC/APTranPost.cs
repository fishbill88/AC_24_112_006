...
namespace PX.Objects.AP
{
	...
	public class APTranPost : PXBqlTable, IBqlTable
    {
	    #region Keys
        ...
        public abstract class tranClass : PX.Data.BQL.BqlString.Field<tranClass>
        {
			...
			public class RQCN : PX.Data.BQL.BqlString.Constant<RQCN> { public RQCN() : base(nameof(RQCN)) {} }
			public class RQCR : PX.Data.BQL.BqlString.Constant<RQCR> { public RQCR() : base(nameof(RQCR)) {} }
        ...
        [PXFormula(typeof(
	        Switch<
				...
				Case<
					Where<APTranPost.docType.IsIn<APDocType.invoice, APDocType.debitAdj, APDocType.creditAdj, APDocType.quickCheck, APDocType.voidQuickCheck, APDocType.cashReturn>>,
