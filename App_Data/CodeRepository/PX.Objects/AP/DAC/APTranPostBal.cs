...
namespace PX.Objects.AP
{
    ...
    [PXHidden]
    public class APTranPostBal : PXBqlTable, IBqlTable
    {
        #region Keys
		...
		[PXDBCalced(typeof(
			Switch<
				Case<Where<Standalone.APRegister.curyID.IsEqual<CM.CurrencyInfo2.curyID>>,
					Switch<
						Case<Where<Standalone.APRegister.paymentsByLinesAllowed.IsEqual<True>>, APTran.curyTranBal>,
						Standalone.APRegister.curyDocBal>
				>,
				Data.Round<
					Mult<
						Switch<
							Case<Where<Standalone.APRegister.paymentsByLinesAllowed.IsEqual<True>>, APTran.tranBal>,
							Standalone.APRegister.docBal>,
						Switch<
