...
namespace PX.Objects.AP
{
	...
	public partial class APAdjust 
		: PXBqlTable, IBqlTable, IAdjustment, IDocumentAdjustment, IAdjustmentAmount, IAdjustmentStub, Common.GraphExtensions.Abstract.DAC.IFinAdjust
	{
		#region Keys
    ...
    public partial class APAdjust2 : APAdjust
    {
		...
		public new abstract class pendingPPD : PX.Data.BQL.BqlString.Field<pendingPPD> { }
...
namespace PX.Objects.AP.Standalone
{
	...
	[PXHidden]
	[Serializable]
	public class APAdjust : PXBqlTable, IBqlTable
	{
		#region AdjdDocType
		public abstract class adjdDocType : PX.Data.BQL.BqlString.Field<adjdDocType> { }
		[PXDBString(3, IsKey = true, IsFixed = true, InputMask = "")]
