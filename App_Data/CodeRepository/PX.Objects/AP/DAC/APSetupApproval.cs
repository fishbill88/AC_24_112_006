...
namespace PX.Objects.AP
{
	...
	public class APSetupApproval : PXBqlTable, IBqlTable, IAssignedMap
	{
		#region Keys
		...
		public class EPSetting : EPApprovalSettings<APSetupApproval, docType, APDocType, APDocStatus.hold, APDocStatus.pendingApproval, APDocStatus.rejected> { }
		#endregion
		#region ApprovalID
