...
namespace PX.Objects.AP
{
	...
	public class APPayBills : PXGraph<APPayBills>
	{
		...
		protected virtual void _createPayments(List<APAdjust> list, PayBillsFilter filter, CurrencyInfo info, PaymentMethod paymenttype)
		{
			foreach (APAdjust adj in list)
			{
			    ...
			    adj.AdjgTranPeriodID = FinPeriodRepository.GetByID(adj.AdjgFinPeriodID, PXAccess.GetParentOrganizationID(adj.AdjgBranchID)).MasterFinPeriodID;
            }
	...
	[Serializable]
	public partial class PayBillsFilter : PXBqlTable, IBqlTable
	{
		#region BranchID
