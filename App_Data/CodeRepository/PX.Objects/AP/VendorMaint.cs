...
namespace PX.Objects.AP
{
	...
	public class VendorMaint : PXGraph<VendorMaint, VendorR>
	{
		...
		public partial class VendorBalanceSummary : PXBqlTable, IBqlTable
		{
			#region VendorID
		...
		protected virtual void Vendor_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
		{
			...
			PXUIFieldAttribute.SetVisible<Vendor.box1099>(cache, null, isVendor1099);
			PXUIFieldAttribute.SetVisible<Vendor.foreignEntity>(cache, null, isVendor1099);
			PXUIFieldAttribute.SetVisible<Vendor.fATCA>(cache, null, isVendor1099);
