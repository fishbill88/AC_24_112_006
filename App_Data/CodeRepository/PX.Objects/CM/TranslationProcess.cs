...
namespace PX.Objects.CM
{
	...
	public class TranslationProcess : PXGraph<TranslationProcess>
	{
		...
		[Serializable]
		public partial class TranslationParams : PXBqlTable, PX.Data.IBqlTable
		{
			#region TranslDefId
		...
		protected virtual void TranslateItems(List<CurrencyRate> list, TranslationParams parameters)
		{
			...
			TranslationHistory existHistory = (TranslationHistory)PXSelect<TranslationHistory,
												...
												.Select(this, parameters.DestLedgerId, parameters.BranchID, parameters.BranchID);

			if (existHistory != null)
			{
				throw new PXException(parameters.BranchID != null
					? Messages.NotReleasedTranslationExistsForLedgerAndBranch
					: Messages.NotReleasedTranslationExistsForLedger, existHistory.ReferenceNbr);
			}

			if (PXSelectJoin<TranslationHistory,
													LeftJoin<Batch,
													...
													Where2<Where<TranslationHistory.ledgerID, Equal<Required<TranslationHistory.ledgerID>>,
														...
														And<Where<TranslationHistory.branchID, Equal<Required<TranslationHistory.branchID>>,
															Or<TranslationHistory.branchID, IsNull,
															Or<Required<TranslationHistory.branchID>, IsNull>>>>>>
				.SelectSingleBound(this, null, parameters.DestLedgerId, parameters.BranchID, parameters.BranchID).Any())
			{
