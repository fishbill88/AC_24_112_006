...
namespace PX.Objects.CM
{
									...
									PXSelectJoin<ARHistoryByPeriod,
													...
													Where<ARHistoryByPeriod.curyID, Equal<Current<RevalueFilter.curyID>>,
															...
															And<Where<RevaluedARHistory.curyFinYtdBalance, NotEqual<decimal0>,
																		...
																		Or<RevaluedARHistory.curyFinYtdDeposits, NotEqual<decimal0>,
																		Or<RevaluedARHistory.finYtdDeposits, NotEqual<decimal0>>>>>>>>>>
													.Select(this))
			{
				...
				else
				{
					...
					if (cmsetup.Current.RevalueARPrepaymentsOption == true)
					{
				...
				if (hist.FinYtdBalance != 0 || hist.CuryFinYtdBalance != 0 || hist.FinPtdRevalued != 0)
				{
	...
	public partial class ARHistoryLastRevaluation : PXBqlTable, PX.Data.IBqlTable
	{
		#region BranchID
