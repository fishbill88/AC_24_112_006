...
namespace PX.Objects.CM
{
		...
		public virtual IEnumerable apaccountlist()
		{
									...
									.Select(this))
			{
				...
				else
				{
					...
					if (cmsetup.Current.RevalueAPPrepaymentsOption == true) {
				...
				if (hist.CuryFinYtdBalance != 0 || hist.FinYtdBalance != 0 || hist.FinPtdRevalued != 0)
				{
	...
	public partial class RevalueFilter : PXBqlTable, PX.Data.IBqlTable
	{
	...
	public partial class APHistoryLastRevaluation : PXBqlTable, PX.Data.IBqlTable
	{
		#region BranchID
		public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
