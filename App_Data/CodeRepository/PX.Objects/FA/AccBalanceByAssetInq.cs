...
namespace PX.Objects.FA
{
	...
	public class AccBalanceByAssetInq : PXGraph<AccBalanceByAssetInq>
	{
		...
		[Serializable]
		public partial class AccBalanceByAssetFilter : PXBqlTable, IBqlTable
		{
		...
		[Serializable]
		public partial class Amounts : PXBqlTable, IBqlTable
		{
			#region AssetID
		...
		[Serializable]
		[PXHidden]
		public partial class FALocationHistoryCurrent : PXBqlTable, IBqlTable
		{
			#region AssetID
			public abstract class assetID : PX.Data.BQL.BqlInt.Field<assetID> { }
			protected int? _AssetID;
