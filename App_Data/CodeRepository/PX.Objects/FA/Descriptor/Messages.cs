...
namespace PX.Objects.FA
{
	...
	public static class Messages
	{
		...
		public const string AveragingConventionNotMatchDeprMethod = "The averaging convention does not match the averaging convention specified for the selected depreciation method.";
		...
		public const string PeriodDoesNotExistForBookNeedToGeneratePeriods = "The {0} period does not exist for the {1} book. To proceed, generate the necessary periods on the Generate Book Calendars (FA501000) form.";
		...
		public const string DisposalPeriodCannotBeEarlierthanPlacedInServiceDatePeriod = "The disposal period ({0}) cannot be earlier than the period of the placed-in service date ({1}).";
		#endregion
