...
namespace PX.Objects.PM
{
	...
	public static partial class Messages
	{
		...
		public const string CannotCorrectContainsUnreleasedRetainage = "You cannot correct the pro forma invoice because the corresponding AR document has at least one unreleased retainage document. Delete the following retainage documents first: {0}.";
