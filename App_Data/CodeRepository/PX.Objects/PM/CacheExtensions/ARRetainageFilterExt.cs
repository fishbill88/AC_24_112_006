...
namespace PX.Objects.PM.CacheExtensions
{
	...
	/// </summary>
	public sealed class ARRetainageFilterExtProject : PXCacheExtension<ARRetainageFilter>
	{
		/// <summary>
		...
		[PM.ActiveProjectBaseAttribute(typeof(ARInvoice.customerID), FieldClass = PM.ProjectAttribute.DimensionName)]
	...
	/// Extension that activates Project-related functionality for the <see cref="ARRetainageFilter"/> when Project accounting module is enabled.
	/// </summary>
	public sealed class ARRetainageFilterExtProjectContract : PXCacheExtension<ARRetainageFilter>
	{
		/// <summary>
		/// Specifies (if set to <see langword="true" />) that the extension is active.
		/// </summary>
