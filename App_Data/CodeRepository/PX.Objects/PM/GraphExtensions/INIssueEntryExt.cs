...
namespace PX.Objects.PM
{
	public class INIssueEntryExt : ProjectCostCenterSupport<INIssueEntry>
	{
		...
		protected virtual bool IsPMVisible => Setup.Current?.VisibleInIN == true;
	...
	public class SiteStatusLookup : INSiteStatusLookupExt<INIssueEntry>
	{
		...
		protected override INTran InitTran(INTran newTran, INSiteStatusSelected siteStatus)
		{
			...
			Base.Caches<INTran>().SetDefaultExt<INTran.projectID>(tran);
			Base.Caches<INTran>().SetDefaultExt<INTran.taskID>(tran);
