...
namespace PX.Objects.PM
{
	...
	[PXBreakInheritance]
	public partial class PMQuote : PXBqlTable, IBqlTable, IAssign, IPXSelectable, INotable
	{
		#region Selected
		...
		[PXDimensionSelector(ProjectAttribute.DimensionName, 
			typeof(Search<PMProject.contractID, Where<PMProject.baseType, Equal<CTPRType.project>>>), typeof(PMProject.contractCD) , DescriptionField = typeof(PMProject.description))]
