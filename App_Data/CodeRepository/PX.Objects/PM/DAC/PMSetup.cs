...
namespace PX.Objects.PM
{
	...
	public class PMSetup : PXBqlTable, PX.Data.IBqlTable
	{
		/// <summary>
		...
		[PXSelector(
			typeof(Search<
				...
				Where<
					...
					And<EPAssignmentMap.mapType, NotEqual<EPMapType.assignment>>>>), DescriptionField = typeof(EPAssignmentMap.name))]
		...
		/// </value>
		[PXDBInt]
        [PXSelector(typeof(Search<PX.SM.Notification.notificationID>), DescriptionField = typeof(PX.SM.Notification.name))]
		...
		[PXSelector(
			typeof(Search<
				...
				Where<
					...
					And<EPAssignmentMap.mapType, Equal<EPMapType.approval>>>>), DescriptionField = typeof(EPAssignmentMap.name))]
		...
		[PXSelector(
			typeof(Search<
				...
				Where<
					EPAssignmentMap.entityType, Equal<AssignmentMapType.AssignmentMapTypeProforma>,
					And<EPAssignmentMap.mapType, Equal<EPMapType.assignment>>>>), DescriptionField = typeof(EPAssignmentMap.name))]
	...
	[PXBreakInheritance]
	[System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
	public class PMSetupQuoteApproval : PMSetup, IAssignedMap
	{
		int? IAssignedMap.AssignmentMapID
		{
			get
			{
				return this.QuoteApprovalMapID;
			}
			set
			{
				this.QuoteApprovalMapID = value;
			}
		}
		...
		int? IAssignedMap.AssignmentNotificationID
		{
			get
			{
				return this.QuoteApprovalNotificationID;
			}
			set
			{
				this.QuoteApprovalNotificationID = value;
			}
		}
		...
		bool? IAssignedMap.IsActive
		{
			get
			{
				return this.QuoteApprovalMapID.HasValue;
			}
		}
	}
