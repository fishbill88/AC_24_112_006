...
namespace PX.Objects.PM.ChangeRequest.GraphExtensions
{
	public class ProjectEntryExt : PXGraphExtension<PX.Objects.PM.ProjectEntry>
	{
		...
		{
			return Base.GetExtension<ProjectEntry_ChangeOrderExt>() != null && Base.GetExtension<ProjectEntry_ChangeOrderExt>().ChangeOrderEnabled();
		}

		public virtual bool ChangeRequestVisible()
		{
			return Base.GetExtension<ProjectEntry_ChangeOrderExt>() != null
				&& Base.GetExtension<ProjectEntry_ChangeOrderExt>().ChangeOrderFeatureEnabled()
