	...
	public class PRDedBenCodeMaint : PXGraph<PRDedBenCodeMaint, PRDeductCode>
	{
		...
		public SelectFrom<PRDeductCodeDetailUS>
			...
			.Where<PRDeductCodeDetail.codeID.IsEqual<PRDeductCode.codeID.FromCurrent>
				.And<PRTaxCode.countryID.IsEqual<BQLLocationConstants.CountryUS>>
				.And<PRTaxCode.isDeleted.IsEqual<False>>>.View DeductCodeTaxesUS;
		...
		public SelectFrom<PRDeductCodeDetailCAN>
			.InnerJoin<PRTaxCode>.On<PRTaxCode.taxID.IsEqual<PRDeductCodeDetail.taxID>>
			.Where<PRDeductCodeDetail.codeID.IsEqual<PRDeductCode.codeID.FromCurrent>
				.And<PRTaxCode.countryID.IsEqual<BQLLocationConstants.CountryCAN>>
				.And<PRTaxCode.isDeleted.IsEqual<False>>>.View DeductCodeTaxesCAN;
		...
		public SelectFrom<PRDeductCodeTaxIncreasingWage>
			...
			.Where<PRDeductCodeTaxIncreasingWage.deductCodeID.IsEqual<PRDeductCode.codeID.FromCurrent>
				...
				.And<PRTaxCode.isDeleted.IsEqual<False>>>.View TaxesIncreasingWage;
		...
		public SelectFrom<PRDeductCodeTaxDecreasingWage>
			...
			.Where<PRDeductCodeTaxDecreasingWage.deductCodeID.IsEqual<PRDeductCode.codeID.FromCurrent>
				.And<PRTaxCode.countryID.IsEqual<PRDeductCode.countryID.FromCurrent>>
				.And<PRTaxCode.isDeleted.IsEqual<False>>>.View TaxesDecreasingWage;
		...
		protected virtual void _(Events.FieldUpdated<PRDeductCode.benefitTypeCD> e)
		{
			...
			if (benefitType != null)
			{
				...
				CalculationType? calculationMethod = PRTypeSelectorAttribute.GetCalculationMethod<PRBenefit>(benefitType.Value, row.CountryID);
				...
				{
					e.Cache.SetValue<PRDeductCode.benefitCalculationMethod>(row, (int?)calculationMethod);
				}
			}
		}
		...
		{
			if (PaymentDeductions.SelectSingle() != null)
			{
