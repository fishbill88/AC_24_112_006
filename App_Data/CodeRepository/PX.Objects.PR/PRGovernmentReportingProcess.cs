...
namespace PX.Objects.PR
{
	public class PRGovernmentReportingProcess : PXGraph<PRGovernmentReportingProcess>
	{
		...
		{
			// The two variables below are needed to avoid the 'PX1008' Acuminator Error.
			// https://github.com/Acumatica/Acuminator/blob/master/docs/diagnostics/PX1008.md
			PRGovernmentReport governmentReport = CurrentReport.Current;
			int orgBAccountID = Filter.Current.OrgBAccountID.Value;

			PXLongOperation.StartOperation(this, delegate ()
			{
				PXLongOperation.SetCustomInfo(new GenerateAufOperationInfo() { FormName = governmentReport.FormName });
				PRAufGenerationEngine.GenerateAuf(orgBAccountID, governmentReport);
			});
