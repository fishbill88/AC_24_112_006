...
{
	public class PTOAdjustmentStatus
	{
		public class ListAttribute : PXStringListAttribute
		{
			public ListAttribute()
				: base(
				new string[] { New, Released, Voided },
				new string[] { Messages.PTOAdjustmentNew, Messages.PTOAdjustmentReleased, Messages.PTOAdjustmentVoided })
			{ }
		}
