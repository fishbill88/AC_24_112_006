...
namespace PX.Objects.PR
{
	...
	public class PaymentBatchExportReason : PaymentBatchReason
	{
		public PaymentBatchExportReason()
			: base(
				new string[] { WrongEmployeeConfiguration, PaycheckError, BatchError, OtherReason },
				new string[] { Messages.WrongEmployeeConfiguration, Messages.PaycheckError, Messages.BatchError, Messages.OtherReason }
			)
		{ }
	}
