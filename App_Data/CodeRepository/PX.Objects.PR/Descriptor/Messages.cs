...
namespace PX.Objects.PR
{
	...
	public static class Messages
	{
		...
		#region Transfer Date Type List
		public const string AnniversaryDate = "Anniversary Date";
		public const string SpecificDate = "Specific Date";
		#endregion

		#region Probation Period Behaviour List
		public const string AccruedAndAvailable = "Accrued and Available";
		public const string AccruedButNotAvailable = "Accrued but Not Available";
		public const string NotAccrued = "Not Accrued";
		#endregion

		#region Banding Rule Rounding Method List
		...
		#region PTO Adjustment Type List
		public const string PTOAdjustment = "Adjustment";
		public const string VoidingPTOAdjustment = "Voiding Adjustment";
		#endregion

		#region PTO Adjustment Status List
		public const string PTOAdjustmentNew = "New";
		public const string PTOAdjustmentReleased = "Released";
		public const string PTOAdjustmentVoided = "Voided";
		#endregion

		#region PTO Adjustment Reason List
		public const string InitialBalanceCorrection = "Initial Balance Correction";
		public const string BonusOrIncentiveAllocation = "Bonus or Incentive Allocation";
		public const string AccrualModification = "Accrual Modification";
		public const string TimecardUsageCorrection = "Time Card Usage Correction";
		public const string AccrualEarnedCorrection = "Accrual Earned Correction";
		public const string DataEntryCorrection = "Data Entry Correction";
		public const string CarryoverCorrection = "Carryover Correction";
		public const string MaximumAccrualCorrection = "Maximum Accrual Correction";
		public const string PTOAdjustmentOtherReason = "Other";
		#endregion
		...
		public const string EmployeeAddressNotRecognized = "The tax calculation service does not recognize the address information specified for the {0} employee. Make sure that this employee has a complete and valid address specified on the General tab of the Employee Payroll Settings form.";
		...
		public const string AtLeastOneActiveEmployeePositionIsRequired = "At least one active record must be listed on the Employment History tab.";
		...
		public const string BooleanParseError = "The '{0}' string cannot be parsed as a boolean.";
		public const string IntegerParseError = "The '{0}' string cannot be parsed as an integer.";
		public const string DecimalParseError = "The '{0}' string cannot be parsed as a decimal.";
		public const string BooleanTaxSettingParseError = "The '{0}' string cannot be parsed as a boolean in the '{1}' tax setting.";
		public const string IntegerTaxSettingParseError = "The '{0}' string cannot be parsed as an integer in the '{1}' tax setting.";
		public const string BooleanEmployeeTaxSettingParseError = "The '{0}' string cannot be parsed as a boolean in the '{1}' tax setting of the '{2}' employee.";
		public const string IntegerEmployeeTaxSettingParseError = "The '{0}' string cannot be parsed as an integer in the '{1}' tax setting of the '{2}' employee.";
		public const string ReportingTypesMissing = "Some reporting types required for the paycheck calculation are missing. Update tax information by clicking Update Taxes on the Tax Maintenance (PR208000) form.";
		...
		public const string NoBankAccountForDirectDeposit = "At least one bank account must be specified in the table on the Payment tab because a direct deposit payment method is selected for the employee.";
		...
		public const string IncorrectPeriodDate = "All records in a single payroll batch must belong to the same pay period.";
		...
		public const string EmployeeHasPTOBanks = "To be able to clear the Custom Settings check box, remove all PTO settings on this tab first.";
		public const string PTOBankIsUsedByEmployees = "You cannot modify general settings of a PTO bank that is already in use. To be able to modify these settings, remove the PTO bank from all employee payroll settings and paychecks first.";
		...
		public const string EffectiveDateValidationError = "The effective date must be after {0}, which is the end date of the pay period of the last released paycheck.";
		...
		public const string PTOBankCannotBeModified = "The PTO bank is used in paychecks and cannot be modified.";
		public const string PTOBankCannotBeDeleted = "The PTO bank is used in paychecks and cannot be deleted.";
		public const string NegativePTOAmount = "This bank has a negative available amount and zero payable hours left.";
		public const string PaychecksCreatedAfterEffectiveDate = "For employees of the specified employee class, paychecks have already been created for pay periods after the specified effective date. You can enter only records whose effective date is after {0}.";
		public const string BandingRuleRoundingCannotBeChanged = "You cannot modify the rounding method for years of service for a PTO bank that is already in use. To be able to modify or delete this setting, remove the PTO bank from all employee payroll settings and paychecks first.";
		public const string CannotModifyBandingRules = "You cannot modify or delete banding rules for a PTO bank that is already in use. To be able to modify or delete these settings, remove the PTO bank from all employee payroll settings and paychecks first.";
		public const string EmployeeClassSettingsChanged = "Settings of a PTO bank with banding rules have been changed. Update the banding PTO hours or percentage, if needed.";
		public const string CannotModifyOrDeleteEmployeeClassSettings = "You cannot modify or delete settings of a PTO bank that is already in use. To be able to modify or delete these settings, remove the PTO bank from all employee payroll settings and paychecks first.";
		public const string PTOBankHasNoEmployeeClassSettings = "The PTO bank has no settings used by the banding rules.";
		public const string DisablingBandingRuleWarning = "Clearing the Apply Banding Rules check box will remove all banding rules (both common and employee class-specific) for the current PTO bank as well as the PTO settings based on the banding rules in all employee payroll settings. Would you like to proceed?";
		public const string BandingRulesDuplicate = "A record already exists for the same combination of employee class and years of service.";
		public const string EmployeeClassDuplicate = "A record already exists for the same employee class.";
		public const string Warning = "Warning";
		public const string PTOCannotBeUsedDuringProbationPeriod = "The {0} PTO bank cannot be used during the probation period.";
		public const string HoursCannotBeAccruedDuringProbationPeriod = "Hours cannot be accrued for the {0} PTO bank during the probation period.";
		public const string PTOBankTabIsEmpty = "No active PTO bank has been specified for the employee.";
		...
		public const string EmployeeClassNotDefinedInEmployeeClassSettings = "This employee class is not listed on the Employee Classes tab of this form and cannot be used in a banding rule.";
		public const string UseCustomSettingsImportRequirement = "To ensure the correct import of employees' paid time off settings, make sure that the Use Custom Settings check box on the Paid Time Off tab of the Employee Payroll Settings form is selected for each involved employee.";
		public const string RestrictModificationOfPTOBanksViaImport = "PTO details on the Paychecks and Adjustments (PR302000) form may be updated manually, and not through the use of an import scenario.";
		public const string ProhibitPTOBankDeletion = "This PTO bank cannot be deleted because it is used in the payroll settings of at least one employee.";
		public const string EmployeePTOBankDuplicate = "Specify a different effective date or select a different PTO bank because a record with the same effective date has already been added for the same PTO bank.";
		public const string MainAddressRequired = "Specify the required address information.";
		...
		public const string EmployeeClassCannotBeDeleted = "This record cannot be deleted because it is linked to a banding rule.";
		public const string FrontLoadingGreaterThanBalanceLimit = "The number of front-loading hours cannot be greater than the balance limit.";
		public const string BalanceLimitLowerThanFrontLoading = "The balance limit cannot be lower than the number of front-loading hours.";
		...
		public const string EmployeePTODetailsReport = "Employee PTO Details";
		...
		public const string PRPTOAdjustment = "PTO Adjustment";
		public const string PRPTOAdjustmentDetail = "PTO Adjustment Detail";
		...
		public const string PRBandingRulePTOBank = "Banding Rules";
		#endregion
		...
		public const string NoOriginalTaxFormBatchForCorrectAction = "No original document has been prepared for at least one employee in the selected year. Do you want to proceed with submission?";
		public const string NoOriginalTaxFormBatch = "No original document has been prepared for this employee in the selected year.";
		...
		public const string ErrorDuringPdfCreation = "An error occurred during the creation of the preview for the PDF file. For details, see the trace log: Click Tools > Trace on the form title bar.";
		...
		public const string ImpossibleToGenerateTaxForm = "The {0} tax form could not be generated in the {1} format.";
		...
		public const string FrontLoading = "Front Loading";
		public const string FrontLoadingAndPercentage = "Front Loading and Percentage";
		public const string FrontLoadingAndHoursPerYear = "Front Loading and Hours Per Year";
		...
		#region Employee Payroll Settings Warnings

		public const string EmployeeAlreadyHasPayrollClass = "The employee already has a payroll class assigned to them. Do you wish to change it?";

		#endregion

		#region PTO warnings/errors

		public const string PTOBankNotActive = "The PTO bank is not active.";
		public const string VoidPTOAdjustmentDescription = "Voiding adjustment for PTO adjustment {0}";
		public const string PTOBankCannotHaveNegativeBalance = "A PTO bank cannot have a negative balance.";
		public const string PTOBankAccrualLimitCannotBeExceeded = "The accrual limit of a PTO bank cannot be exceeded.";
		public const string PTOAdjustmentCannotBeReleased = "The adjustment cannot be released because at least one employee has open paychecks. See the trace log for details.";
		public const string PTOAdjustmentCannotBeVoided = "The adjustment cannot be voided because at least one employee has open paychecks. See the trace log for details.";
		public const string PTOAdjustmentAppliedToPaychecksAndCannotBeVoided = "The PTO adjustment cannot be voided because at least one adjustment detail record has been applied to a paycheck. For details, see the trace log: Click Tools > Trace on the form title bar.";
		public const string PaycheckIsNotReleased = "The {0} paycheck has not been released.";
		public const string PTOAdjustmentAppliedToPaycheck = "The PTO adjustment has been applied to the {0} paycheck.";
		public const string PaycheckCannotBeCreated = "The paycheck cannot be created because this employee has open PTO adjustments. See the trace log for details.";
		public const string PTOAdjustmentIsNotReleased = "The {0} PTO adjustment has not been released.";

		#endregion PTO warnings/errors

		#region Payroll Endpoint API errors

		public const string EmployeeNotFound = "The {0} employee is not found.";

		#endregion Payroll Endpoint API errors
