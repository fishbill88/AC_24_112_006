...
namespace PX.Objects.PR
{
	...
	public class PREmployee : EPEmployee
	{
		...
		#endregion
		#region UseCustomSettings
		/// <summary>
		/// Indicates (if set to <see langword="true" />) that the employee is using customized paid-time-off banks instead of the default ones provided by their payroll class.
		/// </summary>
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Use Custom Settings")]
		public bool? UseCustomSettings { get; set; }
		public abstract class useCustomSettings : BqlBool.Field<useCustomSettings> { }
		#endregion
		#region WorkCodeID
