...
namespace PX.Objects.PR
{
	...
	public class PRDirectDepositBatchEntry : PXGraph<PRDirectDepositBatchEntry>
	{
		...
		public virtual void _(Events.RowSelected<PRCABatch> e)
		{
			...
			{
				IEnumerable<PXResult<CABatchDetail, PRPayment, PRDirectDepositSplit>> batchPaymentDetails = BatchPaymentsDetails.View
					.SelectMulti()
					.Cast<PXResult<CABatchDetail, PRPayment, PRDirectDepositSplit>>();
				Filter.Current.PaymentBatchStatus = batchPaymentDetails.Any() ? PaymentBatchStatus.GetStatus(batchPaymentDetails.Select(x => (PRPayment)x)) : PaymentBatchStatus.ReadyForExport;
	...
	public class PRPaymentBatchFilter : PXBqlTable, IBqlTable
	{
