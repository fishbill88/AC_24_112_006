...
namespace PX.Objects.PR
{
	...
	public class PRPayBatchEntry : PXGraph<PRPayBatchEntry, PRBatch>, PXImportAttribute.IPXPrepareItems
	{
		...
		private void CreatePayments(PRBatch currentBatch)
		{
			...
			foreach (PRBatchEmployee batchEmployee in employeesInCurrent)
			{
				...
				PayRateAttribute.StopRateCalculation(EmployeeEarningDetails.Cache);
				PayRateAttribute.StopRateCalculation(payCheckGraph.Earnings.Cache);
	...
	[Serializable]
	[PXHidden]
	public class AddEmployeeFilter : PXBqlTable, IBqlTable
	{
	...
	[Serializable]
	[PXHidden]
	public class PRBatchTotalsFilter : PXBqlTable, IBqlTable
	{
		#region HideTotals
	...
	[Serializable]
	[PXHidden]
	public class NonSelectableEmployee : PXBqlTable, IBqlTable
	{
		#region EmployeeID
