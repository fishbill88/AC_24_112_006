	...
	public class PREarningTypeMaint : EPEarningTypesSetup
	{
		...
		public SelectFrom<PREarningTypeDetailUS>
			...
			.Where<PREarningTypeDetail.typecd.IsEqual<EPEarningType.typeCD.FromCurrent>
				.And<PREarningTypeDetail.countryID.IsEqual<BQLLocationConstants.CountryUS>>
				.And<PRTaxCode.isDeleted.IsEqual<False>>>.View EarningTypeTaxesUS;

		public SelectFrom<PREarningTypeDetailCAN>
			.InnerJoin<PRTaxCode>.On<PREarningTypeDetail.taxID.IsEqual<PRTaxCode.taxID>>
			.Where<PREarningTypeDetail.typecd.IsEqual<EPEarningType.typeCD.FromCurrent>
				.And<PREarningTypeDetail.countryID.IsEqual<BQLLocationConstants.CountryCAN>>
				.And<PRTaxCode.isDeleted.IsEqual<False>>>.View EarningTypeTaxesCAN;
		...
		protected virtual void _(Events.CacheAttached<PREarningType.wageTypeCD> e) { }

		[PXMergeAttributes(Method = MergeMethod.Append)]
		[PRReportingTypeSelector(typeof(PRWage), LocationConstants.USCountryCode)]
		protected virtual void _(Events.CacheAttached<PREarningType.reportType> e) { }

		[PXMergeAttributes(Method = MergeMethod.Append)]
		[PRWebServiceTypeFromDatabaseSelector(PRTaxWebServiceDataSlot.DataType.WageTypes, LocationConstants.CanadaCountryCode, true)]
		protected virtual void _(Events.CacheAttached<PREarningType.wageTypeCDCAN> e) { }
		...
		protected virtual void _(Events.CacheAttached<PREarningType.reportTypeCAN> e) { }
		...
		protected virtual void _(Events.CacheAttached<PREarningType.quebecReportTypeCAN> e) { }
		#endregion
