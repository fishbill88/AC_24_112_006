...
namespace SP.Objects.IN
{
    ...
    [Serializable]
    public class InventoryLineFilter : PXBqlTable, IBqlTable
    {
        #region Find Item
    ...
    [Serializable]
    public class InventoryLineInfo : PXBqlTable, IBqlTable
    {
        #region Info
    ...
    [PXProjection(typeof(
		...
		Where<InventoryItem.itemStatus, In3<InventoryItemStatus.active, InventoryItemStatus.noPurchases, InventoryItemStatus.noRequest>,
			...
			>), Persistent = false)]
    [Serializable]
    public class InventoryLines : PXBqlTable, IBqlTable
    {
        #region InventoryID
	...
	[Serializable]
	public class InventoryLinesWithoutGroup : PXBqlTable, IBqlTable
	{
		#region InventoryID
	...
	public class InventoryAvailability: PXBqlTable, IBqlTable
	{
		#region InventoryID
		public abstract class inventoryID : BqlInt.Field<inventoryID> { }
    ...
    [Serializable]
    public class InventoryItemsWithCategories : PXBqlTable, IBqlTable
    {
        #region InventoryID
        public abstract class inventoryID : PX.Data.IBqlField
        {
