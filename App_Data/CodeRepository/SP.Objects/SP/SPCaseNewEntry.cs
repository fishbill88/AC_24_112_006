	...
	public class SPCaseNewEntry : PXGraph<SPCaseNewEntry>
	{
		...
		protected virtual void CRCase_SLAETA_FieldDefaulting(PXCache sender, PXFieldDefaultingEventArgs e)
		{
			...
			if (row.ClassID != null && row.Severity != null)
			{
				...
				if (severity != null && severity.ResolutionTimeTarget != null)
				{
					e.NewValue = ((DateTime)row.CreatedDateTime).AddMinutes((int)severity.ResolutionTimeTarget);
					e.Cancel = true;
				}
			}
		...
		protected virtual void CRCase_RowInserted(PXCache sender, PXRowInsertedEventArgs e)
		{
			...
			if (row.CaseClassID != null && row.Severity != null)
			{
				...
				if (severity != null && severity.ResolutionTimeTarget != null)
				{
					row.SLAETA = ((DateTime)row.CreatedDateTime).AddMinutes((int)severity.ResolutionTimeTarget);
				}
			}
		...
		#region Extensions
		public class SPCaseNewEntry_DefaultReportedOnDateTimeExt : CRCaseDefaultReportedOnDateTimeExt<SPCaseNewEntry>
		{
