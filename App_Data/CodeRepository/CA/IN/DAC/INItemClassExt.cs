...
{
	/// <summary>
	/// An extension for <see cref="INItemClass"/> that is used in Canadian Localization.
	/// </summary>
	[Serializable]
	public sealed class INItemClassExt : PXCacheExtension<INItemClass>
	{
		...
		/// <summary>
		/// Flag the indicates that items created from this Item Class should be considered a construction service for the purpose of
