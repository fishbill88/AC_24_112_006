...
namespace PX.Commerce.Shopify
{
	...
	public static class ShopifyMessages
	{
		...
		public const string PINoNonStockItemClass = "The default non-stock item class is required to import non-stock items. Make sure that an item class for non-stock items is selected on the Inventory Settings tab of the Shopify Stores (BC201010) form.";
		public const string PINoStockItemClass = "The default stock item class is required to import stock items. Make sure that an item class for stock items is selected on the Inventory Settings tab of the Shopify Stores (BC201010) form.";
		public const string PINoInventoryNumbering = "The default inventory numbering sequence is required to import template items. Make sure that an inventory numbering sequence is selected on the Inventory Settings tab of the Shopify Stores (BC201010) form.";
		public const string PIDuplicateInventoryCode = "The {0} item could not be imported because the item with the same inventory ID ({1}) already exists in the ERP system. Specify a unique SKU for the item in the {2} store, or fill in the Inventory Numbering Sequence box on the Shopify Stores (BC201010) form; then synchronize the record again.";
	}
	...
	public static class ShopifyCaptions
	{
		...
		public const string CompareAtPrice = "Compare At Price";
		...
		public const string OrderExchangeAddition = "Order Exchange Addition";
		public const string OrderExchangeReturn = "Order Exchange Return";
