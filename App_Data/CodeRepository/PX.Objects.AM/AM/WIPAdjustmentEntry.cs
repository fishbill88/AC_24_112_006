...
namespace PX.Objects.AM
{
    ...
    public class WIPAdjustmentEntry : AMBatchSimpleEntryBase
    {
		...
		[PXRestrictor(typeof(Where<AMProdItem.released, Equal<True>, And<AMProdItem.hold, Equal<False>, And<AMProdItem.closed, Equal<False>, And<AMProdItem.canceled, Equal<False>>>>>),
