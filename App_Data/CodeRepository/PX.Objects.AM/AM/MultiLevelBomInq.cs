...
                    continue;
	...
	/// <summary>
	/// The filter for Multi Level BOM (AM413000) form, which corresponds to the <see cref="MultiLevelBomInq"/> graph.
	/// </summary>
	[PXCacheName("Multi Level BOM Report Filter")]
    [Serializable]
    public class AMMultiLevelBomFilter : PXBqlTable, IBqlTable
    {
        #region BOMID
