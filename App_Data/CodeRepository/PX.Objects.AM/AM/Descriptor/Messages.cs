...
namespace PX.Objects.AM
{
    ...
    public static class Messages
    {
        ...
        public const string UnableToCreateBomFromEstimateStep = "A BOM cannot be created from the {1} revision of the {0} estimate. The {2} step is not valid.";
		...
		public const string MoveControlPointQtyAvailableWithoutBackwardReporting = "The total quantity must be less than or equal to the minimum quantity reported on control point operations for operation {2} in production order {1} of the {0} type.";
		...
		public const string CalculatedLaborTimeLessThan1Minute = "The calculated labor time for the {0} operation of production order {1} {2} is less than 1 minute and therefore cannot be recorded. Would you like to set labor time to 1 minute? Otherwise, the labor time record will be deleted.";
		...
		public const string InventoryItemIsNotAStockOrKit = "The inventory item is not a stock item or a non-stock kit.";
		public const string NoActiveKitSpec = "Cannot create Kit Assembly for one or more of the selected records. All records selected must have an active Kit Specification.";
		public const string KitIDIsAlreadyUsed = "The {0} kit assembly is already used.";
        public const string ValMethodCannotBeChangedDueToProdOrders = "The valuation method cannot be changed because open production orders exist for this item.";
        public const string BranchBaseCurrencyDiscrepancy = "The selected sales order has a different base currency than the current branch has.";
		public const string BomAttrValueDisabled = "The value of the {0} attribute has not been copied from the original production order because it is disabled on the Attributes (CS205000) form. Specify a new default value for the attribute.";
		...
		public const string CreatedKitFromMrp = "The {0} kit with the {1} type has been assembled from MRP.";
		...
		public const string MRPEnginePersistScheduleDisabled = "The saving of planned schedules has been disabled.";
		...
		public const string PlannedKitDemand = "Planned Kit Assembly Demand";
		public const string SOrderNonStockKitDemand = "Sales Order Non-Stock Kit";
		public const string ForecastNonStockKitDemand = "Forecast Non-Stock Kit";
