...
namespace PX.Objects.AM
{
    ...
    public class CreateProductionOrdersProcess : PXGraph<CreateProductionOrdersProcess>
    {
        ...
        public PXFilteredProcessingJoin<AMFixedDemand, ProductionOrdersCreateFilter,
            ...
            LeftJoin<SOLineDemandConfiguration, On<SOLineDemandConfiguration.ordTypeRef, Equal<SOLine.orderType>,
                And<SOLineDemandConfiguration.ordNbrRef, Equal<SOLine.orderNbr>,
                And<SOLineDemandConfiguration.ordLineRef, Equal<SOLine.lineNbr>>>>,
            ...
            And2<Where2<Where<SOLineDemandConfiguration.configResultsID, IsNull, Or<SOLineDemandConfiguration.completed, Equal<True>>>,
				Or<IsNull<SOLineDemandConfiguration.isCompletionRequired, False>,Equal<False>>>,
			...
			Or<Where<AMFixedDemand.planType, Equal<INPlanConstants.planMA>,
				And2<Where<AMProdMatlSplit.aMOrderType, IsNull, And<AMProdMatlSplit.aMProdOrdID, IsNull>>,
					And<AMFixedDemand.hold, Equal<False>>>>>>>,
        ...
        public virtual void CreateProductionOrdersFromSalesLines(List<SOLine> list)
        {
            ...
            foreach (var line in list)
            {
                ...
                if (soLineAMExtension == null
                    ...
                    || (line.Qty.GetValueOrDefault() < 0 && line.Operation != SOOperation.Issue)
        ...
        public virtual void CreateProductionOrders(List<AMFixedDemand> list, ProductionOrdersCreateFilter filter, ProdMaint prodMaintGraph)
        {
            ...
            for (var i = 0; i < list.Count; i++)
            {
                ...
                try
                {
					...
					if (demand.AMOrderType != null && demand.AMProdOrdID != null && demand.AMOperationID != null && demand.AMLineID != null)
					{
						AMProdMatl material = AMProdMatl.PK.Find(prodMaintGraph, demand.AMOrderType, demand.AMProdOrdID, demand.AMOperationID, demand.AMLineID);
						if (!string.IsNullOrEmpty(material.CompBOMID))
						{
							if (string.IsNullOrEmpty(material.CompBOMRevisionID))
							{
								var compBom = PrimaryBomIDManager.GetActiveRevisionBomItemByDate(prodMaintGraph, material.CompBOMID, amProdItem.BOMEffDate);
								if (compBom != null)
								{
									amProdItem.BOMID = compBom.BOMID;
									amProdItem.BOMRevisionID = compBom.RevisionID;
								}
							}
							else
							{
								amProdItem.BOMID = material.CompBOMID;
								amProdItem.BOMRevisionID = material.CompBOMRevisionID;
							}
						}
					}
        ...
        public partial class ProductionOrdersCreateFilter : PXBqlTable, IBqlTable
        {
			...
			[PXSelector(typeof(Search2<SOOrder.orderNbr,
				...
				Where<SOOrder.orderType, Equal<Current<ProductionOrdersCreateFilter.sOOrderType>>>>))]
			[PXRestrictor(typeof(Where<Branch.baseCuryID, Equal<Current<AccessInfo.baseCuryID>>>), Messages.BranchBaseCurrencyDiscrepancy)]
	...
	[PXProjection(typeof(Select2<AMConfigurationResults,
		LeftJoin<AMConfiguration, On<AMConfiguration.configurationID, Equal<AMConfigurationResults.configurationID>,
				And<AMConfiguration.revision, Equal<AMConfigurationResults.revision>>>>>), Persistent = false)]
	public class SOLineDemandConfiguration : PXBqlTable, PX.Data.IBqlTable
	{
		#region OrdLineRef
		/// <summary>
		/// <inheritdoc cref="AMConfigurationResults.ordLineRef"/>
		/// </summary>
        ...
        #region OrdTypeRef
		/// <summary>
		/// <inheritdoc cref="AMConfigurationResults.ordTypeRef"/>
		/// </summary>
		...
		/// <inheritdoc cref="AMConfigurationResults.OrdTypeRef"/>
		/// </summary>
        [PXDBString(BqlField = typeof(AMConfigurationResults.ordTypeRef))]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        #region OrdNbr
		/// <summary>
		/// <inheritdoc cref="AMConfigurationResults.ordNbrRef"/>
		/// </summary>
		...
		/// <inheritdoc cref="AMConfigurationResults.OrdNbrRef"/>
		/// </summary>
        [PXDBString(BqlField = typeof(AMConfigurationResults.ordNbrRef))]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		...
		/// <summary>
		/// <inheritdoc cref="AMConfigurationResults.configResultsID"/>
		/// </summary>
		...
		/// <inheritdoc cref="AMConfigurationResults.ConfigResultsID"/>
		/// </summary>
        [PXDBIdentity(BqlField = typeof(AMConfigurationResults.configResultsID))]
		...
		#region Completed
		/// <summary>
		/// <inheritdoc cref="AMConfigurationResults.completed"/>
		/// </summary>
		...
		/// <summary>
		/// <inheritdoc cref="AMConfiguration.isCompletionRequired"/>
		/// </summary>
		...
		/// <inheritdoc cref="AMConfiguration.IsCompletionRequired"/>
		/// </summary>
        [PXDBBool(BqlField = typeof(AMConfiguration.isCompletionRequired))]
