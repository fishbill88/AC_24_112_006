...
namespace PX.Objects.AM
{
    ...
    public class WorkCenterCrewScheduleInq : PXGraph<WorkCenterCrewScheduleInq>
    {
		...
		/// which corresponds to the <see cref="WorkCenterCrewScheduleInq"/> graph.
		/// </summary>
		#region Internals
		[Serializable]
        [PXCacheName("Work Center Crew Schedule Filter")]
        public class WorkCenterCrewScheduleFilter : PXBqlTable, IBqlTable
        {
            #region WcID
        ...
        public class WorkCenterCrewScheduleDetail : PXBqlTable, IBqlTable
        {
