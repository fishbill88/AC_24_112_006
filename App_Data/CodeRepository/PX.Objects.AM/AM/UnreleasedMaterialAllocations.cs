...
namespace PX.Objects.AM
{
    ...
    public class UnreleasedMaterialAllocations : PXGraph<UnreleasedMaterialAllocations>
    {
        ...
        [PXButton]
        [PXUIField(DisplayName = "View Detail", Visible = false)]
	...
	/// which corresponds to the <see cref="UnreleasedMaterialAllocations"/> graph.
	/// </summary>
    ...
    public class AMUnrelMaterialAllocationsFilter : PXBqlTable, IBqlTable
    {
        #region InventoryID
