...
namespace PX.Objects.AM
{
    ...
    public class AsBuiltConfigFilter : PXBqlTable, IBqlTable
    {
        #region LotSerialNbr
    ...
    [Serializable]
    [PXHidden]
    public class AsBuiltTreeNode : PXBqlTable, IBqlTable
    {
        #region ParentID
    ...
    [PXHidden]
    public class AMProdLotSerial : PXBqlTable, IBqlTable
    {
        #region InventoryID
        public abstract class inventoryID : PX.Data.BQL.BqlInt.Field<inventoryID> { }
