    ...
    public class ProductionConfigurationCopy : ProductionBomCopy
    {
        ...
        protected override void CopyMatl(OperationDetail operationDetail)
        {
            ...
            var q = new PXSelectJoin<AMConfigurationResults,
				...
				LeftJoin<AMConfigurationOptionCurySettings, On<AMConfigurationOptionCurySettings.FK.ConfigOption>>>>>,
                                ...
                                AMConfigResultsOption,
                                    AMConfigurationOption,
                                        AMConfigurationFeature,
											AMConfigurationOptionCurySettings> configItem
                                        in q.Select(ConfigResults?.Current?.ConfigResultsID, operationDetail.BomOperationID))
            {
                ...
                var resultOptionCurySetting = ProcessingGraph.Caches<AMConfigurationOptionCurySettings>().LocateElse((AMConfigurationOptionCurySettings)configItem);
				AMConfigurationOption option = (AMConfigurationOption)configItem;
				option.SiteID = resultOptionCurySetting.SiteID;
				option.LocationID = resultOptionCurySetting.LocationID;
