...
namespace PX.Objects.AM
{
	...
	public class WCMaint : PXGraph<WCMaint, AMWC>
	{
        ...
        [PXButton]
        [PXUIField(DisplayName = "View BOM", Visible = false)]
        ...
        [Serializable]
        [PXHidden]
        public class CalendarWeek : PXBqlTable, IBqlTable
        {
            #region DAY 1
	...
	/// which corresponds to the <see cref="WCMaint"/> graph. 
	/// </summary>
	#region Work Center Update DAC Fields
	[Serializable]
    [PXCacheName("WorkCenter Update Filter")]
    public class WorkCenterUpdateFilter : PXBqlTable, IBqlTable
    {
        #region BFlush
