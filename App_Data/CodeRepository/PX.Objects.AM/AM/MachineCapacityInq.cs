...
namespace PX.Objects.AM
{
    ...
    public class MachineCapacityInq : CapacityInqBase<MachineCapacityInq.MachineCapacityFilter, MachineCapacityInq.MachineCapacityDetail>
    {
		...
		/// <summary>
		/// The filter of the Machine Capacity (AM406000) form (which corresponds to the <see cref="MachineCapacityInq"/> graph).
		/// </summary>
		[Serializable]
		...
		/// <summary>
		/// A DAC that contains the machine capacity details. These records are generated by the <see cref="MachineCapacityInq"/> graph.
		/// </summary>
		[Serializable]
