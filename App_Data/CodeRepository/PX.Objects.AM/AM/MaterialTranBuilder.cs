...
namespace PX.Objects.AM
{
    ...
    public class MaterialTranBuilder
    {
            ...
            INLotSerClass lotSerClass, decimal totalIssueQty, string issueUom, int? siteID, int? locationID, out string exception)
        {
            ...
            var isLotSerTracked = lotSerClass.LotSerTrack != null && lotSerClass.LotSerTrack != INLotSerTrack.NotNumbered;
                ...
                .Select(_graph, prodMatl.OrderType, prodMatl.ProdOrdID, prodMatl.OperationID, prodMatl.LineID))
            {
                ...
                var inventory  = (InventoryItem) result;

                if (inventory.StkItem == true && (split?.InventoryID == null
				...
				var splitBaseQty = inventory.StkItem == true ? Math.Abs(split.BaseQty.GetValueOrDefault()) * (isReturn ? -1 : 1)
					: tran.BaseQty.GetValueOrDefault() * (isReturn ? -1 : 1);
				...
				remainingIssueBaseQty -= returnBaseQty;
        ...
        public virtual List<AMMTran> BuildMaterialByProductTransactions(AMProdMatl prodMatl, decimal totalIssueQty, string issueUom, int? siteID, int? locationID)
        {
            ...
            {
                CreateAMMTran(prodMatl, totalIssueQty, prodMatl.UOM, siteID, locationID ?? GetDefaultReceiptLocationID(prodMatl.InventoryID, siteID, true))
            };
        }
