...
namespace PX.Objects.AM
{
    ...
    public class AMProdMatlSplit : PXBqlTable, IBqlTable, ILSDetail, IProdOper, IItemPlanSource
	{
#if DEBUG
        ...
        public class PXRefNoteAttribute : PX.Data.PXRefNoteAttribute
        {
            ...
            public override void CacheAttached(PXCache sender)
            {
				...
				var fieldAction = (PXAction)Activator.CreateInstance(typeof(PXNamedAction<>).MakeGenericType(typeof(AMProdItem)), new object[] { sender.Graph, ActionName, del, new PXEventSubscriberAttribute[] { new PXUIFieldAttribute { MapEnableRights = PXCacheRights.Select } } }); ;
				fieldAction.SetVisible(false);
				sender.Graph.Actions[ActionName] = fieldAction;
			}
    ...
    public class AMProdMatlSplit2 : PXBqlTable, IBqlTable, IProdOper
    {
        #region OrderType
        public abstract class orderType : PX.Data.BQL.BqlString.Field<orderType> { }
	...
	[PXProjection(typeof(Select2<
		AMProdMatlSplit, InnerJoin<
			...
			>
		>))]
    public class AMProdMatlSplitPlan : PXBqlTable, IBqlTable
    {
        #region OrderType
        public abstract class orderType : PX.Data.BQL.BqlString.Field<orderType> { }
