...
namespace PX.Objects.AM
{
    ...
    public class AMProdAttribute : PXBqlTable, IBqlTable, IProdOper
    {
        ...
        [PXCheckUnique(typeof(AMProdAttribute.orderType), typeof(AMProdAttribute.prodOrdID), IgnoreDuplicatesOnCopyPaste = true)]
