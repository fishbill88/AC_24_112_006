...
namespace PX.Objects.AM
{
    ...
    public class AMProdMatl : PXBqlTable, IBqlTable, ISortOrder, ILSPrimary, IProdOper, IPhantomBomReference, INotable
    {
        ...
        [PXDBBool]
        [DefaultMarkFor(typeof(IIf<Where<Current<AMProdItem.function>,Equal<OrderTypeFunction.regular>>,
			MaterialDefaultMarkFor.purchase,MaterialDefaultMarkFor.noDefault>))]
        [PXFormula(typeof(Default<AMProdMatl.inventoryID>))]
        ...
        [PXDBBool]
        [DefaultMarkFor(typeof(IIf<Where<Current<AMProdItem.function>,Equal<OrderTypeFunction.regular>>,
			MaterialDefaultMarkFor.production,MaterialDefaultMarkFor.noDefault>))]
        [PXFormula(typeof(Default<AMProdMatl.inventoryID>))]
