...
namespace PX.Objects.AM
{
	...
	public class AMEstimateItem : PXBqlTable, IBqlTable, IEstimateInventory, INotable
	{
#if DEBUG
		//
        ...
        [PXDBCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AMEstimateItem.curyInfoID), typeof(AMEstimateItem.unitCost), BaseCalc = false, BqlField = typeof(Standalone.AMEstimateItem.curyUnitCost))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        ...
        [AMDBCurrencyBase(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AMEstimateItem.curyInfoID), typeof(AMEstimateItem.curyUnitCost), BqlField = typeof(Standalone.AMEstimateItem.unitCost))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        [PXUIField(DisplayName = "Unit Cost", Enabled = false)]
        ...
        [AMDBCurrencyBase(typeof(AMEstimateItem.curyInfoID), typeof(AMEstimateItem.curyExtPrice), RecalculateCondition = typeof(Where<priceOverride,Equal<True>>), BqlField = typeof(Standalone.AMEstimateItem.extPrice))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        [PXUIField(DisplayName = "Total Price", Enabled = false)]
        [PXFormula(typeof(Switch<Case<Where<AMEstimateItem.priceOverride, Equal<True>>, Mult<AMEstimateItem.unitPrice, AMEstimateItem.orderQty>>,
        ...
        [PXDBCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AMEstimateItem.curyInfoID), typeof(AMEstimateItem.unitPrice), BaseCalc = false, BqlField = typeof(Standalone.AMEstimateItem.curyUnitPrice))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        ...
        [AMDBCurrencyBase(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AMEstimateItem.curyInfoID), typeof(AMEstimateItem.curyUnitPrice), RecalculateCondition = typeof(Where<priceOverride,Equal<True>>), BqlField = typeof(Standalone.AMEstimateItem.unitPrice))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
