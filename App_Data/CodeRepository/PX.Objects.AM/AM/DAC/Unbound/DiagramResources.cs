...
{
	/// <summary>
	/// A DAC that is used to populate the production order cache in <see cref="ManufacturingDiagram"/>.
	/// </summary>
	[PXCacheName("Production orders resources")]
    public class ProductionOrderResource : PXBqlTable, IBqlTable
    {
	    #region Id
	    [PXString(IsKey = true)]
	...
	/// <summary>
	/// Is used to populate the work center cache in <see cref="ManufacturingDiagram"/>.
	/// </summary>
	[PXCacheName("Work centers resources")]
    public class WorkCenterResource : PXBqlTable, IBqlTable
    {
        #region Id
        [PXString(IsKey = true)]
        [PXUIField(DisplayName = "ID", Visible = false, Visibility = PXUIVisibility.Invisible)]
	...
	/// <summary>
	/// Is used to populate the machine cache in <see cref="ManufacturingDiagram"/>.
	/// </summary>
	[PXCacheName("Machines resources")]
    public class MachineResource : PXBqlTable, IBqlTable
    {
        #region Id
        [PXString(IsKey = true)]
	...
	/// <summary>
	/// Is used to populate the cache of the work center shift calendar in <see cref="ManufacturingDiagram"/>.
	/// </summary>
	[PXCacheName("Work center shift calendar resources")]
    public class WorkCenterShiftCalendarResource : PXBqlTable, IBqlTable
    {
        #region Id
        [PXString(IsKey = true)]
        [PXUIField(DisplayName = "Shift")]
    ...
    public class MachineCalendarResource : PXBqlTable, IBqlTable
    {
        #region Id
        [PXString(IsKey = true)]
        [PXUIField(DisplayName = "Machine")]
