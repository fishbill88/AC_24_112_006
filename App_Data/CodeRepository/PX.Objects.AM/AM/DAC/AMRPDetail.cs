...
namespace PX.Objects.AM
{
	...
	public class AMRPDetail : PXBqlTable, IBqlTable
	{
		...
		/// Kit Revision ID
		/// </summary>
		[RevisionIDField(DisplayName = "Kit Revision", Enabled = false, Visible = false, FieldClass = nameof(FeaturesSet.KitAssemblies))]
		[PXSelector(typeof(Search<INKitSpecHdr.revisionID,
				Where<INKitSpecHdr.kitInventoryID, Equal<Current<AMRPDetail.kitRevisionID>>>>)
			, typeof(INKitSpecHdr.revisionID)
			, typeof(INKitSpecHdr.descr), ValidateValue = false)]
