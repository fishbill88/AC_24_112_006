...
namespace PX.Objects.AM
{
    ...
    public class AMConfigurationRule : PXBqlTable, IBqlTable, IProductConfiguration
    {
    ...
    public class AMConfigurationAttributeRule : PXBqlTable, IBqlTable
    {
    ...
    public class AMConfigurationFeatureRule : PXBqlTable, IBqlTable
    {
        #region ConfigurationID
        public abstract class configurationID : PX.Data.BQL.BqlString.Field<configurationID> { }
