...
namespace PX.Objects.AM
{
    ...
    [PXProjection(typeof(Select2<
		...
		InnerJoin<AMProdOper,
			On<AMProdOper.orderType, Equal<AMProdMatl.orderType>,
            And<AMProdOper.prodOrdID, Equal<AMProdMatl.prodOrdID>,
            And<AMProdOper.operationID, Equal<AMProdMatl.operationID>>>>>>>>), Persistent = false)]
    public class AMMrpProdMatl : PXBqlTable, IBqlTable, INotable
    {
        #region OrderType
        ...
        public virtual string OperationCD
        {
            get
            {
                return this._OperationCD;
            }
            set
            {
                this._OperationCD = value;
            }
        }
        #endregion
        #region LineID
