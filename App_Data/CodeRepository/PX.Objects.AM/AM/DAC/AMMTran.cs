...
namespace PX.Objects.AM
{
    ...
    public class AMMTran : PXBqlTable, IBqlTable, ILSPrimary, IProdOper, IAMBatch, INotable, IProdCostTran, IProdOrder
    {
    ...
    public class AMMTranUnreleasedWipByOperation : PXBqlTable, IBqlTable
    {
#if DEBUG
    ...
    public class AMMTranProdMatl : PXBqlTable, IBqlTable
    {
        #region DocType
    ...
    public class AMMTranProductionOrder : PXBqlTable, IBqlTable
    {
        #region DocType
    ...
    [Serializable]
    [PXProjection(typeof(Select<AMMTran>), Persistent = false)]
    public class AMMTranLotSerialNbrAll : PXBqlTable, IBqlTable
    {
        #region DocType
