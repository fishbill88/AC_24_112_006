...
namespace PX.Objects.AM
{
    ...
    public class AMEstimateReference : PXBqlTable, IBqlTable
    {
        #region Keys
        ...
        [AMDBCurrencyBase(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AMEstimateReference.curyInfoID), typeof(AMEstimateReference.curyUnitPrice))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXUIField(DisplayName = "Unit Price", Enabled = false)]
        ...
        [AMDBCurrencyBase(typeof(AMEstimateReference.curyInfoID), typeof(AMEstimateReference.curyExtPrice))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXUIField(DisplayName = "Total Price", Enabled = false)]
