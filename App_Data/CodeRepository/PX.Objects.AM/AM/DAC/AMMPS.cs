...
namespace PX.Objects.AM
{
    ...
    public class AMMPS : PXBqlTable, IBqlTable, INotable
    {
		...
		[PXDefault(typeof(Search<InventoryItemCurySettings.dfltSiteID, Where<InventoryItemCurySettings.inventoryID, Equal<Current<AMMPS.inventoryID>>,
