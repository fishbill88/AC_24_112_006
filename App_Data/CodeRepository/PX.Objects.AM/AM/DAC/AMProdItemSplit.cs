...
namespace PX.Objects.AM
{
    ...
    public class AMProdItemSplit : PXBqlTable, IBqlTable, ILSDetail, IProdOrder, IItemPlanSource
	{
	...
	[PXProjection(typeof(Select2<AMProdItemSplit,
		...
		Where<AMProdItem.preassignLotSerial, Equal<True>,
				...
				And<AMProdItemSplit.lotSerialNbr, NotEqual<StringEmpty>>>>>),
		Persistent = false)]
	[Serializable]
    [PXCacheName("Prod Item Split Lot/Serial")]
    [System.Diagnostics.DebuggerDisplay("{DebuggerDisplay,nq}")]
    public class AMProdItemSplitPreassign : PXBqlTable, IBqlTable,IProdOrder
    {
