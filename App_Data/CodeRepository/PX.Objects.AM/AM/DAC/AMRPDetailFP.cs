...
namespace PX.Objects.AM
{
	...
	public class AMRPDetailFP : PXBqlTable, IBqlTable
	{
        internal string DebuggerDisplay => $"[{RecordID}] InventoryID={InventoryID}, SiteID={SiteID} ({SiteSequence}), Qty={Qty}, SDFlag={SDFlag}, Type={Type}, LowLevel={LowLevel}";
		...
		#endregion
		#region LateDemand
		[Obsolete("This class has been deprecated and will be removed in Acumatica ERP 2024R2.")]
		public abstract class lateDemand : PX.Data.BQL.BqlBool.Field<lateDemand> { }

		protected bool? _LateDemand;
		[Obsolete("This property has been deprecated and will be removed in Acumatica ERP 2024R2.")]
		[PXBool]
		...
		#endregion
		#region SiteSequence
		/// <inheritdoc cref="SiteSequence"/>
		public abstract class siteSequence : PX.Data.BQL.BqlInt.Field<siteSequence> { }

		/// <summary>
		/// Declares the order of processing for the same <see cref="InventoryID"/>.
		/// </summary>
		[PXInt]
		[PXUIField(DisplayName = "Warehouse Sequence", Visibility = PXUIVisibility.Invisible, Enabled = false)]
		[PXDefault(0, PersistingCheck = PXPersistingCheck.Nothing)]
		public virtual int? SiteSequence { get; set; }
		#endregion
		#region KitRevisionID
		public abstract class kitRevisionID : PX.Data.BQL.BqlGuid.Field<kitRevisionID> { }
		/// <summary>
		/// Kit Revision ID
		/// </summary>
		[PXDBString(10)]
		[PXUIField(DisplayName = "Kit Revision", FieldClass = "KitAssemblies")]
		public virtual String KitRevisionID { get; set; }
		#endregion
		#region ParentSchdNoteID
		/// <inheritdoc cref="ParentSchdNoteID"/>>
		public abstract class parentSchdNoteID : PX.Data.BQL.BqlGuid.Field<parentSchdNoteID> { }
		/// <summary>
		/// Reference to the parent <see cref="AMSchdItem.NoteID"/>.
		/// </summary>
		[PXUIField(DisplayName = "Parent Schedule ID", Enabled = false, Visibility = PXUIVisibility.Invisible)]
		[PXGuid]
		public virtual Guid? ParentSchdNoteID { get; set; }
		#endregion
	}
    ...
    public class AMRPDetailFPSupply : PXBqlTable, IBqlTable
    {
		...
		/// <inheritdoc cref="AMRPDetailFP.SiteSequence"/>
		[PXInt]
		[PXUIField(DisplayName = "Warehouse Sequence", Visibility = PXUIVisibility.Invisible, Enabled = false)]
		[PXDefault(0, PersistingCheck = PXPersistingCheck.Nothing)]
		public virtual int? SiteSequence { get; set; }
