...
namespace PX.Objects.AM
{
    ...
    [Serializable]
    public class AMRPSetup : PXBqlTable, IBqlTable
    {
        ...
        [PXDBInt()]
        [PXDefault(30)]
        [PXUIField(DisplayName = "MPS Time Fence")]
		...
		#endregion
		#region IncludeOnHoldKitAssemblies
		public abstract class includeOnHoldKitAssemblies : PX.Data.BQL.BqlBool.Field<includeOnHoldKitAssemblies> { }
		/// <summary>
		/// Include on hold kit assemblies
		/// </summary>
		[PXDBBool]
		[PXUIField(DisplayName = "Include On-Hold Kit Assemblies", FieldClass = "KitAssemblies")]
		[PXDefault(false)]
		public virtual bool? IncludeOnHoldKitAssemblies { get; set; }
		#endregion
		#region AMPlanningHorizon
		public abstract class aMPlanningHorizon : PX.Data.BQL.BqlInt.Field<aMPlanningHorizon> { }

		protected int? _AMPlanningHorizon;
		/// <summary>
		/// Users shall be able to specify how many calendar days into the future all supply/demand records should not be processed.
		/// </summary>
		[PXDBInt(MinValue = 0)]
		[PXDefault(0)]
		[PXUIField(DisplayName = "Planning Horizon")]
		public virtual int? AMPlanningHorizon
		{
			get
			{
				return this._AMPlanningHorizon;
			}
			set
			{
				this._AMPlanningHorizon = value;
			}
		}
		#endregion
