...
namespace PX.Objects.AM
{
    ...
    public class AMWCSchdDetail : PXBqlTable, IBqlTable, ISchdDetail<AMWCSchdDetail>, ISchdReference
    {
        ...
        public virtual DateTime? StartTime
        {
            ...
            set
            {
                ...
                this._StartTimeString = this._StartTime == null ? string.Empty : this._StartTime.GetValueOrDefault().ToString(PX.Common.LocaleInfo.GetUICulture().DateTimeFormat.ShortTimePattern);
            }
        }
        ...
        public virtual DateTime? EndTime
        {
            ...
            {
                this._EndTime = value;
                this._EndTimeString = this._EndTime == null ? string.Empty : this._EndTime.GetValueOrDefault().ToString(PX.Common.LocaleInfo.GetUICulture().DateTimeFormat.ShortTimePattern);
            }
        }
...
#pragma warning restore PX1031 // DACs cannot contain instance methods
    ...
    public class AMWCSchdDetailGroupByWcSchiftDate : PXBqlTable, IBqlTable
    {
        #region WcID
