...
namespace PX.Objects.AM
{
    ...
    public class AMProdItem : PXBqlTable, IBqlTable, ILSPrimary, INotable, IProdOrder
    {
...
#pragma warning restore PX1030
		...
		#region AutoBackwardReporting
		public abstract class autoBackwardReporting : PX.Data.BQL.BqlBool.Field<autoBackwardReporting> { }

		/// <summary>
		/// Override Auto backward reporting value for the order.
		/// </summary>
		[PXDBBool]
		[PXDefault(true, typeof(Search<AMOrderType.autoBackwardReporting, Where<AMOrderType.orderType, Equal<Current<AMProdItem.orderType>>>>))]
		[PXUIField(DisplayName = "Automatic Backward Reporting")]
		public virtual bool? AutoBackwardReporting
		{
			get;
			set;
		}
    ...
    [Serializable]
    public class AMProdItemStatus : PXBqlTable, IBqlTable
    {
        #region OrderType
		...
		#endregion
		#region IsProcessMFG 
		public abstract class isProcessMFG : BqlBool.Field<isProcessMFG> { }

		[PXDBBool(BqlField = typeof(AMProdItem.isProcessMFG))]
		[PXUIField(DisplayName = "IsProcessMFG ")]
		public virtual bool? IsProcessMFG 
		{
			get;
			set;
		}
    ...
    public class AMProdItemRelated : PXBqlTable, IBqlTable
    {
        #region OrderType
        public abstract class orderType : PX.Data.IBqlField
        {
