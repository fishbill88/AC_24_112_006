...
namespace PX.Objects.AM.Standalone
{
    ...
    public class AMEstimateItem : PXBqlTable, IBqlTable, IEstimateInventory, INotable
    {
        ...
        [PXDBCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AM.AMEstimateItem.curyInfoID), typeof(AM.AMEstimateItem.unitCost), BaseCalc = false)]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        ...
        [AMDBCurrencyBase(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AM.AMEstimateItem.curyInfoID), typeof(AM.AMEstimateItem.curyUnitCost))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        [PXUIField(DisplayName = "Unit Cost", Enabled = false)]
        ...
        [AMDBCurrencyBase(typeof(AM.AMEstimateItem.curyInfoID), typeof(AM.AMEstimateItem.curyExtPrice), RecalculateCondition = typeof(Where<AM.AMEstimateItem.priceOverride,Equal<True>>))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        [PXUIField(DisplayName = "Total Price", Enabled = false)]
        [PXFormula(typeof(Switch<Case<Where<AM.AMEstimateItem.priceOverride, Equal<True>>, Mult<AM.AMEstimateItem.unitPrice, AM.AMEstimateItem.orderQty>>,
        ...
        [PXDBCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AM.AMEstimateItem.curyInfoID), typeof(AM.AMEstimateItem.unitPrice), BaseCalc = false)]
        [PXDefault(TypeCode.Decimal, "0.0000")]
        ...
        [AMDBCurrencyBase(typeof(Search<CommonSetup.decPlPrcCst>), typeof(AM.AMEstimateItem.curyInfoID), typeof(AM.AMEstimateItem.curyUnitPrice), RecalculateCondition = typeof(Where<AM.AMEstimateItem.priceOverride,Equal<True>>))]
        [PXDefault(TypeCode.Decimal, "0.0000")]
