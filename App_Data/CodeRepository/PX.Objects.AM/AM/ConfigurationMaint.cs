...
#pragma warning restore PX1073
                ...
                PXSelect<AMConfigurationRule,
                        Where<AMConfigurationRule.configurationID, Equal<Current<AMConfigurationOption.configurationID>>,
                            And<AMConfigurationRule.revision, Equal<Current<AMConfigurationOption.revision>>,
                                And<Where2<Where<AMConfigurationRule.targetFeatureLineNbr, Equal<Current<AMConfigurationOption.configFeatureLineNbr>>,
									And<AMConfigurationRule.targetOptionLineNbr, Equal<Current<AMConfigurationOption.lineNbr>>>>,
										Or<Where<AMConfigurationRule.ruleSource, Equal<RuleTargetSource.feature>,
											And<AMConfigurationRule.value1, Equal<Current<AMConfigurationOption.lineNbr>>>>>>>>>>
		...
		public virtual bool PrepareImportRow(string viewName, IDictionary keys, IDictionary values)
		{
			...
			if (string.Compare(viewName, AttributeRules.View.Name, true) == 0)
			{
				...
				try
				{
					if (values["ruleType"].ToString() != RuleTypes.Validate)
					{
						GetImportedValue<AMConfigurationAttributeRule.targetFeatureLineNbr>(Views[viewName], values, true);
		...
		protected  virtual object GetImportedValue<Field>(PXView view, IDictionary values, bool isRequired) where Field : IBqlField
		{
        ...
        public class ConfigurationIDLevels : PXBqlTable, IBqlTable
        {
            #region Item
