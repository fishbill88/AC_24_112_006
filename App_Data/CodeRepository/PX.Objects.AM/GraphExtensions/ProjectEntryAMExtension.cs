...
namespace PX.Objects.AM.GraphExtensions
{
    public class ProjectEntryAMExtension : PXGraphExtension<ProjectEntry>
    {
        ...
        protected virtual void CreateProdFilter_InventoryID_FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e)
        {
            ...
            {
				var itemCury = InventoryItemCurySettings.PK.Find(Base, row.InventoryID, Base.Accessinfo.BaseCuryID);
                if (itemCury != null)
                {
                    row.SiteID = itemCury.DfltSiteID;
                    row.LocationID = itemCury.DfltReceiptLocationID;
                }
            }
        }
