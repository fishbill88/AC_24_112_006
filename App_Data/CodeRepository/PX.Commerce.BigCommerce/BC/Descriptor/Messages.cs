...
namespace PX.Commerce.BigCommerce
{
	...
	public static class BigCommerceMessages
	{
		...
		public const string NoNonStockItemClass = "The default non-stock item class is required to import non-stock items. Make sure that an item class for non-stock items is selected on the Inventory Settings tab of the BigCommerce Stores (BC201000) form.";
		...
		public const string NoStockItemClass = "The default stock item class is required to import stock items. Make sure that an item class for stock items is selected on the Inventory Settings tab of the BigCommerce Stores (BC201000) form.";
		...
		public const string PINoInventoryNumbering = "The default inventory numbering sequence is required to import template items. Make sure that an inventory numbering sequence is selected on the Inventory Settings tab of the BigCommerce Stores (BC201000) form.";
		...
		public const string PIDuplicateInventoryCode = "The {0} item could not be imported because the item with the same inventory ID ({1}) already exists in the ERP system. Specify a unique SKU for the item in the {2} store, or fill in the Inventory Numbering Sequence box on the BigCommerce Stores (BC201000) form; then synchronize the record again.";
	}
	...
	public static class BigCommerceCaptions
	{
		...
		public const string OptionDisplayName = "Option Display Name";
		...
		public const string VariantOptions = "Variant Options";
