...
namespace PX.Commerce.BigCommerce
{
	...
	public class MappedStockItemVariant : BCMappedEntity<ProductsVariantData, StockItem>
	{
		...
		public MappedStockItemVariant(StockItem entity, Guid? id, DateTime? timestamp)
			: base(TYPE, entity, id, timestamp) { }
		public MappedStockItemVariant(ProductsVariantData entity, String id, String description, DateTime? timestamp)
			: base(TYPE, entity, id, description, timestamp) { }
	}
	#endregion
	#region MappedNonStockItemVariant
	public class MappedNonStockItemVariant : BCMappedEntity<ProductsVariantData, NonStockItem>
	{
		public const String TYPE = BCEntitiesAttribute.StockItem;
		...
		public MappedNonStockItemVariant(NonStockItem entity, Guid? id, DateTime? timestamp)
			: base(TYPE, entity, id, timestamp) { }
		public MappedNonStockItemVariant(ProductsVariantData entity, String id, String description, DateTime? timestamp)
			: base(TYPE, entity, id, description, timestamp) { }
	}
	#endregion
