...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Width="100%" Caption="Service Order" MarkRequired="Dynamic" BPEventsIndicator="True" FilesIndicator="True" NoteIndicator="True" ActivityIndicator="True" DataMember="ServiceOrderRecords" TabIndex="100" DefaultControlID="edCustomerID">
        <Template>            
            <px:PXPanel ID="PXPanel2" runat="server" RenderStyle="Simple">
                ...
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
                <px:PXLabel ID="dummylabel" runat="server" style="display:none"></px:PXLabel>
            </px:PXPanel>
            ...
            <px:PXPanel ID="edThirdColumn" runat="server" RenderStyle="Simple">
                ...
                <px:PXNumberEdit ID="edCuryEstimatedBillableTotal" runat="server" DataField="CuryEstimatedBillableTotal">
                </px:PXNumberEdit>
    ...
    <px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100;" Width="100%" TabIndex="200" DataSourceID="ds" MarkRequired="Dynamic" DataMember="CurrentServiceOrder">
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ServiceOrderAppointments">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edCuryBillableLineTotal" runat="server" DataField="CuryBillableLineTotal" />
                                    <px:PXNumberEdit ID="edCuryTaxTotal" runat="server" DataField="CuryTaxTotal" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CuryBillableLineTotal" TextAlign="Right" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ProfitabilityRecords" DataKeyNames="ItemID">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edProfProfitMarginPercent" runat="server" DataField="ProfitMarginPercent">
                                    </px:PXNumberEdit>
                                </RowTemplate>
                                <Columns>
            ...
            <px:PXTabItem Text="Prepayments" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False" VisibleExp="DataControls[&quot;edIsPrepaymentEnable&quot;].Value == true">
                <Template>
                    <px:PXFormView ID="PrepaymentTotals" runat="server" DataMember="CurrentServiceOrder" RenderStyle="Simple" SkinID="Transparent">
                        <Template>
                ...
                <Template>
                    <px:PXFormView ID="formG" runat="server" DataSourceID="ds" Style="z-index: 100; left: 18px; top: 36px;" Width="100%" DataMember="CurrentServiceOrder" CaptionVisible="False" SkinID="Transparent">
                        <Template>
                            ...
                            <px:PXNumberEdit ID="edCuryEffectiveCostTotal" runat="server" DataField="CuryEffectiveCostTotal" Enabled="False" />
                            ...
                            <px:PXNumberEdit ID="edProfitPercent" runat="server" DataField="ProfitPercent" Enabled="False" />
                            <px:PXNumberEdit ID="edProfitMarginPercent" runat="server" DataField="ProfitMarginPercent" Enabled="False" />
                        </Template>
                    </px:PXFormView>
                </Template>
            </px:PXTabItem>
            ...
            <px:PXTabItem Text="Other" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False" >
                <Template>
                    ...
                    <px:PXFormView ID="edCommentsForm" runat="server" DataMember="CurrentServiceOrder" RenderStyle="Simple">
                        <Template>                
