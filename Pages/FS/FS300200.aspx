  ...
  <%-- Inventory Lookup --%>
    <px:PXSmartPanel ID="PanelAddSiteStatus" runat="server" Key="ItemInfo" LoadOnDemand="true" Width="1100px" Height="500px"
        ...
        <px:PXPanel ID="PXPanel6" runat="server" SkinID="Buttons">
            <px:PXButton ID="PXButton5" runat="server" CommandName="AddSelectedItems" CommandSourceID="ds" Text="Add" SyncVisible="false" />
    ...
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Style="z-index: 100" BPEventsIndicator="True" FilesIndicator="True" ActivityIndicator="True" NoteIndicator="True" Width="100%" DataMember="AppointmentRecords" TabIndex="100" MarkRequired="Dynamic">
        <Template>
            ...
            <px:PXPanel ID="edThirdColumn" runat="server" RenderStyle="Simple">
              ...
              <px:PXNumberEdit ID="edCuryActualBillableTotal" runat="server" DataField="CuryActualBillableTotal">
              </px:PXNumberEdit>
              <px:PXNumberEdit ID="edCuryTaxTotal" runat="server" Enabled="False" DataField="CuryTaxTotal">
              </px:PXNumberEdit>
              <px:PXNumberEdit ID="edCuryDocTotal" runat="server" Enabled="False" DataField="CuryDocTotal">
              </px:PXNumberEdit>
    ...
    <Items>
      <px:PXTabItem Text="Settings">
          ...
          <px:PXFormView ID="edServiceOrder_Contact" runat="server" Caption="Contact" DataMember="ServiceOrder_Contact" DataSourceID="ds" RenderStyle="Fieldset">
              <Template>
                  ...
                  <px:PXCheckBox ID="edOverrideContact" runat="server" CommitChanges="True" DataField="OverrideContact"/>
          ...
          <px:PXFormView ID="edServiceOrder_Address" runat="server" Caption="Address" DataMember="ServiceOrder_Address" DataSourceID="ds" RenderStyle="Fieldset">
              <Template>
                  <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM"/>
                  <px:PXCheckBox ID="edOverrideAddress" runat="server" CommitChanges="True" DataField="OverrideAddress"/>
          ...
          <px:PXFormView ID="edAppointmentSettings" runat="server" DataMember="AppointmentSelected" DataSourceID="ds" RenderStyle="Simple" Caption="Appointment Time Settings">
              <Template>
                  ...
                  <px:PXLayoutRule runat="server" ControlSize="XL" LabelsWidth="SM"/>
          ...
          <px:PXGrid ID="PXGridDetails" runat="server" DataSourceID="ds" SkinID="Details" StatusField="Availability" TabIndex="1700" Height="100%" Width="100%" SyncPosition="True">
              ...
              <px:PXGridLevel DataMember="AppointmentDetails" DataKeyNames="AppointmentID,AppDetID,SODetID">
                <RowTemplate>
                  ...
                  <px:PXNumberEdit ID="edUCuryDiscAmt" runat="server" DataField="CuryDiscAmt" CommitChanges="True" />
                   <px:PXCheckBox ID="cbManualDisc" runat="server" DataField="ManualDisc" CommitChanges="True" />
            ...
            <ActionBar ActionsText="False" PagerVisible="False">
              <CustomItems>
                ...
                <px:PXToolBarButton Key="cmdStartItemLine">
                    <AutoCallBack Command="StartItemLine" Target="ds" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Key="cmdPauseItemLine">
                    <AutoCallBack Command="PauseItemLine" Target="ds" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Key="cmdResumeItemLine">
                    <AutoCallBack Command="ResumeItemLine" Target="ds" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Key="cmdCompleteItemLine">
                    <AutoCallBack Command="CompleteItemLine" Target="ds" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Key="cmdCancelItemLine">
                        ...
                        <ActionBar ActionsText="False" PagerVisible="False">
                            <CustomItems>
                                ...
                                <px:PXToolBarButton Key="cmdStartStaff">
                                    <AutoCallBack Command="StartStaff" Target="ds" />
                                </px:PXToolBarButton>
                                 <px:PXToolBarButton Key="cmdPauseStaff">
                                    <AutoCallBack Command="PauseStaff" Target="ds" />
                                </px:PXToolBarButton>
                                <px:PXToolBarButton Key="cmdResumeStaff">
                                    <AutoCallBack Command="ResumeStaff" Target="ds" />
                                </px:PXToolBarButton>
                                <px:PXToolBarButton Key="cmdCompleteStaff">
                                    <AutoCallBack Command="CompleteStaff" Target="ds" />
                                </px:PXToolBarButton>
                                <px:PXToolBarButton Key="cmdDepartStaff">
                                    <AutoCallBack Command="DepartStaff" Target="ds" />
                                </px:PXToolBarButton>
                                <px:PXToolBarButton Key="cmdArriveStaff">
                                    <AutoCallBack Command="ArriveStaff" Target="ds" />
                                </px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                    </px:PXGrid>
                ...
                <Template>
                  ...
                  DataSourceID="ds" RenderStyle="Simple" TabIndex="1500">
                    <Template>
                      ...
                      <px:PXSegmentMask ID="edSalesPersonID" runat="server" DataField="AppointmentSelected.SalesPersonID" CommitChanges="True" AutoRefresh="True" >
                      </px:PXSegmentMask>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ProfitabilityRecords" DataKeyNames="ItemID">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="PXNumberEdit1" runat="server" DataField="ProfitMarginPercent">
                                    </px:PXNumberEdit>
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="LineRef" />
                                    ...
                                    <px:PXGridColumn DataField="ProfitMarginPercent" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
      ...
      <px:PXTabItem Text="Prepayments" BindingContext="mainForm" RepaintOnDemand="false" VisibleExp="DataControls[&quot;edIsPrepaymentEnable&quot;].Value == true">
            <Template>
                <px:PXFormView ID="PrepaymentTotals" runat="server" DataMember="ServiceOrderRelated" RenderStyle="Simple" SkinID="Transparent">
                  <Template>
                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" GroupCaption="Prepayment Summary"/>
                    <px:PXNumberEdit ID="edSOPrepaymentReceived" runat="server" DataField="SOPrepaymentReceived" Enabled="False" Size="Empty" />
                    <px:PXNumberEdit ID="edSOPrepaymentApplied" runat="server" DataField="SOPrepaymentApplied" Enabled="False" Size="Empty" />
      ...
      <px:PXTabItem Text="Totals">
          <Template>
              ...
              <px:PXNumberEdit ID="edCuryEstimatedLineTotal" runat="server" DataField="CuryEstimatedLineTotal" Enabled="False" />
              <px:PXNumberEdit ID="edCuryEstimatedCostTotal" runat="server" DataField="CuryEstimatedCostTotal" Enabled="False" />
              <px:PXNumberEdit ID="edCuryLineTotal" runat="server" DataField="CuryLineTotal" Enabled="False" />
              <px:PXNumberEdit ID="edCuryBillableLineTotal" runat="server" DataField="CuryBillableLineTotal" Enabled="False" />
              <px:PXNumberEdit ID="edCuryLogBillableTranAmountTotal" runat="server" DataField="CuryLogBillableTranAmountTotal" Enabled="False" />
              <px:PXNumberEdit ID="edTotalsTabCuryTaxTotal" runat="server" DataField="CuryTaxTotal" Enabled="False" />
              <px:PXNumberEdit ID="edTotalsTabCuryDocTotal" runat="server" DataField="CuryDocTotal" Enabled="False" />
              ...
              <px:PXNumberEdit ID="edAppCompletedBillableTotal" runat="server" DataField="AppCompletedBillableTotal" Enabled="False" />
              <px:PXNumberEdit ID="edTotalsTabCuryCostTotal" runat="server" DataField="CuryCostTotal" Enabled="False"/>
            </Template>
          </px:PXFormView>
          <px:PXLayoutRule runat="server" StartColumn="True"/>
          <px:PXFormView ID="ServiceOrderTotalsTab" runat="server" DataMember="ServiceOrderRelated" RenderStyle="Simple">
            <Template>
              <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="S" GroupCaption="Service Order Totals" />
              <px:PXNumberEdit ID="edSOCuryDocTotal" runat="server" DataField="CuryDocTotal" Enabled="False" />
              <px:PXNumberEdit ID="edCuryEffectiveBillableDocTotal" runat="server" DataField="CuryEffectiveBillableDocTotal" Enabled="False" />
            </Template>
          </px:PXFormView>                
          <px:PXFormView ID="ProfitRatiosTotalsTab" runat="server" DataSourceID="ds" DataMember="AppointmentSelected" RenderStyle="Simple">
            <Template>
              <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="S" GroupCaption="Profit Ratios" />
              <px:PXNumberEdit ID="edTotalsTabProfitMarkup" runat="server" DataField="ProfitPercent" Enabled="False" />
              <px:PXNumberEdit ID="edTotalTabProfitMargin" runat="server" DataField="ProfitMarginPercent" Enabled="False" />
            </Template>
          </px:PXFormView>
          <px:PXLayoutRule runat="server" StartColumn="True"/>
          </Template>
      </px:PXTabItem>
      <px:PXTabItem Text="Billing Documents" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False">
            <Template>
      ...
      <px:PXTabItem Text="Other" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False" >
            <Template>
              ...
              <Template>
                ...
                <px:PXFormView ID="edCommentsForm" runat="server" DataMember="AppointmentSelected" RenderStyle="Simple">
                    <Template>                
