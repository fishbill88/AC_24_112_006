...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXSmartPanel
        ...
        AllowResize="False">
        <px:PXLayoutRule runat="server" StartColumn="True"></px:PXLayoutRule>
        <px:PXFormView ID="PXFormCopyDate" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="75px" DataMember="CopyContractFilter" TabIndex="700" SkinID="Transparent">
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M"></px:PXLayoutRule>
                <px:PXDateTimeEdit ID="edStartDate" runat="server" DataField="StartDate" CommitChanges="True"></px:PXDateTimeEdit>
                <px:PXTextEdit ID="edRefNbr" runat="server" DataField="RefNbr" CommitChanges="True"></px:PXTextEdit>
                <px:PXLabel Height="10px" runat="server"></px:PXLabel>
            </Template>
        </px:PXFormView>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ContractPeriodDetRecords">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edSBP_Uom" runat="server" DataField="UOM" CommitChanges="True"></px:PXSelector>
