                ...
                <Items>
                    <px:PXTabItem Text="General">
                        <Template>
                            ...
                            <px:PXCheckBox ID="edCompleteSrvOrdWhenSrvDone" runat="server" CommitChanges="True" DataField="CompleteSrvOrdWhenSrvDone" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCloseSrvOrdWhenSrvDone" runat="server" CommitChanges="True" DataField="CloseSrvOrdWhenSrvDone" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edRequireContact" runat="server" DataField="RequireContact" CommitChanges="True" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edRequireRoom" runat="server" DataField="RequireRoom" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edRequireCustomerSignature" runat="server" DataField="RequireCustomerSignature" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyNotesFromCustomer" runat="server" DataField="CopyNotesFromCustomer" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyAttachmentsFromCustomer" runat="server" DataField="CopyAttachmentsFromCustomer" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyNotesFromCustomerLocation" runat="server" DataField="CopyNotesFromCustomerLocation" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyAttachmentsFromCustomerLocation" runat="server" DataField="CopyAttachmentsFromCustomerLocation" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyNotesToAppoinment" runat="server" DataField="CopyNotesToAppoinment" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyAttachmentsToAppoinment" runat="server" DataField="CopyAttachmentsToAppoinment" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyNotesToInvoice" runat="server" DataField="CopyNotesToInvoice" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyAttachmentsToInvoice" runat="server" DataField="CopyAttachmentsToInvoice" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyLineNotesToInvoice" runat="server" DataField="CopyLineNotesToInvoice" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edCopyLineAttachmentsToInvoice" runat="server" DataField="CopyLineAttachmentsToInvoice" AlignLeft="True">
                            </px:PXCheckBox>
                            <px:PXCheckBox ID="edOnTravelCompleteStartAppt" runat="server" DataField="OnTravelCompleteStartAppt" AlignLeft="True" />
