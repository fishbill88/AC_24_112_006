    ...
    <%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
        ...
        <asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
            ...
            <px:PXSmartPanel ID="PXSmartPanel2" runat="server" Caption="Driver Selector" CaptionVisible="True" Key="DriverRouteSelected" TabIndex="17900" AutoCallBack-Enabled="true" AutoCallBack-Command="Refresh" AutoCallBack-Target="PXFormView3" ShowAfterLoad="True" Width="540px">
                ...
                <px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" Width="100%" Style="z-index: 100" SkinID="Inquire" TabIndex="2500" PageSize="10" SyncPosition="True" NoteIndicator="False" FilesIndicator="False">
                    <Levels>
                ...
                <px:PXPanel ID="PanelDriverSelectorButtons" runat="server" SkinId="Buttons">
            ...
            <%--/Driver Selector--%>
            <%--Vehicle Selector--%>
            <px:PXSmartPanel ID="VehicleSelector" runat="server" Caption="Vehicle Selector" CaptionVisible="True" Key="VehicleRouteSelected" TabIndex="17900" AutoCallBack-Command="Refresh" AutoCallBack-Target="VehicleRouteForm" ShowAfterLoad="True" Width="550px" AllowResize="False" ShowMaximizeButton="True" CloseAfterAction="true">
                <px:PXLayoutRule runat="server" StartColumn="True"></px:PXLayoutRule>
                ...
                <px:PXGrid ID="VehiclesGrid" runat="server" DataSourceID="ds" Width="100%" Style="z-index: 100" SkinID="Inquire" TabIndex="2500" SyncPosition="True" PageSize="10" AutoAdjustColumns="true">
                    <Levels>
                ...
                <px:PXPanel ID="PanelVehicleSelectorButtons" runat="server" SkinId="Buttons">
                        ...
                        <Template>
                            <px:PXGrid ID="gridAppointmentsInRoute" runat="server" DataSourceID="ds" Width="100%" SkinID="Inquire" TabIndex="3000" SyncPosition="True" KeepPosition="True">
                                ...
                                <ActionBar ActionsText="False" PagerVisible="False">
                                    <CustomItems>
                                        <px:PXToolBarButton Tooltip="Create New Appointment">
                                            <AutoCallBack Target="ds" Command="AddAppointment"></AutoCallBack>
                                            <PopupCommand Target="ds" Command="Cancel"></PopupCommand>
                                        </px:PXToolBarButton>
                                        <px:PXToolBarButton Tooltip="Delete Appointment">
