                    ...
                    <px:PXFormView ID="frmStatusColor" runat="server" DataMember="StatusColorSelected">
                        <Template>
                            ...
                            <px:PXTextEdit ID="plTextColor" runat="server" DataField="TextColor" 
						                       CommitChanges="True" TextMode="Color" />
                            <px:PXTextEdit ID="plBandColor" runat="server" DataField="BandColor" 
						                       CommitChanges="True" TextMode="Color" />
                        </Template>
                    </px:PXFormView>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="StatusColorRecords">
                                <RowTemplate>
                                    ...
                                    <px:PXTextEdit ID="edBandColor" runat="server" DataField="BandColor" CommitChanges="True"/>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="BandColor"/>
