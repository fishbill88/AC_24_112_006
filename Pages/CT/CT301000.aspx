...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXSmartPanel ID="PanelSetup" runat="server" AcceptButtonID="bOK" AutoReload="true" CancelButtonID="bCancel"
		Caption="Set Up Contract" CaptionVisible="True" DesignView="Content" HideAfterAction="false" Key="SetupSettings"
		...
		<Items>
			<px:PXTabItem Text="Summary">
				<Template>
					...
					<px:PXSelector ID="edCuryID" runat="server" DataField="CuryID" Size="XS" CommitChanges="True" />
