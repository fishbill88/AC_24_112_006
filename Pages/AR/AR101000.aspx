		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXSelector ID="edPrepaymentInvoiceNumberingID" runat="server" DataField="PrepaymentInvoiceNumberingID" Text="ARINVOICE" AllowEdit="True" />
					...
					<px:PXCheckBox SuppressLabel="True" ID="chkTermsInCreditMemos" runat="server" DataField="TermsInCreditMemos" AlignLeft="True" Size="Empty"/>
					...
					<px:PXDropDown ID="edPrepareDunningLetter" CommitChanges="True" runat="server" DataField="PrepareDunningLetters" />
						...
						<Levels>
							<px:PXGridLevel DataMember="SetupApproval" >
								...
								<Columns>
									...
									<px:PXGridColumn DataField="AssignmentNotificationID" AutoCallBack="True" DisplayMode="Text" TextField="Name" />
								</Columns>
							</px:PXGridLevel>
						</Levels>                         
					</px:PXGrid>
			...
			<px:PXTabItem Text="Dunning">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Dunning Letter Settings" />
					<px:PXCheckBox SuppressLabel="True" ID="chkIncludeNonOverdueDunning" runat="server" DataField="IncludeNonOverdueDunning" />
					<px:PXCheckBox SuppressLabel="True" ID="chkAddOpenPaymentsAndCreditMemos" runat="server" DataField="AddOpenPaymentsAndCreditMemos" />
					<px:PXCheckBox SuppressLabel="True" ID="chkAddUnpaidPPI" runat="server" DataField="AddUnpaidPPI" />
					<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="M" />
					...
					<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="M" />
					<px:PXGrid ID="gridDunningLevels" runat="server" SkinID="DetailsInTab" Width="100%" Height="300px" AllowPaging="False" TabIndex="200" DataSourceID="ds">
								...
								<Levels>
									<px:PXGridLevel DataMember="Notifications">
										...
										<Columns>
											...
											<px:PXGridColumn DataField="NotificationID" AutoCallBack="True" DisplayMode="Text" TextField="Name" />
