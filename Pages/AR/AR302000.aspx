...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARPaymentEntry" PrimaryView="Document">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Visible="false" CommitChanges="true" Name="UpdateL3Data" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%"
        ...
        <Template>
			...
			<px:PXSelector ID="edRefTranExtNbr" runat="server" DataField="RefTranExtNbr" ValueField="TranNumber" CommitChanges="true" AutoRefresh="true" DataSourceID="ds">
				<Parameters>
            ...
            <px:PXSelector ID="TerminalID" runat="server" DataField="TerminalID" SelectedIndex="-1" AutoRefresh="True" CommitChanges="True">
            </px:PXSelector>
            ...
            <px:PXLayoutRule runat="server" Merge="True" />
            <px:PXCheckBox ID="chkNewAccount" runat="server" CommitChanges="true" DataField="NewAccount"></px:PXCheckBox>
            <px:PXCheckBox ID="chkSaveAccount" runat="server" CommitChanges="true" DataField="SaveAccount"></px:PXCheckBox>
                ...
                <Template>
                    <px:PXGrid ID="detgrid2" runat="server" Style="z-index: 100;" Width="100%" Height="300px" SkinID="DetailsInTab" 
                        AdjustPageSize="Auto" AllowPaging="True" NoteIndicator="true" FilesIndicator="true"
                               NoteField="ARAdjust2__NoteText" FilesField="ARAdjust2__NoteFiles" SyncPosition="true">
                        <Levels>
                            <px:PXGridLevel DataMember="ARPost">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ARAdjust2__PPDVATAdjDescription" LinkCommand="ViewPPDVATAdj"  AllowFilter="false" AllowSort="false" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="PaymentCharges" DataKeyNames="DocType,RefNbr,LineNbr">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edAccountID" runat="server" DataField="AccountID" CommitChanges="True" Enabled="False" AllowEdit="False" />
                                    ...
                                    <px:PXSegmentMask ID="edPCProjectID" runat="server" DataField="ProjectID" CommitChanges="True"/> 
                                    <px:PXSegmentMask ID="edPCTaskID" runat="server" DataField="TaskID" CommitChanges="True" AutoRefresh="True"/>
                                    <px:PXSegmentMask ID="edPCCostCode" runat="server" DataField="CostCodeID" CommitChanges="True" AutoRefresh="True"/>
                                </RowTemplate>
                                <Columns>
