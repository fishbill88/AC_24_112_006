...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARPriceWorksheetMaint" PrimaryView="Document" HeaderDescriptionField="Descr">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Name="ShowItems" Visible="False" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Worksheet Summary" DataMember="Document"
        ...
        <Template>
            ...
            <px:PXCheckBox CommitChanges="True" SuppressLabel="True" ID="chkSkipLineDiscounts" runat="server" DataField="SkipLineDiscounts" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <%-- Inventory Lookup --%>
    <px:PXSmartPanel ID="PanelAddItem" runat="server" Key="ItemInfo" LoadOnDemand="true" Width="800px" Height="500px"
        Caption="Add Item to Worksheet" CaptionVisible="true" DesignView="Content">
        <px:PXFormView ID="formAddItem" runat="server" CaptionVisible="False" DataMember="ItemFilter" DataSourceID="ds"
            ...
            <Template>
                ...
                <px:PXFormView ID="PanelAddItemParametrs" runat="server" CaptionVisible="False" DataMember="addItemParameters" DataSourceID="ds"
                    ...
                    <Template>
                        ...
                        <px:PXCheckBox ID="chkSkipLineDiscounts" runat="server" DataField="SkipLineDiscounts" CommitChanges="True" />
                    </Template>
                </px:PXFormView>
            </Template>
        </px:PXFormView>
