...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARInvoiceEntry" PrimaryView="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ViewPayment" DependOnGrid="gridApplications" CommitChanges="true" />
			<px:PXDSCallbackCommand Visible="False" Name="ViewPPDVATAdj" DependOnGrid="gridApplications"/>
			...
			<px:PXDSCallbackCommand Name="ARTran$RelatedDocument$Link" Visible="false" CommitChanges="True" DependOnGrid="grid" />
			<px:PXDSCallbackCommand Visible="false" CommitChanges="true" Name="CreateLink" />
            <px:PXDSCallbackCommand Visible="false" CommitChanges="true" Name="SyncLink" />
			<px:PXDSCallbackCommand Visible="false" CommitChanges="true" Name="ResendLink" />
		</CallbackCommands>
		<DataTrees>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="Document" Caption="Invoice Summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity" LinkIndicator="True"
		...
		<Template>
			...
			<px:PXNumberEdit CommitChanges="True" ID="edCuryLineRetainageTotal" runat="server" DataField="CuryLineRetainageTotal"  Enabled="False"/>
			...
			<px:PXNumberEdit ID="edCuryDocUnpaidBal" runat="server" DataField="CuryDocUnpaidBal" Enabled="False" />
		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									...
									<px:PXGridColumn DataField="OrigDocType" AutoCallBack="True"/>
									<px:PXGridColumn DataField="OrigRefNbr" AutoCallBack="True" LinkCommand="ViewOrigRetainageDocument"/>
									...
									<px:PXGridColumn DataField="RelatedDocument" Visible="false" RenderEditorText="True" LinkCommand="ARTran$RelatedDocument$Link"/>
									...
									<px:PXGridColumn DataField="DiscPct" TextAlign="Right" CommitChanges="true" />
									<px:PXGridColumn DataField="CuryDiscAmt" TextAlign="Right" CommitChanges="true" />
									...
									<px:PXGridColumn DataField="CuryPrepaymentAmt" TextAlign="Right" CommitChanges="true" />
									...
									<px:PXGridColumn DataField="SOOrderType" AllowUpdate="False" />
									<px:PXGridColumn DataField="SOOrderNbr" AllowUpdate="False" />
									...
									<px:PXGridColumn DataField="CostBasisNull" />
								...
								<RowTemplate>
									...
									<px:PXNumberEdit ID="edCuryUnitPrice" runat="server" DataField="CuryUnitPrice" CommitChanges="true" IsClientControl="false"/>
									<px:PXCheckBox ID="chkManualPrice" runat="server" DataField="ManualPrice" CommitChanges="true" />
									<px:PXNumberEdit ID="edCuryExtPrice" runat="server" DataField="CuryExtPrice" CommitChanges="true" IsClientControl="false"/>
									...
									<px:PXNumberEdit ID="edPrepaymentPct" runat="server" DataField="PrepaymentPct" />
									<px:PXNumberEdit ID="edCuryPrepaymentAmt" runat="server" DataField="CuryPrepaymentAmt" />
									<px:PXTextEdit ID="edSOOrderType" runat="server" DataField="SOOrderType" Enabled="False" />
									...
									<px:PXDropDown runat="server" DataField="CostBasisNull" CommitChanges="True" ID="cmbCostBasis" />
			...
			<px:PXTabItem Text="Financial">
				<Template>
					...
					<px:PXSegmentMask ID="edPrepaymentAccountID" runat="server" DataField="PrepaymentAccountID" CommitChanges="True" />
					<px:PXSegmentMask ID="edPrepaymentSubID" runat="server" DataField="PrepaymentSubID" AutoRefresh="True" />
					...
					<px:PXLayoutRule runat="server" GroupCaption="Default Payment Info" ControlSize="M" LabelsWidth="M" StartColumn="True"/>
					...
					<px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="M" GroupCaption="Tax Info" StartGroup="True" />
					...
					<px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="M" GroupCaption="VAT Totals" StartGroup="True" />
					<px:PXNumberEdit ID="edCuryVatTaxableTotal" runat="server" DataField="CuryVatTaxableTotal" Enabled="False"  Size="M"/>
					<px:PXNumberEdit ID="edCuryVatExemptTotal" runat="server" DataField="CuryVatExemptTotal" Enabled="False"  Size="M"/>
					...
					<px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="M" GroupCaption="Cash Discount Info" StartGroup="True" />
					<px:PXNumberEdit runat="server" DataField="CuryDiscountedDocTotal" ID="edCuryDiscountedDocTotal" Enabled="false" Size="M"/>
					<px:PXNumberEdit runat="server" DataField="CuryDiscountedTaxableTotal" ID="edCuryDiscountedTaxableTotal" Enabled="false" Size="M"/>
					<px:PXNumberEdit runat="server" DataField="CuryDiscountedPrice" ID="edCuryDiscountedPrice" Enabled="false" Size="M"/>
			...
			<px:PXTabItem Text="Taxes">
				<Template>
					<px:PXGrid ID="grid1" runat="server" Width="100%" SkinID="DetailsInTab" Height="300px" TabIndex="500" RepaintColumns="True">
						<AutoSize Enabled="True" MinHeight="150" />
						<Levels>
							<px:PXGridLevel DataMember="Taxes">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="CuryAdjustedTaxableAmt" TextAlign="Right" />
									<px:PXGridColumn DataField="CuryAdjustedTaxAmt" TextAlign="Right" />
								</Columns>
								<Layout FormViewHeight="" />
							</px:PXGridLevel>
						</Levels>
			...
			<px:PXTabItem Text="Retainage" RepaintOnDemand="false" VisibleExp="DataControls[&quot;chkRetainageApply&quot;].Value = 1" BindingContext="form">
				<Template>
					...
					<px:PXGrid ID="gridRetainage" runat="server" Style="z-index: 100;" Width="100%" Height="300px" SkinID="DetailsInTab" SyncPosition="true">
						<Levels>
							<px:PXGridLevel DataMember="RetainageDocuments">
								<Columns>
									...
									<px:PXGridColumn DataField="CuryRetainageReleasedAmt" TextAlign="Right" />
									<px:PXGridColumn DataField="CuryRetainagePaidAmt" TextAlign="Right" />
			...
			<!--#include file="~\Pages\Includes\PaymentLinksTab.inc"-->
			<px:PXTabItem Text="Applications" LoadOnDemand="true" RepaintOnDemand="false">
				<Template>
					<px:PXGrid ID="gridApplications" runat="server" Width="100%" SkinID="DetailsInTab" Height="300px" TabIndex="700" FilesIndicator="True"
						...
						<Levels>
							<px:PXGridLevel DataMember="Adjustments">
								<RowTemplate>
									...
									<px:PXSelector CommitChanges="True" ID="edAdjgRefNbr" runat="server" DataField="AdjgRefNbr" AutoRefresh="true" >
										<Parameters>
											...
											<px:PXControlParam ControlID="gridApplications" Name="ARAdjust2.adjgDocType" PropertyName="DataValues[&quot;AdjgDocType&quot;]" />
										</Parameters>
									</px:PXSelector>
								...
								<Columns>
									...
									<px:PXGridColumn DataField="PPDVATAdjDescription" LinkCommand="ViewPPDVATAdj" AllowFilter="false" AllowSort="false"/>
                                    <px:PXGridColumn DataField="HasExpiredComplianceDocuments" Type="CheckBox" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
