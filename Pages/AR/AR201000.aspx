		...
		<Items>
			<px:PXTabItem Text="General" RepaintOnDemand="false">
				<Template>
					...
					<px:PXSelector runat="server" ID="edDefaultBillingCycleID" DataField="DefaultBillingCycleID" CommitChanges="True" />
					...
					<px:PXLayoutRule runat="server" GroupCaption="Payment Link Settings" StartGroup="True" />
					<px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="M" />
					<px:PXCheckBox ID="chckDisableOnlineInvoiceSync" CommitChanges="true" runat="server" DataField="DisablePayLink" />
					<px:PXLayoutRule ID="PXLayoutRule12" controlsize="SM" labelswidth="M" runat="server" Merge="True" />
					<px:PXDropDown ID="cmbDeliveryMethod" runat="server" datafield="DeliveryMethod" />
					<px:PXCheckBox ID="chckOverwriteDeliveryMethod" CommitChanges="true" runat="server" DataField="allowOverrideDeliveryMethod" />
					<px:PXLayoutRule runat="server" ControlSize="SM" LabelsWidth="SM" />
					<px:PXDropDown ID="cmbPayLinkPaymentMethod" runat="server" datafield="PayLinkPaymentMethod" />
				</Template>
			</px:PXTabItem>
