...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document">
		<Template>
			...
			<px:PXLayoutRule runat="server" LabelsWidth="M" Merge="true" ControlSize="S" />
				<px:PXNumberEdit ID="edDunningFee" runat="server" DataField="DunningFee" />
				<px:PXTextEdit ID="edCuryID" runat="server" DataField="CuryID" Size="XS" Enabled="false" SuppressLabel="true" />
