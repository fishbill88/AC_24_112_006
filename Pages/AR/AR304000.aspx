		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									...
									<px:PXGridColumn DataField="DefScheduleID" AutoCallBack="True" AllowShowHide="Server"/>
			...
			<px:PXTabItem Text="Financial">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Payment Info" StartGroup="True" StartColumn="True"  ControlSize="M"  LabelsWidth="SM"/>
					...
					<px:PXLayoutRule runat="server" ControlSize="M" GroupCaption="Tax Info" LabelsWidth="SM" StartGroup="True" />
					...
					<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="M" GroupCaption="VAT Totals" StartGroup="True" />
					...
					<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="S" GroupCaption="Voucher Details" StartColumn="True" />
				</Template>
			</px:PXTabItem>
