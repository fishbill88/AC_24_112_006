...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <Template>
            ...
            <px:PXCheckBox SuppressLabel="True" ID="chkAddOpenPaymentsAndCreditMemos" runat="server" DataField="AddOpenPaymentsAndCreditMemos" CommitChanges="true"/>
            <px:PXCheckBox SuppressLabel="True" ID="chkAddUnpaidPPI" runat="server" DataField="AddUnpaidPPI" CommitChanges="true"/>
            ...
            <px:PXGroupBox ID="gbIncludeType" runat="server" Caption="Include" CommitChanges="True"
                ...
                <Template>                    
                    <px:PXLabel runat="server" ID="lbl" Text="Include:"  Width="60px"/>
                    <px:PXLayoutRule runat="server" StartColumn="True" StartGroup="true"/>
            ...
            <px:PXLayoutRule runat="server"  LabelsWidth="S" ControlSize="M" StartGroup="true" />            
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; height: 150px;"
        ...
        <Levels>
            <px:PXGridLevel DataMember="DunningLetterList">
                <RowTemplate>
					<px:PXNumberEdit ID="edDunningFee" runat="server" DataField="DunningFee" />
				</RowTemplate>
                <Columns>
                    ...
                    <px:PXGridColumn AllowNull="False" DataField="CuryID" TextAlign="Left" />
