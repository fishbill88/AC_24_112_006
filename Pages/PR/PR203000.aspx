...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="CurrentPayrollEmployee">
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="EmployeePositions" >
								<Columns>
									...
									<px:PXGridColumn DataField="StartReason" CommitChanges="True" />
									<px:PXGridColumn DataField="ProbationPeriodEndDate" CommitChanges="True" />
						...
						<Levels>
							<px:PXGridLevel DataMember="EmployeeAttributes">
								<Columns>
									...
									<px:PXGridColumn DataField="UsedForGovernmentReporting" TextAlign="Center" Type="CheckBox" />
				...
				<Template>
					<px:PXFormView ID="splitTypeForm" runat="server" DataMember="CurrentPayrollEmployee">
						<Template>
							...
							<px:PXLayoutRule runat="server" Merge="True" />
							<px:PXNumberEdit ID="edNetPayMin" runat="server" AllowNull="True" DataField="NetPayMin" />
							<px:PXCheckBox ID="chkNetPayMinUseDflt" runat="server" DataField="NetPayMinUseDflt" CommitChanges="True" />
							<px:PXLayoutRule runat="server" Merge="True" />
			...
			<px:PXTabItem Text="Paid Time Off">
				<Template>
					<px:PXFormView ID="fPTOEmployment" runat="server" DataMember="EmploymentHistory">
						<Template>
							<px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="M" StartRow="True" />
							<px:PXDateTimeEdit ID="edPTOProbationPeriodEndDate" runat="server" DataField="ProbationPeriodEndDate" />
							<px:PXDateTimeEdit ID="edPTOHireDate" runat="server" DataField="HireDate" />
							<px:PXDateTimeEdit ID="edPTOTerminationDate" runat="server" DataField="TerminationDate" />
						</Template>
					</px:PXFormView>
					<px:PXFormView ID="fPTOCustom" runat="server" DataMember="CurrentPayrollEmployee">
						<Template>
							<px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="M" StartRow="True" />
							<px:PXCheckBox ID="edUseCustomSettings" runat="server" DataField="UseCustomSettings" CommitChanges="True" AlignLeft="true"/>
						</Template>
					</px:PXFormView>
					<px:PXGrid runat="server" DataSourceID="ds" ID="grdPTOBanks" SkinID="DetailsInTab" Width="100%" SyncPosition="true">
						<Levels>
							<px:PXGridLevel DataMember="EmployeePTOBanks">
								<RowTemplate>
									<px:PXSelector ID="edBankID" runat="server" DataField="BankID" AllowEdit="true" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="BandingRule" />
									<px:PXGridColumn DataField="StartDate" CommitChanges="true" />
									...
									<px:PXGridColumn DataField="FrontLoadingAmount" CommitChanges="true" />
									<px:PXGridColumn DataField="AccrualLimit" CommitChanges="true" />
									<px:PXGridColumn DataField="AllowNegativeBalance" Type="CheckBox" TextAlign="Center" CommitChanges="true" />
									<px:PXGridColumn DataField="DisburseFromCarryover" Type="CheckBox" TextAlign="Center" CommitChanges="true" />
									<px:PXGridColumn DataField="TransferDate" />
									<px:PXGridColumn DataField="CarryoverType" CommitChanges="true" />
									<px:PXGridColumn DataField="CarryoverAmount" CommitChanges="true" />
									<px:PXGridColumn DataField="ProbationPeriodBehaviour" CommitChanges="true" />
									<px:PXGridColumn DataField="SettlementBalanceType" CommitChanges="true" />
									<px:PXGridColumn DataField="AllowViewAvailablePTOPaidHours" Visible="False" AllowShowHide="False" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton CommandSourceID="ds" DependOnGrid="grdPTOBanks" CommandName="ViewAvailablePTOPaidHours" StateColumn="AllowViewAvailablePTOPaidHours" />
							</CustomItems>
						</ActionBar>
					...
					<px:PXGrid ID="gridDirectDeposit" runat="server" DataSourceID="ds" TabIndex="4700" SkinID="DetailsInTab" Width="100%" Caption="Direct Deposit" SyncPosition="true">
						...
						<Levels>
							<px:PXGridLevel DataMember="EmployeeDirectDeposit">
								...
								<Columns>
									<px:PXGridColumn DataField="BankAcctNbr" Width="120px"  AllowDragDrop="true" AllowShowHide="Server" />
									<px:PXGridColumn DataField="BankAcctType" Width="120px" AllowShowHide="Server" />
									<px:PXGridColumn DataField="BankName" Width="200px" CommitChanges="True" AllowShowHide="Server" />
									<px:PXGridColumn DataField="BankRoutingNbr" Width="120px" AllowShowHide="Server" />
									<px:PXGridColumn DataField="FinInstNbrCan" Width="120px" AllowShowHide="Server" />
									<px:PXGridColumn DataField="BankTransitNbrCan" Width="120px" AllowShowHide="Server" />
									<px:PXGridColumn DataField="BankAcctNbrCan" Width="120px" AllowShowHide="Server" />
									<px:PXGridColumn DataField="BeneficiaryName" Width="200px" AllowShowHide="Server" />
	...
	<px:PXSmartPanel runat="server" ID="pnlViewAvailablePTOPaidHours" Caption="View Payable Hours" CaptionVisible="true" LoadOnDemand="true"
