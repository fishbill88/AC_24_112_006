...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%">
		<Items>
			...
			<px:PXTabItem Text="Printing History" BindingContext="form" VisibleExp="DataControls[&quot;edPaymentMethodID&quot;].Value == CHECK">
				<Template>
					<px:PXGrid ID="printHistoryGrid" SyncPosition="true" SkinID="Inquire" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px">
						<Levels>
						...
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton Text="Printing Details" DependOnGrid="printHistoryGrid" CommandSourceID="ds">
			...
			<px:PXTabItem Text="Export History" BindingContext="form" VisibleExp="DataControls[&quot;edPaymentMethodID&quot;].Value != CHECK" >
				<Template>
	...
	<px:PXSmartPanel runat="server" ID="spnlExportDetails" BindingContext="form" CaptionVisible="true" Key="ExportDetails" AutoRepaint="True">
