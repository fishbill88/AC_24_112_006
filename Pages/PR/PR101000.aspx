		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXSelector ID="edPTOAdjustmentNumberingCD" runat="server" AllowEdit="True" DataField="PTOAdjustmentNumberingCD" />
					<px:PXSelector ID="edROENumberingCD" runat="server" AllowEdit="True" DataField="ROENumberingCD" />
					<px:PXSelector ID="edBatchForSubmissionNumberingCD" runat="server" AllowEdit="True" DataField="BatchForSubmissionNumberingCD" />
					...
					<PX:PXCheckBox ID="edUseBenefitRateFromUnionInCertProject" runat="server" DataField="UseBenefitRateFromUnionInCertProject" />
					...
					<px:PXCheckBox SuppressLabel="True" ID="chkUpdateGL" runat="server" DataField="UpdateGL" CommitChanges="true" />
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Account Settings" StartColumn="true" ControlSize="M" LabelsWidth="M" />
