		...
		<Levels>
			<px:PXGridLevel DataMember="OvertimeRules">
                <RowTemplate>
                    ...
                    <px:PXNumberEdit ID="edNumberOfConsecutiveDays" runat="server" DataField="NumberOfConsecutiveDays" />
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="NumberOfConsecutiveDays" CommitChanges="True" Width="100px" />
