...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:pxdatasource id="ds" runat="server" visible="True" width="100%" typename="PX.Objects.PR.PRPayChecksAndAdjustments" primaryview="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ViewRecordsOfEmployment" Visible="False" DependOnGrid="gridRecordsOfEmployment" CommitChanges="true" />
		</CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:pxformview id="form" runat="server" datasourceid="ds" width="100%" datamember="Document">
		<Template>
			...
			<px:PXDateTimeEdit ID="edTransactionDate" runat="server" DataField="TransactionDate" CommitChanges="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
						...
						<Levels>
							<px:PXGridLevel DataMember="SummaryEarnings">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="RoundedHours" Width="60px" CommitChanges="True" TextAlign="Right" />
									<px:PXGridColumn DataField="Rate" TextAlign="Right" CommitChanges="True" />
            ...
            <Levels>
                <px:PXGridLevel DataMember="PaymentOvertimeRules">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="PROvertimeRule__NumberOfConsecutiveDays" Width="100px" />
	...
	<px:PXSmartPanel runat="server" ID="pnlPTODetails" AutoRepaint="true" Caption="View PTO Details" CaptionVisible="true" Key="PTODetails" Width="300px" Height="600px">
		...
		<px:PXGrid ID="gridDDSplits" runat="server" DataSourceID="ds" SkinID="Inquire">
			<Levels>
				<px:PXGridLevel DataMember="DirectDepositSplits">
					<Columns>
						<px:PXGridColumn DataField="BankAcctNbr" AllowShowHide="Server" />
						<px:PXGridColumn DataField="BankAcctType" AllowShowHide="Server" />
						<px:PXGridColumn DataField="BankName" AllowShowHide="Server"/>
						<px:PXGridColumn DataField="BankRoutingNbr" AllowShowHide="Server" />
						<px:PXGridColumn DataField="FinInstNbrCan" AllowShowHide="Server" />
						<px:PXGridColumn DataField="BankTransitNbrCan" AllowShowHide="Server" />
						<px:PXGridColumn DataField="BankAcctNbrCan" AllowShowHide="Server" />
						<px:PXGridColumn DataField="BeneficiaryName" AllowShowHide="Server" />
						<px:PXGridColumn DataField="Amount"/>
					</Columns>
				</px:PXGridLevel>
			</Levels>
