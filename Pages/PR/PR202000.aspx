...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="CurEmployeeClassRecord">
		<Items>
			<px:PXTabItem Text="Default Settings">
				<Template>
					...
					<px:PXCheckBox ID="chkUsePayrollProjectWorkLocation" runat="server" DataField="UsePayrollProjectWorkLocation" AlignLeft="true" />
