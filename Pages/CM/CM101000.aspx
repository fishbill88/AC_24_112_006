...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="formSettings" runat="server" DataSourceID="ds" Width="100%" DataMember="cmsetup" Caption="CM Settings" TemplateContainer="" TabIndex="900">
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Revaluation Settings" />
			<px:PXCheckBox ID="revalARPrepaymentsOption" runat="server" DataField="RevalueARPrepaymentsOption" />
			<px:PXCheckBox ID="revalAPPrepaymentsOption" runat="server" DataField="RevalueAPPrepaymentsOption" />
		</Template>
	</px:PXFormView>
</asp:Content>
