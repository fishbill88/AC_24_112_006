                ...
                <Template1>
                    <px:PXFormView ID="edDocument" runat="server" DataSourceID="ds" Width="100%" DataMember="Document" Height="100%" FilesIndicator="True"
                        ...
                        <Template>
                            ...
                            <px:PXSegmentMask CommitChanges="True" ID="Branch" runat="server" AutoRefresh="True" DataField="BranchId" DataSourceID="ds" IsClientControl="False" />
    ...
    <script type="text/javascript">
        ...
        function commandPerformed(ds, e) {
            ...
            if (e.command.toLowerCase() === 'cancel' ||
                e.command.toLowerCase() === 'next' ||
                e.command.toLowerCase() === 'previous' ||
                e.command.toLowerCase() === 'first' ||
                e.command.toLowerCase() === 'last') {
            ...
            if (e.command.toLowerCase() === 'processrecognition' ||
                e.command.toLowerCase() === 'refreshstatus') {
