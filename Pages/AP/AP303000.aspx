		...
		<Items>
			...
			<px:PXTabItem Text="General" RepaintOnDemand="false">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Account Info" />
						...
						<px:PXTextEdit ID="edLegalName" runat="server" DataField="LegalName" CommitChanges="True" TabIndex="150"/>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Vendor Properties" StartGroup="True" />
						...
						<px:PXCheckBox ID="chkTaxAgency" runat="server" DataField="TaxAgency" CommitChanges="True"/>
						...
						<px:PXTextEdit runat="server" ID="edBusinessNum" DataField="BusinessNumber" CommitChanges="True" />
                    ...
                    <px:PXFormView runat="server" ID="VendorDefaults" Caption="Project Defaults" DataMember="CurrentVendor" TabIndex="1161" RenderStyle="Fieldset">
                        <Template>
                            ...
                            <px:PXSegmentMask runat="server" ID="edVendorDefaultInventoryId" DataField="VendorDefaultInventoryId" Size="XM" />
                        </Template>
                    </px:PXFormView>
				</Template>
			</px:PXTabItem>
					...
					<px:PXFormView ID="DefLocationPayment" runat="server" DataMember="DefLocation" SkinID="Transparent">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Remit-To Info" />
								<px:PXCheckBox CommitChanges="True" ID="chkOverrideRemitContact" runat="server" DataField="OverrideRemitContact"/>
								<px:PXFormView ID="RemitContact" runat="server" DataMember="RemitContact" RenderStyle="Simple">
									<Template>
										...
										<px:PXLayoutRule runat="server" Merge="True"/>
											<px:PXDropDown ID="Phone1Type"	runat="server" DataField="Phone1Type" Size="S" SuppressLabel="True"/>
										...
										<px:PXLayoutRule runat="server" Merge="True" />
											<px:PXDropDown ID="Phone2Type"	runat="server" DataField="Phone2Type" Size="S" SuppressLabel="True"/>
										...
										<px:PXLayoutRule runat="server" Merge="True" />
											<px:PXDropDown ID="FaxType"		runat="server" DataField="FaxType" Size="S" SuppressLabel="True"/>
					...
					<px:PXFormView ID="DefLocation" runat="server" CaptionVisible="False" DataMember="DefLocation" Width="100%" SkinID="Transparent">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Other Settings" />
								...
								<px:PXLayoutRule runat="server" Merge="True" />
								<px:PXCheckBox ID="chkVPrintOrder" runat="server" DataField="VPrintOrder" AlignLeft="True" Width="134px" />
								<px:PXCheckBox ID="chkVEmailOrder" runat="server" DataField="VEmailOrder" AlignLeft="True"/>
								<px:PXLayoutRule runat="server" />
			...
			<px:PXTabItem Text="GL Accounts" LoadOnDemand="False">
				<Template>
					...
					<px:PXFormView ID="DefLocationGLAccounts" runat="server" DataMember="DefLocation" RenderStyle="Simple" MarkRequired="Dynamic">
						<Template>
							<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
