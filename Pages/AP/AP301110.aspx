...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">    
    ...
    <px:PXGrid DataSourceID="ds" runat="server" ID="grid" SkinID="PrimaryInquire" Caption="Records" Height="400px" Width="100%"
        SyncPosition="true" ShowFilterToolbar="true" AllowSearch="true" FastFilterFields="Subject,MailFrom,Owner"
        AllowPaging="true" AdjustPageSize="Auto" NoteIndicator="true" FilesIndicator="true" AutoAdjustColumns="true"
        OnRowDataBound="grid_RowDataBound"  CssClass="dropFiles1" PreservePageIndex="true">
        <Levels>
