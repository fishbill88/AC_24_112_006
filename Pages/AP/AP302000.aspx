...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" runat="server" UDFTypeField="DocType" Visible="True" Width="100%" TypeName="PX.Objects.AP.APPaymentEntry" PrimaryView="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Visible="False" Name="ViewPPDVATAdj" DependOnGrid="detgrid2"/>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Payment Summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity"
		...
		<Template>
			...
			<px:PXTextEdit ID="edJointPayeeID" runat="server" DataField="SelectedJointPayee.Name" Enabled="false" />
		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Adjustments">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="APInvoice__ProjectID" />
									...
									<px:PXGridColumn AutoCallBack="True" DataField="StubNbr" />
								</Columns>
						...
						<Levels>
							<px:PXGridLevel DataMember="APPost">
								...
								<Columns>
								    ...
								    <px:PXGridColumn DataField="APTran__InventoryID" />
								    <px:PXGridColumn DataField="APTran__ProjectID" />
									<px:PXGridColumn DataField="APRegister__ProjectID" />
								    <px:PXGridColumn DataField="APTran__TaskID" />
								    <px:PXGridColumn DataField="APTran__CostCodeID" />
								    <px:PXGridColumn DataField="APTran__AccountID" />
									...
									<px:PXGridColumn DataField="APAdjust2__PPDVATAdjDescription" LinkCommand="ViewPPDVATAdj" AllowFilter="false" AllowSort="false"/>
                                    <px:PXGridColumn DataField="APAdjust2__HasExpiredComplianceDocuments" Type="CheckBox" />
								    <px:PXGridColumn DataField="APAdjust2__StubNbr" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" MinHeight="150" />
			...
			<px:PXTabItem Text="Financial">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartColumn="true" LabelsWidth="SM" ControlSize="XM" GroupCaption="T5018 Report" StartGroup="true" />
						<px:PXCheckBox runat="server" ID="chkIncludeInT5018Report" DataField="IncludeInT5018Report" AlignLeft="true" />
						...
						<ActionBar>
							<CustomItems>
								...
								<px:PXToolBarButton Text="Set As Final">
                                    <AutoCallBack Command="SetAsFinal" Target="ds" />
                                </px:PXToolBarButton>
							</CustomItems>
						</ActionBar>
                    </px:PXGrid>
	...
	<px:PXSmartPanel ID="AddJointPayeePanel" runat="server" Height="600px" Width="850px" Caption="Select Joint Payee" CaptionVisible="True" Key="BillWithJointPayee" AutoCallBack-Command="Refresh"
        ...
        <px:PXFormView ID="AvailableJointPayeesFilter" runat="server" DataMember="BillWithJointPayeeFilter" RenderStyle="Normal">
            <Template>
                ...
                <px:PXSelector ID="edRefNbr" runat="server" DataField="RefNbr" AutoRefresh="true" CommitChanges="true" />
            </Template>
        </px:PXFormView>
        <px:PXGrid ID="AvailableJointPayeesGrid" runat="server" Height="240px" Width="100%" DataSourceID="ds" SkinID="Details" SyncPosition="true">
            ...
            <Levels>
                <px:PXGridLevel DataMember="BillWithJointPayee">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="CuryJointAmountOwed" />
						<px:PXGridColumn DataField="CuryJointAmountPaid" />
						<px:PXGridColumn DataField="CuryBalance" />                       
                    </Columns>
                </px:PXGridLevel>
            </Levels>
            <ActionBar>
         ...
         <px:PXPanel ID="JointPayeeControlPanel" runat="server" SkinID="Buttons">
            <px:PXButton ID="btnAddJointPayee" runat="server" Text="Add" CommandName="AddJointPayee"  CommandSourceID="ds" />
            <px:PXButton ID="btnAddCloseJointPayee" runat="server" Text="Add & Close" DialogResult="OK"  />
            <px:PXButton ID="btnCloseJointPayee" runat="server" DialogResult="Cancel" Text="Close" />      
        </px:PXPanel>
    </px:PXSmartPanel>
	<px:PXSmartPanel ID="ComplianceDetailPanel" runat="server" Height="600px" Width="500px" Caption="Line Details" CaptionVisible="True" Key="ComplianceDetails" AutoCallBack-Command="Refresh"
        ...
        <px:PXGrid ID="ComplianceDetailGrid" runat="server" Height="240px" Width="100%" DataSourceID="ds" SkinID="Details" SyncPosition="true">
            ...
            <Levels>
                <px:PXGridLevel DataMember="ComplianceDetails">
                    <Columns>
						...
						<px:PXGridColumn DataField="AmountPaid" />                     
                    </Columns>
                </px:PXGridLevel>
            </Levels>
            <ActionBar>
         ...
         <px:PXPanel ID="PXPanel1" runat="server" SkinID="Buttons">
            <px:PXButton ID="btnCloseComplianceDetail" runat="server" DialogResult="Cancel" Text="Close" />      
        </px:PXPanel>
    </px:PXSmartPanel>
</asp:Content>
