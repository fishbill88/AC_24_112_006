		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXCheckBox ID="chkTermsInDebitAdjustments" runat="server" DataField="TermsInDebitAdjustments" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="SetupApproval" >
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="AssignmentNotificationID" DisplayMode="Text" TextField="Name" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>                         
                    </px:PXGrid>
					...
					<px:PXGrid ID="grid" runat="server" Height="400" Width="100%" Style="z-index: 100" AllowSearch="true" DataSourceID="ds"
						...
						<Levels>
							<px:PXGridLevel DataMember="Boxes1099">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
									<px:PXSelector ID="edBoxNbr" runat="server" DataField="BoxNbr" />
								...
								<Columns>
									<px:PXGridColumn DataField="BoxNbr" />
			...
			<px:PXTabItem Text="Canadian Tax Reporting">
				<Template>
					<px:PXFormView runat="server" ID="CanadianTaxReporting" DataMember="Setup" >
						<Template>
							<px:PXLayoutRule GroupCaption="T5018 Settings" runat="server" StartGroup="true" />
							<px:PXTextEdit ID="t5018Threshold" runat="server" DataField="T5018ThresholdAmount" />
						</Template>
					</px:PXFormView>
				</Template>
			</px:PXTabItem>			
