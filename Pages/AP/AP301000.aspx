	...
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXDropDown ID="edDocType" runat="server" DataField="DocType" />
				...
				<GridProperties FastFilterFields="APInvoice__InvoiceNbr, VendorID, VendorID_Vendor_acctName, DocDesc" />
			</px:PXSelector>
			...
			<px:PXPanel ID="PXPanel5" runat="server" RenderSimple="True" RenderStyle="Simple">
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									...
									<px:PXGridColumn DataField="T5018Service" Label="T5018 Service" Type="CheckBox" TextAlign="Center" />
									...
									<px:PXGridColumn DataField="Box1099" DisplayMode="Hint"/>
				...
				<Template>
					<px:PXFormView ID="form2" runat="server" Style="z-index: 100" Width="100%" DataMember="CurrentDocument" CaptionVisible="False" SkinID="Transparent" DataSourceID="ds" MarkRequired="Dynamic">
						<Template>
							...
							<px:PXLayoutRule runat="server" GroupCaption="Default Payment Info" StartGroup="True" StartColumn="True" ControlSize="M" LabelsWidth="M"/>
							...
							<px:PXLayoutRule runat="server" ControlSize="M" GroupCaption="Tax" LabelsWidth="M" StartGroup="True" />
							...
							<px:PXNumberEdit ID="edCuryVatTaxableTotal" runat="server" DataField="CuryVatTaxableTotal" Enabled="False" AllowEdit="True" Size="M"/>
							<px:PXNumberEdit ID="edCuryVatExemptTotal" runat="server" DataField="CuryVatExemptTotal" Enabled="False" AllowEdit="True" Size="M"/>

							<px:PXLayoutRule runat="server" ControlSize="XM" GroupCaption="Receipt Info" LabelsWidth="SM" StartGroup="True" StartColumn="True"/>
...
<%--									<px:PXGridColumn DataField="OrderNbr" TextAlign="Right" />
            ...
            <px:PXTabItem Text="Joint Payees" BindingContext="Form" VisibleExp="DataControls[&quot;chkIsJointPayees&quot;].Value = 1" DependsOnView="JointPayees">
				<Template>
					<px:PXGrid runat="server" ID="grdJointPayees" Caption="Joint Payees" CaptionVisible="true" AllowPaging="True" Height="300px" SkinID="DetailsInTab" Width="100%" DataSourceID="ds" KeepPosition="True" PageSize="12" SyncPosition="True" NoteIndicator="False" FilesIndicator="False" AllowFilter="True">
						<Levels>
							<px:PXGridLevel DataMember="JointPayees">
								<Columns>
									...
									<px:PXGridColumn DataField="APLineNbr" CommitChanges="True" AllowShowHide="Server" />
									<px:PXGridColumn DataField="BillLineAmount" AllowShowHide="Server" />
									<px:PXGridColumn DataField="CuryJointAmountOwed" CommitChanges="True" Required="True" />
									<px:PXGridColumn DataField="CuryJointAmountPaid" CommitChanges="True" />
									<px:PXGridColumn DataField="CuryJointBalance" CommitChanges="True" />
									<px:PXGridColumn DataField="CanDelete" AllowShowHide="False" Visible="false"/>
								</Columns>
								<RowTemplate>
									<px:PXSelector runat="server" ID="edAPLineNbr" DataField="APLineNbr" AutoRefresh="True" /></RowTemplate></px:PXGridLevel></Levels>
						<CallbackCommands>
						...
						<Levels>
							<px:PXGridLevel DataMember="JointAmountApplications">
								<Columns>
									...
									<px:PXGridColumn DataField="CuryJointAmountToPay" />
    ...
    <px:PXSmartPanel ID="ReleaseRetainagePanel" runat="server" Caption="Release Retainage Panel"
        DesignView="Hidden" LoadOnDemand="true" Key="ReleaseRetainageFilter" CreateOnDemand="false">
        <px:PXFormView ID="ReleaseRetainageForm" runat="server" DataSourceID="ds" DataMember="ReleaseRetainageFilter">
            <Template>
                <px:PXTextEdit runat="server" ID="DateEdit" DataField="Date" />
                <px:PXTextEdit runat="server" ID="PostPeriodEdit" DataField="PostPeriod" />
                <px:PXTextEdit runat="server" ID="AmountToReleaseEdit" DataField="AmountToRelease" />
            </Template>
        </px:PXFormView>
    </px:PXSmartPanel>
