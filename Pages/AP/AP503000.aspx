...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edPayTypeID" TabIndex="6100">
		...
		<Template>
			...
			<px:PXCheckBox AlignLeft="True" Size="M" CommitChanges="True" ID="chkAPQuickBatchGeneration" runat="server" DataField="APQuickBatchGeneration" />
		</Template>
	</px:PXFormView>
</asp:Content>
						...
						<Levels>
							<px:PXGridLevel DataMember="APDocumentList">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="JointPayeeExternalName" AllowFilter="false" AllowSort="false" />
									<px:PXGridColumn DataField="CuryJointAmountOwed" AllowFilter="false" AllowSort="false" />
									<px:PXGridColumn DataField="CuryJointBalance" AllowFilter="false" AllowSort="false" />
