...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
		...
		<Levels>
			<px:PXGridLevel DataMember="AccountRecords">
				<RowTemplate>
				    ...
				    <px:PXDropDown ID="Type" runat="server" DataField="Type" CommitChanges="true" />
				...
				<Columns>
					...
					<px:PXGridColumn DataField="Type" Type="DropDownList" CommitChanges="true" />
	...
	<px:PXSmartPanel ID="PanelAccountTypeChange" runat="server" Style="z-index: 108; left: 315px; position: absolute; top: 399px;"
        Caption="Update Account Type" CaptionVisible="true" DesignView="Content" LoadOnDemand="true" ShowAfterLoad="true" Key="AccountTypeChangePrepare"
        AutoCallBack-Enabled="true" AutoCallBack-Command="Refresh" AutoReload="true" Width="378px" >
        <px:PXFormView ID="FormAccountTypeChange" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" SkinID="Transparent" DataMember="AccountTypeChangePrepare">
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XS" ControlSize="XM"/>
                <px:PXLabel runat="server" ID="messageLabel" SkinID="Label" Height="100%" OnDataBinding="messageLabel_DataBinding"/>
            </Template>
        </px:PXFormView>
        <px:PXPanel ID="AccountTypeChangeButtons" runat="server" SkinID="Buttons" Style="margin-right: 25px;">
            <px:PXButton ID="AccountTypeChangeUpdate" runat="server" DialogResult="OK" Text="Update" Width="65px" Height="24px" />
            <px:PXButton ID="AccountTypeChangeCancel" runat="server" DialogResult="No" Text="Cancel" Width="65px" Height="24px" Style="margin-left: 5px" />
        </px:PXPanel>
    </px:PXSmartPanel>
</asp:Content>
