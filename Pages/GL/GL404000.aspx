...
<asp:Content ID="Content2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server"   Width="100%"
		...
		<Template>
			...
			<px:PXNumberEdit ID="edBegBal" runat="server" DataField="BegBal" Size="SM">
			</px:PXNumberEdit>
			<px:PXNumberEdit ID="edTurnOver" runat="server" DataField="TurnOver" Size="SM">
			</px:PXNumberEdit>
			<px:PXNumberEdit ID="edEndBal" runat="server" DataField="EndBal" Size="SM">
			</px:PXNumberEdit>
		</Template>
	</px:PXFormView>
</asp:Content>
		...
		<Levels>
			<px:PXGridLevel DataMember="GLTranEnq">
				<Columns>
					...
					<px:PXGridColumn DataField="SignBegBalance" TextAlign="Right" AllowSort = "False" AllowFilter ="False" />
					<px:PXGridColumn DataField="DebitAmt" TextAlign="Right" />
					<px:PXGridColumn DataField="CreditAmt" TextAlign="Right" />
					<px:PXGridColumn DataField="SignEndBalance" TextAlign="Right" MatrixMode="True" AllowSort = "False" AllowFilter ="False" />
					<px:PXGridColumn DataField="CuryID"  AllowShowHide="Server" />
					<px:PXGridColumn DataField="SignCuryBegBalance" TextAlign="Right" AllowShowHide="Server" AllowSort = "False" AllowFilter ="False" />
					...
					<px:PXGridColumn DataField="SignCuryEndBalance" TextAlign="Right" AllowShowHide="Server" AllowSort = "False" AllowFilter ="False" />
