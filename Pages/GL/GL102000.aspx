...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="669px" Width="100%" DataMember="GLSetupRecord"
		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXCheckBox ID="chkAutoReleaseReclassBatch" runat="server" DataField="AutoReleaseReclassBatch" CommitChanges="true"/>
						...
						<Levels>
							<px:PXGridLevel DataMember="SetupApproval" >
								<RowTemplate>
									...
									<px:PXDropDown ID="edBatchType" runat="server" DataField="BatchType" CommitChanges="True" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="BatchType" CommitChanges="True" />
