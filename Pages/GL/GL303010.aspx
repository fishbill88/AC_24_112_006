...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource  EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.GL.JournalEntryImport" PrimaryView="Map" HeaderDescriptionField="Description">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand CommitChanges="True" Name="Validate" Visible="False" />
			<px:PXDSCallbackCommand CommitChanges="True" Name="MergeDuplicates" Visible="False" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server"   Width="100%" DataMember="Map" Caption="Import Summary" NoteIndicator="True" FilesIndicator="True"
		ActivityIndicator="True" ActivityField="NoteActivity" LinkIndicator="True" BPEventsIndicator="True" DefaultControlID="edImportNbr" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects" MarkRequired="Dynamic">
		<Template>
			...
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="125px" ControlSize="XM" />
						...
						<Levels>
							<px:PXGridLevel DataMember="MapDetails" ImportDataMember="ImportTemplate">
								<RowTemplate>
									...
									<px:PXSegmentMask ID="edImportBranchCD" runat="server" DataField="ImportBranchCD"/>
									...
									<px:PXSegmentMask ID="edMapBranchID" runat="server" DataField="MapBranchID" Enabled="False" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ImportBranchCD" CommitChanges="True" />
									<px:PXGridColumn DataField="MapBranchID" />
									...
									<px:PXGridColumn DataField="YtdBalance" TextAlign="Right" CommitChanges="True" MatrixMode="True" />
                                    <px:PXGridColumn DataField="CuryYtdBalance" TextAlign="Right" AllowShowHide="Server" CommitChanges="True" MatrixMode="True" />
									<px:PXGridColumn DataField="AccountType" />
									<px:PXGridColumn DataField="Description" />
								</Columns>
								<Mode InitNewRow="True" AllowUpdate="True" />
