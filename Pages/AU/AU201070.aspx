        ...
        <Levels>
            <px:PXGridLevel DataMember="ViewHandlers" SortOrder="Order">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="EventType" Width="100" />
                    <px:PXGridColumn DataField="EventContainerName" Width="100" />
                    <px:PXGridColumn DataField="EventOrFieldNamesCaption" Width="100" />
    ...
    <px:PXSmartPanel runat="server" ID="PanelEditHandler" Key="FilterHandlerEdit"
        ...
        <px:PXFormView runat="server" DataSourceID="ds" ID="FormHandlerEdit" DataMember="FilterHandlerEdit" Width="100%" SkinID="Transparent" AutoRepaint="True">
            <Template>
                ...
                <px:PXDropDown ID="EventType" runat="server" DataField="EventType" CommitChanges="True"  />
                ...
                <px:PXDropDown ID="TriggeredByChangeOfFieldNames" runat="server" DataField="TriggeredByChangeOfFieldNames" CommitChanges="True" />
