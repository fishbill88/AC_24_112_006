...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" 
        ...
        <Template>
            ...
            <px:PXDropDown ID="edFlowSubTypeField" runat="server" DataField="FlowSubTypeField" AllowNull="True" CommitChanges="True" />
            <px:PXCheckBox ID="chkEnableFlowSubTypeField" runat="server" DataField="EnableWorkflowSubTypeField" />
        </Template>
    </px:PXFormView>
</asp:Content>
        ...
        <Levels>
            <px:PXGridLevel DataMember="Workflows" >
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="WorkflowSubID" Width="50px" CommitChanges="True" AllowNull="True" NullText="DEFAULT" />
    ...
    <px:PXSmartPanel runat="server" ID="DlgExtendWorkflow" Key="DlgExtendWorkflow" 
        ...
        <px:PXFormView runat="server" ID="Form" DataMember="DlgExtendWorkflow" Width="100%" SkinID="Transparent" AutoRepaint="True">
            <Template>
                ...
                <px:PXDropDown runat="server" ID="SysWorkflowID" DataField="SysWorkflowID" CommitChanges="True" />
                ...
                <px:PXDropDown runat="server" ID="WorkflowSubID" DataField="WorkflowSubID" CommitChanges="True"/>
