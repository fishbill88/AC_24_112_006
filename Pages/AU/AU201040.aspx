        ...
        <Template2>
            <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%"  AutoRepaint="True"
                ...
                <Template>
                    ...
                    <px:PXNumberEdit ID="edColumns" runat="server" DataField="Columns" CommitChanges="True" />
                ...
                <Levels>
                    <px:PXGridLevel DataMember="ViewFieldsPerForm">
                        ...
                        <Columns>
                            ...
                            <px:PXGridColumn DataField="RequiredCondition" Width="120px" />
                            <px:PXGridColumn DataField="HideCondition" Width="200px" />
                            <px:PXGridColumn DataField="ColumnSpan" Width="100px" />
                            <px:PXGridColumn DataField="ControlSize" CommitChanges="True" Width="100px" MatrixMode="true" AllowStrings="True" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="phDialogs" runat="Server">
    <px:PXSmartPanel runat="server" ID="PanelDynamicForm" Key="FilterPreview"
        ...
        <px:PXPanel ID="PXPanel1" runat="server" SkinID="Buttons" Height="42px">
    ...
    <px:PXSmartPanel ID="pnlCombos" runat="server" Style="z-index: 108; left: 351px; position: absolute; top: 99px"
        Width="550px" Caption="Combo Box Values" CaptionVisible="true" LoadOnDemand="true" Key="ComboBoxSourceMode"
        ...
        <div style="padding: 5px">
            <px:PXFormView runat="server" DataSourceID="ds" ID="ComboBoxValuesSource" DataMember="ComboBoxSourceMode" Width="100%" SkinID="Transparent" AutoRepaint="True">
                <Template>
                    <px:PXDropDown ID="ddValuesSource" runat="server" DataField="ComboBoxValuesSource" CommitChanges="true" Width="220" />
                </Template>
            </px:PXFormView>
