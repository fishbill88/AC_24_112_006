...
<asp:Content ID="Content2" ContentPlaceHolderID="phL" Runat="Server">
	                            <px:PXGrid runat="server" ID="gridStateProperties" AutoAdjustColumns="True" Width="100%"  DataSourceID="ds" 
                                           SyncPositionWithGraph="True" SkinID="Primary" AllowPaging="True" AdjustPageSize="Auto" SyncPosition="True"
                                           KeepPosition="True" MatrixMode="True" OnEditorsCreated="grd_EditorsCreated_RelativeDates" >
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="ViewFields" >
                                        ...
                                        <RowTemplate>
                                            <pxa:PXFormulaCombo ID="edSPFDefaultValue" runat="server" DataField="DefaultValue" EditButton="True"
                                        ...
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="IsFromSchema" Type="CheckBox" Width="60px" TextAlign="Center" CommitChanges="True" />
                                            <px:PXGridColumn DataField="DefaultValue" Width="200px" MatrixMode="True" Key="value" AllowStrings="True" DisplayMode="Value" CommitChanges="True" />
