...
<asp:Content runat="server" ID="phDialogs" ContentPlaceHolderID="phDialogs">
    <px:PXSmartPanel runat="server" ID="PanelEditAction" Key="FilterActionEdit"
        ...
        <px:PXTab runat="server" ID="tabActionsDetails" Width="100%" OnPreRender="tabActionsDetails_OnPreRender" OnSelectedTabChanged="tabActionsDetails_OnSelectedTabChanged">
            <AutoSize Enabled="True" MinHeight="150" />
            <Items>
                ...
                <px:PXTabItem Text="Actions Executed on Success" RepaintOnDemand="False" >
                    <Template>
                        <px:PXGrid runat="server" ID="gridNextActions" CaptionVisible="False" AutoAdjustColumns="True" Width="100%" AllowPaging="False" 
                            MatrixMode="True" SyncPosition="True" SkinID="Details" SyncPositionWithGraph="True">
                            <AutoSize Enabled="True" MinHeight="150" />
                            <AutoCallBack Enabled="True" Command="refreshFieldsGrid" Target="ds" SuppressOnReload="True" FromUIOnly="True"></AutoCallBack>
                            <Mode InitNewRow="True" AllowRowSelect="true" />
                            <ActionBar ActionsVisible="True">
                                <CustomItems>
                                    <px:PXToolBarButton DisplayStyle="Image" ImageKey="ArrowUp" Visible="true" Tooltip="Move Up">
                                        <ActionBar />
                                        <AutoCallBack Command="actionSequenceMoveUp" Target="ds" />
                                    </px:PXToolBarButton>
                                    <px:PXToolBarButton DisplayStyle="Image" ImageKey="ArrowDown" Visible="True" Tooltip="Move Down">
                                        <ActionBar />
                                        <AutoCallBack Command="actionSequenceMoveDown" Target="ds" />
                                    </px:PXToolBarButton>
                                </CustomItems>
                            </ActionBar>
                            <Levels>
                                <px:PXGridLevel DataMember="NextActionsPerAction" SortOrder="LineNumber">
                                    <Columns>
                                        <px:PXGridColumn DataField="IsActive" Type="CheckBox" Width="60px" TextAlign="Center" CommitChanges="True" />
                                        <px:PXGridColumn DataField="NextActionName" Width="200px" CommitChanges="True" DisplayMode="Text" Type="DropDownList" />
                                        <px:PXGridColumn DataField="ActionType" Width="100px" />
                                        <px:PXGridColumn DataField="Condition" Width="150px" />
                                        <px:PXGridColumn DataField="UpdateFormFields" Width="120px" LinkCommand="editActionSequenceFormFieldValues" />
                                        <px:PXGridColumn DataField="StopOnError" Type="CheckBox" Width="50px" />
                                        <px:PXGridColumn DataField="Status" Width="50px" />
                                    </Columns>
                                </px:PXGridLevel>
                            </Levels>
                ...
                <px:PXTabItem Text="Triggering Actions" RepaintOnDemand="False" >
                    <Template>
                        <px:PXGrid runat="server" ID="gridPrevActions" CaptionVisible="False" AutoAdjustColumns="True" Width="100%" AllowPaging="False"
                            MatrixMode="True" SyncPosition="True" SkinID="Details" SyncPositionWithGraph="True">
                            <AutoSize Enabled="True" MinHeight="150" />
                            <AutoCallBack Enabled="True" Command="refreshFieldsGrid" Target="ds" SuppressOnReload="True" FromUIOnly="True"></AutoCallBack>
                            <ActionBar ActionsVisible="True">
                            ...
                            <Levels>
                                <px:PXGridLevel DataMember="PrevActionsPerAction" SortOrder="ActionName">
                                    <Mode InitNewRow="True" AllowRowSelect="true" />
                                    <Columns>
                                        <px:PXGridColumn DataField="IsActive" Type="CheckBox" Width="60px" TextAlign="Center" CommitChanges="True" />
                                        <px:PXGridColumn DataField="PrevActionName" Width="200px" CommitChanges="True" DisplayMode="Text" Type="DropDownList" />
                                        <px:PXGridColumn DataField="ActionType" Width="100px" />
                                        <px:PXGridColumn DataField="Condition" Width="150px" />
                                        <px:PXGridColumn DataField="UpdateFormFields" Width="120px" LinkCommand="editActionSequenceFormFieldValues" />
                                        <px:PXGridColumn DataField="StopOnError" Type="CheckBox" Width="50px" />
    ...
    <px:PXSmartPanel ID="ConfirmRevert" runat="server" Caption="Reverse Changes" CaptionVisible="True"
    ...
    <px:PXSmartPanel runat="server" ID="PanelActionSequenceFormFieldValues" Key="SelectedActionSequence"
        Caption="Dialog Box Values"
        CaptionVisible="True"
        AcceptButtonID="ButtonActionSequenceFormFieldValuesOk"
        CancelButtonID="ButtonActionSequenceFormFieldValuesOk"
        ...
        AutoRepaint="True"
        AutoReload="True"
        AutoCallBack-Enabled="true" AutoCallBack-Target="GridActionSequenceFormFieldValues" AutoCallBack-Command="Refresh"
        CallBackMode-CommitChanges="True" CallBackMode-PostData="Page">
        <px:PXGrid ID="GridActionSequenceFormFieldValues" runat="server" DataSourceID="ds"
            SyncPosition="True"
            Width="100%" AdjustPageSize="Auto" BorderWidth="0px" AllowSearch="True" SkinID="Details"
            AllowPaging="false"
            AutoAdjustColumns="true">
            ...
            <Levels>
                <px:PXGridLevel DataMember="FormFieldValuesPerActionSequence">
                    <Mode InitNewRow="True" AllowRowSelect="True" />
                    <RowTemplate>
                        <pxa:PXFormulaCombo ID="edAAFFValue" runat="server" DataField="Value" EditButton="True"
                            FieldsAutoRefresh="True" FieldsRootAutoRefresh="true" LastNodeName="Fields and Parameters"
                            IsInternalVisible="false" IsExternalVisible="false" OnRootFieldsNeeded="edFormFieldValue_Params"
                            SkinID="GI" />
                    </RowTemplate>
                    <Columns>
                        <px:PXGridColumn DataField="IsActive" Width="50px" Type="CheckBox" />
                        <px:PXGridColumn DataField="FieldName" Width="200px" CommitChanges="True" />
                        <px:PXGridColumn DataField="IsFromScheme" Type="CheckBox" Width="60px" TextAlign="Center" CommitChanges="True"  />
                        <px:PXGridColumn DataField="Value" Width="200px" CommitChanges="True" Key="value" AllowSort="False" MatrixMode="true" AllowStrings="True" DisplayMode="Value" />
        ...
        <px:PXPanel ID="PanelButtonsActionSequenceFormFieldValues" runat="server" SkinID="Buttons">
            <px:PXButton ID="ButtonActionSequenceFormFieldValuesOk" runat="server" DialogResult="OK" Text="Close" />
        </px:PXPanel>
    </px:PXSmartPanel>
