...
<Template1>
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="100%" SkinID="Details" Caption="Operations" AutoAdjustColumns="True" SyncPosition="true">
        ...
        <AutoCallBack Command="Refresh" Target="gridmatl" ActiveBehavior="true" >
            <Behavior RepaintControlsIDs="tab,gridmatl,gridStep,gridTool,gridOvhd,outsideProcessingform,curySettingsForm" />
        </AutoCallBack>
    </px:PXGrid>
</Template1>
<Template2>
...
<Items>
    ...
    <px:PXTabItem Text="Steps" LoadOnDemand="True" RepaintOnDemand="True">
        <Template>
            <px:PXGrid ID="gridStep" runat="server" DataSourceID="ds" Height="150px" Width="100%" SkinID="DetailsInTab" SyncPosition="true">
                <Levels>
                    <px:PXGridLevel DataMember="BomStepRecords" >
                        ...
                        <Columns>
                            <px:PXGridColumn AllowNull="False" DataField="Descr" Width="351px" AutoCallBack="true" />
                ...
                <Levels>
                    <px:PXGridLevel DataMember="BomToolRecords" >
                        <RowTemplate>
                            ...
                            <px:PXNumberEdit Size="s" ID="edToolUnitCost" runat="server" DataField="UnitCost" CommitChanges="true"/>
                        </RowTemplate>
                        <Columns>
                            <px:PXGridColumn DataField="LineID" TextAlign="Right" Visible="False" />
