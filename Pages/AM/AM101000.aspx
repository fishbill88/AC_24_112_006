            ...
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXPanel ID="pnlDataEntrySettings" runat="server" Caption="Data Entry Settings" RenderStyle="Fieldset">
                        ...
                        <px:PXDropDown ID="edDupInvBOM" runat="server" DataField="DuplicateItemOnBOM"/>
                        <px:PXDropDown ID="edDupInvOper" runat="server" DataField="DuplicateItemOnOper"/>
                        ...
                        <px:PXCheckBox ID="edBOMHoldRevisionsOnEntry" runat="server" DataField="BOMHoldRevisionsOnEntry" />
                    </px:PXPanel>
