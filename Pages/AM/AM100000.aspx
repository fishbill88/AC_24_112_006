...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" 
        ...
        <Template>
            ...
            <px:PXNumberEdit ID="edPlanningHorizon" runat="server" DataField="AMPlanningHorizon"/>
            ...
            <px:PXCheckBox ID="edIncludeOnHoldKitAssemblies" runat="server" DataField="IncludeOnHoldKitAssemblies"/> 
            <px:PXCheckBox ID="edUseFixMfgLeadTime" runat="server" DataField="UseFixMfgLeadTime"/>
            <px:PXCheckBox ID="edIncludeExpiredBlanketSalesOrders" runat="server" DataField="IncludeExpiredBlanketSalesOrders"/>
