		...
		<Levels>
			<px:PXGridLevel  DataMember="UnapprovedTrans" DataKeyNames="EmployeeID, LineNbr">
			    <RowTemplate>
                    ...
                    <px:PXMaskEdit ID="edWCID" runat="server" DataField="WcID" />
                    <px:PXNumberEdit ID="edQtyScrapped" runat="server" DataField="QtyScrapped"/>
                    <px:PXSelector ID="edReasonCode" runat="server" DataField="ReasonCodeID"  />
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="Qty" TextAlign="Right" Width="108px" CommitChanges="True"/>                  
                    ...
                    <px:PXGridColumn DataField="QtyScrapped" CommitChanges="True"/>
                    <px:PXGridColumn DataField="ReasonCodeID" CommitChanges="True"/>
                    <px:PXGridColumn DataField="ScrapAction" CommitChanges="True"/>
                </Columns>
			</px:PXGridLevel>
		</Levels>
