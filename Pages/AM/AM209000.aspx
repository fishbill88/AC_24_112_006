        ...
        <Levels>
            <px:PXGridLevel DataKeyNames="ProdOrdID,OperationID" DataMember="ProdOperRecords">
                <RowTemplate>
                    ...
                    <px:PXCheckBox ID="edOPerControlPoint" runat="server" DataField="ControlPoint" CommitChanges="True" Width="150px" />
                    <px:PXCheckBox ID="edAutoReportQty" runat="server" DataField="AutoReportQty" Width="150px" />
                </RowTemplate>
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ControlPoint" Type="CheckBox" TextAlign="Center"  CommitChanges="True" />
                    <px:PXGridColumn DataField="AutoReportQty" Type="CheckBox" TextAlign="Center" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
