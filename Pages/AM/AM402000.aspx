...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="Filter" DefaultControlID="edInventoryID">
        <Template>
            ...
            <px:PXCheckBox ID="edShowActiveOnly" runat="server" DataField="ShowActiveOnly" CommitChanges="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
		...
		<Levels>
			<px:PXGridLevel DataMember="BOMWhereUsedRecs" DataKeyNames="BOMID, SiteID" >
                <RowTemplate>
                    ...
                    <px:PXDateTimeEdit ID="efEffEndDate" runat="server" DataField="EffEndDate" />
                    <px:PXDropDown ID="edBOMStatus" runat="server" DataField="BOMStatus" />
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="ParentItemClassID" Width="100px" />
                    <px:PXGridColumn DataField="BOMSiteID" Width="130px" />
                    <px:PXGridColumn DataField="BOMID" Width="90px" LinkCommand="ViewBOM" />
                    <px:PXGridColumn DataField="RevisionID" Width="80px" />
                    <px:PXGridColumn DataField="BOMStatus" Width="85px" />
                    <px:PXGridColumn DataField="EffStartDate" Width="85px" />
                    <px:PXGridColumn DataField="EffEndDate" Width="85px" />
