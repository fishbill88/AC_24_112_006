    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="EstimateOperationRecords" DefaultControlID="edEstimateID" 
        ...
        <Template>
            <px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True"  LabelsWidth="SM" ControlSize="M" />
                ...
                <px:PXNumberEdit ID="edSetupTimeRaw" runat="server" DataField="SetupTimeRaw" Visible="False" />
                ...
                <px:PXNumberEdit ID="edRunUnitTimeRaw" runat="server" DataField="RunUnitTimeRaw" Visible="False" />
                ...
                <px:PXNumberEdit ID="edMachineUnitTimeRaw" runat="server" DataField="MachineUnitTimeRaw" Visible="False" />
                <px:PXMaskEdit ID="edQueueTime" runat="server" DataField="QueueTime" />
                <px:PXNumberEdit ID="edQueueTimeRaw" runat="server" DataField="QueueTimeRaw" Visible="False" />
                <px:PXMaskEdit ID="edFinishTime" runat="server" DataField="FinishTime" />
                <px:PXNumberEdit ID="edFinishTimeRaw" runat="server" DataField="FinishTimeRaw" Visible="False" />
                <px:PXMaskEdit ID="edMoveTime" runat="server" DataField="MoveTime" />
                <px:PXNumberEdit ID="edMoveTimeRaw" runat="server" DataField="MoveTimeRaw" Visible="False" />
