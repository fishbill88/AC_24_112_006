...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="ProdSetupRecord" DefaultControlID="edMoveNumberingID" TabIndex="1700" >
		<Template>
			...
			<px:PXCheckBox ID="chkLockWorkflowEnabled" runat="server" DataField="LockWorkflowEnabled"  CommitChanges="true"/>
