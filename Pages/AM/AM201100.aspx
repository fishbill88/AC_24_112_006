...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="OrderType" Caption="Order Types"
        ...
        <Template>
            ...
            <px:PXDropDown ID="edFunction" runat="server" DataField="Function" CommitChanges="True"/>
        </Template>
    </px:PXFormView>
</asp:Content>
		...
		<Items>
			<px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXCheckBox ID="edAutoBackwardReporting" runat="server" DataField="AutoBackwardReporting" />
                    ...
                    <px:PXDropDown ID="edExceedQtyOperations" runat="server" DataField="ExceedQtyOperations" />
