		...
		<Items>
			<px:PXTabItem Text="General" >
                <Template>
                    ...
                    <px:PXCheckBox ID="edAutoBackwardReporting" runat="server" DataField="AutoBackwardReporting" CommitChanges="True" />
			...
			<px:PXTabItem Text="References">
                <Template>
                    ...
                    <px:PXSelector ID="edProductOrdID" runat="server" DataField="ProductOrdID" AllowEdit="True" AutoRefresh="True" CommitChanges="True" />
                    <px:PXSelector ID="edParentOrderType" runat="server" DataField="ParentOrderType" AllowEdit="True" CommitChanges="True" />
                    <px:PXSelector ID="edParentOrdID" runat="server" DataField="ParentOrdID" AllowEdit="True" AutoRefresh="True" CommitChanges="True" />
