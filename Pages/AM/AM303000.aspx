    ...
    <px:PXTab ID="tab" runat="server" Width="100%" DataMember="EstimateRecordSelected" DataSourceID="ds" >
		<Items>
		    ...
		    <px:PXTabItem Text="Image">
                <Template>
                    <px:PXLabel ID="imgUploaderID" runat="server" Text="Image URL:"></px:PXLabel>
                    <px:PXLayoutRule ControlSize="S"  runat="server" StartColumn="True" />
                    <px:PXImageUploader Height="375px" Width="375px" ID="imgUploader" runat="server" DataField="ImageUrl" AllowUpload="true"
                                        ShowComment="true" DataMember="EstimateRecordSelected"  SuppressLabel="True" />
                </Template>
			</px:PXTabItem>
