...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" BorderStyle="NotSet" PrimaryView="batch" TypeName="PX.Objects.AM.LaborEntry" HeaderDescriptionField="TranDesc">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand CommitChanges="True" Name="ProductionAttributes" Visible="False" DependOnGrid="grid"/>
        ...
        <Levels>
            <px:PXGridLevel DataMember="transactions" DataKeyNames="DocType,BatNbr,LineNbr">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="LaborTimeRaw" Visible="False" AllowShowHide="False" />
