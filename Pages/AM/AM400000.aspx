...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    ...
    <Template>
      ...
      <px:PXSelector runat="server" ID="edRefNbr" DataField="RefNbr" CommitChanges="True" />
      <px:PXLayoutRule runat="server" ID="PXLayoutRule18" StartColumn="True" LabelsWidth="M"/>
      <px:PXSelector runat="server" ID="edParentRefNbr" DataField="ParentRefNbr" CommitChanges="True"/>
      <px:PXLayoutRule runat="server" ID="PXLayoutRule19" StartColumn="True" LabelsWidth="M"/>
      <px:PXSelector runat="server" ID="edProductRefNbr" DataField="ProductRefNbr" CommitChanges="True"/></Template></px:PXFormView>
    ...
    <Levels>
        <px:PXGridLevel DataMember="Detailrecs" >
            <RowTemplate>
                ...
                <px:PXSegmentMask ID="edTransferSite" runat="server" DataField="TransferSiteID" AllowEdit="True"/>
                <px:PXSelector ID="edKitRevisionID" runat="server" DataField="KitRevisionID" />
            </RowTemplate>
            <Columns>
                ...
                <px:PXGridColumn DataField="TransferSiteID"/>
                <px:PXGridColumn DataField="KitRevisionID"/>
            </Columns>
        </px:PXGridLevel>
    </Levels>
...
<px:PXSmartPanel ID="PanelProductionOrder" runat="server" Caption="Create Production Orders" CaptionVisible="True"
...
<%-- Assemble Kit Panel --%>
<px:PXSmartPanel ID="PanelKitAssembly" runat="server" Caption="Create Kit Assemblies" CaptionVisible="True"
                 DesignView="Content" LoadOnDemand="True" AutoCallBack-Command="Refresh" CallBackMode-CommitChanges="True" AutoReload="True" CloseButtonDialogResult="Abort"
                 Key="PlanKitAssemblyFilter" AutoCallBack-Target="gridKitAssemblyDisplay" CallBackMode-PostData="Page" Width="1000px" Height="450px" TabIndex="2000" >
    <px:PXGrid ID="gridKitAssemblyDisplay" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Inquire" SyncPosition="True" >
        <Levels>
            <px:PXGridLevel DataMember="ProcessRecords" DataKeyNames="LineNbr" >
                <RowTemplate>
                    <px:PXLayoutRule runat="server" StartColumn="True" />
                    <px:PXSegmentMask ID="edKitAssembleInventoryID" runat="server" DataField="InventoryID" />
                    <px:PXDropDown ID="edKitAssembleSource" runat="server" DataField="Source" />
                    <px:PXSegmentMask ID="edKitAssembleSiteID" runat="server" DataField="SiteID" />
                    <px:PXNumberEdit ID="edKitAssembleQty" runat="server" DataField="Qty" />
                    <px:PXTextEdit ID="edKitAssembleUOM" runat="server" DataField="UOM"/>
                    <px:PXDateTimeEdit ID="edKitAssemblePlanDate" runat="server" DataField="PlanDate"/>
                    <px:PXNumberEdit ID="edKitAssembleGroupNumber" runat="server" DataField="GroupNumber" CommitChanges="True" />
                </RowTemplate>
                <Columns>
                    <px:PXGridColumn DataField="InventoryID" Width="130px" />
                    <px:PXGridColumn DataField="Source" Width="120px" />
    ...
    <px:PXPanel ID="PXPanelKitAssemblyBtn" runat="server" SkinID="Buttons">
        <px:PXButton ID="PXPanelKitAssemblyOk" runat="server" DialogResult="OK" Text="Create" ></px:PXButton>
        <px:PXButton ID="PXPanelKitAssemblyCancel" runat="server" DialogResult="Abort" Text="Cancel"></px:PXButton>
    </px:PXPanel>
</px:PXSmartPanel>
