...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" DataMember="Filter" Width="100%" Caption="Selection"
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="M" />
            <px:PXCheckBox CommitChanges="True" ID="edPrintWithDeviceHub" runat="server" DataField="PrintWithDeviceHub" />
            <px:PXCheckBox CommitChanges="True" ID="edDefinePrinterManually" runat="server" DataField="DefinePrinterManually"  />
            <px:PXSelector CommitChanges="True" ID="edPrinterID" runat="server" DataField="PrinterID" />
            <px:PXNumberEdit CommitChanges="True" ID="edNumberOfCopies" runat="server" DataField="NumberOfCopies"/>
        </Template>
    </px:PXFormView>
</asp:Content>
