...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="invlookup">
        <Template>
			...
			<px:PXNumberEdit ID="edaMGroupWindow" runat="server" DataField="aMGroupWindow" Width="200px" />			
            <px:PXLayoutRule ID="PXLayoutRule2" runat="server" StartColumn="True"  LabelsWidth="M" ControlSize="M" />
            <px:PXDropDown ID="edRepSource" runat="server" DataField="ReplenishmentSource" AutoRefresh="True"/>
            <px:PXSelector ID="edRepSiteID" runat="server" DataField="ReplenishmentSiteID" AutoRefresh="True"/>
            <px:PXNumberEdit ID="edTransferLeadTime" runat="server" DataField="TransferLeadTime" Width="200px" />
            <px:PXNumberEdit ID="edLeadTime" runat="server" DataField="LeadTime" Width="200px" />
        </Template>
    </px:PXFormView>
</asp:Content>
