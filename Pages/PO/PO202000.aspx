...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="LandedCostCode" Caption="Landed Cost Code"
        ...
        <Template>
            ...
            <px:PXDropDown runat="server" DataField="AllocationMethod" AllowNull="False" ID="edAllocationMethod" CommitChanges="true"  />
            ...
            <px:PXSelector ID="edTaxCategoryID" runat="server" DataField="TaxCategoryID" AllowEdit="True" AutoRefresh="True" CommitChanges="true"/>
