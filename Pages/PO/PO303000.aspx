	...
	<px:PXTab ID="tab" runat="server" Height="300px" Style="z-index: 100;" Width="100%" DataSourceID="ds" DataMember="CurrentDocument">
		...
		<Items>
			<px:PXTabItem Text="Landed Costs">
				<Template>
					<px:PXGrid ID="gridLandedCost" runat="server" DataSourceID="ds" Style="z-index: 100"
			...
			<px:PXTabItem Text="Details">
				<Template>
					<px:PXGrid ID="gridReceiptLines" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="DetailsInTab" ActionsPosition="Top">
						<Levels>
