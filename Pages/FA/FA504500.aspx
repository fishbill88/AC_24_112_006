...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Filter" TypeName="PX.Objects.FA.AssetGLTransactions">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="Schedule" Visible="false" CommitChanges="true" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
				...
				<Levels>
					<px:PXGridLevel DataMember="GLTransactions">
						...
						<Columns>
							...
							<px:PXGridColumn AllowUpdate="False" DataField="SelectedQty" TextAlign="Right" AllowFilter="false" />
							<px:PXGridColumn AllowUpdate="False" DataField="SelectedAmt" TextAlign="Right" AllowFilter="false"/>
							<px:PXGridColumn AllowUpdate="False" DataField="OpenQty" TextAlign="Right" AllowFilter="false" />
