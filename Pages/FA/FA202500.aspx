...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Depreciation Method Summary"
		...
		<Template>
			...
			<px:PXNumberEdit runat="server" DataField="DBMultiplier" ID="edDBMultiplier" CommitChanges="True" />
			<px:PXCheckBox ID="chkSwitchToSL" runat="server" DataField="SwitchToSL" CommitChanges="True" />
