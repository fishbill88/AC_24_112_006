...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PM.CommitmentInquiry"
        ...
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Visible="false" Name="PMCommitmentAlias$RefNoteID$Link" CommitChanges="True" />
            ...
            <px:PXDSCallbackCommand Visible="false" Name="ViewVendor" CommitChanges="True"/>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection"
        ...
        <Template>
            ...
            <px:PXLayoutRule ID="PXLayoutRule2" runat="server" ControlSize="SM" LabelsWidth="SM" StartColumn="True" />
            <px:PXSegmentMask runat="server" ID="edVendorID" DataField="VendorID" DataSourceID="ds" CommitChanges="True"/>
            <px:PXSelector runat="server" ID="edOwnerID" DataField="OwnerID" DataSourceID="ds" CommitChanges="True"/>
            <px:PXDropDown runat="server" ID="edRelatedDocumentType" DataField="RelatedDocumentType" CommitChanges="True" />
            <px:PXLayoutRule ID="LayoutRule_QTY" runat="server" ControlSize="SM" LabelsWidth="S" StartColumn="True" GroupCaption="Committed Totals"/>
    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="PrimaryInquire" SyncPosition="true" FastFilterFields="ExtRefNbr, RefNoteID">
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <Columns>
                    <px:PXGridColumn DataField="POLineCommitment__RelatedDocumentTypeExt"/>
                    <px:PXGridColumn DataField="RefNoteID" RenderEditorText="True" LinkCommand="PMCommitment$RefNoteID$Link"/>
                    <px:PXGridColumn DataField="POLineCommitment__VendorID" LinkCommand="ViewVendor"/>
                    <px:PXGridColumn DataField="POLineCommitment__VendorName"/>
                    <px:PXGridColumn DataField="POOrder__OwnerID"/>
                    ...
                    <px:PXGridColumn DataField="PMProject__OwnerID" />
