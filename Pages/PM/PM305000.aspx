...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:pxformview id="form" runat="server" datasourceid="ds" style="z-index: 100" width="100%" datamember="Document" caption="Selection"
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="S" StartColumn="True" StartGroup="True" GroupCaption="Totals By Revision"/>
            <px:PXNumberEdit ID="edTotalAmountToComplete" runat="server" DataField="TotalAmountToComplete" Enabled="False" />
            <px:PXNumberEdit ID="edTotalAmount" runat="server" DataField="TotalAmount" Enabled="False" />
            <px:PXNumberEdit ID="edTotalBudgetedAmount" runat="server" DataField="TotalBudgetedAmount" Enabled="False" />
            <px:PXNumberEdit ID="edTotalProjectedAmount" runat="server" DataField="TotalProjectedAmount" Enabled="False" />
            <px:PXNumberEdit ID="edTotalVarianceAmount" runat="server" DataField="TotalVarianceAmount" Enabled="False" />
            <px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="S" StartColumn="True" StartGroup="True" GroupCaption="Totals By Project"/>
            <px:PXNumberEdit ID="edTotalBudgetedRevenueAmount" runat="server" DataField="ProjectTotals.TotalBudgetedRevenueAmount" Enabled="False" />
            <px:PXNumberEdit ID="edTotalBudgetedCompletedAmount" runat="server" DataField="ProjectTotals.TotalBudgetedCompletedAmount" Enabled="False" />
            <px:PXNumberEdit ID="edTotalBudgtedAmountToComplete" runat="server" DataField="ProjectTotals.TotalBudgetedAmountToComplete" Enabled="False" />
            <px:PXNumberEdit ID="edTotalBudgetedCostAmount" runat="server" DataField="ProjectTotals.TotalBudgetedCostAmount" Enabled="False" />
            <px:PXNumberEdit ID="edTotalBudgtedGrossProfit" runat="server" DataField="ProjectTotals.TotalBudgetedGrossProfit" Enabled="False" />
            <px:PXNumberEdit ID="edTotalBudgtedVarianceAmount" runat="server" DataField="ProjectTotals.TotalBudgetedVarianceAmount" Enabled="False" />
            <px:PXNumberEdit ID="edTotalProjectedGrossProfit" runat="server" DataField="ProjectTotals.TotalProjectedGrossProfit" Enabled="False" />
        </Template>
    </px:pxformview>
</asp:Content>
        ...
        <Levels>
            <px:PXGridLevel DataMember="Details">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="VarianceQuantity" TextAlign="Right" CommitChanges="true"/>
                    <px:PXGridColumn DataField="VarianceAmount" TextAlign="Right" CommitChanges="true"/>
