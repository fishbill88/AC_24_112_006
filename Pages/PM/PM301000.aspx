...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="511px" DataSourceID="ds" DataMember="ProjectProperties">
        ...
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                    ...
                    <px:PXSelector ID="selectProjectGroupID" runat="server" DataField="ProjectGroupID" CommitChanges="true" AllowEdit="true" AutoRefresh="true" />
                    ...
                    <px:PXDropDown ID="edAccountingMode" runat="server" AllowNull="False" DataField="AccountingMode" CommitChanges="True"/>
            ...
            <px:PXTabItem Text="Tasks">
                <Template>
                    <px:PXGrid SyncPosition="True" runat="server" ID="TaskGrid" Width="100%" DataSourceID="ds" Height="100%" SkinID="DetailsInTab">
                        <Levels>
                            <px:PXGridLevel DataMember="Tasks" DataKeyNames="ProjectID,TaskCD">
                                <RowTemplate>
									...
									<px:PXDropDown ID="edCompletedPctMethod" runat="server" DataField="CompletedPctMethod" />
                                </RowTemplate>
                                <Columns>
									...
									<px:PXGridColumn DataField="CompletedPctMethod" CommitChanges="True" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <ActionBar >
                            <CustomItems>
                                <px:PXToolBarButton Text="Add Common Tasks">
                                    <AutoCallBack Command="ViewAddCommonTask" Target="ds" />
                                </px:PXToolBarButton>
            ...
            <px:PXTabItem Text="Revenue Budget" LoadOnDemand="False">
                <Template>
                    ...
                    <px:PXGrid ID="RevenueBudgetGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="DetailsInTab" SyncPosition="True" OnRowDataBound="BudgetGrid_RowDataBound" AllowPaging="True" AdjustPageSize="None" PageSize="200">
                        <Levels>
                            <px:PXGridLevel DataMember="RevenueBudget">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CuryInclTaxAmount" />
                                </Columns>
                                <RowTemplate>
                        ...
                        <Mode InitNewRow="True" AllowUpload="True" />
                        <CallbackCommands>
                            <FetchRow RepaintControls="None" RepaintControlsIDs="RevenueFilter" />
                        </CallbackCommands>
                    </px:PXGrid>
                </Template>
            </px:PXTabItem>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CostBudget">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ProductivityTracking" TextAlign="Right" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <ActionBar>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="BalanceRecords" DataKeyNames="RecordID">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CuryVarianceAmount" TextAlign="Right" />
                                    <px:PXGridColumn DataField="Performance" TextAlign="Right" />
                                    <px:PXGridColumn DataField="CuryInclTaxAmount" TextAlign="Right" />
                                </Columns>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="PurchaseOrders">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="POLine__CuryExtCost" TextAlign="Right" />
                                    <px:PXGridColumn DataField="POLine__OrderQty" TextAlign="Right" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Invoices">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMProforma__IsMigratedRecord" Type="CheckBox" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                         <ActionBar >
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ChangeOrders">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ReversingRefNbr" LinkCommand="ViewReversingChangeOrders" />
        ...
        <Template>
            ...
            <px:PXTabItem Text="Defaults">
                <Template>
                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
                    <px:PXLayoutRule ID="PXLayoutRule6" runat="server" StartGroup="True" GroupCaption="GL ACCOUNTS" />
                    <px:PXSegmentMask ID="edDefaultSalesAccountID" runat="server" DataField="DefaultSalesAccountID" AutoRefresh="True" CommitChanges="true" />
                    <px:PXSegmentMask ID="edDefaultSalesSubID" runat="server" DataField="DefaultSalesSubID" AutoRefresh="True" CommitChanges="true" />
                    <px:PXSegmentMask ID="edDefaultExpenseAccountID" runat="server" DataField="DefaultExpenseAccountID" AutoRefresh="True" CommitChanges="true" />
                    <px:PXSegmentMask ID="edDefaultExpenseSubID" runat="server" DataField="DefaultExpenseSubID" AutoRefresh="True" CommitChanges="true" />
                    <px:PXSegmentMask ID="edDefaultAccrualAccountID" runat="server" DataField="DefaultAccrualAccountID" AutoRefresh="True" CommitChanges="true" />
                    <px:PXSegmentMask ID="edDefaultAccrualSubID" runat="server" DataField="DefaultAccrualSubID" AutoRefresh="True" CommitChanges="true"/>
                    ...
                    <px:PXGrid runat="server" ID="gridMarkups" SyncPosition="True" FilesIndicator="False" AllowFilter="False" AllowSearch="False" Width="600" Height="220" Caption="Document Markups" CaptionVisible="True" AllowPaging="False" AdjustPageSize="None" NoteIndicator="False">
                        <Levels>
                            <px:PXGridLevel DataMember="Markups">
                                <RowTemplate>
                                  ...
                                  <px:PXSegmentMask runat="server" ID="edMarkupInventoryID" DataField="InventoryID" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="Type" />
                                    <px:PXGridColumn DataField="Description" />
                     ...
                     <px:PXLabel ID="dummylable1" runat="server"></px:PXLabel>
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="GL Accounts for Payroll" LabelsWidth="SM" ControlSize="XM"/>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ComplianceDocuments">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ThroughDate" TextAlign="Left" CommitChanges="True"/>
    ...
    <!--#include file="~\Pages\Includes\ReversingChangeOrdersPanel.inc"-->
</asp:Content>
