...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" DefaultControlID="edModule" BPEventsIndicator="true"
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
			<px:PXDropDown ID="edOrigDocType" runat="server" DataField="OrigDocType" CommitChanges="True" />
			<px:PXTextEdit ID="edOrigDocNbr" runat="server" DataField="OrigDocNbr" CommitChanges="True" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask runat="server" ID="edAccountGroupID" DataField="AccountGroupID" CommitChanges="True" />
                                    ...
                                    <px:PXSegmentMask runat="server" ID="edAccountID" DataField="AccountID" AutoRefresh="True" CommitChanges="True" />
                                    <px:PXSegmentMask runat="server" ID="edSubID" DataField="SubID" AutoRefresh="True" />
                                    <px:PXSegmentMask runat="server" ID="edOffsetAccountID" DataField="OffsetAccountID" AutoRefresh="True" />
                                    <px:PXSegmentMask runat="server" ID="edOffsetSubID" DataField="OffsetSubID" AutoRefresh="True" />
                                </RowTemplate>
