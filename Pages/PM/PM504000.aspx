...
<asp:Content ID="Content1" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds"
		...
		<Template>
            ...
            <px:PXCheckBox ID="chkRecalculateProjectBalances" runat="server" DataField="RecalculateProjectBalances" AlignLeft="True" />
            ...
            <px:PXCheckBox ID="chkRecalculateInclusiveTaxes" runat="server" DataField="RecalculateInclusiveTaxes" CommitChanges="true" AlignLeft="True" />
		</Template>
	</px:PXFormView>
</asp:Content>
