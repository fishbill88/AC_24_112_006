        ...
        <Levels>
            <px:PXGridLevel DataMember="Transactions">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="AccountGroupID" Label="Debit Account Group" />
                    <px:PXGridColumn DataField="AccountID" Label="Debit Account" />
                    <px:PXGridColumn DataField="SubID" Label="Debit Subaccount" />
                    <px:PXGridColumn DataField="OffsetAccountGroupID" Label="Credit Account Group" />
                    <px:PXGridColumn DataField="OffsetAccountID" Label="Credit Account" />
                    <px:PXGridColumn DataField="OffsetSubID" Label="Credit SubAccount" />
