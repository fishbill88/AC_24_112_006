...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
		TypeName="PX.Objects.PM.PMAccessDetail" PrimaryView="Project">
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" Caption="Project"
		DataMember="Project" DefaultControlID="edContractCD" TemplateContainer="">
		<Template>
			...
			<px:PXTextEdit ID="editProjectGroup" runat="server" DataField="ProjectGroupID" Enabled="False" />
		</Template>
	</px:PXFormView>
</asp:Content>
