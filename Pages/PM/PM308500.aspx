                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Details">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edRevenueInventoryID" runat="server" DataField="RevenueInventoryID" AutoRefresh="true" AllowEdit="true"/>
                    ...
                    <px:PXGrid ID="gridMarkups" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" NoteIndicator="True">
                        ...
                        <Levels>
                            ...
                            <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edMarkupInventoryID" runat="server" DataField="InventoryID" AutoRefresh="true"/>
                                </RowTemplate>
                                <Columns>
