...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="168%" Width="100%" SelectedIndex="1">
		<Items>
			...
			<px:PXTabItem Text="Project Groups">
				<Template>
					<px:PXGrid ID="gridProjectGroups" BorderWidth="0px" runat="server" Height="150px" Width="100%"
						AdjustPageSize="Auto" AllowSearch="True" SkinID="DetailsInTab" TabIndex="400"
						DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="ProjectGroup">
								<Mode AllowAddNew="false" AllowDelete="false" />
								<Columns>
									<px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" AllowCheckAll="True" />
									<px:PXGridColumn DataField="ProjectGroupID" />
									<px:PXGridColumn DataField="Description" />
								</Columns>
								<RowTemplate>
									<px:PXSelector ID="editProjectGroupID" runat="server" DataField="ProjectGroupID" AllowEdit="true" />
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
