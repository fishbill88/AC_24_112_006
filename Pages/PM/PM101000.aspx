        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXSelector ID="edProgressWorksheetNumbering" runat="server" DataField="ProgressWorksheetNumbering" AllowEdit="True" Text="PROGRESSWS" />
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="Notifications" DataKeyNames="Module,NotificationCD">
                                        <RowTemplate>
                                            ...
                                            <px:PXSelector ID="edNotificationID" runat="server" DataField="NotificationID" AutoRefresh="True" AllowEdit="True" ValueField="Name" />
                                        ...
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="NotificationID" DisplayMode="Text" TextField="Name" />
            ...
            <px:PXTabItem Text="Approval">
                 <Template>
                    <px:PXLayoutRule runat="server" GroupCaption="Approval Settings" StartGroup="True" StartColumn="True" LabelsWidth="L" ControlSize="L"/>
                    <px:PXSelector ID="PXSelector1" runat="server" DataField="AssignmentMapID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" />
                    <px:PXSelector ID="PXSelector3" runat="server" DataField="ProformaApprovalMapID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" />
                    <px:PXSelector runat="server" ID="PXSelector7" DataField="ChangeRequestApprovalMapID" AllowEdit="True" AllowAddNew="True" TextField="Name" />
                    <px:PXSelector ID="PXSelector9" runat="server" DataField="ChangeOrderApprovalMapID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" />
                    <px:PXSelector ID="PXSelector11" runat="server" DataField="QuoteApprovalMapID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" />
                    <px:PXSelector ID="PXSelector13" runat="server" DataField="CostProjectionApprovalMapID" AllowEdit="True" AllowAddNew="True" TextField="Name"/>
                    <px:PXSelector ID="PXSelector15" runat="server" DataField="ProgressWorksheetApprovalMapID" AllowEdit="True" AllowAddNew="True" TextField="Name"/>

                    <px:PXLayoutRule runat="server" GroupCaption="Pending Approval Notification" StartGroup="True" StartColumn="True" LabelsWidth="L" ControlSize="L"/>
                    <px:PXSelector ID="PXSelector2" runat="server" DataField="AssignmentNotificationID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" />
                    <px:PXSelector ID="PXSelector4" runat="server" DataField="ProformaApprovalNotificationID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" />
                    <px:PXSelector runat="server" ID="PXSelector8" DataField="ChangeRequestApprovalNotificationID" AllowEdit="True" AllowAddNew="True" TextField="Name" />
                    <px:PXSelector ID="PXSelector10" runat="server" DataField="ChangeOrderApprovalNotificationID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" />
                    <px:PXSelector ID="PXSelector12" runat="server" DataField="QuoteApprovalNotificationID" TextField="Name" AllowEdit="True"/>
                    <px:PXSelector ID="PXSelector14" runat="server" DataField="CostProjectionApprovalNotificationID" AllowEdit="True" AllowAddNew="True" TextField="Name"/>
                    <px:PXSelector ID="PXSelector16" runat="server" DataField="ProgressWorksheetApprovalNotificationID" AllowEdit="True" AllowAddNew="True" TextField="Name"/>
                </Template>
            </px:PXTabItem>
        </Items>
