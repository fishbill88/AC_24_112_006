...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="True" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PM.ProformaEntry" PrimaryView="Document" BorderStyle="NotSet">
        <CallbackCommands>
            <px:PXDSCallbackCommand Name="AutoApplyPrepayments" Visible="false" />
            <px:PXDSCallbackCommand Name="ViewTransactionDetails" Visible="false" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="511px" DataSourceID="ds" DataMember="DocumentSettings">
        ...
        <Items >
            <px:PXTabItem Text="Progress Billing">
                <Template>
                    <px:PXGrid ID="ProgressiveLinesGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="DetailsInTab" SyncPosition="True" RepaintColumns="true">
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Load Lines" Tooltip="Upload lines from the revenue budget">
            ...
            <px:PXTabItem Text="Financial">
                <Template>
                    <px:PXLayoutRule runat="server" StartColumn="True" GroupCaption="AR Invoice Info" ControlSize="XM" LabelsWidth="SM" />
                    <px:PXDropDown ID="edARInvoiceDocType" runat="server" DataField="ARInvoiceDocType" CommitChanges="True" DisplayMode="Text" />
                    <px:PXSelector ID="edARInvoiceRefNbr" runat="server" DataField="ARInvoiceRefNbr" CommitChanges="True" AutoRefresh="True" AllowEdit="True" />
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Tax Info" />
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Other Info" />
                    <px:PXCheckBox ID="cbIsMigratedRecord" runat="server" DataField="IsMigratedRecord" />
