							...
							<px:PXFormView ID="formRules" runat="server" DataSourceID="ds" DataMember="StepRules" Width="100%" SkinID="Transparent">
								<Template>
									...
									<px:PXPanel ID="formSelection" runat="server" Width="100%" RenderStyle="Simple">
										...
										<px:PXSelector ID="edSourceBranchID" runat="server" DataField="SourceBranchID" CommitChanges="True"/>										
									</px:PXPanel>
									<px:PXPanel ID="PXPanel6" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule26" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
										<px:PXSelector ID="edAccountGroupFrom" runat="server" DataField="AccountGroupFrom" CommitChanges="true"/>
										<px:PXNumberEdit ID="edRangeStart" runat="server" DataField="RangeStart" CommitChanges="True"/>
										<px:PXLayoutRule ID="PXLayoutRule27" runat="server" StartColumn="True" />
										<px:PXSelector ID="edAccountGroupTo" runat="server" DataField="AccountGroupTo" CommitChanges="true"/>
									...
									<pxa:PMFormulaEditor ID="edBillableQtyFormula" runat="server" DataSourceID="ds" DataField="BillableQtyFormula" Parameters="@Rate,@Price" CommitChanges="true"/>
							...
							<px:PXFormView ID="formSettings" runat="server" DataSourceID="ds" DataMember="StepSettings" Width="100%" SkinID="Transparent">
								<Template>
									...
									<px:PXPanel ID="formSelection" runat="server" Width="100%" RenderStyle="Simple">
										...
										<px:PXDropDown ID="PXDropDown1" runat="server" DataField="DateSource" CommitChanges="true"/>
										
										<px:PXLayoutRule ID="PXLayoutRule88" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM"/>
										<px:PXCheckBox ID="PXCheckBox2" runat="server" DataField="AllocateZeroQty" AlignLeft="True" CommitChanges="true"/>
										<px:PXCheckBox ID="PXCheckBox3" runat="server" DataField="AllocateZeroAmount" AlignLeft="True" CommitChanges="true"/>
										<px:PXCheckBox ID="PXCheckBox4" runat="server" DataField="AllocateNonBillable" AlignLeft="True" CommitChanges="true"/>
                                        
                                        <px:PXLayoutRule ID="PXLayoutRule19" runat="server" StartRow="true" StartColumn="True" ColumnSpan="2" LabelsWidth="SM" />
                                        <px:PXCheckBox ID="PXCheckBox9" runat="server" DataField="MarkAsNotAllocated" CommitChanges="true"/>
									</px:PXPanel>
                                    ...
                                    <px:PXLayoutRule ID="PXLayoutRule24" runat="server" StartRow="True" StartGroup="True" GroupCaption="Transaction Reversal" />
									<px:PXPanel ID="PXPanel5" runat="server" Width="100%" RenderStyle="Simple">
                                        <px:PXLayoutRule ID="PXLayoutRule25" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M"  />
										<px:PXDropDown ID="edReverse" runat="server" DataField="Reverse" CommitChanges="true"/>
                                        <px:PXCheckBox ID="PXCheckBox10" runat="server" DataField="UseReversalDateFromOriginal" CommitChanges="true"/>
                                    </px:PXPanel>
									...
									<px:PXPanel ID="PXPanel3" runat="server" Width="100%" RenderStyle="Simple">
										...
										<px:PXCheckBox ID="PXCheckBox5" runat="server" DataField="GroupByDate" CommitChanges="true"/>
										<px:PXCheckBox ID="PXCheckBox6" runat="server" DataField="GroupByEmployee" CommitChanges="true"/>
										<px:PXLayoutRule ID="PXLayoutRule11" runat="server" StartColumn="True" />
										<px:PXCheckBox ID="PXCheckBox7" runat="server" DataField="GroupByVendor" AlignLeft="True" CommitChanges="true"/>
										<px:PXCheckBox ID="PXCheckBox8" runat="server" DataField="GroupByItem" AlignLeft="True" CommitChanges="true" />
									</px:PXPanel>
								</Template>
								<CallbackCommands>
