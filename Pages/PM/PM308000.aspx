...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Change Order Summary" FilesIndicator="True"
        ...
        <Template>
            ...
            <px:PXTextEdit ID="linkReversingRefNbr" runat="server" DataField="ReversingRefNbr" Enabled="false" AlignLeft="True" TextAlign ="Left" >
								<LinkCommand Target="ds" Command="ViewReversingChangeOrders" ></LinkCommand>
			</px:PXTextEdit>
            ...
            <px:PXTextEdit ID="edProjectNumber" runat="server" DataField="ProjectNbr" CommitChanges="true"/>            
             ...
             <px:PXTextEdit ID="linkOriginalRefNbr" runat="server" DataField="OrigRefNbr" Enabled="false" AlignLeft="True" TextAlign ="Left">
								<LinkCommand Target="ds" Command="ViewOrigChangeOrder" ></LinkCommand>
			</px:PXTextEdit>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Details">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector runat="server" ID="edTaxCategoryID" DataField="TaxCategoryID" AutoRefresh="true" />
                                </RowTemplate>
                                <Columns>
                                    ...
                                    <px:PXGridColumn CommitChanges="true" DataField="TaxCategoryID" />
                                    <px:PXGridColumn CommitChanges="true" DataField="RetainagePct" />
                                    <px:PXGridColumn CommitChanges="true" DataField="RetainageAmt" />
                                    <px:PXGridColumn CommitChanges="true" DataField="RetainageAmtInProjectCury" />
                                    </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <ActionBar>
