                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Add Common Tasks">
									<AutoCallBack Command="AddCommonTasks" Target="ds">
...
<asp:Content ID="Dialogs" ContentPlaceHolderID="phDialogs" runat="Server">
    ...
    <px:PXSmartPanel ID="PanelAddCommonTasks" runat="server" Height="396px" Width="873px" Caption="Add Tasks" CaptionVisible="True" Key="TasksForAddition" AutoCallBack-Command="Refresh"
        AutoCallBack-Enabled="True" AutoCallBack-Target="gridAddCommonTasks">
        <px:PXGrid ID="gridAddCommonTasks" runat="server" Height="240px" Width="100%" DataSourceID="ds" SkinID="Inquire" NoteIndicator="false" FilesIndicator="false">
            <AutoSize Enabled="true" />
            <Levels>
        ...
        <px:PXPanel ID="PXPanelBtn" runat="server" SkinID="Buttons">
            <px:PXButton ID="PXButtonAddCommonTasksOk" runat="server" DialogResult="OK" Text="Add " CommandName="AddCommonTasks" CommandSourceID="ds" />
            <px:PXButton ID="PXButtonAddCommonTasksCancel" runat="server" DialogResult="Cancel" Text="Cancel" />
        </px:PXPanel>
    </px:PXSmartPanel>
