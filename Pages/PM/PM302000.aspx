...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" EnableAttributes="true" Visible="True" Width="100%" PrimaryView="Task" TypeName="PX.Objects.PM.ProjectTaskEntry" BorderStyle="NotSet" HeaderDescriptionField="FormCaptionDescription">
    </px:PXDataSource>
</asp:Content>
        ...
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="GL ACCOUNTS" />
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="GL Accounts for Payroll" />
