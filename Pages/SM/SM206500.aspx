...
<asp:content id="cont3" contentplaceholderid="phG" runat="Server">
    	...
    	<px:PXSmartPanel ID="paramsPanel" runat="server" Height="396px" Width="850px" Caption="Print Job Parameters" Key="PrintJobParameters" >
			<px:PXGrid ID="paramsGrid" runat="server" Height="240px" Width="100%" DataSourceID="ds" SkinID="Details" SyncPosition="true">
				...
				<Levels>
					<px:PXGridLevel DataMember="PrintJobParameters" DataKeyNames="JobID,ParameterName">
						<Columns>
