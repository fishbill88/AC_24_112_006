	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
           ...
           <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="L" />
            ...
            <px:PXCheckBox runat="server" ID="edSimpleMapping" DataField="IsSimpleMapping" AlignLeft="True" />
	...
	<px:PXTab ID="tab" runat="server" Height="168%" Style="z-index: 100" Width="100%">
		<Items>
							...
							<px:PXGridLevel DataMember="FieldMappings">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="ParentLineNbr" Visible="false" AllowShowHide="False"
										ForceExport="true" />
                                    <px:PXGridColumn DataField="ExecuteActionBehavior" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<CallbackCommands>
			...
			<px:PXTabItem Text="Source Restrictions">
				<Template>
					<px:PXGrid ID="gridSourceRestrictions" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
			...
			<px:PXTabItem Text="Target Restrictions">
				<Template>
					<px:PXGrid ID="gridTargetRestrictions" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
						Width="100%" AdjustPageSize="Auto" AllowSearch="True" SkinID="DetailsInTab" MatrixMode="true">
						<ActionBar>
						</ActionBar>
						<Levels>
			...
			<px:PXTabItem Text="Executed By Events" BindingContext="form" VisibleExp="DataControls[&quot;chkShowCreatedByEventsTabExpr&quot;].Value=1">
				<Template>
