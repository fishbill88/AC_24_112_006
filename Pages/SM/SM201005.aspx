	...
	<px:PXTab ID="tab" runat="server" Width="100%" Height="255px">
		<Items>
			...
			<px:PXTabItem Key="ad" Text="Active Directory">
				<Template>
					<px:PXGrid ID="gridActiveDirectory" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
			...
			<px:PXTabItem Key="ad" Text="Claims">
				<Template>
					<px:PXGrid ID="gridClaims" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
						Width="100%" ActionsPosition="Top" SkinID="DetailsInTab" >
						<Levels>
