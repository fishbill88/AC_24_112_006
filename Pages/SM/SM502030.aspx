...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.BusinessProcess.UI.BusinessProcessEventHistoryMaint" SuspendUnloading="False" PrimaryView="Filter">
         <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="viewRelatedEntity" CommitChanges="True" Visible="False" DependOnGrid="grid"/>
                ...
                <Levels>
                    <px:PXGridLevel DataMember="Events">
                        ...
                        <Columns>
                            ...
                            <px:PXGridColumn DataField="BPEvent__Type" Width="210" />
                            <px:PXGridColumn DataField="BPEvent__Active" Width="60" Type="CheckBox" AllowResize="false"/>
                            ...
                            <px:PXGridColumn DataField="Source" Width="200" LinkCommand="viewRelatedEntity" AllowSort="false" AllowFilter="false" />
                        </Columns>
                    </px:PXGridLevel>
                </Levels>
            ...
            <px:PXGrid ID="grid2" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="260px"
                ...
                <Levels>
                    <px:PXGridLevel DataMember="EventSubscribers">
                        ...
                        <Columns>
                            <px:PXGridColumn DataField="Selected" TextAlign="Center" Type="CheckBox" Width="70px" AllowResize="false" CommitChanges="True"/>
                            <px:PXGridColumn DataField="LastRunStatus" Width="60" Type="Icon" TextAlign="Center" AllowResize="false" />
                            ...
                            <px:PXGridColumn DataField="Type" Width="100" AllowUpdate="False"/>
