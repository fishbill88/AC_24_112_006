...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Caption="General Settings"
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Timeout Settings" />
			<px:PXCheckBox  ID="chkUsePreconfiguredTimeouts" runat="server" 
			                DataField="PrefsGlobal.UsePreconfiguredTimeouts" CommitChanges="True"/>
			<px:PXDropDown runat="server" ID="lstLogoutTimeout" DataField="PrefsGlobal.LogoutTimeout" 
			               CommitChanges="True" />
			<px:PXTextEdit ID="edPreconfiguredLogoutTimeout" runat="server" 
            				DataField="PrefsGlobal.PreconfiguredLogoutTimeout" />
