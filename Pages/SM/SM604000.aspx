...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds"
                     ...
                     Height="0"> <%-- Height = 0 is used to hide main toolbar but make available to run long run operation in refreshStatistics method --%>
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="refreshStatistics" Visible="True" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
                ...
                <Template>
	                <px:PXFormView  ID="mainFormView"
		                ...
		                <Template>
                            ...
                            <px:PXNumberEdit ID="edMaximumNumberOfBankFeedAccounts" runat="server" DataSourceID="ds" DataField="MaximumNumberOfBankFeedAccounts" />
		                </Template>
	                </px:PXFormView>
                </Template>
            </px:PXTabItem>
                            ...
                            <px:PXGrid ID="gridMonthly"
                                ...
                                <ActionBar ActionsVisible="true" ActionsText="False">
                                    <Actions>
                                     ...
                                     <CustomItems>
                                        <px:PXToolBarButton DisplayStyle="Text" Key="refreshStatistics" >
                                            <ActionBar GroupIndex="0" Order="2" />
                                            <AutoCallBack Command="refreshStatistics" Target="ds" />
                                        </px:PXToolBarButton>
                                    </CustomItems>
                                </ActionBar>
		                        ...
		                        <Levels>
			                        <px:PXGridLevel DataMember="LicenseStatisticDaily">
			                            <Columns>
			                                ...
			                                <px:PXGridColumn Width="200px" DataField="APITotalRequestsThrottledStats" />
                                            <px:PXGridColumn Width="200px" DataField="APIRequestsThrottledDueToConcurrencyStats" />
                                            <px:PXGridColumn Width="200px" DataField="APIRequestsThrottledDueToFrequencyStats" />
                                        </Columns>
			                        </px:PXGridLevel>
		                        </Levels>
		                        <AutoSize Enabled="True" MinHeight="200" />
								...
								<Levels>
									<px:PXGridLevel DataMember="ConstraintHistory">
										<Columns>
                                            ...
                                            <px:PXGridColumn Width="200px" DataField="NbrOfBankFeedAccounts" />
										</Columns>
									</px:PXGridLevel>
								</Levels>
								<AutoSize Enabled="True" MinHeight="200" />
