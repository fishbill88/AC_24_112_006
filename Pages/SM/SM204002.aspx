...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXSelector ID="edUserId" runat="server" DataField="UserId" AllowEdit="True" CommitChanges="true" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" DataSourceID="ds" Height="387px" Style="z-index: 100" Width="100%" DataMember="CurrentEMailAccounts" DefaultControlID="edDescription">
		<Items>
			...
			<px:PXTabItem Text="Incoming Mail Processing" BindingContext="form">
				<Template>
					...
					<px:PXCheckBox ID="chkAddIncomingProcessingTags" runat="server" DataField="AddIncomingProcessingTags" />
					...
					<px:PXCheckBox ID="edRouteEmployeeEmails" runat="server" DataField="RouteEmployeeEmails" CommitChanges="True" />
