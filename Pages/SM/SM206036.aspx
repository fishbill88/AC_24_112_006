...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Api.SYImportProcessSingle"
		...
		<CallbackCommands>
            <px:PXDSCallbackCommand Name="replace" Visible="False" DependOnGrid="gridPreparedData" />
            <px:PXDSCallbackCommand Name="addSubstitution" Visible="False" DependOnGrid="gridPreparedData" StateColumn="CanAddSubstitutions" />            <px:PXDSCallbackCommand Name="replaceOneValue" Visible="False" />
			...
			<px:PXTabItem Text="Prepared Data">
				<Template>
					<px:PXGrid ID="gridPreparedData" runat="server" DataSourceID="ds" Height="411px"
						...
						<Mode AllowAddNew="False" AllowDelete="False" AllowSort="False"/>
						<Levels>
						...
						<ActionBar PagerVisible="False">
							<CustomItems>
                                <px:PXToolBarButton Text="Replace" CommandSourceID="ds" CommandName="replace" />
                                <px:PXToolBarButton Text="Add Substitution" CommandSourceID="ds" CommandName="addSubstitution" StateColumn="CanAddSubstitutions" />
					...
					<px:PXGrid ID="grHistory" runat="server" DataSourceID="ds" Height="460px" Style="z-index: 100"
						...
						<Levels>
							<px:PXGridLevel DataMember="History">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="XM" />
									<px:PXNumberEdit ID="edStatusDate" runat="server" DataField="StatusDate" />
                                    <px:PXDateTimeEdit ID="edStatusDateToDisplay" runat="server" DataField="StatusDate" DisplayFormat="g" />
								...
								<Columns>
                                    <px:PXGridColumn DataField="StatusDateToDisplay" DisplayFormat="g" Width="120px" />
