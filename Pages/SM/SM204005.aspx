...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" Visible="True" PrimaryView="TaskTemplates" TypeName="PX.SM.TaskTemplateMaint">
		...
		<DataTrees> 
			...
			<px:PXTreeDataMember TreeView="ScreenOwnerItemsWithPaths" TreeKeys="Key"/>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="frmTask" runat="server" DataSourceID="ds" DataMember="TaskTemplates" Width="100%" DefaultControlID="edTaskTemplateID">
		<Template>
			...
			<px:PXTreeSelectorWithGrid runat="server" ID="edOwnerName" DataField="OwnerName" TreeDataSourceID="ds" PopulateOnDemand="True" InitialExpandLevel="0" ShowRootNode="false"
				MinDropWidth="468" MaxDropWidth="600" AllowEditValue="False" AppendSelectedValue="False" AutoRefresh="true"
				TreeDataMember="ScreenOwnerItemsWithPaths"
				SelectorDataMember="ScreenOwnerUserItems"
				SelectorKeyField="Path"
				SelectorDescriptionField="Name"
				HideKeyField="true"
				TreeParentId="Path"
				SelectorTabTitle="Employees">
				<DataBindings>
					<px:PXTreeItemBinding DataMember="ScreenOwnerEntityItems" TextField="Name" ValueField="Key" ToolTipField="Name" ImageUrlField="Icon" />
				</DataBindings>
            ...
            <px:PXTreeSelector runat="server" ID="edSummary" DataField="Summary" TreeDataSourceID="ds" PopulateOnDemand="True" InitialExpandLevel="0" ShowRootNode="false"
                MinDropWidth="468" MaxDropWidth="600" AllowEditValue="true" AppendSelectedValue="true" AutoRefresh="true" TreeDataMember="EntityItemsWithPrevious">
                <DataBindings>
