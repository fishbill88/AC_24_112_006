...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="formBPEvent" runat="server" DataSourceID="ds" Style="z-index: 100" 
        ...
        <Template>
            ...
            <px:PXDropDown ID="edActionName2" runat="server" DataField="ActionName2" CommitChanges="True"/>
            <px:PXCheckBox ID="ShowMassAction" runat="server" DataField="ShowMassAction" />
            <px:PXLayoutRule runat="server" />
            ...
            <px:PXCheckBox ID="chkIsTriggerConditionsVisible" runat="server" DataField="IsTriggerConditionsVisible" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100;" Width="100%" DataSourceID="ds" DataMember="CurrentEvent">
        ...
        <Items>
            <px:PXTabItem Text="Trigger Conditions" BindingContext="formBPEvent" VisibleExp="DataControls[&quot;chkIsTriggerConditionsVisible&quot;].Value"> 
                <Template>
                            ...
                            <px:PXGridLevel  DataMember="TriggerConditions">
                                <RowTemplate>
                                    <pxa:PXFormulaCombo ID="edValue" runat="server" DataField="Value" EditButton="True" FieldsAutoRefresh="True"
                                                        OnRootFieldsNeeded="edValue_RootFieldsNeeded" IsExternalVisible="False" IsInternalVisible="False"
                                                        FieldsRootAutoRefresh="true" SkinID="GI" />
                                    <pxa:PXFormulaCombo ID="edValue2" runat="server" DataField="Value2" EditButton="True" FieldsAutoRefresh="True"
                                                        OnRootFieldsNeeded="edValue_RootFieldsNeeded" IsExternalVisible="False" IsInternalVisible="False"
                                                        FieldsRootAutoRefresh="true" SkinID="GI" />
                                    <pxa:PXFormulaCombo ID="edFieldName" runat="server" DataField="FieldName" EditButton="True" FieldsAutoRefresh="True"
                                                        OnRootFieldsNeeded="edValue_RootFieldsNeeded" IsExternalVisible="False" IsInternalVisible="False"
                                                        FieldsRootAutoRefresh="true" SkinID="GI" />
                                </RowTemplate>
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="FieldName" Width="200px" MatrixMode="true" AllowStrings="True" DisplayMode="Value" CommitChanges="True" />
                                    <px:PXGridColumn DataField="Condition" Type="DropDownList" Width="200px" CommitChanges="True"/>
                                    <px:PXGridColumn DataField="IsFromSchema" Width="65px" AutoCallBack="True" AllowSort="False" TextAlign="Center" Type="CheckBox"/>
                                    <px:PXGridColumn DataField="Value" Width="200px" AllowSort="False" MatrixMode="true" AllowStrings="True" DisplayMode="Value" CommitChanges="True"/>
                                    <px:PXGridColumn DataField="Value2" Width="200px" AllowSort="False" MatrixMode="true" AllowStrings="True" DisplayMode="Value" CommitChanges="True"/>
