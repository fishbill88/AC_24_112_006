...
using PX.CloudServices.Customization.Certification;
...
public partial class Page_SM204505 : PX.Web.UI.PXPage
{
	protected void Page_Init(object sender, EventArgs e)
	{
		...
		if (ServiceLocator.Current.GetInstance<IOptions<CertificationStatusOptions>>().Value.EndpointType != CertificationEndpoint.None)
