...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXFormView ID="frmHeader" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" 
		...
		<Template>
            ...
            <px:PXTextEdit runat="server" DataField="ScreenID" ID="edScreenID" Visible="false"/>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="150px">
        ...
        <Items>
            ...
            <px:PXTabItem Text="Widgets" Visible="True">
                <Template>
                    <px:PXGrid ID="gridWidgets" runat="server" DataSourceID="ds" Width="100%" Height="150px"
                        NoteIndicator="False" FilesIndicator="False" SkinID="Inquire" AllowFilter="True">
                        <ActionBar>
                            <Actions>
                                <AddNew Enabled="False"></AddNew>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="AllWidgets">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="WidgetName" />
                                    <px:PXGridColumn DataField="SourceSetting" />
                                    <px:PXGridColumn DataField="Type" />

                                    <%-- For Copy&Paste --%>
                                    <px:PXGridColumn DataField="Workspace" Visible="False"/>
                                    <px:PXGridColumn DataField="Width" Visible="False"/>
                                    <px:PXGridColumn DataField="Height" Visible="False"/>
                                    <px:PXGridColumn DataField="Settings"  Visible="False" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
