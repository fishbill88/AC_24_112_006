	...
	<script type="text/javascript">
		function commandResult(ds, context) {
			if (context.command == "Save" || context.command == "Delete" ||
				context.command == "CopyPaste@ImportXml" ||
				context.command == "publishToUI" || context.command == "unpublish")
			{
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXTextEdit runat="server" DataField="SitemapTitle" ID="edSitemapTitle" TabIndex="2" />
		    <px:PXSelector runat="server" DataField="WorkspaceID" ID="edWorkspaceID" DisplayMode="Text" TabIndex="3" />
		    <px:PXSelector runat="server" DataField="SubcategoryID" ID="edSubcategoryID" DisplayMode="Text" TabIndex="4" />
		    ...
		    <px:PXCheckBox ID="chkShowDeletedRecords" runat="server" DataField="ShowDeletedRecords" AlignLeft="True" TabIndex="5" />
		    <px:PXCheckBox ID="chkShowArchivedRecords" runat="server" DataField="ShowArchivedRecords" AlignLeft="True" TabIndex="6" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="CurrentDesign">
		<Items>
			...
			<px:PXTabItem Text="Data Sources">
				<Template>
					<px:PXGrid ID="grdTables" runat="server" DataSourceID="ds" Height="150px" SkinID="DetailsInTab"
						...
						<Levels>
							<px:PXGridLevel  DataMember="Tables">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" 
										ControlSize="M" />
									<px:PXSelector ID="edName" runat="server" DataField="Name" DisplayMode="Text" TextMode="Editable" TextField="Title" FilterByAllFields="true"/>
									<px:PXTextEdit ID="edDescription" runat="server" DataField="Description" />
									<px:PXTextEdit ID="edAlias" runat="server" DataField="Alias" />
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="Name" Width="250px" DisplayMode="Text" LinkCommand="NavigateToDataSource" />
									<px:PXGridColumn DataField="Description" Width="250px" />
									<px:PXGridColumn DataField="Alias" Width="250px" />
									<px:PXGridColumn DataField="IsAddRelatedTableAllowed" Type="CheckBox" />
								</Columns>
						...
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton CommandName="addRelatedTable" CommandSourceID="ds" 
								                    Text="Add Related Table" DependOnGrid="grdTables" 
								                    StateColumn="IsAddRelatedTableAllowed">
								</px:PXToolBarButton>
							</CustomItems>
						</ActionBar>
							...
							<px:PXGrid ID="grdJoins" runat="server" DataSourceID="ds" Height="100%" Style="z-index: 100" Width="100%"
								...
								<ActionBar>
									<CustomItems>
										...
										<px:PXToolBarButton CommandSourceID="ds" CommandName="addRelatedTableRelations" 
											Text="Add Related Table" DependOnGrid="grdJoins"  
											StateColumn="IsAddRelatedTableAllowed">
										</px:PXToolBarButton>
									</CustomItems>
								</ActionBar>
							...
							<px:PXGrid ID="grdOns" runat="server" DataSourceID="ds" Height="200px" Width="100%" AutoAdjustColumns="True"
								...
								<ActionBar>
									<CustomItems>
										...
										<px:PXToolBarButton CommandSourceID="ds" CommandName="browseForRelation" 
											Text="Add Relations" DependOnGrid="grdJoins"
											StateColumn="IsAddRelatedTableAllowed">
										</px:PXToolBarButton>
									</CustomItems>
								</ActionBar>
						...
						<Levels>
							<px:PXGridLevel  DataMember="Parameters">
								<RowTemplate>
									...
									<px:PXDropDown ID="edName4" runat="server" DataField="Name" CommitChanges="true" AutoSuggest="True" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="Name" Type="DropDownList" Width="150px" MatrixMode="true" AutoCallBack="True" />
                    ...
                    <px:PXSplitContainer runat="server" PositionInPercent="true" SplitterPosition="25" Width="100%">
                        ...
                        <Template1>
                            <px:PXGrid ID="grdNavScreens" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Navigation Targets" SkinID="Details"
                                AutoAdjustColumns="True" CaptionVisible="True" AllowPaging="False" SyncPosition="True" NoteIndicator="False" FilesIndicator="False">
                        ...
                        <Template2>
                            <px:PXFormView ID="frmNavWindowMode" runat="server" DataMember="NavigationScreens" AllowPaging="False"> 
                                ...
                                <Template>
                                    <px:PXLayoutRule runat="server" Merge="True" ControlSize="SM" LabelsWidth="S" GroupCaption="Side Panel Settings" />
                                    <px:PXDropDown ID="edNavIcon" runat="server" DataField="Icon" CommitChanges="True" />
                                    <px:PXTextEdit ID="edNavCustomTitle" runat="server" DataField="CustomTitle" CommitChanges="True" Size="XXL"/>
                                </Template>
                            </px:PXFormView>
	...
	<px:PXSmartPanel ID="pnlCreateCopy" runat="server"  Caption="Copy Generic Inquiry"
		CaptionVisible="true" DesignView="Hidden" LoadOnDemand="false" Key="CreateCopyOrOverwriteGIDialog" CreateOnDemand="false" AutoCallBack-Enabled="true"
		AutoCallBack-Target="formCreateCopy" AutoCallBack-Command="Refresh" CallBackMode-CommitChanges="True" CallBackMode-PostData="Page"
		AcceptButtonID="btnCreateCopy2">
			<px:PXFormView ID="formCreateCopy" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" 
			               CaptionVisible="False" DataMember="CreateCopyOrOverwriteGIDialog">
				<ContentStyle BackColor="Transparent" BorderStyle="None" BorderWidth="0px" />
				<Template>
					<px:PXLayoutRule ID="lrMessage" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
					<px:PXTextEdit Size="xl" Enabled="False" TextMode="MultiLine" SuppressLabel="True" Height="100px"
					               ID="lblMessage" runat="server" Encode="True" DataField="Message" />
				</Template>
			</px:PXFormView>
			<px:PXPanel ID="pnlCreateCopyButtons" runat="server" SkinID="Buttons">
				<px:PXButton ID="btnCreateCopy1" runat="server" DialogResult="Yes" Text="Copy" />						
				<px:PXButton ID="btnCreateCopy2" runat="server" DialogResult="No" Text="Overwrite" />						
				<px:PXButton ID="btnCreateCopy3" runat="server" DialogResult="Cancel" Text="Cancel" />						
			</px:PXPanel>
	</px:PXSmartPanel>

	<px:PXSmartPanel ID="pnlDeleteUsedGI" runat="server"  Caption="Delete Generic Inquiry"
		CaptionVisible="true" DesignView="Hidden" LoadOnDemand="false" Key="DeleteUsedGIDialog" CreateOnDemand="false" AutoCallBack-Enabled="true"
		AutoCallBack-Target="formDeleteUsedGI" AutoCallBack-Command="Refresh" CallBackMode-CommitChanges="True" CallBackMode-PostData="Page"
		AcceptButtonID="btnDeleteGI1">
			<px:PXFormView ID="formDeleteUsedGI" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" 
			               CaptionVisible="False" DataMember="DeleteUsedGIDialog">
				<ContentStyle BackColor="Transparent" BorderStyle="None" BorderWidth="0px" />
				<Template>
					<px:PXLayoutRule ID="lrMessage" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
					<px:PXTextEdit Size="xxl" Enabled="False" TextMode="MultiLine" SuppressLabel="True" Height="100px"
					               ID="lblMessage" runat="server" Encode="True" DataField="Message" />
				</Template>
			</px:PXFormView>
			<px:PXPanel ID="pnlDeleteGIButtons" runat="server" SkinID="Buttons">
				<px:PXButton ID="btnDeleteGI1" runat="server" DialogResult="OK" Text="Delete" />						
				<px:PXButton ID="btnDeleteGI2" runat="server" DialogResult="Cancel" Text="Cancel" />						
			</px:PXPanel>
	</px:PXSmartPanel>

	<px:PXSmartPanel ID="pnlDeleteUsedField" runat="server"  Caption="Remove Field"
		CaptionVisible="true" DesignView="Hidden" LoadOnDemand="false" Key="DeleteUsedFieldDialog" CreateOnDemand="false" AutoCallBack-Enabled="true"
		AutoCallBack-Target="formDeleteUsedField" AutoCallBack-Command="Refresh" CallBackMode-CommitChanges="True" CallBackMode-PostData="Page"
		AcceptButtonID="btnDelete1">
			<px:PXFormView ID="formDeleteUsedField" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" 
			               CaptionVisible="False" DataMember="DeleteUsedFieldDialog">
				<ContentStyle BackColor="Transparent" BorderStyle="None" BorderWidth="0px" />
				<Template>
					<px:PXLayoutRule ID="lrMessage" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
					<px:PXTextEdit Size="xxl" Enabled="False" TextMode="MultiLine" SuppressLabel="True" Height="100px"
			...
			<px:PXPanel ID="pnlDeleteFieldButtons" runat="server" SkinID="Buttons">
				<px:PXButton ID="btnDelete1" runat="server" DialogResult="OK" Text="Remove" />						
				<px:PXButton ID="btnDelete2" runat="server" DialogResult="Cancel" Text="Cancel" />						
			</px:PXPanel>
	</px:PXSmartPanel>

	<px:PXSmartPanel ID="pnlOverwriteExistingOnImportDialog" runat="server"  Caption=""
		CaptionVisible="False" DesignView="Hidden" LoadOnDemand="false" Key="OverwriteExistingOnImportDialog" CreateOnDemand="false" AutoCallBack-Enabled="true"
		AutoCallBack-Target="formOverwriteExistingOnImportDialog" AutoCallBack-Command="Refresh" CallBackMode-CommitChanges="True" CallBackMode-PostData="Page"
		AcceptButtonID="btnOverwriteExistingOnImportDialogYes">
			<px:PXFormView ID="formOverwriteExistingOnImportDialog" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" 
			               CaptionVisible="True" Caption="Import Generic Inquiries" DataMember="OverwriteExistingOnImportDialog">
				<ContentStyle BackColor="Transparent" BorderStyle="None" BorderWidth="0px" />
				<Template>
					<px:PXLayoutRule ID="lrMessage" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
					<px:PXTextEdit Size="xxl" Enabled="False" TextMode="MultiLine" SuppressLabel="True" Height="100px"
			...
			<px:PXPanel ID="pnlOverwriteExistingOnImportDialogButtons" runat="server" SkinID="Buttons">
				<px:PXButton ID="btnOverwriteExistingOnImportDialogYes" runat="server" DialogResult="Yes" Text="Import" />						
				<px:PXButton ID="btnOverwriteExistingOnImportDialogNo" runat="server" DialogResult="No" Text="Cancel" />						
			</px:PXPanel>
	</px:PXSmartPanel>

	<!--#include file="~\Pages\Includes\PublishToUIPanel.inc"-->
</asp:Content>
