...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <script type="text/javascript">
        function copyInitiateLoginURI_Click() {
            try {
                var input = px_alls["edInitiateSignInUrl"];
                input.select();
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%"
		Caption="Provider Summary" DataMember="Providers">
            ...
            <px:PXTextEdit ID="edInitiateSignInUrl" runat="server" DataField="InitiateSignInUrl" Enabled="false" Size="M" />
            <px:PXButton ID="btnCpyInitiateLoginURI" runat="server" Text="Copy" AlignLeft="true">
                <ClientEvents Click="copyInitiateLoginURI_Click" />
            </px:PXButton>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="AutoIdentifyingUsersRules">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Verified" Type="CheckBox" />
