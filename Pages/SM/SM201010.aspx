...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<pxa:DynamicDataSource ID="ds" runat="server" Visible="True" PrimaryView="UserList" 
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ViewEMailAccount" Visible="False" CommitChanges="True" DependOnGrid="gridEMailAccounts" />
			<px:PXDSCallbackCommand Name="AddEMailAccount" Visible="False" CommitChanges="True" />
		</CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" 
		...
		<Template>
            ...
            <px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True" LabelsWidth="XM" />
		...
		<Items>
			...
			<px:PXTabItem Key="statistics" Text="Statistics">
				<Template>
					...
					<px:PXDateTimeEdit ID="edLastLoginDate" runat="server" DataField="LastLoginDate" Size="SM"/>
					<px:PXDateTimeEdit ID="edLastLockedOutDate" runat="server" DataField="LastLockedOutDate" Size="SM"/>
					<px:PXDateTimeEdit ID="edLastPasswordChangedDate" runat="server" DataField="LastPasswordChangedDate" Size="SM"/>
                    ...
                    <px:PXFormView runat="server" ID="PrefsForm" DataSourceID="ds" DataMember="UserPrefs" Width="100%" SkinID="Transparent">
                        <Template>
							...
							<px:PXSelector ID="edBranchCD" runat="server" DataField="DefBranchID" ValueField="BranchID" 
                                           TextField="BranchCD" DisplayMode="Text">
							...
							<px:PXTextEdit ID="edPacejetWorkstationID" runat="server" DataField="PacejetWorkstationID" />
                        </Template>
                    </px:PXFormView>
					<px:PXFormView runat="server" ID="formContactTeamsSettings" DataSourceID="ds" DataMember="Contact" Width="100%" SkinID="Transparent">
						<Template>
							<px:PXLayoutRule runat="server" StartColumn="True" GroupCaption="Teams Preferences" ControlSize="XL" LabelsWidth="M" />
							<px:PXTextEdit runat="server" ID="edTeamsID" CommitChanges="True" DataField="TeamsID" />
							<px:PXDropDown runat="server" ID="edDefaultTeamsClient" DataField="DefaultTeamsClient" />
						</Template>
					</px:PXFormView>
                </Template>
            </px:PXTabItem>
			...
			<px:PXTabItem Key="EmailAccounts" Text="Email Accounts">
				<Template>
					<px:PXGrid ID="gridEMailAccounts" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
								Width="100%" ActionsPosition="Top" SkinID="Details">
								<Levels>
									<px:PXGridLevel DataMember="EMailAccounts">
										<Columns>
											<px:PXGridColumn DataField="Description" LinkCommand="ViewEMailAccount"/>
											<px:PXGridColumn DataField="Address" Width="350px"/>
											<px:PXGridColumn DataField="IsActive" Width="80px" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="EmailAccountType" />
											<px:PXGridColumn DataField="AuthenticationMethod" Width="190px"/>
											<px:PXGridColumn DataField="LoginName" />
											<px:PXGridColumn DataField="ReplyAddress" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="PluginTypeName" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="IsOfPluginType" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="SenderDisplayNameSource" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="AccountDisplayName" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="AuthenticationType" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="OAuthApplicationID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="AzureTenantID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="OutcomingHostName" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="OutcomingAuthenticationRequest" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="OutcomingAuthenticationDifferent" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="OutcomingSSLRequest" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="OutcomingLoginName" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="OutcomingPort" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="OutcomingMailSender" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="IncomingHostProtocol" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="IncomingProcessing" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="AddIncomingProcessingTags" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="IncomingHostName" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="IncomingSSLRequest" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="IncomingPort" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="SendGroupMails" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="AutoReceiveDelay" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="ImapRootFolder" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="ValidateFrom" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="Timeout" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="FetchingBehavior" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="IncomingDelSuccess" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="IncomingAttachmentType" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="DeleteUnProcessed" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="ProcessUnassigned" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="ResponseNotificationID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="ConfirmReceipt" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="ConfirmReceiptNotificationID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="ProcessScenarioID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="ForbidRouting" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="Included" Visible="False" SyncVisible="false" TextAlign="Center" Type="CheckBox" />
											<px:PXGridColumn DataField="InboxCount" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="OutboxCount" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="LastSendDateTime" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="LastReceiveDateTime" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="DefaultWorkgroupID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="DefaultOwnerID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="DefaultEmailAssignmentMapID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="CreatedByID" Visible="False" SyncVisible="false" />
											<px:PXGridColumn DataField="CreatedByScreenID" Visible="False" SyncVisible="false" />
											...
											<px:PXGridColumn DataField="LastModifiedByScreenID" Visible="False" SyncVisible="false" />
								...
								<ActionBar>
									<Actions>
										<EditRecord MenuVisible="False" />
										<NoteShow MenuVisible="False" />
										<AddNew MenuVisible="False" ToolBarVisible="False" />
										<Delete MenuVisible="False" ToolBarVisible="False" />
									</Actions>
									<CustomItems>
										<px:PXToolBarButton DisplayStyle="Image" Tooltip="Add Email Account" ImageKey="RecordAdd" CommandName="AddEMailAccount" CommandSourceID="ds" />
									</CustomItems>
								</ActionBar>
							</px:PXGrid>
				</Template>
