...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" runat="server" Visible="True" PrimaryView="Notifications"
		...
		<DataTrees> 
            ...
            <px:PXTreeDataMember TreeView="EntityItemsWithPrevious" TreeKeys="Key"/>
		</DataTrees>
	</px:PXDataSource>
</asp:Content>
		...
		<Template>
		  ...
		  <px:PXTextEdit ID="edName" runat="server" DataField="Name" AlreadyLocalized="False" DefaultLocale=""  />
			<px:PXSelector ID="edScreenID" runat="server" DataField="ScreenID" DisplayMode="Hint" FilterByAllFields="true" CommitChanges="True"
				AllowEdit="True" OnEditRecord="edScreenID_OnEditRecord"
			...
			<px:PXCheckBox SuppressLabel="True" runat="server" ID="edAttachActivity" DataField="attachActivity" AlignLeft="False"/>
			...
			<px:PXTreeSelector ID="edRefNoteId" runat="server" DataField="RefNoteID"
				...
				<DataBindings>
					<px:PXTreeItemBinding DataMember="EntityItemsWithPrevious" TextField="Name" ValueField="Path" ImageUrlField="Icon" ToolTipField="Path"/>
				</DataBindings>
			</px:PXTreeSelector>
			<px:PXLayoutRule runat="server" Merge="true" LabelsWidth="S" ControlSize="L"/>
			...
			<px:PXLayoutRule runat="server" StartRow="true" LabelsWidth="S" ControlSize="L" />
			<px:PXTreeSelectorWithGrid ID="edNTo" runat="server" DataField="NTo" 
				TreeDataSourceID="ds" PopulateOnDemand="True" InitialExpandLevel="0"
				ShowRootNode="False" MinDropWidth="468" MaxDropWidth="600" AllowEditValue="true"
				AppendSelectedValue="true" AutoRefresh="true" 
				TreeDataMember="ScreenEmailItems"
				SelectorDataMember="UserEmailItems"
				...
				>
				<DataBindings>
					<px:PXTreeItemBinding DataMember="ScreenEmailItems"  TextField="Name" ValueField="Key" ImageUrlField="Icon" ToolTipField="Name" />
				</DataBindings>
			</px:PXTreeSelectorWithGrid>
			<px:PXTreeSelectorWithGrid ID="edCc" runat="server" DataField="NCc" 
				TreeDataSourceID="ds" PopulateOnDemand="True" InitialExpandLevel="0"
				ShowRootNode="false" MinDropWidth="468" MaxDropWidth="600" AllowEditValue="true"
				AppendSelectedValue="true" AutoRefresh="true" 
				TreeDataMember="ScreenEmailItems"
			...
			<px:PXTreeSelectorWithGrid ID="edNBcc" runat="server" DataField="NBcc" 
				TreeDataSourceID="ds" PopulateOnDemand="True" InitialExpandLevel="0"
				ShowRootNode="false" MinDropWidth="468" MaxDropWidth="600" AllowEditValue="true"
				AppendSelectedValue="true" AutoRefresh="true" 
				TreeDataMember="ScreenEmailItems"
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	...
	<px:PXSmartPanel ID="pnlImportSendGridDesign" runat="server" Caption="Import SendGrid Design" CaptionVisible="True"
	                 Key="SendGridDesignImportParametersView" LoadOnDemand="true" AutoCallBack-Command="Refresh"
	                 AcceptButtonID="btnImportSendGridDesignOK" CancelButtonID="btnImportSendGridDesignCancel"
	                 Height="680" Width="613" AllowResize="False">
		<px:PXFormView ID="frmImportSendGridDesign" runat="server" DataSourceID="ds" DataMember="SendGridDesignImportParametersView" SkinID="Transparent"
		               Style="">
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True"/>
				<px:PXLabel runat="server" ID="lblSendGridDesign" Text="Select design to import:" />
				<px:PXLayoutRule runat="server" ColumnWidth="100%"/>
				<px:PXSelector runat="server" ID="selSendGridDesign" DataField="DesignID" CommitChanges="True" DisplayMode="Text" setDefaultSort="False" SuppressLabel="true">
					<GridProperties >
						<Columns>
							<px:PXGridColumn DataField="UpdatedAt" SortDirection="Descending"/>
				...
				<px:PXLabel runat="server" ID="caption" Style="padding: 5px 0 20px 0; width: 100%">
					The contents and the subject of the current template will be overridden by the imported design.
				</px:PXLabel>
				<px:PXImageView ID="edImageUrl" runat="server" DataField="ThumbnailUrl"
				                Style="max-height: 100%; max-width: 100%;"/>
			</Template>
		</px:PXFormView>
		<px:PXPanel ID="pnlImportSendGridDesignButtons" runat="server" SkinID="Buttons" Style="position: absolute; bottom: 5px; right: 20px">
			<px:PXButton ID="btnImportSendGridDesignOK" runat="server" Text="Import" CommandSourceID="ds" DialogResult="OK"/>
			<px:PXButton ID="btnImportSendGridDesignCancel" runat="server" Text="Cancel" CommandSourceID="ds" DialogResult="Cancel"/>
		</px:PXPanel>
	</px:PXSmartPanel>
</asp:Content>
