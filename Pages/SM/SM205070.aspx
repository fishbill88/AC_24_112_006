...
<px:PXTab ID="tab" runat="server" Style="z-index: 100;" Width="100%">
					...
					<Levels>
						<px:PXGridLevel DataMember="Samples">
							<Columns>
								...
								<px:PXGridColumn DataField="ScreenId" Width="170" LinkCommand="actionOpenUrl" />
								<px:PXGridColumn DataField="InternalScreenId" LinkCommand="actionViewScreen" />
			...
			<Template>
				<px:PXGrid runat="server" ID="GridSqlSummary"
					...
					<Levels>
						...
						<px:PXGridLevel DataMember="SqlSummary">
							<Columns>
								...
								<px:PXGridColumn DataField="QueryHash" />
			...
			<Template>
				...
				<px:PXGrid runat="server" ID="GridTraceLog" Width="100%" Height="400px" SyncPosition="True" 
					...
					<Levels>
						...
						<px:PXGridLevel DataMember="TraceEventsLog">
							<Columns>
								...
								<px:PXGridColumn DataField="SMPerformanceInfo__ScreenId" Width="150px" LinkCommand="actionOpenUrl" />
					...
					<ActionBar PagerVisible="False" DefaultAction="buttonEventLogDetails">
						<CustomItems>
							<px:PXToolBarButton Text="View Event Details" Key="buttonEventLogDetails">
								<AutoCallBack Target="ds" Command="actionViewEventDetails"></AutoCallBack>
							</px:PXToolBarButton>
						</CustomItems>
					</ActionBar>
		...
		<px:PXGrid runat="server" ID="GridProfiler"
			...
			<Levels>
				...
				<px:PXGridLevel DataMember="Sql">
					<Columns>
						<px:PXGridColumn DataField="QueryOrderID" Visible="false" SyncVisible="false" />
						<px:PXGridColumn DataField="SqlId" Visible="false" SyncVisible="false" />
						<px:PXGridColumn DataField="TableList" Width="300" />
						<px:PXGridColumn DataField="SQLHash" />
	...
	<px:PXSmartPanel runat="server" ID="PanelEventLogDetails" Width="50%" Height="680px"
		...
		AutoRepaint="True" Key="TraceEventsLog">
