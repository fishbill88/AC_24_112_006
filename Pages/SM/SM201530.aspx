...
<asp:Content ID="Content2" ContentPlaceHolderID="phF" runat="Server">
                    ...
                    <px:PXGrid runat="server" ID="grid" Width="100%" Height="100%" DataSourceID="ds" AutoGenerateColumns="Recreate" SkinID="Details" Caption="Operations" SyncPosition="true">
                                ...
                                <ActionBar PagerVisible="False" DefaultAction="buttonStop">
                                    ...
                                    <CustomItems>
                                        ...
                                        <px:PXToolBarButton Text="CREATE MEMORY DUMP" CommandSourceID="ds">
                                            <AutoCallBack Target="ds" Command="actionCreateMemoryDump"></AutoCallBack>
                                        </px:PXToolBarButton>
                                    </CustomItems>
                                </ActionBar>
                                <Levels>
					    ...
					    <Levels>
						    <px:PXGridLevel DataMember="Samples" SortOrder="RequestStartTime DESC">
							    <Columns>
								    ...
								    <px:PXGridColumn DataField="ScreenId" Width="170" Type="HyperLink" />
								    <px:PXGridColumn DataField="UrlToScreen" Type="HyperLink" />
	...
	<px:PXSmartPanel ID="PXSmartPanelCreateMemoryDump" runat="server" Caption="Create Memory Dump" CaptionVisible="True" AutoRepaint="True" Key="ViewMemoryDumpOptions" AllowResize="false">
		<px:PXFormView ID="ViewMemoryDumpOptions" runat="server" DataMember="ViewMemoryDumpOptions" DataSourceID="ds" AutoRepaint="True" SkinID="Transparent">
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True" SuppressLabel="True"/>
				<px:PXGroupBox RenderStyle="Simple" ID="PXGroupBoxDumpContentType" runat="server" CommitChanges="True" DataField="DumpContentType" Width="600px">
					<Template>
						<px:PXLayoutRule runat="server" Merge="False" LabelsWidth="M" ControlSize="XM" />
						<px:PXRadioButton runat="server" ID="PXRadioButtonDumpContentTypeMini" Value="0" Text="Running Processes Only (Mini-Dump)" />
						<px:PXRadioButton runat="server" ID="PXRadioButtonDumpContentTypeFull" Value="1" Text="Full Memory Dump" />
					</Template>
				</px:PXGroupBox>
				<px:PXTextEdit
					runat="server"
					ID="PXTextEditDumpInformation"
					Encode="True"
					DataField="InformationMessage"
					TextMode="MultiLine"
		...
		<px:PXPanel ID="PXPanelCreateMemoryDump" runat="server" SkinID="Buttons">
			<px:PXButton ID="PXButtonCreateMemoryDumpCreate" runat="server" DialogResult="Yes" Text="Create"/>
			<px:PXButton ID="PXButtonCreateMemoryDumpCancel" runat="server" DialogResult="Cancel" Text="Cancel" />
		</px:PXPanel>
		<style type="text/css">
			#ctl00_phF_PXSmartPanelCreateMemoryDump_ViewMemoryDumpOptions_PXTextEditDumpInformation, #ctl00_phF_PXSmartPanelCreateMemoryDump_ViewMemoryDumpOptions_PXTextEditDumpWarning
			{
				border: 0px;
			}
			#ctl00_phF_PXSmartPanelCreateMemoryDump_ViewMemoryDumpOptions_PXTextEditDumpWarning
			{
