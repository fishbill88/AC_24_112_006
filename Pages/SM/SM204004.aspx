	...
	<px:PXFormView ID="PXFormView1" runat="server" DataSourceID="ds" DataMember="Notifications"
		...
		<Template>
			<px:PXPanel ID="PXPanel1" runat="server" RenderStyle="Simple" Style="margin: 10px; padding: 10px;">
				...
				<px:PXTreeSelectorWithGrid ID="edNTo" runat="server" DataField="NTo" PopulateOnDemand="True"
					...
					<DataBindings>
						<px:PXTreeItemBinding DataMember="ScreenUserItems" TextField="Name" ValueField="Key" ImageUrlField="Icon" ToolTipField="Path" />
					</DataBindings>
				...
				<px:PXTreeSelector ID="edsubject" runat="server" DataField="Subject" 
					...
					AppendSelectedValue="True" AutoRefresh="True" TreeDataMember="EntityItemsWithPrevious" >
					<DataBindings>
				...
				<Template>
                   <px:PXToolBar ID="textAreaBtns" runat="server" SkinID="">
                    ...
                    <px:PXTextEdit ID="edBody" runat="server" DataField="Body" AlreadyLocalized="False" TextMode="MultiLine"
                        SuppressLabel="true" Width="100%" SelectOnFocus="false" SkinID="RichText" >
