...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<pxa:DynamicDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Prefs"
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand CommitChanges="True" Name="ViewUser" Visible="False" DependOnGrid="gridEMail" />
		</CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Caption="General Settings"
		...
		<Template>
			...
			<px:PXDropDown ID="edEmailProcessingLogging" runat="server" DataField="EmailProcessingLogging" />
			<px:PXDropDown ID="edEmailProcessingLoggingRetentionPeriod" runat="server" DataField="EmailProcessingLoggingRetentionPeriod" />
		...
		<Levels>
			<px:PXGridLevel DataMember="EMailAccounts">
				<Columns>
					...
					<px:PXGridColumn DataField="UserId" LinkCommand="ViewUser" />
