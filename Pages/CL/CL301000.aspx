        ...
        <Items>
            <px:PXTabItem Text="Lien Waiver Settings">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" GroupCaption="Actions for Outstanding Lien Waivers" StartGroup="True" />
                    ...
                    <px:PXCheckBox AlignLeft="True" runat="server" ID="chkShouldGenerateConditional" DataField="ShouldGenerateConditional" 
                                   CommitChanges="True" />
                     <px:PXCheckBox AlignLeft="True" runat="server" ID="chkGenerateWithoutCommitmentConditional" DataField="GenerateWithoutCommitmentConditional" 
                                   CommitChanges="True" />
                    ...
                    <px:PXDropDown runat="server" ID="edGroupByConditional" DataField="GroupByConditional" />
                    ...
                    <px:PXCheckBox AlignLeft="True" runat="server" ID="chkShouldGenerateUnconditional" DataField="ShouldGenerateUnconditional" 
                                   CommitChanges="True" />
                    <px:PXCheckBox AlignLeft="True" runat="server" ID="chkGenerateWithoutCommitmentUnconditional" DataField="GenerateWithoutCommitmentUnconditional" 
                                   CommitChanges="True" />
                    ...
                    <px:PXDropDown runat="server" ID="edGroupByUnconditional" DataField="GroupByUnconditional" />
                </Template>
            </px:PXTabItem>
