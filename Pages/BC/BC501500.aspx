...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
  <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="ProcessFilter" Width="100%" Height="" AllowAutoHide="false">
    <Template>
      ...
      <px:PXDropDown runat="server" ID="CstPXDropDown7" DataField="EntityType" CommitChanges="True"  AutoSuggest="False" ></px:PXDropDown>
      
	  <px:PXLayoutRule LabelsWidth="SM" ControlSize="SM" runat="server" ID="PXLayoutRule2" StartColumn="True" ></px:PXLayoutRule>
	  <px:PXDropDown runat="server" ID="edRowsToProcess" DataField="RowsToProcess" CommitChanges="True" ></px:PXDropDown>
	</Template>
			...
			<px:PXGridLevel DataMember="Statuses">
				<Columns >
				  ...
				  <px:PXGridColumn LinkCommand="NavigateExtern" DataField="ExternID" Width="140" ></px:PXGridColumn>
					<px:PXGridColumn DataField="ExternDescription" Width="280"></px:PXGridColumn>
