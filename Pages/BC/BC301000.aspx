			...
			<Levels>
				<px:PXGridLevel DataMember="StatusDetailsPanel">
					<Columns>
						...
						<px:PXGridColumn DataField="LocalID" Width="200" LinkCommand="NavigateDetailLocal" />
						<px:PXGridColumn DataField="Source" Width="200" LinkCommand="NavigateDetailLocal" />
						<px:PXGridColumn DataField="ExternID" Width="200" LinkCommand="NavigateDetailExtern" />
					</Columns>
				</px:PXGridLevel>
			</Levels>
