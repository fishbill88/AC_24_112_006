		...
		<Items>
			<px:PXTabItem Visible="True" Text="Connection Settings">
				<Template>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingShopify" runat="server" ID="frmStorePreferences">
						<Template>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentStore" runat="server" ID="frmCurrencyZone">
						<Template>
							<px:PXLayoutRule StartColumn="True" ControlSize="L" LabelsWidth="SM" runat="server" ID="PXLayoutRule1" StartRow="True"></px:PXLayoutRule>
							<px:PXTextEdit runat="server" ID="edDefaultCurrency" DataField="DefaultStoreCurrency"></px:PXTextEdit>
							<px:PXTextEdit runat="server" ID="edSupportedCurrencies" DataField="SupportedCurrencies"></px:PXTextEdit>
							<px:PXTextEdit runat="server" ID="edStoreTimeZone" DataField="StoreTimeZone"></px:PXTextEdit>
						</Template>
					</px:PXFormView>
			...
			<px:PXTabItem Text="Entity Settings">
				<Template>
					<px:PXGrid MatrixMode="True" runat="server" SkinID="Details" Width="100%" ID="CstPXGrid60" SyncPosition="true">
			...
			<px:PXTabItem Text="Customer Settings">
				<Template>
					...
					<px:PXCheckbox runat="server" ID="CstPXSelectorUseMultipleGuestAccounts" DataField="MultipleGuestAccounts"></px:PXCheckbox>
				</Template>
				<ContentLayout ControlSize="XM" LabelsWidth="M"></ContentLayout>
			</px:PXTabItem>
			<px:PXTabItem Text="Inventory Settings">
				<Template>
					<px:PXLayoutRule ControlSize="L" LabelsWidth="M" runat="server" ID="CstPXLayoutRule56" StartGroup="True" GroupCaption="Export Settings"></px:PXLayoutRule>
					...
					<px:PXLayoutRule ControlSize="L" GroupCaption="Import Settings" ID="ImportSettingsHeader" LabelsWidth="M" runat="server" StartGroup="True" StartColumn="True"/>
					<px:PXSelector AllowEdit="True" CommitChanges="True" DataField="InventoryNumberingID" ID="InventoryNumberingID" runat="server" />					
					<px:PXSegmentMask runat="server" DataField="InventoryTemplate" ID="CstPXSegmentMask30"></px:PXSegmentMask>			
					<px:PXSelector AllowEdit="True" CommitChanges="True" DataField="ProductItemClassSubstitutionListID" ID="ProductItemClassSubstitutionListID" runat="server" />							
					<px:PXSelector AllowEdit="True" CommitChanges="True" DataField="StockItemClassID" ID="StockItemClassID" runat="server" />
					<px:PXSelector AllowEdit="True" CommitChanges="True" DataField="NonStockItemClassID" ID="NonStockItemClassID" runat="server" />
					</Template>
			</px:PXTabItem>
			<px:PXTabItem Text="Order Settings">
				<Template>
					...
					<px:PXDropDown runat="server" ID="edOrderExportTypes" DataField="OtherSalesOrderTypes"></px:PXDropDown>
					...
					<px:PXCheckBox runat="server" ID="cbAllowOrderEdit" DataField="AllowOrderEdit"></px:PXCheckBox>
					...
					<px:PXSelector CommitChanges="True" AllowEdit="False" runat="server" ID="PXSelector4" DataField="ShippingCarrierListID"></px:PXSelector>
					<px:PXLayoutRule ControlSize="L" LabelsWidth="M" runat="server" ID="CstPXLayoutRule8511" StartColumn="True"></px:PXLayoutRule>
					<px:PXLayoutRule GroupCaption="Point-Of-Sale Orders" runat="server" ID="PXLayoutRule234" StartGroup="True"></px:PXLayoutRule>
					...
					<px:PXLayoutRule GroupCaption="Direct POS Orders" runat="server" ID="PXLayoutRule2" StartGroup="True"></px:PXLayoutRule>
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingShopify" runat="server" ID="PXFormView2342">
						<Template>
							<px:PXLayoutRule StartColumn="True" LabelsWidth="SM" ControlSize="M" runat="server" ID="PXLayoutRule234" StartRow="True"></px:PXLayoutRule>
							...
							<px:PXSelector CommitChanges="True" AllowEdit="True" runat="server" ID="PXSelectorPosDEOType" DataField="POSDirectExchangeOrderType"></px:PXSelector>
						</Template>
					</px:PXFormView>
					<px:PXLayoutRule GroupCaption="Shipped POS Orders" runat="server" ID="PXLayoutRule3" StartGroup="True"></px:PXLayoutRule>
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingShopify" runat="server" ID="PXFormView2343">
						<Template>
							<px:PXLayoutRule StartColumn="True" LabelsWidth="SM" ControlSize="M" runat="server" ID="PXLayoutRule234" StartRow="True"></px:PXLayoutRule>
							...
							<px:PXSelector CommitChanges="True" AllowEdit="True" runat="server" ID="PXSelectorPosSEOType" DataField="POSShippingExchangeOrderType"></px:PXSelector>
						</Template>
					</px:PXFormView>
			...
			<px:PXTabItem Text="Payment Settings">
				<Template>
					<px:PXSplitContainer runat="server" ID="sp1" SplitterPosition="300" SkinID="Horizontal" Height="500px">
						...
						<Template1>
							<px:PXGrid SyncPosition="True" AutoAdjustColumns="True" runat="server" ID="PaymentsMethods"  MatrixMode="True"  SkinID="DetailsInTab" Width="100%">
						...
						<Template2>
							<px:PXGrid CaptionVisible="True" AutoAdjustColumns="True" MatrixMode="" SyncPosition="True" SkinID="Details"
								Width="100%" runat="server" ID="FeeMappings" Caption="Shopify Fees">
								<Levels>
									<px:PXGridLevel DataMember="FeeMappings" >
									<Columns>
										<px:PXGridColumn CommitChanges="True" DisplayMode="Text" DataField="FeeType" Width="220" ></px:PXGridColumn>
										<px:PXGridColumn CommitChanges="True" DisplayMode="Value" DataField="EntryTypeID" Width="120" ></px:PXGridColumn>
										<px:PXGridColumn DataField="EntryDescription" Width="220" ></px:PXGridColumn>
										<px:PXGridColumn DataField="TransactionType" Width="70" ></px:PXGridColumn></Columns>
									<RowTemplate>
										<px:PXSelector AutoRefresh="True" runat="server" ID="CstPXSelector113" DataField="EntryType"></px:PXSelector>
									</RowTemplate>
									</px:PXGridLevel>
								</Levels>
