		...
		<Items>
			<px:PXTabItem Text="Connection Settings">
				<Template>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBinding" runat="server" ID="frmLocale">
						<Template>
			...
			<px:PXTabItem Text="Inventory Settings">
				<Template> 
					...
					<px:PXSelector runat="server" ID="CstPXSelector29" DataField="InventoryNumberingID" AllowEdit="True"  CommitChanges="True"></px:PXSelector>
					<px:PXSegmentMask runat="server" DataField="InventoryTemplate" ID="InventoryTemplate"></px:PXSegmentMask>
						...
						<Levels>
							<px:PXGridLevel DataMember="PaymentMethods">
								<Columns>
								   ...
								   <px:PXGridColumn TextAlign="Center" Type="CheckBox" DataField="CreatePaymentfromOrder" Width="120" ></px:PXGridColumn>
								</Columns>								
								<RowTemplate>
