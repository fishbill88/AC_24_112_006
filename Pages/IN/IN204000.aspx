    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="621px" DataSourceID="ds" DataMember="siteaccounts">
        ...
        <Items>
            <px:PXTabItem Text="Locations">
                <Template>
                    <px:PXPanel ID="locationForm" runat="server" Style="z-index: 100" Width="100%" CaptionVisible="False">
                        ...
                        <px:PXSegmentMask ID="edNonStockPickingLocationID" runat="server" DataField="NonStockPickingLocationID" DataSourceID="ds" AutoRefresh="True" CommitChanges="True"/>
                    </px:PXPanel>
			...
			<px:PXTabItem Text="Manufacturing">
				<Template>
                    <px:PXPanel ID="mfgForm" runat="server" Style="z-index: 100" Width="100%" CaptionVisible="False">
			...
			<px:PXTabItem Text="Inventory Planning">
				<Template>
                    <px:PXPanel ID="mfgForm2" runat="server" Style="z-index: 100" Width="100%" CaptionVisible="False">
					    <px:PXLayoutRule runat="server" StartColumn="True" StartGroup="True" GroupCaption="Inventory Planning Settings" />
					    <px:PXLayoutRule runat="server" Merge="True" LabelsWidth="M" ColumnWidth="M" />
                    ...
                    <px:PXGrid ID="grid2" runat="server" DataSourceID="ds" SkinID="DetailsWithFilter" Caption="Transfer Lead Time" AdjustPageSize="Auto" AllowPaging="True" Width="100%" SyncPosition="true">
                        <ActionBar>
                            <Actions>
                                <FilesMenu Enabled="True" />
                            </Actions>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="AMLeadTimes" DataKeyNames="SiteID,TransferSiteID">
                                <RowTemplate>
                                    <px:PXSegmentMask ID="edRepWarehouse" runat="server" DataField="TransferSiteID"></px:PXSegmentMask>
                                    <px:PXNumberEdit ID="edTransferLeadTime" runat="server" DataField="TransferLeadTime" ValueType="Int16" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="TransferSiteID" CommitChanges="true"/>
                                    <px:PXGridColumn DataField="TransferLeadTime" CommitChanges="true" TextAlign="Right" />
                                </Columns>
                                <Layout FormViewHeight="" />
                            </px:PXGridLevel>
                        </Levels>
