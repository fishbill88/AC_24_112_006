            ...
            <px:PXTabItem Text="Storage">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="144px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%"
                        AdjustPageSize="Auto" AllowPaging="True" AllowSearch="True" Caption="Storage Summary" SkinID="PrimaryInquire"
                        TabIndex="8" RestrictFields="True" SyncPosition="true" FastFilterFields="InventoryID,SiteID">
                        <Mode AllowAddNew="False" AllowUpdate="False" AllowDelete="False" AllowColMoving="False" AllowSort="False" />
                        <Levels>
