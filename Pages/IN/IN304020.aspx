...
<!--#include file="~\Pages\Includes\BarcodeSupport\ScanFieldInit.inc"-->
<!--#include file="~\Pages\Includes\BarcodeSupport\SoundResponse.inc"-->
...
<asp:content id="cont2" contentplaceholderid="phF" runat="Server">
    <px:PXFormView ID="formHeader" runat="server" DataSourceID="ds" Height="120px" Width="100%" Visible="true" DataMember="HeaderView" DefaultControlID="edBarcode">
        <Template>
            ...
            <px:PXSelector ID="edTransferToSiteID" runat="server" DataField="TransferToSiteID" CommitChanges="true" AutoRefresh="true" AutoComplete="false" Enabled="false" />
    ...
    <px:PXSmartPanel ID="PanelSettings" runat="server" Caption="Settings" CaptionVisible="True" ShowAfterLoad="true"
        ...
        <px:PXFormView ID="frmSettings" runat="server" DataSourceID="ds" DataMember="UserSetupView" SkinID="Transparent" >
            <Template>
                ...
                <px:PXCheckBox ID="edUseDefaultLotSerialNbr" runat="server" DataField="UseDefaultLotSerialNbr" CommitChanges="true" />
