		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXSelector CommitChanges="True" ID="edAssemblyDisassemblyReasonCodeReasonCode" runat="server" DataField="AssemblyDisassemblyReasonCode" AllowEdit="True" />
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Inventory Turnover Settings" />
					<px:PXLabel ID="lblIncudeToTurnover" runat="server" Text="Calculation Rules:"/>
					<px:PXCheckBox ID="chkIncludeSaleInTurnover" runat="server" DataField="IncludeSaleInTurnover" SuppressLabel="True" />
					<px:PXCheckBox ID="chkIncludeProductionInTurnover" runat="server" DataField="IncludeProductionInTurnover" SuppressLabel="True" />
					<px:PXCheckBox ID="chkIncludeAssemblyInTurnover" runat="server" DataField="IncludeAssemblyInTurnover" SuppressLabel="True" />
					<px:PXCheckBox ID="chkIncludeIssueInTurnover" runat="server" DataField="IncludeIssueInTurnover" SuppressLabel="True" />
					<px:PXCheckBox ID="chkIncludeTransferInTurnover" runat="server" DataField="IncludeTransferInTurnover" SuppressLabel="True" />
				</Template>
			</px:PXTabItem>
