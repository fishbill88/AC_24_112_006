...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="selSpecialOrderCostCenterID" runat="server" DataField="SpecialOrderCostCenterID" AutoRefresh="True" />
                                    <px:PXSelector ID="selToSpecialOrderCostCenterID" runat="server" DataField="ToSpecialOrderCostCenterID" AutoRefresh="True" />
                                    <px:PXSegmentMask CommitChanges="True" ID="edProjectID" runat="server" DataField="ProjectID" AutoRefresh="true" />
                                    <px:PXSegmentMask CommitChanges="True" ID="edToProjectID" runat="server" DataField="ToProjectID" AutoRefresh="true" />
                                </RowTemplate>
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CostLayerType" CommitChanges="true" MatrixMode="true" />
                                    <px:PXGridColumn DataField="SpecialOrderCostCenterID" CommitChanges="true" />
                                    ...
                                    <px:PXGridColumn DataField="ToCostLayerType" CommitChanges="true" MatrixMode="true" />
                                    <px:PXGridColumn DataField="ToSpecialOrderCostCenterID" CommitChanges="true" />
    ...
    <px:PXSmartPanel ID="PanelAddSiteStatus" runat="server" Key="ItemInfo" LoadOnDemand="true" Width="900px" Height="500px"
