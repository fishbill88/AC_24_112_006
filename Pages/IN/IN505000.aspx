...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds"
		...
		<Template>
            ...
            <px:PXLayoutRule runat="server" Merge="True" LabelsWidth="S" ControlSize="XM" />
			...
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XXS" SuppressLabel="True" />
			<px:PXLayoutRule runat="server" Merge="True" LabelsWidth="M" ControlSize="XXS" SuppressLabel="True" />
				<px:PXCheckBox CommitChanges="True" ID="chkRebuildHistory" runat="server" DataField="RebuildHistory" />	
				<px:PXSelector Size="S" ID="edFinPeriodID" runat="server" DataField="FinPeriodID" CommitChanges ="true" SuppressLabel="true" />
			<px:PXLayoutRule runat="server" Merge="False" SuppressLabel="true" />
			<px:PXCheckBox CommitChanges="True" ID="chkReplanBackorders" runat="server" DataField="ReplanBackorders" />
			<px:PXCheckBox CommitChanges="True" ID="chkShowOnlyAllocatedItems" runat="server" DataField="ShowOnlyAllocatedItems" />
		</Template>
	</px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	...
	BatchUpdate="true" AllowPaging="true" AdjustPageSize="Auto" TabIndex="100" 
		SkinID="PrimaryInquire" Caption="Details" FilesIndicator="true" NoteIndicator="true">	
	    <Levels>
