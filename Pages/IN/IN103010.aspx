...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INAccessDetailByClass" PrimaryView="Class">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="First" StartNewGroup="True" HideText="True"/>
            <px:PXDSCallbackCommand Name="Prev" HideText="True"/>
            <px:PXDSCallbackCommand Name="Next" HideText="True"/>
            <px:PXDSCallbackCommand Name="Last" HideText="True"/>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Item Class" DataMember="Class"
        ...
        <Template>
            ...
            <px:PXSegmentMask ID="edItemClassID" runat="server" DataField="ItemClassCD" AutoGenerateColumns="true">
