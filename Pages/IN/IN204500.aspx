        ...
        <Items>
            ...
            <px:PXTabItem Text="Inventory Planning" RepaintOnDemand="False">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True"  GroupCaption="Planning Method Settings" ></px:PXLayoutRule>
                    <px:PXDropDown runat="server" ID="dpPlanningMethod" DataField="PlanningMethod" CommitChanges="True" />
                    <px:PXFormView RenderStyle="Simple" runat="server" ID="PlanningReplenishmentSettingsForm" DataMember="PlanningReplenishmentSettings">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" GroupCaption="Replenishment Settings" />
                    ...
                    <px:PXFormView runat="server" RenderStyle="Simple" ID="frmInventoryPlanningSettings" DataMember="inventoryPlanningSettings">
                        <Template>
                            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" GroupCaption="Inventory Planning Settings" />
                            <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Inventory Planning Settings" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXDropDown runat="server" CommitChanges="True" ID="edAMReplenishmentSource" DataField="AMReplenishmentSource" />
                            ...
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXSegmentMask CommitChanges="True" ID="edSourceSiteID" runat="server" DataField="AMSourceSiteID" />
                            <px:PXCheckBox runat="server" CommitChanges="True" DataField="AMSourceSiteIDOverride" ID="chkAMSourceSiteIDOverride" /> 
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            ...
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXNumberEdit runat="server" ID="edTransferLeadTime" DataField="AMTransferLeadTime" />
                            <px:PXCheckBox runat="server" CommitChanges="True" DataField="AMTransferLeadTimeOverride" ID="chkAMTransferLeadTimeOverride" />
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                    ...
                    <px:PXFormView ID="preferedVendorFieldsForm" RenderStyle="Simple" runat="server" DataMember="preferedVendorFields">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="XM" GroupCaption="Preferred Parameters" />
                            <px:PXCheckBox CommitChanges="True" ID="chkPreferredVendorOverride" runat="server" DataField="PreferredVendorOverride" ></px:PXCheckBox>
                            <px:PXSegmentMask CommitChanges="True" ID="edPreferredVendorID" runat="server" DataField="PreferredVendorID" AllowEdit="True" ></px:PXSegmentMask>
                            <px:PXSegmentMask ID="edPreferredVendorLocationID" runat="server" DataField="PreferredVendorLocationID" AutoRefresh="True" ></px:PXSegmentMask>
                            <px:PXSegmentMask ID="edInventoryItem__DefaultSubItemID" runat="server" DataField="InventoryItem__DefaultSubItemID" ></px:PXSegmentMask>
                        </Template>
                    </px:PXFormView>
                    <px:PXFormView ID="preferredForm" RenderStyle="Simple" runat="server" DataMember="PreferredVendorItem" CaptionVisible="False" >
                        <Template>
                            ...
                            <px:PXNumberEdit ID="edERQ" runat="server" DataField="ERQ" Enabled="False" />
                        </Template>
                    </px:PXFormView> 
                    <px:PXFormView runat="server" RenderStyle="Simple" ID="frmProductionDefaults" DataMember="productionOrderDefaultSettings">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="XM" GroupCaption="Production Order Defaults" />
                            <px:PXLayoutRule runat="server" Merge="True" />                            
                            <px:PXDropDown CommitChanges="true" ID="edAMReplenishmentSource" runat="server" DataField="AMReplenishmentSource"/>
                            <px:PXCheckBox CommitChanges="True" ID="chkAMReplenishmentSourceOverride" runat="server" DataField="AMReplenishmentSourceOverride" />
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXSegmentMask CommitChanges="True" ID="edSourceSiteID" runat="server" DataField="AMSourceSiteID" />
                            <px:PXCheckBox runat="server" CommitChanges="True" DataField="AMSourceSiteIDOverride" ID="chkAMSourceSiteIDOverride" /> 
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXNumberEdit ID="edAMMinOrdQty" runat="server" DataField="AMMinOrdQty" />
                            <px:PXCheckBox CommitChanges="True" ID="chkAMMinOrdQtyOverride" runat="server" DataField="AMMinOrdQtyOverride" />

                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXNumberEdit ID="edAMMaxOrdQty" runat="server" DataField="AMMaxOrdQty" />
                            <px:PXCheckBox CommitChanges="True" ID="chkAMMaxOrdQtyOverride" runat="server" DataField="AMMaxOrdQtyOverride" />   
                            
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXNumberEdit ID="edAMLotSize" runat="server" DataField="AMLotSize" />
                            <px:PXCheckBox CommitChanges="True" ID="chkAMLotSizeOverride" runat="server" DataField="AMLotSizeOverride" />                              

                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXNumberEdit ID="edAMMFGLeadTime" runat="server" DataField="AMMFGLeadTime" />
                            <px:PXCheckBox CommitChanges="True" ID="chkAMMFGLeadTimeOverride" runat="server" DataField="AMMFGLeadTimeOverride" />  
                        </Template>
                    </px:PXFormView>  
			...
			<px:PXTabItem Text="Manufacturing" RepaintOnDemand="False">
                <Template>
                    <px:PXFormView RenderStyle="Simple" runat="server" ID="manufacturingSettingsForm" DataMember="manufacturingSettings">
                        <Template>
                            ...
                            <px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="XM" GroupCaption="Production Order Defaults" />
                            <px:PXLayoutRule runat="server" />
                            <px:PXDropDown runat="server" ID="edAMReplenishmentSource" Enabled="false" DataField="ReplenishmentSource" />
                            <px:PXLayoutRule runat="server" />
