...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="TXSetupRecord" Caption="Tax Preferences" AllowCollapse="False" DefaultControlID="edTaxRoundingGainAcctID" TabIndex="100">
		<Template>
			...
			<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="ECM Settings" StartColumn="False" />
			<px:PXSelector ID="edECMProvider" runat="server" DataField="ECMProvider" CommitChanges="true" />
		</Template>
