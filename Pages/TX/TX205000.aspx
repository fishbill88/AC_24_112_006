				...
				<Template >
					<px:PXFormView ID="GLAccountsLocation" runat="server" DataMember="CurrentTax" SkinID="Transparent">
						<Template>
							...
							<px:PXSegmentMask ID="edOnARPrepaymentTaxAcctID" runat="server" DataField="OnARPrepaymentTaxAcctID" CommitChanges="true" />
							<px:PXSegmentMask ID="edOnARPrepaymentTaxSubID" runat="server" DataField="OnARPrepaymentTaxSubID" />
