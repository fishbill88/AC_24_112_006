...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="TxCategory" Caption="Tax Category" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="true" ActivityField="NoteActivity">
		<Template>
			...
			<px:PXCheckBox ID="chkTaxCatFlag" runat="server" DataField="TaxCatFlag"  CommitChanges="True"/>
		...
		<Levels>
			<px:PXGridLevel DataMember="Details">
				...
				<RowTemplate>
					...
					<px:PXCheckBox ID="edTax__DirectTax" runat="server" DataField="Tax__DirectTax" />
				</RowTemplate>
			</px:PXGridLevel>
		</Levels>
