    ...
    <px:PXTab ID="tab" runat="server" Height="200px" Style="z-index: 100;" Width="100%"
		...
		<Items>
		    <px:PXTabItem Text="Cash Account Settings">
                <Template>
                    <px:PXGrid ID="gridDetailsCA" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
            ...
            <px:PXTabItem Text="Vendor Payment Settings">
                <Template>
                    <px:PXGrid ID="gridDetailsAP" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
                        Width="100%" ActionsPosition="Top" TabIndex="20"
                        SkinID="Details">
                        <Levels>
