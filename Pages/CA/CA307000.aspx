...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	...
	SelectedIndexExpr='<%#
		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									...
									<px:PXGridColumn DataField="DisplayCardType" />
			...
			<px:PXTabItem Text="Transactions Excluded from Deposit" LoadOnDemand="False" RepaintOnDemand="False" >
				<Template>
						...
						<Levels>
							<px:PXGridLevel DataMember="CardTypeSummary">
								<RowTemplate>
									...
									<px:PXMaskEdit ID="edprocCenterCardTypeCode" runat="server" DataField="DisplayCardType" />
