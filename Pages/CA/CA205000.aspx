...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="ProcessingCenter" TypeName="PX.Objects.CA.CCProcessingCenterMaint" HeaderDescriptionField="Name">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Visible="false" Name="ImportTerminals" CommitChanges="True" DependOnGrid="drgPosTerminals" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="ProcessingCenter" Caption="Credit Card Processing Center" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True"
		...
		<Template>
			...
			<px:PXCheckBox ID="chkAcceptPOSPayments" CommitChanges="true" runat="server" DataField="AcceptPOSPayments" AlignLeft="true" />
			<px:PXCheckBox ID="chkAllowUnlinkedRefund" CommitChanges="true" runat="server" DataField="AllowUnlinkedRefund" AlignLeft="true" />
			<px:PXCheckBox ID="chkAllowPayLink" CommitChanges="true" runat="server" DataField="AllowPayLink" AlignLeft="true" />
		</Template>
	</px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataMember="CurrentProcessingCenter">
		<Items>
			...
			<px:PXTabItem BindingContext="form" Text="Payment Links" VisibleExp="DataControls[&quot;chkAllowPayLink&quot;].Value == true">
				<Template>
					...
					<px:PXCheckBox AlignLeft="True" ID="chkPayLinkAllowPartialPayment" runat="server" DataField="AllowPartialPayment" CommitChanges="True" />
					<px:PXSelector ID="PXSelector1" runat="server" DataField="WebhookID" AutoRefresh="True" DataSourceID="ds" AllowEdit="true" />
					</px:PXPanel>
					<px:PXGrid ID="gridProcCenterBranch" SyncPosition="true" runat="server" DataSourceID="ds" Height="100%" Width="100%" SkinID="DetailsInTab">
						<Levels>
							<px:PXGridLevel DataMember="ProcCenterBranch">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
									<px:PXSegmentMask CommitChanges="True" ID="edBranchID" runat="server"
											 DataField="BranchID" DataSourceID="ds" />
									<px:PXCheckBox ID="chkDefault" runat="server" DataField="DefaultForBranch"  />
									<px:PXSelector ID="edCCDPaymentMethodID" runat="server" DataField="CCPaymentMethodID" AutoRefresh="true" CommitChanges="true" />
									<px:PXSelector ID="edCCCashAccountID" runat="server" DataField="CCCashAccountID" AutoRefresh="true" CommitChanges="true" />	

									<px:PXSelector ID="edEFTPaymentMethodID" runat="server" DataField="EFTPaymentMethodID" AutoRefresh="true" CommitChanges="true" />
									<px:PXSelector ID="edEFTashAccountID" runat="server" DataField="EFTCashAccountID" AutoRefresh="true" CommitChanges="true" />	
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="BranchID" CommitChanges="true" />
									<px:PXGridColumn DataField="DefaultForBranch" Type="CheckBox"  Width="100px"/>
									<px:PXGridColumn DataField="CCPaymentMethodID" DisplayMode="Hint" CommitChanges="true" Width="200px" />
									<px:PXGridColumn DataField="CCCashAccountID" DisplayMode="Hint" CommitChanges="true" Width="200px" />
									<px:PXGridColumn DataField="EFTPaymentMethodID" DisplayMode="Hint" CommitChanges="true" Width="200px"/>
									<px:PXGridColumn DataField="EFTCashAccountID" DisplayMode="Hint" CommitChanges="true"  Width="200px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" />
			...
			<px:PXTabItem Text ="POS Terminals" VisibleExp="DataControls[chkAcceptPOSPayments].Value==true" BindingContext="form">
				<Template>
					<px:PXGrid ID="grdPosTerminals" runat="server" DataSourceID="ds" Height="100%" Width="100%" SkinID="Inquire">
						<Levels>
							<px:PXGridLevel DataMember="PosTerminals">
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
									<px:PXTextEdit ID="edTerminalID" runat="server" DataField="TerminalID" />
									<px:PXTextEdit ID="edTerminalName" runat="server" DataField="TerminalName" />
									<px:PXTextEdit ID="edDisplayName" runat="server" DataField="DisplayName" />
									<px:PXCheckBox ID="chkTerminalIsActive" runat="server" DataField="IsActive" />
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="TerminalID" />
									<px:PXGridColumn DataField="TerminalName" />
						...
						<ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Import terminals">
                                    <AutoCallBack Command="ImportTerminals" Target="ds">
