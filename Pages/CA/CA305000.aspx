			...
			<Levels>
				<px:PXGridLevel DataKeyNames="DocType,RefNbr" DataMember="AvailablePayments">
					<Columns>
						...
						<px:PXGridColumn DataField="BAccountCD" />
						<px:PXGridColumn DataField="BAccountName" />
						...
						<Levels>
							<px:PXGridLevel DataMember="DepositPayments">
								<RowTemplate>
									...
									<px:PXSegmentMask ID="edBAccountID" runat="server" DataField="BAccount__AcctCD" />
									<px:PXTextEdit ID="edLocationCD" runat="server" DataField="PaymentInfo__LocationCD" />
									<px:PXSegmentMask ID="edCashAccountID1" runat="server" DataField="CashAccountID" />
