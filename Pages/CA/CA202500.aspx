...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="CreditCards" Width="100%" AllowAutoHide="false">
        <Template>
            ...
            <px:PXSelector runat="server" CommitChanges="True" DataSourceID="ds" ID="edBranchID" DataField="BranchID" />
            ...
            <px:PXSegmentMask runat="server" CommitChanges="True" DataSourceID="ds" ID="edCashAccountID" DataField="CashAccountID" AutoRefresh="True"/>
