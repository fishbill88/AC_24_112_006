...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100"
        ...
        <ActionBar Position="TopAndBottom" DefaultAction="ViewDetailsDoc" PagerVisible="False" ActionsText="False">
            <CustomItems>
                <px:PXToolBarButton Text="Unhide Transaction" Key="cmdUH" CommandName="Unhide" CommandSourceID="ds" DependOnGrid="grid" StateColumn="Hidden">
                    <ActionBar GroupIndex="1" Order="1" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Text="Unmatch Transaction" Key="cmdUM" CommandName="Unmatch" CommandSourceID="ds" DependOnGrid="grid" StateColumn="DocumentMatched">
                    <ActionBar GroupIndex="1" Order="2" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Text="Unmatch All Transaction" Key="cmdUMA" CommandName="UnmatchAll" CommandSourceID="ds" DependOnGrid="grid">
                    <ActionBar GroupIndex="1" Order="3" />
                </px:PXToolBarButton>
                <px:PXToolBarButton Text="View Matched Document" Key="cmdVD" CommandName="ViewDoc" CommandSourceID="ds" DependOnGrid="grid" StateColumn="DocumentMatched">
        ...
        <Levels>
            <px:PXGridLevel DataKeyNames="CashAccountID,TranID" DataMember="Details">
                <RowTemplate>
                    ...
                    <px:PXTextEdit runat="server" DataField="UserDesc" ID="edUserDesc">
                    </px:PXTextEdit>
                    <px:PXSelector runat="server" DataField="BankFeedAccountMapID" ID="lblBankFeedAccount" TextField="AccountNameMask">
                    </px:PXSelector>
                </RowTemplate>
                <Columns>
                    <px:PXGridColumn DataField="TranID"/>
                    <px:PXGridColumn DataField="DocumentMatched" Width="70px" TextAlign="Center" Type="CheckBox">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="Processed" Width="85px" TextAlign="Center" Type="CheckBox">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="Hidden" Width="65px" TextAlign="Center" Type="CheckBox">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="CuryDebitAmt" Width="100px" TextAlign="Right" MatrixMode="true">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryCreditAmt" TextAlign="Right" Width="100px" MatrixMode="true">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryDisplayDebitAmt" Width="100px" TextAlign="Right" MatrixMode="true">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="CuryDisplayCreditAmt" TextAlign="Right" Width="100px" MatrixMode="true">
                    </px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="UserDesc" Width="200px">
                    </px:PXGridColumn>
                    <px:PXGridColumn DataField="BankFeedAccountMapID" TextField="BankFeedAccountMapID_CABankFeedAccountMapping_AccountNameMask" Width="150px">
                    </px:PXGridColumn>
                </Columns>
            </px:PXGridLevel>
        </Levels>
