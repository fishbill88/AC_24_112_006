...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="TranFilter" TypeName="PX.Objects.CA.CABankTransactionsMaint">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ResetMatchSettingsToDefault" CommitChanges="true" Visible="false" />
			...
			<px:PXDSCallbackCommand Name="RetrieveTransactions" CommitChanges="true" />
	...
	<px:PXSplitContainer runat="server" ID="PXSplitContainer" Height="100%" PositionInPercent="true"
		...
		<Template1>
			...
			<px:PXGrid ID="grid1" runat="server" DataSourceID="ds" Style="z-index: 100; border-right: 1px solid #BBBBBB;"
                ...
                StatusField="MatchStatsInfo" FilesIndicator="False" FeedbackMode="ForceDataEntry">
				<GridStyles>
					<Caption Height="23px" />
				</GridStyles>
				<AutoCallBack Target="PXGrid1" Command="Refresh" ActiveBehavior="true">
					<Behavior RepaintControls="None" RepaintControlsIDs="form,gridAdjustments,gridCASplits,PXGrid1,gridDetailMatches4,gridExpenseReceiptDetailMatches,frmMatchToPayments,frmCreateDocumentInv,frmCreateDocument,tab2" />
				</AutoCallBack>
				<ActionBar ActionsVisible="true" DefaultAction="ViewDetailsDoc" PagerVisible="False" ActionsText="False">
					...
					<CustomItems>
						<px:PXToolBarButton Text="Clear Match" Key="cmdCM" CommandName="ClearMatch" CommandSourceID="ds" DependOnGrid="grid1">
							<ActionBar GroupIndex="1" Order="2" />
						</px:PXToolBarButton>
						<px:PXToolBarButton Text="Clear Match" Key="cmdCAM" CommandName="ClearAllMatches" CommandSourceID="ds" DependOnGrid="grid1">
							<ActionBar GroupIndex="1" Order="3" />
						</px:PXToolBarButton>
						<px:PXToolBarButton Text="Hide Transaction" Key="cmdH" CommandName="Hide" CommandSourceID="ds" DependOnGrid="grid1">
							<ActionBar GroupIndex="1" Order="4" />
						</px:PXToolBarButton>
						<px:PXToolBarButton Text="Split" Key="cmdS" CommandName="Split" CommandSourceID="ds" DependOnGrid="grid1">
				...
				<Levels>
					<px:PXGridLevel DataKeyNames="CashAccountID,TranID" DataMember="Details">
						...
						<Columns>
							...
							<px:PXGridColumn DataField="UserDesc">
							</px:PXGridColumn>
							<px:PXGridColumn DataField="BankFeedAccountMapID" TextField="BankFeedAccountMapID_CABankFeedAccountMapping_AccountNameMask">
							</px:PXGridColumn>
						</Columns>
					</px:PXGridLevel>
				</Levels>
					...
					<px:PXTabItem Text="Match to Payments" RepaintOnDemand="False" BindingContext="form">
						<Template>
							<px:PXFormView ID="frmMatchToPayments" runat="server" DataSourceID="ds" DataMember="DetailsForPaymentMatching" Style="z-index: 100"
								...
								<CallbackCommands>
									<Save RepaintControls="None" RepaintControlsIDs="grid1,PXGrid1,frmCreateDocument,frmCreateDocumentInv,gridAdjustments,gridCASplits" />
								</CallbackCommands>
								<Template>
							...
							<px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" Style="z-index: 100"
								...
								<CallbackCommands>
									<Save RepaintControls="None" RepaintControlsIDs="grid1,frmCreateDocument,frmMatchToPayments,frmCreateDocumentInv,gridAdjustments,gridCASplits" />
								</CallbackCommands>
								<Parameters>
								...
								<Levels>
									<px:PXGridLevel DataMember="DetailMatchesCA" DataKeyNames="TranID">
										...
										<Columns>
											...
											<px:PXGridColumn DataField="OrigTranTypeUI" Type="DropDownList" MatrixMode="true" />
											<px:PXGridColumn DataField="Status" Type="DropDownList" MatrixMode="true" />
											<px:PXGridColumn DataField="TranDesc" />
					...
					<px:PXTabItem Text="Match to Invoices" RepaintOnDemand="False" BindingContext="form">
						<Template>
							<px:PXFormView ID="frmCreateDocumentInv" runat="server" DataSourceID="ds" DataMember="DetailsForInvoiceApplication" Style="z-index: 100"
								...
								NoteIndicator="false" SkinID="Preview">
								<CallbackCommands>
									<Save RepaintControls="None" RepaintControlsIDs="grid1,gridDetailMatches4,frmCreateDocument,frmMatchToPayments,gridAdjustments,gridCASplits" />
								</CallbackCommands>
								<Template>
									<px:PXLayoutRule ID="PXLayoutRule26" runat="server" LabelsWidth="sm" ControlSize="m" StartRow="true" />
							...
							<px:PXGrid ID="gridDetailMatches4" runat="server" Width="100%" DataSourceID="ds"
								...
								<CallbackCommands>
									<Save RepaintControls="None" RepaintControlsIDs="grid1,frmCreateDocumentInv,frmCreateDocument,frmMatchToPayments,gridAdjustments,gridCASplits" />
								</CallbackCommands>
