		...
		<Levels>
			<px:PXGridLevel DataMember="CustomerCardPaymentData">
			    <RowTemplate>
                    ...
                    <px:PXSegmentMask ID="cashAccountID" AutoRefresh="True" DataField="CashAccountID" runat="server">
                        </px:PXSegmentMask>
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="PaymentType" CommitChanges="True">
                    </px:PXGridColumn>
    ...
    <px:PXSmartPanel ID="PanelPaymentMethod" runat="server" Caption="Select Payment Method" CaptionVisible="True" LoadOnDemand="True"
		...
		<div style="padding: 5px">
			<px:PXFormView ID="formPaymentMethod" runat="server" DataSourceID="ds" CaptionVisible="False" DataMember="PMFilter">
				...
				<Template>
					<px:PXLayoutRule runat="server" StartRow="True" StartColumn="True"/>
                    <px:PXSelector ID="edEftPaymentMethodId" runat="server" AutoRefresh = "True" DataField="EftPaymentMethodId" CommitChanges="true" LabelWidth="220px">
                    </px:PXSelector>
                    <px:PXCheckBox ID="edOverwriteEftPaymentMethod" runat="server" AlignLeft="True" DataField="OverwriteEftPaymentMethod" CommitChanges="true" >
                    </px:PXCheckBox>
                    <px:PXSelector ID="edCCPaymentMethodId" runat="server" AutoRefresh = "True" DataField="CCPaymentMethodId" CommitChanges="true" LabelWidth="220px">
                    </px:PXSelector>
                    <px:PXCheckBox ID="edOverwriteCCPaymentMethod" runat="server" AlignLeft="True" DataField="OverwriteCCPaymentMethod" CommitChanges="true" >
                    </px:PXCheckBox>
				</Template>
			</px:PXFormView>
		</div>
