...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="669px" Width="100%" DataMember="CASetupRecord"
						...
						<Levels>
							<px:PXGridLevel DataMember="Approval" >
								...
								<Columns>
									...
									<px:PXGridColumn DataField="AssignmentNotificationID" RenderEditorText="True" AutoCallBack="True" DisplayMode="Text" TextField="Name" />
								</Columns>
                           </px:PXGridLevel>
                       </Levels>                         
                   </px:PXGrid>
		...
		<px:PXTabItem Text="Bank Statements">
			<Template>
