		...
		<Items>
			<px:PXTabItem Text="Branch Details" RepaintOnDemand="false">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Dunning Process Settings" StartGroup="True" />
					<px:PXCheckBox ID="edIsDunningCompanyBranchID" runat="server" DataField="IsDunningCompanyBranchID" />
