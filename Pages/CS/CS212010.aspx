...
<asp:Content ID="Content3" ContentPlaceHolderID="phG" Runat="Server">
	...
	<AutoSize Container="Window" Enabled="True" MinHeight="200" />
		<Items>
			...
			<Template>
				<px:PXGrid ID="gridImportedRows" runat="server" Height="400px" Width="100%" AutoGenerateColumns="Recreate"
				DataSourceID="ds" 
				RepaintColumns="true"
				GenerateColumnsBeforeRepaint = "true">
				<AutoSize Container="Parent" Enabled="True" MinHeight="200" />
			...
			<Template>
				<px:PXGrid ID="gridUploadFile" runat="server" Height="400px" Width="100%" AutoGenerateColumns="Recreate"
				DataSourceID="ds" 
				RepaintColumns="true"
				GenerateColumnsBeforeRepaint = "true">
				<AutoSize Container="Parent" Enabled="True" MinHeight="200" />
