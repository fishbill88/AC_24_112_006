...
<asp:Content ID="Content1" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="PXFormView1" runat="server" Width="100%" Caption="Company Summary" DataMember="BAccount" NoteIndicator="True" FilesIndicator="True" DefaultControlID="edAcctCD">
		<Template>
			...
			<px:PXDropDown ID="edStatus" runat="server" DataField="OrganizationView.Status" AlignLeft="True"/>
		...
		<Items>
			<px:PXTabItem Text="Company Details" RepaintOnDemand="false">
				<Template>
				    ...
				    <px:PXFormView ID="Company" runat="server" Caption="Base Currency Settings" DataMember="OrganizationView" RenderStyle="Fieldset" DataSourceID="ds">
				        <Template>
				            <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
					...
					<px:PXFormView ID="ConfigurationSettings" runat="server" DataMember="OrganizationView" RenderStyle="Simple" DataSourceID="ds">
						<Template>
							...
							<px:PXDropDown CommitChanges="true" ID="edOrganizationLocalization" runat="server" DataField="OrganizationLocalizationCode" />
							<px:PXDropDown CommitChanges="true" ID="edCashDiscountBase" runat="server" DataField="CashDiscountBase" />
					...
					<px:PXFormView ID="CommonSettings" runat="server" DataMember="commonsetup" DataSourceID="ds" RenderStyle="Simple">
						<Template>
							<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
							<px:PXNumberEdit ID="edDecPlQty" runat="server" DataField="DecPlQty" CommitChanges="True" />
		                ...
		                <Levels>
		                    <px:PXGridLevel DataMember="BranchesView">
		                        <Columns>
		                            ...
		                            <px:PXGridColumn DataField="IsDunningCompanyBranchID" TextAlign="Center" Type="CheckBox" CommitChanges="true" />
		    ...
		    <px:PXTabItem Text="Canadian Tax Reporting" RepaintOnDemand="false">
		        <Template>
					<px:PXFormView ID="T5018Settings" runat="server" DataMember="T5018Settings" DataSourceID="ds" Width="100%" SkinID="Transparent">
						<Template>
							<px:PXLayoutRule runat="server" ID="T5018Group" GroupCaption="T5018 Settings" StartRow="True" LabelsWidth="M" ControlSize="XM" />
							<px:PXDropDown runat="server" ID="edT5018TaxYear" DataField="T5018ReportingYear" CommitChanges="true"/>
							<px:PXTextEdit runat="server" ID="edProgramNumber" DataField="ProgramNumber" />
							<px:PXTextEdit runat="server" ID="edTransmitterNumber" DataField="TransmitterNumber" />
						</Template>
					</px:PXFormView>
		            <px:PXFormView ID="frmCanadaTaxReport" runat="server" DataMember="TaxReportingAccount" Width="100%" CaptionVisible="False" TemplateContainer="" DataSourceID="ds" SkinID="Transparent">
		                <Template>
		                    <px:PXLayoutRule runat="server" ID="CRA" GroupCaption="CRA" StartRow="True" LabelsWidth="M" ControlSize="XM" />
							<px:PXTextEdit ID="edCRAPayrollAccountNumber" runat="server" DataField="CRAPayrollAccountNumber" DataSourceID="ds" />
							<px:PXSelector ID="edT4ContactID" runat="server" DataField="T4ContactID" DataSourceID="ds" />
		                    <px:PXLayoutRule runat="server" ID="RL1" GroupCaption="RL1" StartRow="True" LabelsWidth="M" ControlSize="XM" />
		                    <px:PXTextEdit ID="edRL1IdentificationNumber" runat="server" DataField="RL1IdentificationNumber" DataSourceID="ds" />
		                    <px:PXTextEdit ID="edRL1FileNumber" runat="server" DataField="RL1FileNumber" DataSourceID="ds" />
		                    <px:PXTextEdit ID="edRL1QuebecEnterpriseNumber" runat="server" DataField="RL1QuebecEnterpriseNumber" DataSourceID="ds" />
		                    <px:PXTextEdit ID="edRL1QuebecTransmitterNumber" runat="server" DataField="RL1QuebecTransmitterNumber" DataSourceID="ds" />
		                </Template>
		            </px:PXFormView>
		        </Template>
		    </px:PXTabItem>
			<px:PXTabItem Text="Taxes" RepaintOnDemand="False">
				<Template>
				...
				<Template>
					<px:PXFormView ID="frmLogo" runat="server" DataMember="OrganizationView" Width="100%" CaptionVisible="False" TemplateContainer="" DataSourceID="ds" SkinID="Transparent">
						<Template>
						    ...
						    <px:PXLabel ID="lblLogoReportImgUploader" runat="server">Recommended Size: Width 300px, Height 100px</px:PXLabel>
