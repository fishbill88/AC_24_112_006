...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" 
		...
		<Template>
			...
			<px:PXSelector ID="edReportCode" runat="server" DataField="ReportCode" AutoGenerateColumns="True" CommitChanges="True" />
			<px:PXTextEdit ID="edDescription" runat="server" DataField="Description" CommitChanges="True" />
			<px:PXDropDown ID="edType" runat="server" AllowNull="False" DataField="Type" CommitChanges="True" />
			<px:PXSelector ID="edRowSetCode" runat="server" DataField="RowSetCode" AllowAddNew="True" AllowEdit="True" AutoRefresh="True" CommitChanges="True" />
			<px:PXSelector ID="edColumnSetCode" runat="server" DataField="ColumnSetCode" AllowAddNew="True" AllowEdit="True" AutoRefresh="True" CommitChanges="True" />
