	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXSelector ID="edCROpportunityClassID" runat="server" DataField="CROpportunityClassID"
				Size="SM" FilterByAllFields="True" AutoRefresh="True" />
			...
			<px:PXTabItem Text="Details">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Conversion Settings" StartGroup="True"/>
						<px:PXSelector ID="edTargetContactClassID" runat="server" DataField="TargetContactClassID" AutoRefresh="True" />
						<px:PXSelector ID="edTargetBAccountClassID" runat="server" DataField="TargetBAccountClassID" AutoRefresh="True" />
