	...
	<px:PXTab ID="tab" runat="server" Height="450px" Style="z-index: 100" Width="100%"
		...
		<Items>
			<px:PXTabItem Text="Details">
				...
				<Template>
					<px:PXPanel ID="PXPanel1" runat="server" DataMember="CurrentEvent" RenderStyle="Simple" ContentLayout-OuterSpacing="Around">
						<px:PXSelector ID="ddType" runat="server" DataField="Type" CommitChanges="True" DisplayMode="Text" Visible ="False" />
						<px:PXSelector ID="edNoteID" runat="server" DataField="NoteID" Visible="False" AutoRefresh="True"/>
						...
						<Levels>
							<px:PXGridLevel DataMember="Activities">
								<RowTemplate>
									...
									<px:PXDateTimeEdit ID="edStartDate" runat="server" DataField="StartDate" DisplayFormat="g" EditFormat="g" />
									<px:PXTimeSpan TimeMode="true" ID="edTimeSpent" runat="server" DataField="TimeSpent" InputMask="hh:mm" MaxHours="99" />
									<px:PXDateTimeEdit TimeMode="true" ID="edTimeBillable" runat="server" DataField="TimeBillable" Enabled="False" />
									<px:PXDateTimeEdit TimeMode="true" ID="edOvertimeBillable" runat="server" DataField="OvertimeBillable" Enabled="False" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="IsBillable" TextAlign="Center" Type="CheckBox" Width="60px" AutoCallBack="true" />
									<px:PXGridColumn DataField="Subject" LinkCommand="ViewActivity"/>
									<px:PXGridColumn DataField="CostCodeID" AutoCallBack="True" />
									<px:PXGridColumn DataField="UIStatus" RenderEditorText="true" />
