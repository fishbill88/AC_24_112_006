	...
	<px:PXFormView ID="frmHeader" runat="server" Width="100%" Caption="Location Summary"
		...
		<Template>
			<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" />
				<px:PXSegmentMask ID="edBAccountID" runat="server" DataField="BAccountID" AllowEdit="True" FilterByAllFields="True" TextMode="Search" DisplayMode="Hint" CommitChanges="true" AutoRefresh="True" />
			...
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Other Settings" />
						...
						<px:PXSelector ID="edCPriceClassID" runat="server" DataField="CPriceClassID" AutoRefresh="True" />
						<px:PXSegmentMask ID="edCDefProjectID" runat="server" DataField="CDefProjectID" CommitChanges="True" AutoRefresh="True" />
			...
			<px:PXTabItem Text="Shipping">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Tax Settings" />
						...
						<px:PXSelector ID="edCTaxZoneID" runat="server" DataField="CTaxZoneID" CommitChanges="True" AutoRefresh="True" />
					...
					<px:PXLayoutRule runat="server" GroupCaption="Shipping Instructions" />
						<px:PXSegmentMask ID="edCSiteID" runat="server" DataField="CSiteID" AutoRefresh="True" />
						<px:PXSelector CommitChanges="True" ID="edCarrierID" runat="server" DataField="CCarrierID" AutoRefresh="True" />
						<px:PXSelector ID="edShipTermsID" runat="server" DataField="CShipTermsID" AutoRefresh="True" />
						<px:PXSelector ID="edShipZoneID" runat="server" DataField="CShipZoneID" AutoRefresh="True" />
						<px:PXSelector ID="edFOBPointID" runat="server" DataField="CFOBPointID" AutoRefresh="True" />
						...
						<px:PXSelector ID="edCalendar" runat="server" DataField="CCalendarID" AutoRefresh="True" />
