...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="MassMails"
		...
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ViewBusinessAccount" Visible="false" />
            <px:PXDSCallbackCommand Name="ViewContact" Visible="false" />
		</CallbackCommands>
		<DataTrees>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
				...
				<Template>
					<px:PXPanel ID="PXPanel1" runat="server">
						<px:PXLayoutRule ID="PXLayoutRule4" runat="server" StartColumn="True" LabelsWidth="S"
							ControlSize="M" />
						<px:PXSelector ID="edMassMailCD" runat="server" DataField="MassMailCD" AutoRefresh="True" />
						...
						<Levels>
							<px:PXGridLevel DataMember="Leads">
								<Columns>
									...
									<px:PXGridColumn AllowUpdate="False" DataField="DisplayName" LinkCommand="ViewContact">
										<NavigateParams>
											<px:PXControlParam Name="ContactID" ControlID="leads" PropertyName="DataValues[&quot;ContactID&quot;]" />
										</NavigateParams>
									</px:PXGridColumn>
									<px:PXGridColumn DataField="FullName" />
									<px:PXGridColumn DataField="BAccount__AcctCD" LinkCommand="ViewBusinessAccount" />
			...
			<px:PXTabItem Text="Campaigns" VisibleExp="DataControls[&quot;edSource&quot;].Value == 1"
				...
				<Template>
					<px:PXGrid ID="campaigns" runat="server" DataSourceID="ds" Style="z-index: 105;"
						Width="100%" BorderStyle="None" AdjustPageSize="Auto" BorderWidth="0px" SkinID="Inquire" SyncPosition="True">
						<AutoSize Enabled="True" />
						<Levels>
							<px:PXGridLevel DataMember="Campaigns">
								<Columns>
									<px:PXGridColumn AllowNull="False" DataField="Selected" TextAlign="Center" Type="CheckBox"
										Width="60px"/>
									<px:PXGridColumn AllowUpdate="False" DataField="CampaignID" LinkCommand="MassEmailCampaign_CRMarketingCampaign_ViewDetails"/>
			...
			<px:PXTabItem Text="Marketing List" VisibleExp="DataControls[&quot;edSource&quot;].Value == 0"
				...
				<Template>
					<px:PXGrid ID="mailList" runat="server" DataSourceID="ds" Style="z-index: 105;" Width="100%"
						BorderStyle="None" AdjustPageSize="Auto" BorderWidth="0px" SkinID="Inquire" SyncPosition="True">
						<AutoSize Enabled="True" />
						<Levels>
							<px:PXGridLevel DataMember="MailLists">
								<Columns>
									...
									<px:PXGridColumn AllowUpdate="False" DataField="MailListCode" DisplayFormat="&gt;aaaaaaaaaa"
										Width="200px" LinkCommand="MassEmailMarketingLists_CRMarketingList_ViewDetails" />
	...
	<px:PXSmartPanel ID="PanelSendMassEmail" runat="server" Style="z-index: 108; left: 315px; position: absolute; top: 399px;"
		Caption="Send Mass Email" CaptionVisible="true" DesignView="Content" LoadOnDemand="true" ShowAfterLoad="true" Key="MassMailPrepare"
		AutoCallBack-Enabled="true" AutoCallBack-Command="Refresh" AutoCallBack-Target="SendMassEmailForm" AutoReload="true">
		<px:PXFormView ID="FormSendMassEmail" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" SkinID="Transparent" DataMember="MassMailPrepare">
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True" />
				<px:PXLabel runat="server" Text="Do you want to send the mass email now?" />
				<px:PXCheckBox ID="edCampaignUpdateListMembers" runat="server" DataField="CampaignUpdateListMembers" CommitChanges="true" TabIndex="40" AlignLeft="true" />
			</Template>
		</px:PXFormView>
		<px:PXPanel ID="SendMassEmailButtons" runat="server" SkinID="Buttons" Style="margin-right: 25px;">
			<px:PXButton ID="SendMassEmailOK" runat="server" DialogResult="OK" Text="Send"  Width="60px" Height="24px"/>
			<px:PXButton ID="SendMassEmailCancel" runat="server" DialogResult="Cancel" Text="Cancel"  Width="60px" Height="24px" Style="margin-left: 5px"/>
		</px:PXPanel>
	</px:PXSmartPanel>

	<!--#include file="~\Pages\CR\Includes\CRSelectNotificatonTemplateExt.inc"-->
