...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" Caption="Contact Summary" DataMember="Contact" DataSourceID="ds" NoteIndicator="True" FilesIndicator="True"
		...
		<Template>
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" Merge="True" />
				...
				<px:PXButton runat="server" CommandSourceID="ds" CommandName="ContactTeamsCardOffline" ID="edContactTeamsCardOffline" CssClass="Button teamsImageButton" Width="20" Height="24">
					<Images Normal="svg:teams@teams_offline" />
				</px:PXButton>
				<px:PXButton runat="server" CommandSourceID="ds" CommandName="ContactTeamsCardAvailable" ID="edContactTeamsCardAvailable" CssClass="Button teamsImageButton" Width="20" Height="24">
					<Images Normal="svg:teams@teams_available" />
				</px:PXButton>
				<px:PXButton runat="server" CommandSourceID="ds" CommandName="ContactTeamsCardBusy" ID="edContactTeamsCardBusy" CssClass="Button teamsImageButton" Width="20" Height="24">
					<Images Normal="svg:teams@teams_busy" />
				</px:PXButton>
				<px:PXButton runat="server" CommandSourceID="ds" CommandName="ContactTeamsCardAway" ID="edContactTeamsCardAway" CssClass="Button teamsImageButton" Width="20" Height="24">
	...
	<px:PXTab ID="tab" runat="server" DataSourceID="ds" Height="500px" DataMember="ContactCurrent" Width="100%">
		<Items>
					...
					<px:PXLayoutRule ID="PXLayoutRule12" runat="server" GroupCaption="Contact" StartGroup="True"/>
						<px:PXFormView ID="PXFormView1" runat="server" DataMember="ContactCurrent" DataSourceID="ds" SkinID="Transparent">
							<Template>
								...
								<px:PXLayoutRule runat="server" ID="gbTeams" StartGroup="True" GroupCaption="Teams" />
								<px:PXTextEdit runat="server" ID="edTeamsID" DataField="TeamsID" CommitChanges="True" />
							</Template>
			...
			<px:PXTabItem Text="Locations">
	            <Template>
	                <px:PXGrid ID="roleAssignmentsGrid" runat="server" DataSourceID="ds" SkinID="Details" AutoSize="True"  Width="100%">
		                <Levels>
			                <px:PXGridLevel DataMember="RoleAssignments">
				                <Columns>
					                <px:PXGridColumn DataField="LocationID" />
					                <px:PXGridColumn DataField="Role" />
				                </Columns>
								<RowTemplate>
									<px:PXSelector runat="server" ID="edLocationID" DataField="LocationID"  AllowEdit="True"></px:PXSelector>
								</RowTemplate>
			                </px:PXGridLevel>
		                </Levels>
		                <AutoSize Enabled="true" MinHeight="250" MinWidth="300" />
