...
public partial class Page_CR301000 : PX.Web.UI.PXPage
{
	...
	private LeadMaint.CreateContactFromLeadGraphExt GetCreateContactExt() => Graph.GetExtension<LeadMaint.CreateContactFromLeadGraphExt>();
	...
	protected void AccountInfo_DataBound(object sender, EventArgs e)
	{
		(sender as PXFormView).Visible = GetCreateAccountExt()?.NeedToUse ?? true;
	}

	protected void ContactInfo_DataBound(object sender, EventArgs e)
	{
		(sender as PXFormView).Visible = GetCreateContactExt()?.NeedToUse ?? true;
	}
