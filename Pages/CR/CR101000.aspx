		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXSelector ID="edDefaultLeadClassID" runat="server" DataField="DefaultLeadClassID" AllowEdit="True" AutoRefresh="True" />
					<px:PXSelector ID="edDefaultContactClassID" runat="server" DataField="DefaultContactClassID" AllowEdit="True" AutoRefresh="True" />
					...
					<px:PXSelector Size="xm" ID="edDefaultOpportunityAssignmentMapID" runat="server"
						DataField="DefaultOpportunityAssignmentMapID" TextField="Name" AllowEdit="True" AutoRefresh="True" />
					<px:PXLayoutRule runat="server" />
                    ...
                    <px:PXSelector ID="edQuoteApprovalMapID" runat="server" DataField="QuoteApprovalMapID" TextField="Name" AllowEdit="True" DataSourceID="ds" edit="1" AutoRefresh="True" />
                    <px:PXSelector ID="edQuoteApprovalNotificationID" runat="server" DataField="QuoteApprovalNotificationID" TextField="Name" AllowEdit="True" AutoRefresh="True"/>
								...
								<Levels>
									<px:PXGridLevel DataMember="Notifications">
										<RowTemplate>
											...
											<px:PXSelector ID="edEMailAccount" runat="server" DataField="EMailAccountID" DisplayMode="Text" AutoRefresh="True" />
										</RowTemplate>
										<Columns>
