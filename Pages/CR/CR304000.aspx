...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Opportunity Summary" DataMember="Opportunity" FilesIndicator="True"
        ...
        <Template>
            ...
            <px:PXSelector CommitChanges="True" ID="edClassID" runat="server" DataField="ClassID" AllowEdit="True" TextMode="Search" FilterByAllFields="True" edit="1" AutoRefresh="True" />
            ...
            <px:PXSelector ID="edLocationID" runat="server" DataField="LocationID"  AllowEdit="True" TextMode="Search" DisplayMode="Hint" FilterByAllFields="True" CommitChanges="True" AutoRefresh="True" />
			...
			<px:PXButton runat="server" ID="edContactTeamsCardOffline" CommandSourceID="ds" CommandName="ContactTeamsCardOffline" CssClass="Button teamsImageButton" Style="margin-left: 28px" Width="20" Height="24">
				<Images Normal="svg:teams@teams_offline" />
			</px:PXButton>
			<px:PXButton runat="server" ID="edContactTeamsCardAvailable" CommandSourceID="ds" CommandName="ContactTeamsCardAvailable" CssClass="Button teamsImageButton" Style="margin-left: 28px" Width="20" Height="24">
				<Images Normal="svg:teams@teams_available" />
			</px:PXButton>
			<px:PXButton runat="server" ID="edContactTeamsCardBusy" CommandSourceID="ds" CommandName="ContactTeamsCardBusy" CssClass="Button teamsImageButton" Style="margin-left: 28px" Width="20" Height="24">
				<Images Normal="svg:teams@teams_busy" />
			</px:PXButton>
			<px:PXButton runat="server" ID="edContactTeamsCardAway" CommandSourceID="ds" CommandName="ContactTeamsCardAway" CssClass="Button teamsImageButton" Style="margin-left: 28px" Width="20" Height="24">
			...
			<px:PXLayoutRule runat="server" Merge="True" />
            <px:PXSelector CommitChanges="True" ID="edOwnerID" runat="server" DataField="OwnerID" TextMode="Search" DisplayMode="Text" FilterByAllFields="True" AutoRefresh="true" />
            ...
            <px:PXNumberEdit CommitChanges="True" ID="edCuryLineDiscountTotal" runat="server" DataField="CuryLineDiscountTotal" />
