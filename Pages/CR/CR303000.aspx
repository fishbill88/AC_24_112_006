...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Width="100%" Caption="Account Summary" DataMember="BAccount" DataSourceID="ds" NoteIndicator="True" 
        ...
        <Template>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" Merge="True" LabelsWidth="SM" ControlSize="XM" />
                <px:PXSelector CommitChanges="True" ID="OwnerID" runat="server" DataField="OwnerID" TextMode="Search" DisplayMode="Text" FilterByAllFields="True" AutoRefresh="True" />
				<px:PXButton runat="server" ID="edOwnerTeamsCardOffline" CommandSourceID="ds" CommandName="OwnerTeamsCardOffline" CssClass="Button teamsImageButton" Width="20" Height="24">
					<Images Normal="svg:teams@teams_offline" />
				</px:PXButton>
				<px:PXButton runat="server" ID="edOwnerTeamsCardAvailable" CommandSourceID="ds" CommandName="OwnerTeamsCardAvailable" CssClass="Button teamsImageButton" Width="20" Height="24">
					<Images Normal="svg:teams@teams_available" />
				</px:PXButton>
				<px:PXButton runat="server" ID="edOwnerTeamsCardBusy" CommandSourceID="ds" CommandName="OwnerTeamsCardBusy" CssClass="Button teamsImageButton" Width="20" Height="24">
					<Images Normal="svg:teams@teams_busy" />
				</px:PXButton>
				<px:PXButton runat="server" ID="edOwnerTeamsCardAway" CommandSourceID="ds" CommandName="OwnerTeamsCardAway" CssClass="Button teamsImageButton" Width="20" Height="24">
                ...
                <px:PXSelector ID="ClassID" runat="server" CommitChanges="True" DataField="ClassID" AllowEdit="true"
                    FilterByAllFields="True" TextMode="Search" DisplayMode="Hint" AutoRefresh="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
        ...
        <Items>
            ...
            <px:PXTabItem Text="General" RepaintOnDemand="false">
                <Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Account Info" />
						<px:PXFormView ID="frmAccountInfo" runat="server" DataMember="CurrentBAccount" RenderStyle="Simple">
							<Template>
								<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" />
								<px:PXTextEdit ID="edAcctName" runat="server" DataField="AcctName" CommitChanges="True" />
							</Template>
						</px:PXFormView>

					<px:PXLayoutRule runat="server" GroupCaption="Account Address" StartGroup="True" />
						<px:PXFormView ID="DefAddress" runat="server" DataMember="DefAddress" RenderStyle="Simple">
							<Template>
								<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" />
					...
					<px:PXLayoutRule runat="server" GroupCaption="Additional Account Info" StartGroup="True" />
						<px:PXFormView ID="DefContact" runat="server" DataMember="DefContact" DataSourceID="ds" RenderStyle="Simple">
							<Template>
								<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" />
            ...
            <px:PXTabItem Text="CRM Info" RepaintOnDemand="False">
                <Template>
                        <px:PXFormView ID="frmCRMinfo" runat="server" CaptionVisible="False" DataSourceID="ds"
                            ...
                            <Template>
                                <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="CRM" StartColumn="True" ControlSize="XM" LabelsWidth="M" />
                                    ...
                                    <px:PXSelector ID="edCampaignSourceID" runat="server" DataField="CampaignSourceID" AllowEdit="True" TextMode="Search" DisplayMode="Hint" FilterByAllFields="True" AutoRefresh="True" />
                    ...
                    <px:PXFormView ID="frmFinancialSettings" runat="server" DataSourceID="ds" CaptionVisible="False"
                                   DataMember="CurrentBAccount" SkinID="Transparent" >
                            <Template>
                                <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Financial Settings" StartColumn="True"
                                                 ControlSize="XM" LabelsWidth="SM" />
                                    <px:PXSelector Size="xs" ID="edCuryID" runat="server" DataField="CuryID" CommitChanges="True" />
                                    <px:PXCheckBox ID="chkAllowOverrideCury" runat="server" DataField="AllowOverrideCury"  CommitChanges="True" />
                            </Template>
                            <ContentLayout OuterSpacing="None" />
                            <ContentStyle BackColor="Transparent" BorderStyle="None">
                            </ContentStyle>
					...
					<px:PXFormView ID="frmDefLocation1" runat="server" DataMember="DefLocation" DataSourceID="ds" Width="100%" CaptionVisible="False" SkinID="Transparent">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Other Settings" />
								...
								<px:PXSelector ID="edCPriceClassID" runat="server" DataField="CPriceClassID" AllowEdit="True" AutoRefresh="True" />
								<px:PXSelector ID="edCDefProjectID" runat="server" DataField="CDefProjectID" AllowEdit="True" AutoRefresh="True" />
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Tax Settings" />
								...
								<px:PXSelector ID="edCTaxZoneID" runat="server" DataField="CTaxZoneID" AllowEdit="True" AutoRefresh="True" />
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Shipping Instructions" />
								...
								<px:PXSelector CommitChanges="True" ID="edCarrierID" runat="server" DataField="CCarrierID" AllowEdit="True" AutoRefresh="True" />
								<px:PXSelector ID="edShipTermsID" runat="server" DataField="CShipTermsID" AllowEdit="True" AutoRefresh="True" />
								<px:PXSelector ID="edShipZoneID" runat="server" DataField="CShipZoneID" AllowEdit="True" AutoRefresh="True" />
								<px:PXSelector ID="edFOBPointID" runat="server" DataField="CFOBPointID" AllowEdit="True" AutoRefresh="True" />
								...
								<px:PXSelector ID="edCCalendarID" runat="server" DataField="CCalendarID" AutoRefresh="True" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Opportunities">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ContactID" Visible="false" SyncVisible="false" />
                                    <px:PXGridColumn DataField="CRLead__ContactID" Visible="false" SyncVisible="false" />
                                </Columns>
                                <Layout FormViewHeight="" />
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Cases">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ReportedOnDateTime" />
                                    <px:PXGridColumn DataField="TimeEstimated" DisplayFormat="###:##:##" />
                                    <px:PXGridColumn DataField="ResolutionDate" />
                                    <px:PXGridColumn DataField="WorkgroupID" />
                                    <px:PXGridColumn DataField="OwnerID" DisplayMode="Text" />
                                    <px:PXGridColumn DataField="Contact__ContactID" Visible="false" SyncVisible="false" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="100" MinWidth="100" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Orders">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DisplayMode="Value" DataField="ContactID" Visible="false" SyncVisible="false"/>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="100" MinWidth="100" />
			...
			<!--#include file="~\Pages\CR\Includes\MarketingListDetailsExt.inc"-->
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="NotificationSources" DataKeyNames="SourceID,SetupID">
                                        <RowTemplate>
                                            ...
                                            <px:PXSegmentMask ID="edNBranchID" runat="server" DataField="NBranchID" AutoRefresh="True" />
                                            <px:PXCheckBox ID="chkActive" runat="server" Checked="True" DataField="Active" />
                                            <px:PXSelector ID="edSetupID" runat="server" DataField="SetupID" AutoRefresh="True" />
                                            <px:PXSelector ID="edReportID" runat="server" DataField="ReportID" ValueField="ScreenID" AutoRefresh="True" />
                                            <px:PXSelector ID="edNotificationID" runat="server" DataField="NotificationID" ValueField="Name" AutoRefresh="True" />
                                            <px:PXSelector ID="edEMailAccountID" runat="server" DataField="EMailAccountID" DisplayMode="Text" AutoRefresh="True" />
                                        </RowTemplate>
                                        <Columns>
    ...
    <px:PXSmartPanel ID="pnlChangeID" runat="server" Caption="Specify New ID" CaptionVisible="true" DesignView="Hidden" LoadOnDemand="true" 
        ...
        <px:PXFormView ID="formChangeID" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" CaptionVisible="False" DataMember="ChangeIDDialog">
            ...
            <Template>
                ...
                <px:PXSegmentMask ID="edAcctCD" runat="server" DataField="CD" AutoRefresh="True" />
            </Template>
        </px:PXFormView>
