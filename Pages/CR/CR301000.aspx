...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" UDFTypeField="ClassID" EnableAttributes="true" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CR.LeadMaint" PrimaryView="Lead">
		...
		<CallbackCommands>
			<%--Needed to be able to be duplicated on toolbar--%>
			<px:PXDSCallbackCommand Name="CreateContact" Visible="True"/>
			<px:PXDSCallbackCommand Name="CreateBothContactAndAccount" Visible="True"/>
			<px:PXDSCallbackCommand Name="ConvertToOpportunityAll" Visible="True"/>
			<%-- --%>
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%"
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" StartColumn="True" Merge="True" LabelsWidth="SM" ControlSize="XM" />
				...
				<px:PXSelector ID="edBAccountID" runat="server" AllowEdit="True" DataField="BAccountID" CommitChanges="True" FilterByAllFields="True" TextMode="Search" DataSourceID="ds" AutoRefresh="true" />
				...
				<px:PXSelector ID="edCampaignID" runat="server" DataField="CampaignID" CommitChanges="True" AutoRefresh="True" />
		...
		<Items>
			<px:PXTabItem Text="Contact Info" RepaintOnDemand="False">
				<Template>
					...
					<px:PXFormView ID="edOpportunity_Contact" runat="server" DataMember="LeadCurrent" DataSourceID="ds" RenderStyle="Simple" DefaultControlID="edFirstName">
						<Template>
			...
			<px:PXTabItem Text="CRM Info" RepaintOnDemand="False">
				<Template>
					<px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" GroupCaption="CRM" StartColumn="True" />
						<px:PXSelector ID="edClassID" runat="server" AllowEdit="True" DataField="ClassID" FilterByAllFields="True" TextMode="Search" CommitChanges="True" AutoRefresh="True" />
	...
	<px:PXSmartPanel
		...
		<px:PXFormView ID="frmLinkAccount" runat="server" DataSourceID="ds"  SkinID="Transparent" DataMember="LinkAccount" 
			...
			<Template>
				...
				<px:PXLayoutRule runat="server" />
				<px:PXGroupBox RenderStyle="Simple" RenderSimple="True" ID="edLinkType" runat="server" DataField="LinkAccountOption" CommitChanges="True" Style="text-align:right">
					<Template>
