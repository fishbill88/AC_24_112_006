...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXSelector ID="edCRContactClassID" runat="server" DataField="ClassID" Size="SM" FilterByAllFields="True" AutoRefresh="True" />
			...
			<px:PXTabItem Text="Details">
				<Template>
					...
					<px:PXLayoutRule ID="PXLayoutRule3" runat="server" GroupCaption="Conversion Settings" StartGroup="True"/>
						<px:PXSelector ID="edTargetLeadClassID" runat="server" DataField="TargetLeadClassID" AllowEdit="True" AutoRefresh="True" />
