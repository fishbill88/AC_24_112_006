...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		<Template>
			...
			<px:PXSelector ID="edCRLeadClassID" runat="server" DataField="ClassID" Size="SM" FilterByAllFields="True" AutoRefresh="True" />
			...
			<px:PXTabItem Text="Details">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Data Entry Settings" StartGroup="True"/>
						...
						<px:PXSelector ID="edDefaultAssignmentMapID" runat="server" DataField="DefaultAssignmentMapID" AllowEdit="True" DisplayMode="Text" AutoRefresh="True" />
					<px:PXLayoutRule ID="PXLayoutRule3" runat="server" GroupCaption="Conversion Settings" StartGroup="True"/>
						<px:PXSelector ID="edTargetContactClassID" runat="server" DataField="TargetContactClassID" AllowEdit="True" AutoRefresh="True" />
						<px:PXSelector ID="edTargetBAccountClassID" runat="server" DataField="TargetBAccountClassID" AllowEdit="True" AutoRefresh="True" />
						<px:PXCheckBox ID="chkRequireBAccountCreation" runat="server" DataField="RequireBAccountCreation"/>
						<px:PXSelector ID="edTargetOpportunityClassID" runat="server" DataField="TargetOpportunityClassID" CommitChanges="True" AllowEdit="True" AutoRefresh="True" />
