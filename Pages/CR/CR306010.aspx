...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Activities" NoteIndicator="True"
		FilesIndicator="True" DefaultControlID="edSubject" Width="100%" AllowCollapse="true">
				<Template>
					<px:PXPanel ID="PXPanel1" runat="server" DataMember="CurrentActivity" RenderStyle="Simple" ContentLayout-OuterSpacing="Around">
						...
						<px:PXSelector ID="ddType" runat="server" DataField="Type" CommitChanges="True" DisplayMode="Text" AutoRefresh="True" />
						...
						<px:PXLayoutRule ID="PXLayoutRule9" runat="server" LabelsWidth="SM" ControlSize="M" />
					    ...
					    <px:PXSelector ID="edARRefNbr" runat="server" DataField="TimeActivity.ARRefNbr" Enabled="False" AllowEdit="True" AutoRefresh="True" />
					</px:PXPanel>
				</Template>
	</px:PXFormView>
	<style type="text/css">
