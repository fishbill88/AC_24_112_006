...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
		...
		<Items>
			<px:PXTabItem Text="Details">
				<Template>
					<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 385px;" Width="100%" BorderWidth="0px" SkinID="Details" SyncPosition="True" Height="385px" TabIndex="7700"
						StatusField="Availability" OnRowDataBound="grid_RowDataBound" >
						<Levels>
							<px:PXGridLevel DataMember="Transactions" DataKeyNames="RefNbr,LineNbr">
								<Columns>
									...
									<px:PXGridColumn DataField="ReplaceSMEquipmentID" Visible="false" />
									<px:PXGridColumn DataField="EquipmentAction" CommitChanges="True" Visible="false" />
									<px:PXGridColumn DataField="Comment" CommitChanges="True" Visible="false" />
									<px:PXGridColumn DataField="SMEquipmentID" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="NewEquipmentLineNbr" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="ComponentID" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="EquipmentComponentLineNbr" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="RelatedDocument" RenderEditorText="True" LinkCommand="ATRan$RelatedDocument$Link" Visible="false" />
									...
									<px:PXGridColumn DataField="SubID" DisplayFormat="&gt;AA-AA-AA-AA-AA-AA" CommitChanges="True" />
								...
								<RowTemplate>
									...
									<px:PXSelector runat="server" ID="edReplaceSMEquipmentID" DataField="ReplaceSMEquipmentID" AllowEdit="True" />
			...
			<px:PXTabItem Text="Financial">
				<Template>
					...
					<px:PXCheckBox ID="chkDisableAutomaticTaxCalculation" SuppressLabel="True" runat="server" DataField="DisableAutomaticTaxCalculation" />
					...
					<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" GroupCaption="VAT Totals" StartGroup="True" />
				...
				<Template>
					...
					<px:PXFormView ID="formPT" runat="server" Style="position:absolute;top:0px;right:0px;" DataSourceID="ds" Width="230px" DataMember="CurrentDocument"
						...
						<Template>
							...
							<px:PXNumberEdit ID="edCuryBalanceWOTotal" runat="server" Enabled="False" DataField="CuryBalanceWOTotal" />
			...
			<Levels>
				<px:PXGridLevel DataMember="arTranList">
					...
					<Columns>
                        ...
                        <px:PXGridColumn DataField="RelatedDocument" RenderEditorText="True" LinkCommand="ARTran$RelatedDocument$Link" Visible="false" />
					</Columns>
				</px:PXGridLevel>
			</Levels>
		</px:PXGrid>
	...
	<!--#include file="~\Pages\SO\Includes\InventoryLookup.inc"-->
