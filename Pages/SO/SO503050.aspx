...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Width="100%" AllowPaging="true" AllowSearch="true" AdjustPageSize="Auto" 
        SkinID="PrimaryInquire" Caption="Shipments" SyncPosition="True" FastFilterFields="ShipmentNbr,CustomerID,CustomerID_BAccountR_acctName,CustomerOrderNbr" RepaintColumns="true">
        <Levels>
    ...
    <!--#include file="~\Pages\IN\Includes\LocationLinkFilter.inc"-->
</asp:Content>