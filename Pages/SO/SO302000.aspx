            ...
            <px:PXTabItem Text="Shipping">
                <Template>
					...
					<px:PXFormView runat="server" ID="formDeliverySettings" DataMember="CurrentDocument" Caption="Delivery Settings" CaptionVisible="True" AllowCollapse="False" RenderStyle="Fieldset">
						<Template>
							<px:PXLayoutRule runat="server" StartGroup="True" LabelsWidth="M" ControlSize="XM" />
							<px:PXCheckBox runat="server" ID="chkAddressVerification" DataField="SkipAddressVerification" />
							...
							<px:PXFormView runat="server" ID="formPacejetOptions" DataMember="CarrierData" SkinID="Inside" RenderStyle="Simple">
								<Template>
									...
									<px:PXCheckBox ID="chkAdditionalHandling" runat="server" DataField="AdditionalHandling" CommitChanges="True" />
									<px:PXCheckBox ID="chkEmailNotification" runat="server" DataField="EmailNotification" />
									<px:PXCheckBox ID="chkHazardousMaterials" runat="server" DataField="HazardousMaterials" />
									<px:PXCheckBox ID="edPrintReturnLabel" runat="server" DataField="PrintReturnLabel" />
									<px:PXTextEdit ID="edProBillNbr" runat="server" DataField="ProBillNbr" />
									<px:PXTextEdit ID="edDeliveryInstructions" runat="server" DataField="DeliveryInstructions" TextMode="MultiLine" Height="100px" />
								</Template>
							</px:PXFormView>
						</Template>
					</px:PXFormView>					
