        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkCreditHoldEntry" runat="server" DataField="CreditHoldEntry" CommitChanges="true" />
                    <px:PXCheckBox SuppressLabel="True" ID="chkRemoveCreditHoldByPayment" runat="server" DataField="RemoveCreditHoldByPayment" Style="margin-left: 25px" />
                    <px:PXCheckBox SuppressLabel="True" ID="chkRequireControlTotal" runat="server" DataField="RequireControlTotal" />
                    <px:PXCheckBox SuppressLabel="True" ID="chkBillSeparately" runat="server" DataField="BillSeparately" CommitChanges="true" />
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkDisableAutomaticTaxCalculation" runat="server" DataField="DisableAutomaticTaxCalculation" CommitChanges="True" />
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Copying Settings" />
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkCopyHeaderNotesToShipment" runat="server" DataField="CopyHeaderNotesToShipment" />
                    <px:PXCheckBox SuppressLabel="True" ID="chkCopyHeaderFilesToShipment" runat="server" DataField="CopyHeaderFilesToShipment" />
                    <px:PXCheckBox CommitChanges="True" ID="chkCopyHeaderNotesToInvoice" runat="server" DataField="CopyHeaderNotesToInvoice" />
                    <px:PXCheckBox CommitChanges="True" ID="chkCopyHeaderFilesToInvoice" runat="server" DataField="CopyHeaderFilesToInvoice" />
                    ...
                    <px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="XM" />
                    <px:PXLayoutRule runat="server" StartGroup="True" StartColumn="True" GroupCaption="Accounts Receivable Settings" />
                    ...
                    <px:PXCheckBox CommitChanges="True" ID="chkAMIncludeSupplyPlan" runat="server" DataField="AMIncludeSupplyPlan" />
                    ...
                    <px:PXCheckBox runat="server" ID="edAMProductionOrderEntry" DataField="AMProductionOrderEntry" CommitChanges="True" />
					<px:PXCheckBox runat="server" ID="edAMProductionOrderEntryOnHold" DataField="AMProductionOrderEntryOnHold" CommitChanges="True" />
					<px:PXCheckBox runat="server" ID="edAMEstimateEntry" DataField="AMEstimateEntry" CommitChanges="True" />
