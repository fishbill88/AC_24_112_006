    ...
    <px:PXFormView ID="PXFormView1" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
        ...
        <Template>
            ...
            <px:PXSelector ID="edSelectionDisciplineId" runat="server" DataField="DisciplineId" CommitChanges="True"
                AutoRefresh="True" />
            <px:PXSelector ID="edSelectionStatusId" runat="server" DataField="StatusID" CommitChanges="True"
                AutoRefresh="True" />
            <px:PXSelector ID="edSelectionProjectIssueId" runat="server" DataField="ProjectIssueID" CommitChanges="True"
                AutoRefresh="True" />
            <px:PXSelector ID="edSelectionRFIId" runat="server" DataField="RFIID" CommitChanges="True"
                AutoRefresh="True" />
