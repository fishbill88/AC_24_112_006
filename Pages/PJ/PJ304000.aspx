...
<asp:Content ID="DailyFieldReportTabsContent" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%">
        ...
        <Items>
            ...
            <px:PXTabItem Text="Progress Worksheets">
                <Template>
                    <px:PXGrid ID="ProgressWorksheetLinesGrid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="DetailsInTab" SyncPosition="True" RepaintColumns="true">
                        <Levels>
                            <px:PXGridLevel DataMember="ProgressWorksheetLines">
                                <RowTemplate>
                                    <px:PXSelector ID="edPwTaskID" runat="server" DataField="TaskID" />
                                    <px:PXSelector ID="edPwInventoryID" runat="server" DataField="InventoryID" />
                                    <px:PXSelector ID="edPwCostCodeID" runat="server" DataField="CostCodeID" />
                                    <px:PXSelector ID="edPwAccountGroupID" runat="server" DataField="AccountGroupID" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="PMProgressWorksheet__HiddenRefNbr"  LinkCommand="ViewProgressWorksheet"/>
                                    <px:PXGridColumn DataField="PMProgressWorksheet__HiddenStatus"/>
