...
<asp:Content ID="PhotoLogContent" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="PhotoLog"
        ...
        <Template>
			...
			<px:PXNumberEdit ID="chkIsUploadFilesVisible" runat="server" DataField="PhotoLogId" Enabled="False" Visible="False"/>
		</Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="PhotoLogTabsContent" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%">
        <Items>
            <px:PXTabItem Text="Photos" BindingContext="form" VisibleExp="DataControls[&quot;chkIsUploadFilesVisible&quot;].Value > 0">
                <Template>
                    <px:PXSplitContainer runat="server" ID="PhotosSplitContainer" SplitterPosition="1000" Orientation="Vertical" Height="100%" Width="100%" >
                        ...
                        <Template1>
							<px:PXMultiUpload ID="addPhotosDialog" runat="server" View="Photos" Action="UploadFiles" DropTarget=".dropFiles1"/>
                            <px:PXGrid ID="gridPhotos" runat="server" SkinID="Details" Width="100%" DataSourceID="ds" AdjustPageSize="Auto"
                                       ...
                                       AllowFilter="True" AllowSearch="True" FastFilterFields="PhotoCd, Name, UploadedById, Description" AutoGenerateColumns="Append" CssClass="dropFiles1">
                                ...
                                <ActionBar PagerVisible="Bottom">
									...
									<CustomItems>
										<px:PXToolBarButton Key="cmdUploadFromAttachments" Text="Upload From Attachments">
											<AutoCallBack Command="UploadFromAttachments" Target="ds" />
										</px:PXToolBarButton>
									</CustomItems>
                                </ActionBar>
                            </px:PXGrid>
