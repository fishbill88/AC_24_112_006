            ...
            <Levels>
                <px:PXGridLevel DataMember="openOrders">
                    <Columns>
                        ...
                        <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="OpenQty"
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document"
        ...
        <Template>
            ...
            <px:PXSelector ID="edOwnerID" runat="server" DataField="OwnerID" TextMode="Search" DisplayMode="Text" FilterByAllFields="True" AutoRefresh="true" CommitChanges="True"/>
            ...
            <px:PXNumberEdit ID="edCuryDetailExtCostTotal" runat="server" DataField="CuryDetailExtCostTotal" Enabled="False" />
            <px:PXNumberEdit ID="edCuryLineDiscTotalHeader" runat="server" DataField="CuryLineDiscTotal" Enabled="False" />
        ...
        <px:PXGrid ID="ChangeOrdersGrid" runat="server" Height="350px" Width="100%" Style="z-index: 100" AllowPaging="True" AdjustPageSize="Auto" AllowSearch="true" DataSourceID="ds"
            ...
            <Levels>
                <px:PXGridLevel DataMember="ChangeOrderDetails">
                    <Columns>
                        <px:PXGridColumn DataField="PMChangeOrder__RefNbr" LinkCommand="ViewChangeOrder"/>
...
<px:PXTabItem Text="Financial">
    <Template>
        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XL" GroupCaption="Subcontract Info" />
        ...
        <px:PXSelector ID="PXSelector2" runat="server" DataField="OwnerWorkgroupID" />
        <px:PXLayoutRule runat="server" Merge="True" />
        <px:PXCheckBox ID="PXCheckBox2" runat="server" Checked="True" DataField="DontPrint" Size="SM" CommitChanges="true" />
        <px:PXCheckBox ID="PXCheckBox3" runat="server" DataField="Printed" Enabled="False" Size="SM" />
        <px:PXLayoutRule runat="server" />
        <px:PXLayoutRule runat="server" Merge="True" />
        <px:PXCheckBox ID="PXCheckBox4" runat="server" Checked="True" DataField="DontEmail" Size="SM" CommitChanges="true" />
        <px:PXCheckBox ID="PXCheckBox5" runat="server" DataField="Emailed" Enabled="False" Size="SM" />
        <px:PXLayoutRule runat="server" />
        ...
        <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="vat totals" />
        ...
        <px:PXLayoutRule runat="server" StartColumn="true" ControlSize="XM" LabelsWidth="SM" GroupCaption="discount Totals" />
        <px:PXNumberEdit ID="edCuryLineDiscTotal" runat="server" DataField="CuryLineDiscTotal" Enabled="False" Size="XM" />
        <px:PXNumberEdit ID="PXNumberEdit1" runat="server" DataField="CuryDiscTot" Enabled="False" Size="XM" />
...
<px:PXSmartPanel ID="PanelAddSiteStatus" runat="server" Key="ItemInfo" LoadOnDemand="true" Width="1100px"
    ...
    <px:PXFormView ID="formSitesStatus" runat="server" CaptionVisible="False" DataMember="ItemFilter"
    ...
    <px:PXPanel ID="PXPanel5" runat="server" SkinID="Buttons">
        <px:PXButton ID="PXButton6" runat="server" CommandName="AddSelectedItems" CommandSourceID="ds" Text="Add"
            SyncVisible="false"/>
