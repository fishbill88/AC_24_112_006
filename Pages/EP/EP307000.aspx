		...
		<Levels>
			<px:PXGridLevel DataKeyNames="NoteID" DataMember="Activity">
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="ProjectID" AutoCallBack="True" CommitChanges="true" />
                    <px:PXGridColumn DataField="ProjectDescription" AutoCallBack="True"/>
                    <px:PXGridColumn DataField="ProjectTaskID" AutoCallBack="True" CommitChanges="true" />
                    <px:PXGridColumn DataField="ProjectTaskDescription" AutoCallBack="True"/>
                    ...
                    <px:PXGridColumn DataField="CostCodeDescription" AutoCallBack="True"/>
