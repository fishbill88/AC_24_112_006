...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="ExpenseClaim" Caption="Document Summary"
        ...
        <Template>
            ...
            <pxa:PXCurrencyRate DataField="CuryID" ID="PXCurrencyRate1" runat="server" DataSourceID="ds" RateTypeView="_EPExpenseClaim_CurrencyInfo_" DataMember="CurrencyList" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ExpenseClaimDetails" DataKeyNames="ClaimDetailID">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="APRefNbr" LinkCommand="ViewAPInvoice" />
                                    <px:PXGridColumn DataField="EmployeeID" Visible="False"/>
                                    <px:PXGridColumn DataField="ClaimDetailID"/>
                                </Columns>
                                <RowTemplate>
