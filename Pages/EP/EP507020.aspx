...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" 
		Width="100%" Height="150px" SkinID="PrimaryInquire" TabIndex="700" FilesIndicator="False" NoteIndicator="True" SyncPosition="True" AllowSearch="true" FastFilterFields="OwnerID_EPEmployee_AcctName,ProjectID,ProjectTaskID" BatchUpdate="true">
		<Levels>
			<px:PXGridLevel DataKeyNames="TaskID" DataMember="Activity">
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="ProjectDescription" />
                    <px:PXGridColumn DataField="ProjectTaskID" />
                    <px:PXGridColumn DataField="ProjectTaskDescription" />
                    <px:PXGridColumn DataField="CostCodeID" />
                    <px:PXGridColumn DataField="CostCodeDescription" />
