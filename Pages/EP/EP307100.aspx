...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
						...
						<Levels>
							<px:PXGridLevel DataMember="TimeActivities">
								<RowTemplate>
									...
									<px:PXDateTimeEdit DataField="Date" ID="edDate" runat="server" />
	...
	<px:PXSmartPanel ID="pnlBulkTimeEntry" runat="server" Caption="Mass Enter Time" CaptionVisible="True" LoadOnDemand="True" Width="100%" Height="100%" Key="CompanyTreeMembers"
		...
		<px:PXSplitContainer runat="server" ID="splitBulkTimeEntry" Orientation="Vertical" SplitterPosition="300">
			<Template1>
				...
				<px:PXGrid ID="gridCompanyTreeMembers" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="Details" AutoAdjustColumns="true" AllowPaging="false" SyncPosition="true">
					<Levels>
					...
					<Levels>
						<px:PXGridLevel DataMember="BulkEntryTimeActivities">
							<RowTemplate>
								...
								<px:PXDateTimeEdit DataField="Date" ID="edBulkDate" runat="server" AutoRefresh="true" />
