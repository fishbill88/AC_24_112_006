...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <px:PXDataSource ID="ds" runat="server" AutoCallBack="True" Visible="True" Width="100%" PrimaryView="AssigmentMap" TypeName="PX.Objects.EP.EPApprovalMapMaint"
        PageLoadBehavior="InsertRecord" HeaderDescriptionField="Name">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXSplitContainer runat="server" ID="sp0" SplitterPosition="270" Style="background-color: #eeeeee;" >
        <AutoSize Enabled="true" Container="Window" MinHeight="660"/>
        <Template1>
        ...
        <Template2>
			<px:PXFormView ID="formRuleNode" runat="server" DataMember="CurrentNode" DataSourceID="ds" Style="z-index: 100;"  Width="100%" RenderStyle="Normal">
				<Template>
				...
				<Items>
					...
					<px:PXTabItem Text="Rule Actions" RepaintOnDemand="false">
						<Template>
							...
							<px:PXGrid ID="ruleApproversGrid" runat="server" SkinID="Details" DataSourceID="ds" ActionsPosition="Top" Height="110px" Width="100%"
								MatrixMode="true" CaptionVisible="false" Style="z-index: 101;" AllowPaging="false" >
								<Levels>
									<px:PXGridLevel DataMember="RuleApprovers">
										<RowTemplate>
											<px:PXSelector CommitChanges="True" ID="edOwnerID" runat="server" DataField="OwnerID" AutoRefresh="True"/>
										</RowTemplate>
										<Columns>
											<px:PXGridColumn DataField="OwnerID" AutoCallBack="true"/>
											<px:PXGridColumn DataField="CREmployee__AcctCD" LinkCommand="CREmployee__AcctCD_ViewDetails"/>
											<px:PXGridColumn DataField="Contact__Salutation"/>
											<px:PXGridColumn DataField="CREmployee__DepartmentID"/>
										</Columns>
									</px:PXGridLevel>
								</Levels>
							...
							<px:PXFormView ID="PXFormViewBottom" runat="server" Width="100%" DataMember="CurrentNode" DataSourceID="ds" SkinID="Transparent">
								<Template>
									...
									<px:PXCheckBox ID="edAllowReassignment" runat="server" DataField="AllowReassignment" CommitChanges="True" />
