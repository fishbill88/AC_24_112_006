	...
	<px:PXSplitContainer ID="splitShiftCodes" runat="server" PositionInPercent="false" SplitterPosition="550" Orientation="Vertical" Height="100%">
		<Template1>
			<px:PXGrid ID="gridSummary" runat="server" Width="100%" AllowPaging="True" AllowSearch="true" AdjustPageSize="Auto"
				DataSourceID="ds" SkinID="Details" SyncPosition="true" KeepPosition="true" Caption="Shift Codes" CaptionVisible="true">
				<Levels>
		...
		<Template2>
			<px:PXGrid ID="gridDetails" runat="server" Width="100%" Style="z-index: 100" AllowPaging="True" AllowSearch="true" 
				AdjustPageSize="Auto" DataSourceID="ds" SkinID="Details" Caption="Rates" CaptionVisible="true">
				<Levels>
