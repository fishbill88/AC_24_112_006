    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" ActionsPosition="Top"
        ...
        <Levels>            
            <px:PXGridLevel DataMember="Records" >
                ...
                <Columns>
                    <px:PXGridColumn AllowCheckAll="True" AllowNull="False" AllowSort="False" DataField="Selected" TextAlign="Center" Type="CheckBox" />
                    ...
                    <px:PXGridColumn DataField="OrigOwnerID" DisplayMode="Text" Visible="False" SyncVisible="False" SyncVisibility="False" />
                    ...
                    <px:PXGridColumn DataField="IgnoreDelegations" TextAlign="Center" Type="CheckBox" Visible="False" SyncVisible="false"/>
                </Columns>
