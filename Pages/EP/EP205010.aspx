						...
						<Template>
							<px:PXFormView ID="formRuleType" runat="server" Width="100%" DataMember="CurrentNode" DataSourceID="ds" FilesIndicator="false" NoteIndicator="false" SyncPosition="true" SkinID="Transparent">
								<Template>
									...
									<px:PXTextEdit ID="edRuleName" runat="server" DataField="Name" AutoRefresh="true" CommitChanges="True" />
								...
								<Levels>
									<px:PXGridLevel DataMember="Rules">
										<Columns>
											...
											<px:PXGridColumn AutoCallBack="True" Type="DropDownList" AllowSort="False" DataField="FieldName" AllowResize="true" CommitChanges="True" />
