...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <px:PXSmartPanel ID="PanelAddSiteStatus" runat="server" Key="ItemInfo" LoadOnDemand="true" Width="800px" Height="500px" Caption="Inventory Lookup" CaptionVisible="true"
        AutoCallBack-Command='Refresh' AutoCallBack-Enabled="True" AutoCallBack-Target="formSitesStatus" DesignView="Content">
        <px:PXFormView ID="formSitesStatus" runat="server" CaptionVisible="False" DataMember="ItemFilter" DataSourceID="ds" Width="100%" SkinID="Transparent">
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
					...
					<px:PXGrid ID="gridVendor" runat="server" DataSourceID="ds" Width="100%" Height="200px" SkinID="DetailsWithFilter" Caption="Bidding Vendors" SyncPosition="True">
						...
						<ActionBar>
							<CustomItems>
								...
								<px:PXToolBarButton Text="Choose" Tooltip="Choose selected vendor for all requisition" Key="chooseVnd">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="POOrders" DataKeyNames="OrderType,OrderNbr">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edOrderOwner" runat="server" DataField="OwnerId" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="POOrder__OrderType" RenderEditorText="True" />
