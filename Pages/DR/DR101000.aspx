...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="DRSetupRecord" AllowCollapse="False" DefaultControlID="edScheduleNumberingID" TabIndex="100">
		<Template>
			...
			<px:PXCheckBox DataField="UseFairValuePricesInBaseCurrency" ID="chkUseFairValuePricesInBaseCurrency" runat="server" SuppressLabel="True" />
			<px:PXCheckBox DataField="RecognizeAdjustmentsInPreviousPeriods" ID="chkRecognizeAdjustmentsInPreviousPeriods" runat="server" SuppressLabel="True" />
		</Template>
