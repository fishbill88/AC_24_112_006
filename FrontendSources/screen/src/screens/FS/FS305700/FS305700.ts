...
@graphInfo({ graphType: 'PX.Objects.FS.ServiceContractEntry', primaryView: 'ServiceContractRecords', showUDFIndicator: true  })
...
export class FSContractSchedule extends PXView {
	...
	@linkCommand("OpenScheduleScreen") RefNbr: PXFieldState;
