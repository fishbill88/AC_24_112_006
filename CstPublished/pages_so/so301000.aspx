...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" ID="rthCstPXLayoutRule2" />
	<px:PXTextEdit runat="server" TextMode="MultiLine" Height="60px" DataField="UsrHubspotDealID" ID="edUsrHubspotDealID" />
	<px:PXNumberEdit runat="server" Enabled="False" CommitChanges="True" DataField="UsrRTHOrderQty" ID="edUsrRTHOrderQty" />
	<px:PXNumberEdit runat="server" Enabled="False" CommitChanges="True" DataField="UsrRTHCuryDetailExtPriceTotal" ID="edUsrRTHCuryDetailExtPriceTotal" />
	<px:PXNumberEdit runat="server" Enabled="False" CommitChanges="True" DataField="UsrRTHCuryLineDiscTotal" ID="edUsrRTHCuryLineDiscTotal" />
	<px:PXNumberEdit runat="server" Enabled="False" CommitChanges="True" DataField="UsrRTHCuryDiscTot" ID="edUsrRTHCuryDiscTot" />
	<px:PXNumberEdit runat="server" Enabled="False" CommitChanges="True" DataField="UsrRTHCuryFreightTot" ID="edUsrRTHCuryFreightTot" />
	<px:PXNumberEdit runat="server" Enabled="False" CommitChanges="True" DataField="UsrRTHCuryTaxTotal" ID="edUsrRTHCuryTaxTotal" />
	<px:PXNumberEdit runat="server" Enabled="False" CommitChanges="True" DataField="UsrRTHCuryOrderTotal" ID="edUsrRTHCuryOrderTotal" /></Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask CommitChanges="True" ID="edInventoryID" runat="server" DataField="InventoryID" AllowEdit="True" ></px:PXSegmentMask>
                                   
									<px:PXCheckBox runat="server" ID="edSDSelected" DataField="SDSelected" Text="SDSelected" ></px:PXCheckBox>
                                    <px:PXCheckBox runat="server" ID="edExcludedFromExport" DataField="ExcludedFromExport" AllowEdit="False"></px:PXCheckBox>
									<px:PXDropDown runat="server" ID="edEquipmentAction" DataField="EquipmentAction" CommitChanges="True" ></px:PXDropDown>
									<px:PXTextEdit runat="server" ID="edSMComment" DataField="Comment" ></px:PXTextEdit>
									<px:PXSelector runat="server" ID="edSMEquipmentID" DataField="SMEquipmentID" CommitChanges="True" AutoRefresh="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="edNewEquipmentLineNbr" DataField="NewEquipmentLineNbr" CommitChanges="True" AutoRefresh="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="edSMComponentID" DataField="ComponentID" CommitChanges="True" AutoRefresh="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="edEquipmentComponentLineNbr" DataField="EquipmentComponentLineNbr" CommitChanges="True" AutoRefresh="True" ></px:PXSelector>
                                    ...
                                    <px:PXCheckBox ID="chkIsFree" runat="server" DataField="IsFree" ></px:PXCheckBox>
                                    <px:PXSegmentMask CommitChanges="True" ID="edSiteID" runat="server" DataField="SiteID" AutoRefresh="True">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.inventoryID" PropertyName="DataValues[&quot;InventoryID&quot;]" Type="String" ></px:PXControlParam>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.subItemID" PropertyName="DataValues[&quot;SubItemID&quot;]" Type="String" ></px:PXControlParam>
                                        </Parameters>
                                    </px:PXSegmentMask>
                                    <px:PXSegmentMask ID="edLocationID" runat="server" DataField="LocationID" AutoRefresh="True">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.siteID" PropertyName="DataValues[&quot;SiteID&quot;]" Type="String" ></px:PXControlParam>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.inventoryID" PropertyName="DataValues[&quot;InventoryID&quot;]" Type="String" ></px:PXControlParam>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.subItemID" PropertyName="DataValues[&quot;SubItemID&quot;]" Type="String" ></px:PXControlParam>
                                        </Parameters>
                                    </px:PXSegmentMask>
                                    ...
                                    <px:PXNumberEdit ID="edOrderQty" runat="server" DataField="OrderQty" CommitChanges="True" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edQtyOnOrders" runat="server" DataField="QtyOnOrders" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edBlanketOpenQty" runat="server" DataField="BlanketOpenQty" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edUnshippedQty" runat="server" DataField="UnshippedQty" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edShippedQty" runat="server" DataField="ShippedQty" Enabled="False" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edOpenQty" runat="server" DataField="OpenQty" Enabled="False" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edUnitPrice" runat="server" DataField="CuryUnitPrice"  CommitChanges="True"></px:PXNumberEdit>
                                    <px:PXCheckBox ID="chkManualPrice" runat="server" DataField="ManualPrice" CommitChanges="True" ></px:PXCheckBox>
                                    <px:PXSelector ID="edManualDiscountID" runat="server" DataField="DiscountID" AllowEdit="True" edit="1" ></px:PXSelector>
                                    ...
                                    <px:PXCheckBox ID="chkAutomaticDiscountsDisabled" runat="server" DataField="AutomaticDiscountsDisabled" ></px:PXCheckBox>
                                    ...
                                    <px:PXCheckBox ID="chkCompleted" runat="server" DataField="Completed" CommitChanges="true" ></px:PXCheckBox>
                                    <px:PXNumberEdit ID="edCuryExtPrice" runat="server" DataField="CuryExtPrice" CommitChanges="True" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edCuryLineAmt" runat="server" DataField="CuryLineAmt" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edLineMarginPct" runat="server" DataField="MarginPct" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edLineCuryMarginAmt" runat="server" DataField="CuryMarginAmt" ></px:PXNumberEdit>
                                    <px:PXDateTimeEdit ID="edSchedOrderDate" runat="server" DataField="SchedOrderDate" ></px:PXDateTimeEdit>
                                    <px:PXTextEdit ID="edCustomerOrderNbr" runat="server" DataField="CustomerOrderNbr" ></px:PXTextEdit>
                                    ...
                                    <px:PXDateTimeEdit ID="edSchedShipDate" runat="server" DataField="SchedShipDate" ></px:PXDateTimeEdit>
                                    <px:PXNumberEdit ID="edCuryUnbilledAmt" runat="server" DataField="CuryUnbilledAmt" Enabled="False" ></px:PXNumberEdit>
                                    <px:PXDateTimeEdit ID="edRequestDate1" runat="server" DataField="RequestDate" ></px:PXDateTimeEdit>
                                    <px:PXDateTimeEdit ID="edShipDate" runat="server" DataField="ShipDate" ></px:PXDateTimeEdit>
                                    <px:PXDropDown ID="edShipComplete" runat="server" AllowNull="False" DataField="ShipComplete" SelectedIndex="2" ></px:PXDropDown>
                                    <px:PXNumberEdit ID="edCompleteQtyMin" runat="server" DataField="CompleteQtyMin" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edCompleteQtyMax" runat="server" DataField="CompleteQtyMax" ></px:PXNumberEdit>
                                    <px:PXDateTimeEdit ID="edExpireDate" runat="server" DataField="ExpireDate" DisplayFormat="d" ></px:PXDateTimeEdit>
                                    ...
                                    <px:PXSegmentMask CommitChanges="True" ID="edSalesAcctID" runat="server" DataField="SalesAcctID" AutoRefresh="True" ></px:PXSegmentMask>
                                    <px:PXSegmentMask ID="edSalesSubID" runat="server" DataField="SalesSubID" AutoRefresh="True" ></px:PXSegmentMask>
                                    <px:PXCheckBox CommitChanges="True" ID="chkPOCreate" runat="server" DataField="POCreate" ></px:PXCheckBox>
                                    <px:PXDropDown ID="edPOSource" runat="server" DataField="POSource" ></px:PXDropDown>
                                    <px:PXDateTimeEdit ID="edPOCreateDate" runat="server" DataField="POCreateDate" DisplayFormat="d" ></px:PXDateTimeEdit>
                                    <px:PXSelector runat="server" DataField="POOrderNbr" AllowEdit="true" ID="edDSPOOrderNbr" ></px:PXSelector>
                                    <px:PXDropDown runat="server" DataField="POOrderStatus" ID="edPOOrderStatus" ></px:PXDropDown>
                                    <px:PXNumberEdit runat="server" DataField="POLineNbr" ID="edDSPOLineNbr" ></px:PXNumberEdit>
                                    <px:PXCheckBox runat="server" DataField="POLinkActive" CommitChanges="True" ID="edPOLinkActive" ></px:PXCheckBox>
                                    ...
                                    <px:PXSelector ID="edTaxZoneID" runat="server" DataField="TaxZoneID" AutoRefresh="True" CommitChanges="true" ></px:PXSelector>
                                    <px:PXSelector ID="edTaxCategoryID" runat="server" DataField="TaxCategoryID" AutoRefresh="True" CommitChanges="true" ></px:PXSelector>
									<px:PXDropDown ID="edAvalaraCustomerUsageTypeID1" runat="server" DataField="AvalaraCustomerUsageType" CommitChanges="true" ></px:PXDropDown>
                                    ...
                                    <px:PXSelector Size="xm" ID="edLotSerialNbr" runat="server" AllowNull="False" DataField="LotSerialNbr" AutoRefresh="True">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.inventoryID" PropertyName="DataValues[&quot;InventoryID&quot;]" Type="String" ></px:PXControlParam>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.subItemID" PropertyName="DataValues[&quot;SubItemID&quot;]" Type="String" ></px:PXControlParam>
                                            <px:PXControlParam ControlID="grid" Name="SOLine.locationID" PropertyName="DataValues[&quot;LocationID&quot;]" Type="String" ></px:PXControlParam>
                                        </Parameters>
                                    </px:PXSelector>
                                    <px:PXCheckBox CommitChanges="True" ID="chkCommissionable" runat="server" Checked="True" DataField="Commissionable" ></px:PXCheckBox>
                                    <px:PXLayoutRule runat="server" ></px:PXLayoutRule>
                                    <px:PXSelector ID="edBlanketNbr" runat="server" DataField="BlanketNbr" ></px:PXSelector>
                                    <px:PXSegmentMask ID="edTaskID" runat="server" DataField="TaskID" AutoRefresh="True" ></px:PXSegmentMask>
                                    <px:PXSegmentMask ID="edCostCode" runat="server" DataField="CostCodeID" AutoRefresh="True" ></px:PXSegmentMask>
                                   <px:PXCheckBox runat="server" CommitChanges="True" DataField="AMProdCreate" ID="chkAMProdCreate" ></px:PXCheckBox>
									<px:PXSelector runat="server" ID="edAMOrderType" DataField="AMOrderType" AutoRefresh="True" AllowEdit="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="edAMProdOrdID" DataField="AMProdOrdID" AutoRefresh="True" AllowEdit="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="edAMEstimateID" DataField="AMEstimateID" AutoRefresh="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="edAMEstimateRevisionID" DataField="AMEstimateRevisionID" AutoRefresh="True" AllowEdit="True" ></px:PXSelector>
									<px:PXSelector runat="server" ID="edAMConfigKeyID" DataField="AMConfigKeyID" AutoRefresh="True" ></px:PXSelector>
                                </RowTemplate>
                                <Columns>
	<px:PXGridColumn DataField="UsrATAIRTHLineNbr" Width="70" CommitChanges="True" />
	<px:PXGridColumn Type="CheckBox" DataField="UsrATAISkipPrint" Width="60" CommitChanges="True" />
                                    <px:PXGridColumn DataField="Availability" SyncVisible="False" Visible="false" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ExcludedFromExport" AllowShowHide="Server" Type="CheckBox"></px:PXGridColumn>                                    
									<px:PXGridColumn DataField="IsConfigurable" Type="CheckBox" TextAlign="Center" Width="85px" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="BranchID" RenderEditorText="True" CommitChanges="True" ></px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="AssociatedOrderLineNbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="GiftMessage" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SortOrder" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LineType" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="InvoiceNbr" AllowShowHide="Server" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Operation" AllowShowHide="Server" Label="Operation" RenderEditorText="True" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="InventoryID" CommitChanges="True" AllowDragDrop="true" ></px:PXGridColumn>
	...
	<px:PXGridColumn DataField="UsrVendorAddress" Width="280" />
                                    <px:PXGridColumn DataField="RelatedItems" Type="Icon" LinkCommand="AddRelatedItems" AllowShowHide="Server" AllowFilter="false" AllowSort="false" ForceExport="true" DisplayMode="Value"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SubstitutionRequired" Type="CheckBox" AllowNull="False" TextAlign="Center" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="IsSpecialOrder" Type="CheckBox" AllowNull="False" TextAlign="Center" CommitChanges="true" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="EquipmentAction" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Comment" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SMEquipmentID" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="NewEquipmentLineNbr" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ComponentID" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="EquipmentComponentLineNbr" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="RelatedDocument" RenderEditorText="True" LinkCommand="SOLine$RelatedDocument$Link"></px:PXGridColumn>
									<px:PXGridColumn DataField="SDSelected" CommitChanges="True" Type="CheckBox" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SubItemID" NullText="<SPLIT>" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="AutoCreateIssueLine" TextAlign="Center" Type="CheckBox" AllowShowHide="Server" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="IsFree" TextAlign="Center" CommitChanges="true" Type="CheckBox" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SiteID" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LocationID" AllowShowHide="Server" NullText="<SPLIT>" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TranDesc" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="UOM" CommitChanges="True" AllowDragDrop="true"></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="OrderQty" TextAlign="Right" CommitChanges="True" AllowDragDrop="true"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="BaseOrderQty" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="QtyOnOrders" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="BlanketOpenQty" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="UnshippedQty" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="ShippedQty" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="OpenQty" TextAlign="Right" AllowNull="False" ></px:PXGridColumn>
	<px:PXGridColumn DataField="UsrSWKRTHCost" Width="100" />
	<px:PXGridColumn DataField="UsrSWKSPCCost" Width="100" CommitChanges="True" />
	<px:PXGridColumn DataField="UsrSWKSPCCode" Width="140" CommitChanges="True" />
                                    <px:PXGridColumn DataField="CuryUnitCost" TextAlign="Right" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="CuryUnitPrice" TextAlign="Right" CommitChanges="True"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ManualPrice" TextAlign="Center" AllowNull="False" Type="CheckBox" CommitChanges="True"></px:PXGridColumn>
	<px:PXGridColumn Type="CheckBox" DataField="UsrSWKManualCost" Width="60" CommitChanges="True" />
	<px:PXGridColumn DataField="UsrVendorSpecTerms" Width="280" />
	<px:PXGridColumn DataField="UsrVendorNotes" Width="280" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryExtPrice" TextAlign="Right" CommitChanges="True" ></px:PXGridColumn>
	<px:PXGridColumn DataField="CuryExtCost" Width="100" />
                                    <px:PXGridColumn AllowNull="False" DataField="DiscPct" TextAlign="Right" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryDiscAmt" TextAlign="Right" AllowNull="False" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="DiscountID" TextAlign="Left" CommitChanges="True" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="DiscountSequenceID" TextAlign="Left" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ManualDisc" TextAlign="Center" AllowNull="False" CommitChanges="True" Type="CheckBox" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="AutomaticDiscountsDisabled" TextAlign="Center" AllowNull="False" Type="CheckBox" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryDiscPrice" NullText="0.0" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SkipLineDiscounts" Type="CheckBox" TextAlign="Center" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="AvgCost" TextAlign="Right" NullText="0.0" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="CuryLineAmt" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="MarginPct" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryMarginAmt" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SchedOrderDate" CommitChanges="True" NullText="<SPLIT>" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CustomerOrderNbr" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CustomerLocationID" CommitChanges="true" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CustomerLocationID_Location_descr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ShipVia" AllowShowHide="Server" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="FOBPoint" AllowShowHide="Server" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ShipTermsID" AllowShowHide="Server" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ShipZoneID" AllowShowHide="Server" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SchedShipDate" CommitChanges="True" NullText="<SPLIT>" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TaxZoneID" CommitChanges="true" ></px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="CuryUnbilledAmt" AllowNull="False" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="RequestDate" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ShipDate" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ShipComplete" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="CompleteQtyMin" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="CompleteQtyMax" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="Completed" TextAlign="Center" Type="CheckBox" CommitChanges="true" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="OrigOrderType" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="OrigOrderNbr" LinkCommand="ViewOrigOrder" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POCreate" AllowNull="False" CommitChanges="True" TextAlign="Center" Type="CheckBox" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="IsPOLinkAllowed" Type="CheckBox" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POSource" CommitChanges="True" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POCreateDate" CommitChanges="True" NullText="<SPLIT>" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POOrderNbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POOrderStatus" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POLineNbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POLinkActive" Type="CheckBox" TextAlign="Center" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LotSerialNbr" AllowShowHide="Server" NullText="&lt;SPLIT&gt;" CommitChanges="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ExpireDate" AllowShowHide="Server" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ReasonCode" CommitChanges ="true" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SalesPersonID" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TaxCategoryID" CommitChanges="true" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="AvalaraCustomerUsageType" CommitChanges="true" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Commissionable" AllowNull="False" CommitChanges="True" TextAlign="Center" Type="CheckBox" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="BlanketNbr" LinkCommand="ViewBlanketOrder" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="AlternateID" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SalesAcctID" CommitChanges ="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SalesSubID" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TaskID" Label="Task" CommitChanges ="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CostCodeID" Label="Task" CommitChanges="true" ></px:PXGridColumn>
                                    ...
                                    <px:PXGridColumn DataField="AMProdCreate" Type="Checkbox" TextAlign="Center" Width="100px" AutoCallBack="True" CommitChanges="true" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AMorderType" Width="80px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AMProdOrdID" Width="90" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AMEstimateID" Width="90" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AMEstimateRevisionID" Width="80" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AMParentLineNbr" Width="85px" ></px:PXGridColumn>
									<px:PXGridColumn DataField="AMIsSupplemental" Type="CheckBox" TextAlign="Center" Width="85px" ></px:PXGridColumn>
	...
	<px:PXTabItem Text="Sales People">
		<Template>
			<px:PXGrid runat="server" ID="grdSalesPeople" Height="473px" SkinID="DetailsInTab" Width="100%" MatrixMode="True" DataSourceID="ds">
				<Mode AllowAddNew="True" AllowDelete="True" />
				<Levels>
					<px:PXGridLevel DataMember="SalesPeople">
						<Columns>
							<px:PXGridColumn DataField="IsDefault" Type="CheckBox" Width="60" />
							<px:PXGridColumn DataField="SalesPersonID" Width="140" CommitChanges="True" />
							<px:PXGridColumn DataField="SalesPersonID_description" Width="220" />
							<px:PXGridColumn DataField="CommisionPct" Width="100" /></Columns></px:PXGridLevel></Levels></px:PXGrid></Template></px:PXTabItem>
            <px:PXTabItem Text="Shipping" VisibleExp="DataControls[&quot;chkShowShipmentsTab&quot;].Value == 1" BindingContext="form">
                <Template>
                    ...
                    <px:PXFormView ID="formDeliverySettings" runat="server" DataSourceID="ds" DataMember="CurrentDocument" RenderStyle="Fieldset" Caption="Delivery Settings">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" Merge="True" ></px:PXLayoutRule>
                            <px:PXSelector CommitChanges="True" Size="s" ID="edShipVia" runat="server" DataField="ShipVia" DataSourceID="ds" ></px:PXSelector>
                            <px:PXButton ID="shopRates" runat="server" Text="Shop For Rates" CommandName="ShopRates" CommandSourceID="ds" ></px:PXButton>
                            <px:PXLayoutRule runat="server" ></px:PXLayoutRule>
                            <px:PXCheckBox ID="edWillCall" runat="server" DataField="WillCall" Tooltip="The Will Call flag depends on the Common Carrier selection in the Ship Via field." Width="80px" ></px:PXCheckBox>
							<px:PXDropDown runat="server" ID="edDeliveryConfirmation" DataField="DeliveryConfirmation" CommitChanges="True" ></px:PXDropDown>
							<px:PXDropDown runat="server" ID="edEndorsementService" DataField="EndorsementService" CommitChanges="True" ></px:PXDropDown>
                            <px:PXDropDown runat="server" ID="edFreightClass" DataField="FreightClass" ></px:PXDropDown>
                            <px:PXSelector ID="edFOBPoint" runat="server" DataField="FOBPoint" DataSourceID="ds" ></px:PXSelector>
                            <px:PXNumberEdit ID="edPriority" runat="server" DataField="Priority" ></px:PXNumberEdit>
                            <px:PXSelector CommitChanges="True" ID="edShipTermsID" runat="server" DataField="ShipTermsID" DataSourceID="ds" AutoRefresh="True" ></px:PXSelector>
                            <px:PXSelector CommitChanges="True" ID="edShipZoneID" runat="server" DataField="ShipZoneID" DataSourceID="ds" ></px:PXSelector>
                            ...
                            <px:PXCheckBox ID="chkInsurance" runat="server" DataField="Insurance" CommitChanges="True" ></px:PXCheckBox>
                            <px:PXCheckBox CommitChanges="True" ID="chkUseCustomerAccount" runat="server" DataField="UseCustomerAccount" ></px:PXCheckBox>
	<px:PXTextEdit runat="server" DataField="UsrCustomerAccount" ID="edUsrCustomerAccount" />
	<px:PXNumberEdit runat="server" DataField="UsrFreightPriceLimit" ID="edUsrFreightPriceLimit" CommitChanges="True" />
	<px:PXNumberEdit runat="server" Enabled="False" DataField="UsrFreightTotal" ID="edUsrFreightTotal" />
                            <px:PXCheckBox CommitChanges="True" ID="chkGroundCollect" runat="server" DataField="GroundCollect" ></px:PXCheckBox>
							<px:PXFormView runat="server" ID="formPacejet" DataMember="CarrierData" SkinID="Inside" RenderStyle="Simple">
								<Template>
									...
									<px:PXCheckBox runat="server" ID="chkAdditionalHandling" DataField="AdditionalHandling" ></px:PXCheckBox>
									<px:PXCheckBox runat="server" ID="chkLiftGate" DataField="LiftGate" ></px:PXCheckBox>
									<px:PXCheckBox runat="server" ID="chkInsideDelivery" DataField="InsideDelivery" ></px:PXCheckBox>
									<px:PXCheckBox runat="server" ID="chkLimitedAccess" DataField="LimitedAccess" ></px:PXCheckBox>
								</Template>
                    ...
                    <px:PXFormView ID="formI" runat="server" DataSourceID="ds" DataMember="CurrentDocument" Caption="Intercompany Purchase" RenderStyle="Fieldset">
                        <Template>
                            ...
                            <px:PXDropDown ID="edIntercompanyPOType" runat="server" DataField="IntercompanyPOType" ></px:PXDropDown>
                            <px:PXSelector ID="edIntercompanyPONbr" runat="server" DataField="IntercompanyPONbr" AllowEdit="True" Enabled="False" ></px:PXSelector>
                            <px:PXSelector ID="edIntercompanyPOReturnNbr" runat="server" DataField="IntercompanyPOReturnNbr" AllowEdit="True" Enabled="False" ></px:PXSelector>
                        </Template>
                        <ContentStyle BackColor="Transparent" BorderStyle="None" ></ContentStyle>
                    </px:PXFormView>
                    <px:PXLayoutRule runat="server" StartColumn="True" Merge="True"></px:PXLayoutRule>
                    <px:PXFormView ID="formShippingSettings" runat="server" DataSourceID="ds" DataMember="CurrentDocument" RenderStyle="Fieldset" Caption="Order Shipping Settings">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" ></px:PXLayoutRule>
                            <px:PXDateTimeEdit CommitChanges="True" ID="edShipDate" runat="server" DataField="ShipDate" ></px:PXDateTimeEdit>
                            <px:PXCheckBox ID="chkShipSeparately" runat="server" DataField="ShipSeparately" ></px:PXCheckBox>
                            <px:PXLayoutRule runat="server" ></px:PXLayoutRule>
                            <px:PXDropDown ID="edShipComplete" runat="server" AllowNull="False" DataField="ShipComplete" SelectedIndex="2" CommitChanges="True" ></px:PXDropDown>
                            <px:PXLayoutRule runat="server" Merge="True" ></px:PXLayoutRule>
                            <px:PXDateTimeEdit ID="edCancelDate" runat="server" DataField="CancelDate" ></px:PXDateTimeEdit>
                            <px:PXCheckBox ID="chkCancelled" runat="server" DataField="Cancelled" Enabled="false"></px:PXCheckBox>
                            <px:PXLayoutRule runat="server" ></px:PXLayoutRule>
                            <px:PXSegmentMask CommitChanges="True" ID="edDefaultSiteID" runat="server" DataField="DefaultSiteID" DataSourceID="ds" ></px:PXSegmentMask>
	<px:PXTextEdit runat="server" TextMode="MultiLine" Width="200" Height="200" DataField="UsrShippingNotes" ID="edUsrShippingNotes" />
	<px:PXLayoutRule runat="server" EndGroup="True" ID="rth1CstLayoutRule6" />
	...
	<px:PXLayoutRule runat="server" Merge="True" />
	<px:PXLayoutRule runat="server" Merge="True" />
	<px:PXLayoutRule runat="server" Merge="True" /></Template>
                        <ContentStyle BackColor="Transparent" BorderStyle="None" ></ContentStyle>
                    </px:PXFormView>
	<px:PXLayoutRule runat="server" StartColumn="True" ID="rth1CstPXLayoutRule5" />
	<px:PXFormView runat="server" SkinID="Transparent" ID="edfrmShipping" DataMember="CurrentDocument">
		<Template>
			<px:PXLayoutRule runat="server" StartColumn="True" StartRow="True" ID="rCstPXLayoutRule3" />
			<px:PXTextEdit runat="server" TextMode="MultiLine" LabelWidth="200" Width="250" Height="250" DataField="UsrShippingInstructions" ID="edUsrShippingInstructions" /></Template></px:PXFormView></Template>
            </px:PXTabItem>
