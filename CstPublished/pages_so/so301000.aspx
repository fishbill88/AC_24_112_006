...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" ID="STCstPXLayoutRule122" />
	<px:PXTextEdit runat="server" ID="edUsrHubspotDealID" DataField="UsrHubspotDealID" TextMode="MultiLine" Height="60px" />
	<px:PXNumberEdit runat="server" ID="edUsrRTHOrderQty" DataField="UsrRTHOrderQty" Enabled="False" CommitChanges="True" />
	<px:PXNumberEdit runat="server" ID="edUsrRTHCuryDetailExtPriceTotal" DataField="UsrRTHCuryDetailExtPriceTotal" Enabled="False" CommitChanges="True" />
	<px:PXNumberEdit runat="server" ID="edUsrRTHCuryLineDiscTotal" DataField="UsrRTHCuryLineDiscTotal" Enabled="False" CommitChanges="True" />
	<px:PXNumberEdit runat="server" ID="edUsrRTHCuryDiscTot" DataField="UsrRTHCuryDiscTot" Enabled="False" CommitChanges="True" />
	<px:PXNumberEdit runat="server" ID="edUsrRTHCuryFreightTot" DataField="UsrRTHCuryFreightTot" Enabled="False" CommitChanges="True" />
	<px:PXNumberEdit runat="server" ID="edUsrRTHCuryTaxTotal" DataField="UsrRTHCuryTaxTotal" Enabled="False" CommitChanges="True" />
	<px:PXNumberEdit runat="server" ID="edUsrRTHCuryOrderTotal" DataField="UsrRTHCuryOrderTotal" Enabled="False" CommitChanges="True" /></Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	...
	<px:PXGridColumn DataField="UsrSWKManualCost" Width="60" CommitChanges="True" Type="CheckBox" />
	...
	<px:PXNumberEdit runat="server" ID="edUsrFreightPriceLimit" DataField="UsrFreightPriceLimit" Enabled="" />
	<px:PXTextEdit runat="server" ID="CstPXTextEdit9" DataField="UsrCustomerAccount" />
	<px:PXNumberEdit runat="server" ID="edUsrFreightTotal" DataField="UsrFreightTotal" Enabled="False" />
                    ...
                    <px:PXLayoutRule runat="server" StartColumn="True" Merge="False"></px:PXLayoutRule>
	...
	<px:PXTextEdit runat="server" ID="edUsrShippingNotes" DataField="UsrShippingNotes" Width="200" Height="200" TextMode="MultiLine" />
	<px:PXLayoutRule runat="server" ID="CstLayoutRule6" EndGroup="True" /></Template>
                        <ContentStyle BackColor="Transparent" BorderStyle="None" ></ContentStyle>
                    </px:PXFormView>
	<px:PXLayoutRule runat="server" ID="CstPXLayoutRule5" StartColumn="True" />
	<px:PXFormView runat="server" ID="edfrmShipping" DataMember="CurrentDocument" SkinID="Transparent">
		<Template>
			<px:PXLayoutRule runat="server" ID="CstPXLayoutRule3" StartRow="True" StartColumn="True" />
			<px:PXTextEdit runat="server" ID="edUsrShippingInstructions" DataField="UsrShippingInstructions" LabelWidth="200" Width="250" Height="250" TextMode="MultiLine" /></Template></px:PXFormView></Template>
            </px:PXTabItem>
