...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="423px" Style="z-index: 100;" Width="100%" TabIndex="23">
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions" DataKeyNames="ShipmentNbr,LineNbr">
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="PickedQty" TextAlign="Right" />
            ...
            <px:PXTabItem Text="Orders" LoadOnDemand="True" RepaintOnDemand="True" >
                <Template>
                    <px:PXGrid ID="grid5" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" Width="100%" SkinID="Details" BorderWidth="0px" AdjustPageSize="Auto">
                        <Levels>
            ...
            <px:PXTabItem Text="Shipping">
                <Template>
					...
					<px:PXFormView runat="server" ID="formPacejetProcessing" DataMember="CarrierData" SkinID="Inside" RenderStyle="Simple">
						<Template>	
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Pacejet Processing" LabelsWidth="SM" ControlSize="XM" />
							<px:PXDropDown runat="server" ID="edExternalStatus" DataField="ExternalStatus" />
							<px:PXTextEdit runat="server" ID="edPacejetWorkstationID" DataField="PacejetWorkstationID" />
						</Template>
					</px:PXFormView>
                            </Template>
					...
					<px:PXFormView runat="server" ID="formDeliverySettings" DataMember="CurrentDocument" Caption="Delivery Settings" CaptionVisible="True" AllowCollapse="False" RenderStyle="Fieldset">
						<Template>
							<px:PXLayoutRule runat="server" StartGroup="True" LabelsWidth="M" ControlSize="XM" ></px:PXLayoutRule>
							<px:PXCheckBox runat="server" ID="chkAddressVerification" DataField="SkipAddressVerification" ></px:PXCheckBox>
							<px:PXCheckBox ID="chkUseCustomerAccount" runat="server" CommitChanges="True" DataField="UseCustomerAccount" ></px:PXCheckBox>
							...
							<px:PXFormView runat="server" ID="formPacejetOptions" DataMember="CarrierData" SkinID="Inside" RenderStyle="Simple">
								<Template>
									...
									<px:PXCheckBox ID="chkAdditionalHandling" runat="server" DataField="AdditionalHandling" CommitChanges="True" ></px:PXCheckBox>
									<px:PXCheckBox ID="chkEmailNotification" runat="server" DataField="EmailNotification" ></px:PXCheckBox>
									<px:PXCheckBox ID="chkHazardousMaterials" runat="server" DataField="HazardousMaterials" ></px:PXCheckBox>
									<px:PXCheckBox ID="edPrintReturnLabel" runat="server" DataField="PrintReturnLabel" ></px:PXCheckBox>
									<px:PXTextEdit ID="edProBillNbr" runat="server" DataField="ProBillNbr" ></px:PXTextEdit>
									<px:PXTextEdit ID="edDeliveryInstructions" runat="server" DataField="DeliveryInstructions" TextMode="MultiLine" Height="100px" ></px:PXTextEdit>
								</Template>
							</px:PXFormView></Template>
					</px:PXFormView>					
					<px:PXFormView runat="server" ID="formLTLSettings" DataMember="CarrierData" Caption="LTL Settings" CaptionVisible="True" AllowCollapse="False" RenderStyle="Fieldset">
						<Template>
							<px:PXLayoutRule runat="server" StartGroup="True" LabelsWidth="M" />
							<px:PXCheckBox runat="server" ID="edLiftGate" DataField="LiftGate" />
							<px:PXCheckBox runat="server" ID="edInsideDelivery" DataField="InsideDelivery" />
							<px:PXCheckBox runat="server" ID="edLimitedAccess" DataField="LimitedAccess" />
						</Template>
					</px:PXFormView>
					<px:PXFormView ID="formBroker" runat="server" Caption="Broker Info" DataMember="CurrentDocument" DataSourceID="ds" AllowCollapse="false" RenderStyle="Fieldset">
                        <Template>
                           <px:PXSelector ID="edBrokerID" runat="server" DataField="BrokerContactID" DisplayMode="Text" TextMode="Search" FilterByAllFields="True" AutoRefresh="True" AllowEdit="True"/>
                        </Template>
					</px:PXFormView>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Packages">
                                 <RowTemplate>
                                    ...
                                    <px:PXTextEdit ID="edReturnTrackNumber" runat="server" DataField="ReturnTrackNumber" />
								</RowTemplate>
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ReturnTrackNumber" />
                                    <px:PXGridColumn DataField="NonStandardContainer" />
                                    <px:PXGridColumn DataField="AdditionalHandling" />
                                    <px:PXGridColumn DataField="SSCC" />
    ...
    <px:PXGrid ID="gridPickList" runat="server" DataSourceID="ds" SkinID="Inquire" SyncPosition="True" Caption="Items" CaptionVisible="True">
        <Levels>
    ...
    <px:PXPanel ID="PXPanelPickListButtons" runat="server" SkinID="Buttons">
        <px:PXButton ID="PXButtonDeletePickList" runat="server" CommandName="DeletePickList" CommandSourceID="ds" DialogResult="Cancel" />
