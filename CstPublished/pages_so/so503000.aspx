...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
        ...
        <Levels>
            <px:PXGridLevel DataMember="Orders">
                <RowTemplate>
                    ...
                    <px:PXSelector ID="edShipmentNbr" runat="server" DataField="ShipmentNbr" Enabled="False" AllowEdit="True" ></px:PXSelector>
                    ...
                    <px:PXDateTimeEdit ID="edShipDate" runat="server" DataField="ShipDate" Enabled="False" ></px:PXDateTimeEdit>
                    <px:PXSelector ID="edCuryID" runat="server" DataField="CuryID" Enabled="False" ></px:PXSelector>
                    <px:PXNumberEdit ID="edShipmentQty" runat="server" AllowNull="False" DataField="ShipmentQty" Enabled="False" ></px:PXNumberEdit></RowTemplate>
                <Columns>
                    ...
                    <px:PXGridColumn AllowUpdate="False" DataField="ShipmentNbr" LinkCommand="viewDocument" ></px:PXGridColumn>
                    <px:PXGridColumn AllowUpdate="False" DataField="Status" RenderEditorText="True" ></px:PXGridColumn>
	...
	<px:PXGridColumn DataField="AttributeBILLCOMPLE" Width="60" Type="CheckBox" />
                    ...
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ShipmentQty" TextAlign="Right" ></px:PXGridColumn>
                    <px:PXGridColumn AllowUpdate="False" DataField="ShipVia" DisplayFormat="&gt;aaaaaaaaaaaaaaa" ></px:PXGridColumn>
                    <px:PXGridColumn AllowUpdate="False" DataField="ShipVia_Carrier_description" ></px:PXGridColumn>
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ShipmentWeight" TextAlign="Right" ></px:PXGridColumn>
                    <px:PXGridColumn AllowNull="False" AllowUpdate="False" DataField="ShipmentVolume" TextAlign="Right" ></px:PXGridColumn>
                    <px:PXGridColumn AllowUpdate="False" DataField="LabelsPrinted" Type="CheckBox" TextAlign="Center" ></px:PXGridColumn></Columns>
            </px:PXGridLevel>
        </Levels>
