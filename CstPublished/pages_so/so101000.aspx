...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
            ...
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXPanel ID="pnlDataEntrySettings" runat="server" Caption="Data Entry Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule ID="PXLayoutRule2" runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXSelector ID="edDefaultOrderType" runat="server"
                            DataField="DefaultOrderType" DataSourceID="ds" ></px:PXSelector>
                        <px:PXSelector ID="edTransferOrderType" runat="server"
                            DataField="TransferOrderType" DataSourceID="ds" ></px:PXSelector>
	...
	<px:PXCheckBox runat="server" ID="CstPXCheckBox8" DataField="UsrHidePrintingMethod2" /></px:PXPanel>
                    <px:PXPanel ID="pnlPriceSettings" runat="server" Caption="Price Settings" RenderStyle="Fieldset">
                        ...
                        <px:PXCheckBox ID="edUsePriceAdjustmentMultiplier" runat="server" DataField="UsePriceAdjustmentMultiplier" ></px:PXCheckBox>
                        <px:PXLabel ID="lblIgnoreMinGrossProfitOptions" runat="server">Ignore Min. Markup Validation for Prices Specific To</px:PXLabel>
                        <px:PXCheckBox ID="edIgnoreMinGrossProfitCustomerPrice" runat="server" DataField="IgnoreMinGrossProfitCustomerPrice" ></px:PXCheckBox>
                        <px:PXCheckBox ID="edIgnoreMinGrossProfitCustomerPriceClass" runat="server" DataField="IgnoreMinGrossProfitCustomerPriceClass" ></px:PXCheckBox>
                        <px:PXCheckBox ID="edIgnoreMinGrossProfitPromotionalPrice" runat="server" DataField="IgnoreMinGrossProfitPromotionalPrice" ></px:PXCheckBox>
                    </px:PXPanel>
                    <px:PXPanel ID="pnlFreightCalc" runat="server" Caption="Freight Calculation Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXDropDown ID="edFreightAllocation" runat="server" AllowNull="False" DataField="FreightAllocation" ></px:PXDropDown>
                    </px:PXPanel>
                    <px:PXPanel ID="pnlShipmentSettings" runat="server" Caption="Shipment Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXDropDown ID="edFreeItemShipping" runat="server" AllowNull="False" DataField="FreeItemShipping" SelectedIndex="-1" ></px:PXDropDown>
                        <px:PXCheckBox ID="chkHoldShipments" runat="server" Checked="True" DataField="HoldShipments" ></px:PXCheckBox>
                        <px:PXCheckBox ID="chkRequireShipmentTotal" runat="server" Checked="True" DataField="RequireShipmentTotal" ></px:PXCheckBox>
                        <px:PXCheckBox ID="chkAddAllToShipment" runat="server" DataField="AddAllToShipment" CommitChanges="true" ></px:PXCheckBox>
                        <px:PXCheckBox ID="chkCreateZeroShipments" runat="server" DataField="CreateZeroShipments" CommitChanges="true" ></px:PXCheckBox>
                    </px:PXPanel>
                    <px:PXPanel ID="pnlInvoiceSettings" runat="server" Caption="Invoice Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXCheckBox ID="chkCreditCheckError" runat="server" DataField="CreditCheckError" ></px:PXCheckBox>
                        <px:PXCheckBox ID="chkUseShipDateForInvoiceDate" runat="server" DataField="UseShipDateForInvoiceDate" ></px:PXCheckBox>
                    </px:PXPanel>
                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                    <px:PXPanel ID="pnlPostingSettings" runat="server" Caption="Posting Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXCheckBox ID="chkAutoReleaseIN" runat="server" DataField="AutoReleaseIN" ></px:PXCheckBox>
                    </px:PXPanel>
                    <px:PXPanel ID="pnlSalesProfitability" runat="server" Caption="Sales Profitability Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXDropDown ID="edSalesProfitabilityForNSKits" runat="server" AllowNull="False" DataField="SalesProfitabilityForNSKits" ></px:PXDropDown>
                    </px:PXPanel>
                    <px:PXPanel ID="pnlIntercompany" runat="server" Caption="Intercompany Order Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXSelector ID="edDfltIntercompanyOrderType" runat="server" AllowNull="False" DataField="DfltIntercompanyOrderType" ></px:PXSelector>
                        <px:PXSelector ID="edDfltIntercompanyRMAType" runat="server" AllowNull="False" DataField="DfltIntercompanyRMAType" ></px:PXSelector>
                        <px:PXCheckBox ID="chkDisableAddingItemsForIntercompany" runat="server" DataField="DisableAddingItemsForIntercompany" ></px:PXCheckBox>
                        <px:PXCheckBox ID="chkDisableEditingPricesDiscountsForIntercompany" runat="server" DataField="DisableEditingPricesDiscountsForIntercompany" CommitChanges="true" ></px:PXCheckBox> 
                    </px:PXPanel>
                    <px:PXPanel ID="pnlRelatedItemSettings" runat="server" Caption="Related Item Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
                        <px:PXCheckBox ID="chkShowOnlyAvailableRelatedItems" runat="server" DataField="ShowOnlyAvailableRelatedItems" ></px:PXCheckBox>
                    </px:PXPanel>
                    <px:PXPanel ID="pnlRelatedCaseSettings" runat="server" Caption="Related Case Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" ></px:PXLayoutRule>
	...
	<px:PXPanel runat="server" ID="edShippingFreightSetting" Caption="Shipping and Freight Settings" DataMember="sosetup" RenderStyle="Fieldset">
		...
		<px:PXSelector runat="server" ID="edUsrFreeFreightAllowed" DataField="UsrFreeFreightAllowed" /></px:PXPanel></Template>
            ...
            <px:PXTabItem Text="Approval">
                <Template>
                    <px:PXSplitContainer ID="splitApprovals" runat="server" Orientation="Horizontal" SplitterPosition="350" SkinID="Horizontal" Height="500px"  SavePosition="True">
                        <AutoSize Enabled="true" />
                        <Template1>
                            <px:PXGrid ID="gridApproval" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" Caption="Sales Orders" CaptionVisible="true" Height="150px" AdjustPageSize="Auto" AllowPaging="True" >
                                <AutoSize Enabled="True"/>
                                <Levels>
                                    <px:PXGridLevel DataMember="SetupApproval">
                                        ...
                                        <Columns>
                                            <px:PXGridColumn DataField="IsActive" RenderEditorText="True" TextAlign="Center" Type="CheckBox" />
                                            ...
                                            <px:PXGridColumn DataField="AssignmentNotificationID" Width="250px" RenderEditorText="True" DisplayMode="Text" TextField="Name" />
                                        </Columns>
                                    </px:PXGridLevel>
                                </Levels>
                            </px:PXGrid>
                        ...
                        <Template2>
                            <px:PXGrid ID="gridInvoiceApproval" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" Caption="Invoices" CaptionVisible="true" >
                                <AutoSize Enabled="True" MinHeight="150"/>
                                <Levels>
                                    <px:PXGridLevel DataMember="SetupInvoiceApproval">
                                        <RowTemplate>
                                            <px:PXLayoutRule runat="server" StartColumn="True"  LabelsWidth="M" ControlSize="XM" />
                                            <px:PXCheckBox ID="edInvoiceIsActive" runat="server" DataField="IsActive" CommitChanges="True"  />
                                            <px:PXDropDown ID="edInvoiceDocType" runat="server" DataField="DocType" CommitChanges="True"  />
                                            <px:PXSelector ID="edInvoiceAssignmentMapID" runat="server" DataField="AssignmentMapID" AllowEdit="True" CommitChanges="True" />
                                            <px:PXSelector ID="edInvoiceAssignmentNotificationID" runat="server" DataField="AssignmentNotificationID" AllowEdit="True" />
                                        </RowTemplate>
                                        <Columns>
                ...
                <Template>
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="PickPackShipSetup" DefaultControlID="edShowPickTab" RenderStyle="Simple">
						<Template>
                            ...
                            <px:PXCheckBox SuppressLabel="True" ID="edPrintCommercialInvoices" runat="server" DataField="PrintCommercialInvoices" CommitChanges="true" />
							...
							<px:PXCheckBox SuppressLabel="True" ID="edConfirmEachPackageDimensions" runat="server" DataField="ConfirmEachPackageDimensions" CommitChanges="true" />
							...
							<px:PXCheckBox SuppressLabel="True" ID="edAllowMultipleTotesPerShipment" runat="server" DataField="AllowMultipleTotesPerShipment" CommitChanges="true" />
                            ...
                            <px:PXCheckBox SuppressLabel="True" ID="edAllowBidirectionalPickLists" runat="server" DataField="AllowBidirectionalPickLists" CommitChanges="true" />
						</Template>
					</px:PXFormView>
                </Template>
            </px:PXTabItem>
