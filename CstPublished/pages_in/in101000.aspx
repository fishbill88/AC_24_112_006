		...
		<Items>
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXSelector ID="edBatchNumberingID" runat="server" DataField="BatchNumberingID" Text="BATCH" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edReceiptNumberingID" runat="server" DataField="ReceiptNumberingID" Text="INRECEIPT" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edIssueNumberingID" runat="server" DataField="IssueNumberingID" Text="INISSUE" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edAdjustmentNumberingID" runat="server" DataField="AdjustmentNumberingID" Text="INADJUST" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edKitAssemblyNumberingID" runat="server" DataField="KitAssemblyNumberingID" Text="INKITASSY" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edPINumberingID" runat="server" AllowEdit="True" DataField="PINumberingID" Text="PIID" ></px:PXSelector>
					<px:PXSelector ID="edReplenishmentNumberingID" runat="server" DataField="ReplenishmentNumberingID" Text="INREPL" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector ID="edServiceItemNumbering" runat="server" DataField="ServiceItemNumberingID" AllowEdit="True" ></px:PXSelector>
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Inventory Options" ></px:PXLayoutRule>
					<px:PXCheckBox CommitChanges="True" SuppressLabel="True" ID="chkUseInventory" runat="server" Checked="True" DataField="UseInventorySubItem" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkReplanBackOrders" runat="server" DataField="ReplanBackOrders" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkAllocateDocumentsOnHold" runat="server" DataField="AllocateDocumentsOnHold" ></px:PXCheckBox>
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Account Settings" ></px:PXLayoutRule>
					<px:PXSegmentMask CommitChanges="True" ID="edARClearingAcctID" runat="server" DataField="ARClearingAcctID" ></px:PXSegmentMask>
					<px:PXSegmentMask ID="edARClearingSubID" runat="server" DataField="ARClearingSubID" AutoRefresh="True" ></px:PXSegmentMask>
                    <px:PXSegmentMask CommitChanges="True" ID="edTransitBranchID" runat="server" DataField="TransitBranchID" ></px:PXSegmentMask>
					<px:PXSegmentMask CommitChanges="True" ID="edINTransitAcctID" runat="server" DataField="INTransitAcctID" ></px:PXSegmentMask>
					<px:PXSegmentMask ID="edINTransitSubID" runat="server" DataField="INTransitSubID" AutoRefresh="True" ></px:PXSegmentMask>
					<px:PXSegmentMask CommitChanges="True" ID="edINProgressAcctID" runat="server" DataField="INProgressAcctID" ></px:PXSegmentMask>
					<px:PXSegmentMask ID="edINProgressSubID" runat="server" DataField="INProgressSubID" AutoRefresh="True" ></px:PXSegmentMask>
					...
					<px:PXCheckBox SuppressLabel="True" ID="PXCheckBox5" runat="server" Checked="True" DataField="RequireControlTotal" ></px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkByOne" runat="server" DataField="AddByOneBarcode" ></px:PXCheckBox>
					<px:PXCheckBox SuppressLabel="True" ID="chkAutoAdd" runat="server" DataField="AutoAddLineBarcode" ></px:PXCheckBox>
					<px:PXSegmentMask CommitChanges="True" ID="edDfltStkItemClassID" runat="server" DataField="DfltStkItemClassID" AllowEdit="True" ></px:PXSegmentMask>
					<px:PXSegmentMask CommitChanges="True" ID="edDfltNonStkItemClassID" runat="server" DataField="DfltNonStkItemClassID" AllowEdit="True" ></px:PXSegmentMask>
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Default Reason Codes" ></px:PXLayoutRule>
					<px:PXSelector CommitChanges="True" ID="edReceiptReasonCode" runat="server" DataField="ReceiptReasonCode" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector CommitChanges="True" ID="edIssuesReasonCode" runat="server" DataField="IssuesReasonCode" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector CommitChanges="True" ID="edAdjustmentReasonCode" runat="server" DataField="AdjustmentReasonCode" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector CommitChanges="True" ID="edAssemblyDisassemblyReasonCodeReasonCode" runat="server" DataField="AssemblyDisassemblyReasonCode" AllowEdit="True" ></px:PXSelector>
					<px:PXSelector CommitChanges="True" ID="edPIAdjReasonCode" runat="server" DataField="PIReasonCode" AllowEdit="True" ></px:PXSelector>
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Physical Inventory Settings" ></px:PXLayoutRule>
					<px:PXCheckBox SuppressLabel="True" ID="chkPIUseTags" runat="server" DataField="PIUseTags" ></px:PXCheckBox>
					<px:PXNumberEdit ID="edPILastTagNumber" runat="server" DataField="PILastTagNumber" ></px:PXNumberEdit>
					<px:PXNumberEdit CommitChanges="True" ID="edTurnoverPeriodsPerYear" runat="server" DataField="TurnoverPeriodsPerYear" ></px:PXNumberEdit>
					<px:PXCheckBox SuppressLabel="True" ID="autoReleasePIAdjustment" runat="server" DataField="AutoReleasePIAdjustment" ></px:PXCheckBox>

					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Inventory Turnover Settings" ></px:PXLayoutRule>
					<px:PXLabel ID="lblIncudeToTurnover" runat="server" Text="Calculation Rules:"></px:PXLabel>
					<px:PXCheckBox ID="chkIncludeSaleInTurnover" runat="server" DataField="IncludeSaleInTurnover" SuppressLabel="True" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkIncludeProductionInTurnover" runat="server" DataField="IncludeProductionInTurnover" SuppressLabel="True" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkIncludeAssemblyInTurnover" runat="server" DataField="IncludeAssemblyInTurnover" SuppressLabel="True" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkIncludeIssueInTurnover" runat="server" DataField="IncludeIssueInTurnover" SuppressLabel="True" ></px:PXCheckBox>
					<px:PXCheckBox ID="chkIncludeTransferInTurnover" runat="server" DataField="IncludeTransferInTurnover" SuppressLabel="True" ></px:PXCheckBox></Template>
			</px:PXTabItem>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Notifications" DataKeyNames="Module,NotificationCD">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector ID="edNotificationID" runat="server" DataField="NotificationID" AutoRefresh="True" AllowEdit="True" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="NotificationID" Width="150px" AutoCallBack="True" DisplayMode="Text" TextField="Name" />
				...
				<Template>
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="ScanSetup" DefaultControlID="edUseDefaultQtyInReceipt" RenderStyle="Simple">
						<Template>
							...
							<px:PXCheckBox SuppressLabel="True" ID="edUseDefaultLotSerialNbrInTransfer" runat="server" DataField="UseDefaultLotSerialNbrInTransfer" CommitChanges="true" />
