...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
        ...
        <Items>
            <px:PXTabItem Text="General">
                <Template>
                    ...
                    <px:PXFormView ID="CurySettingsFormDefaultSite" runat="server" SkinID="Inside" RenderStyle="Fieldset" DataSourceID="ds" DataMember="ItemCurySettings" CaptionVisible="false">
                        <Template>
	...
	<px:PXFormView runat="server" ID="frmRTH" DataMember="ItemSettings">
		<Template>
			<px:PXNumberEdit runat="server" Width="104px" DataField="UsrSWKRTHCost" ID="edUsrSWKRTHCost" /></Template></px:PXFormView></Template>
                    </px:PXFormView>
                    <px:PXLayoutRule runat="server" ID="PXLayoutRuleA1" StartGroup="true" GroupCaption="Posting of Item Cost" ControlSize="XM" />
		...
		<px:PXGrid ID="relatedItemsGrid" runat="server" DataSourceID="ds" Height="150px" Width="100%" ActionsPosition="Top" SkinID="Details" 
            ...
            <px:PXTabItem Text="Attributes">
                <Template>
                    ...
                    <px:PXImageUploader Height="150px" Width="420px" ID="imgUploader" runat="server" DataField="ImageUrl" DataMember="ItemSettings" AllowUpload="true" AllowNoImage="true" SuppressLabel="True" />
                </Template>
            </px:PXTabItem>
