...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Document Summary"
        ...
        <Template>
            ...
            <px:PXDropDown  ID="edReceiptType" runat="server" SelectedIndex="-1" DataField="ReceiptType" ></px:PXDropDown>
            ...
            <px:PXDateTimeEdit CommitChanges="True" ID="edReceiptDate" runat="server" DataField="ReceiptDate" ></px:PXDateTimeEdit>
            <px:PXSelector ID="edFinPeriodID" runat="server" DataField="FinPeriodID" ></px:PXSelector>
			...
			<px:PXSelector ID="edHeadProjectID" runat="server" DataField="ProjectID" AllowEdit="True" CommitChanges="True" ></px:PXSelector>
            ...
            <px:PXCheckBox CommitChanges="True" SuppressLabel="True" ID="chkAutoCreateInvoice" runat="server" Checked="True" DataField="AutoCreateInvoice" ></px:PXCheckBox>
            <px:PXDropDown ID="edReturnInventoryCostMode" runat="server" AllowNull="False" DataField="ReturnInventoryCostMode" CommitChanges="true" ></px:PXDropDown>
            <px:PXTextEdit CommitChanges="True" ID="edInvoiceNbr" runat="server" DataField="InvoiceNbr" ></px:PXTextEdit>
	        <px:PXSelector ID="trsWorkgroupID" runat="server" DataField="WorkgroupID" CommitChanges="True" ></px:PXSelector>
            ...
            <px:PXNumberEdit ID="edControlQty" runat="server" DataField="ControlQty" ></px:PXNumberEdit>
            <px:PXNumberEdit ID="edUnbilledQty" runat="server" DataField="UnbilledQty" ></px:PXNumberEdit>
            <px:PXNumberEdit ID="edCuryOrderTotal" runat="server" DataField="CuryOrderTotal" ></px:PXNumberEdit>
                    ...
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 455px;" Width="100%"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                <Columns>
                                    <px:PXGridColumn DataField="Availability" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Selected" Type="CheckBox" CommitChanges="true" AllowCheckAll="True" TextAlign="Center" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="BranchID" DisplayFormat="&gt;AAAAAAAAAA" AutoCallBack="True" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="InventoryID" DisplayFormat="&gt;AAAAAAAAAA" AutoCallBack="True" Label="Inventory ID" AllowDragDrop="true"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LineType" Type="DropDownList" AutoCallBack="True" Label="Line Type" AllowDragDrop="true"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SubItemID" DisplayFormat="&gt;AA-A-A" NullText="&lt;SPLIT&gt;" AutoCallBack="True" Label="Subitem ID" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SiteID" DisplayFormat="&gt;AAAAAAAAAA" AutoCallBack="True" Label="Warehouse ID" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LocationID" DisplayFormat="&gt;AAAAAAAAAA" NullText="&lt;SPLIT&gt;" Label="Location ID" AutoCallBack="True"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TranDesc" Label="Transaction Descr." ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="UOM" AutoCallBack="True" DisplayFormat="&gt;aaaaaa" Label="Unit of Measure" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowUpdate="False" DataField="OrigOrderQty" Label="Ordered Qty." TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowUpdate="False" DataField="OpenOrderQty" Label="Open Qty." TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="ReceiptQty" TextAlign="Right" AutoCallBack="True" Label="Order Qty" AllowDragDrop="true"></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="BaseReceiptQty" TextAlign="Right" Label="Base Order Qty" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="UnassignedQty" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="OrigReceiptNbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="OrigReceiptLineNbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ExpenseAcctID" DisplayFormat="&gt;######" AutoCallBack="True" Label="Account" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ExpenseAcctID_Account_description" Label="Account Description" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ExpenseSubID" DisplayFormat="&gt;AA-AA-AA-AA-AAA" Label="Sub" ></px:PXGridColumn>
									<px:PXGridColumn DataField="POAccrualAcctID" DisplayFormat="&gt;######" AutoCallBack="True"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POAccrualSubID" DisplayFormat="&gt;AA-AA-AA-AA-AAA"></px:PXGridColumn>
                                    <px:PXGridColumn AutoCallBack="True" DataField="ProjectID" Label="Project" ></px:PXGridColumn>
                                    <px:PXGridColumn AutoCallBack="True" DataField="TaskID" DisplayFormat="&gt;AAAAAAAAAA" Label="Task" ></px:PXGridColumn>
                                    <px:PXGridColumn AutoCallBack="True" DataField="CostCodeID"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SpecialOrderCostCenterID" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ExpireDate" Label="Expire Date" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LineNbr" TextAlign="Right" Visible="False" Label="Line Nbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SortOrder" TextAlign="Right" Visible="False" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LotSerialNbr" NullText="&lt;SPLIT&gt;" Label="Lot/Serial Nbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POType" RenderEditorText="True" Label="Order Type" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="PONbr" Label="Order Nbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="POLineNbr" TextAlign="Right" Label="PO Line Nbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SOOrderType" Label="Transfer Type" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SOOrderNbr" Label="Transfer Nbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SOOrderLineNbr" TextAlign="Right" Label="Transfer Line Nbr" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="SOShipmentNbr" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="AllowComplete" TextAlign="Center" Type="CheckBox" AutoCallBack="True"
                                        Label="Allow Complete Line" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="AllowOpen" TextAlign="Center" Type="CheckBox" AutoCallBack="True"
                                        Label="Allow Open Line" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="ReturnedQty" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn AutoCallBack="True" DataField="ReasonCode" DisplayFormat="&gt;aaaaaaaaaa" Label="Reason Code" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="AllowEditUnitCost" TextAlign="Center" AllowNull="False" Type="CheckBox"></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="CuryUnitCost" TextAlign="Right" Label="Unit Cost" CommitChanges="true" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="CuryExtCost" TextAlign="Right" CommitChanges="true" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="TranCost" TextAlign="Right" ></px:PXGridColumn>
                                    <px:PXGridColumn AllowNull="False" DataField="TranCostFinal" TextAlign="Right" ></px:PXGridColumn>
                                </Columns>
                                <RowTemplate>
                                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" ></px:PXLayoutRule>
                                    ...
                                    <px:PXSegmentMask CommitChanges="True" ID="edInventoryID" runat="server" DataField="InventoryID" AllowEdit="True" AutoRefresh="true">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid" Name="POReceiptLine.lineType" PropertyName="DataValues[&quot;LineType&quot;]" Type="String" ></px:PXControlParam>
                                        </Parameters>
                                    </px:PXSegmentMask>
                                    <px:PXSegmentMask CommitChanges="True" ID="edSubItemID" runat="server" DataField="SubItemID" AutoRefresh="True">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid" Name="POReceiptLine.inventoryID" PropertyName="DataValues[&quot;InventoryID&quot;]" Type="String" ></px:PXControlParam>
                                        </Parameters>
                                    </px:PXSegmentMask>
                                    ...
                                    <px:PXSegmentMask ID="edLocationID" runat="server" DataField="LocationID" AutoRefresh="true">
                                        <Parameters>
                                            <px:PXControlParam ControlID="grid" Name="POReceiptLine.siteID" PropertyName="DataValues[&quot;SiteID&quot;]" Type="String" ></px:PXControlParam>
                                            <px:PXControlParam ControlID="grid" Name="POReceiptLine.inventoryID" PropertyName="DataValues[&quot;InventoryID&quot;]" Type="String" ></px:PXControlParam>
                                            <px:PXControlParam ControlID="grid" Name="POReceiptLine.subItemID" PropertyName="DataValues[&quot;SubItemID&quot;]" Type="String" ></px:PXControlParam>
                                        </Parameters>
                                    </px:PXSegmentMask>
                                    ...
                                    <px:PXNumberEdit ID="edOrigOrderQty" runat="server" DataField="OrigOrderQty" Enabled="False" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edOperOrderQty" runat="server" DataField="OpenOrderQty" Enabled="False" ></px:PXNumberEdit>
                                    <px:PXNumberEdit CommitChanges="True" ID="edReceiptQty" runat="server" DataField="ReceiptQty" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edCuryUnitCost" runat="server" DataField="CuryUnitCost" CommitChanges="true" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edCuryExtCost" runat="server" DataField="CuryExtCost" CommitChanges="true" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edTranCost" runat="server" DataField="TranCost" ></px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edTranCostFinal" runat="server" DataField="TranCostFinal" ></px:PXNumberEdit>
                                    ...
                                    <px:PXSelector ID="edSOOrderNbr" runat="server" DataField="SOOrderNbr" AllowEdit="True" ></px:PXSelector>
                                    <px:PXSelector ID="edSOShipmentNbr" runat="server" DataField="SOShipmentNbr" AllowEdit="True" ></px:PXSelector>
                                    <px:PXLayoutRule runat="server" Merge="True" ></px:PXLayoutRule>
                                    <px:PXNumberEdit Size="xxs" ID="edPOLineNbr" runat="server" DataField="POLineNbr" ></px:PXNumberEdit>
                                    <px:PXCheckBox ID="chkAllowComplete" runat="server" DataField="AllowComplete" ></px:PXCheckBox>
                                    <px:PXLayoutRule runat="server" Merge="False" ></px:PXLayoutRule>
                                    <px:PXSelector ID="edOrigReceiptNbr" runat="server" DataField="OrigReceiptNbr" AllowEdit="True" ></px:PXSelector>
                                    <px:PXLayoutRule ID="PXLayoutRule11" runat="server" ColumnSpan="2" ></px:PXLayoutRule>
                                    ...
                                    <px:PXSegmentMask CommitChanges="True" ID="edExpenseAcctID" runat="server" DataField="ExpenseAcctID" AutoRefresh="true" ></px:PXSegmentMask>
                                    ...
                                    <px:PXSelector ID="edReasonCode" runat="server" DataField="ReasonCode" ></px:PXSelector>
                                    <px:PXSegmentMask CommitChanges="True" ID="edProjectID" runat="server" DataField="ProjectID" ></px:PXSegmentMask>
                                    <px:PXSegmentMask CommitChanges="True" ID="edTaskID" runat="server" AutoRefresh="True" DataField="TaskID" ></px:PXSegmentMask>
                                    <px:PXSegmentMask CommitChanges="True" ID="edCostCodeID" runat="server" AutoRefresh="True" DataField="CostCodeID" ></px:PXSegmentMask>
                                    <px:PXSelector ID="selSpecialOrderCostCenterID" runat="server" DataField="SpecialOrderCostCenterID" ></px:PXSelector>
                                </RowTemplate>
                            </px:PXGridLevel>
                        </Levels>
                        ...
                        <Mode InitNewRow="True" AllowFormEdit="True" AllowDragRows="true"></Mode>
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="POReceiptLineSplittingExtension_ShowSplits" CommandSourceID="ds" DependOnGrid="grid" ></px:PXToolBarButton>
                                <px:PXToolBarSeperator ></px:PXToolBarSeperator>
                                <px:PXToolBarButton Text="Add Line" Key="cmdAddReceiptLine" CommandSourceID="ds" CommandName="AddPOReceiptLine" ></px:PXToolBarButton>
                                ...
                                <px:PXToolBarButton Key="cmdPOReceiptReturn" CommandSourceID="ds" CommandName="AddPOReceiptReturn" ></px:PXToolBarButton>
                                <px:PXToolBarButton Key="cmdPOReceiptLineReturn" CommandSourceID="ds" CommandName="AddPOReceiptLineReturn" ></px:PXToolBarButton>
                                <px:PXToolBarButton Text="Add Transfer" Key="cmdAddTransfer" CommandSourceID="ds" CommandName="AddTransfer" ></px:PXToolBarButton>
                                <px:PXToolBarSeperator ></px:PXToolBarSeperator>
                                <px:PXToolBarButton Text="View PO Order" Key="cmdViewPOOrder">
                                    <AutoCallBack Command="ViewPOOrder" Target="ds" ></AutoCallBack>
                                </px:PXToolBarButton>
                    ...
                    <px:PXGrid ID="formOrders" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" BorderStyle="None" AdjustPageSize="Auto">
                        <Levels>
                            <px:PXGridLevel DataMember="ReceiptOrdersLink" >
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="POType" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="PONbr" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryID" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TaxZoneID" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TaxCalcMode" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="PayToVendorID" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" ></px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" ></AutoSize>
		...
		<Template>
					...
					<px:PXGrid ID="formTransfers" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" BorderStyle="None" AdjustPageSize="Auto">
						<Levels>
							<px:PXGridLevel DataMember="RelatedTransfers" >
								<RowTemplate>
									<px:PXSelector ID="edTransferRefNbr" runat="server" DataField="RefNbr" AutoRefresh="True" AllowEdit="True" edit="1" ></px:PXSelector>
								</RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="RefNbr" RenderEditorText="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="Status" RenderEditorText="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="TransferType" RenderEditorText="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="TranDate" RenderEditorText="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="FinPeriodID" RenderEditorText="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="SiteID" RenderEditorText="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="TotalQty" RenderEditorText="True" ></px:PXGridColumn>
									<px:PXGridColumn DataField="BatchNbr" RenderEditorText="True" ></px:PXGridColumn>
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" MinHeight="150" ></AutoSize>
                    ...
                    <px:PXGrid ID="formPRHistory" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" BorderStyle="None" AdjustPageSize="Auto">
                        <Levels>
                            <px:PXGridLevel DataMember="ReceiptHistory" >
                                <RowTemplate>
	                                <px:PXSelector SuppressLabel="True" Size="s" ID="edReceiptNbr" runat="server" DataField="ReceiptNbr" AutoRefresh="True" AllowEdit="True" edit="1" ></px:PXSelector>
	                                <px:PXSelector SuppressLabel="True" Size="s" ID="edInvtRefNbr" runat="server" DataField="InvtRefNbr" AutoRefresh="True" AllowEdit="True" edit="1" ></px:PXSelector>
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="ReceiptType" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="ReceiptNbr" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="DocDate" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="FinPeriodID" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TotalQty" RenderEditorText="True" ></px:PXGridColumn>
	                                <px:PXGridColumn DataField="InvtDocType" RenderEditorText="True" ></px:PXGridColumn>
	                                <px:PXGridColumn DataField="InvtRefNbr" RenderEditorText="True" ></px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" ></AutoSize>
                    ...
                    <px:PXGrid ID="formBillingHistory" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" BorderStyle="None" StatusField="StatusText" AdjustPageSize="Auto">
                        <Levels>
                            <px:PXGridLevel DataMember="ApDocs" >
                                <RowTemplate>
	                                <px:PXSelector SuppressLabel="True" Size="s" ID="edRefNbr" runat="server" DataField="RefNbr" AutoRefresh="True" AllowEdit="True" edit="1" ></px:PXSelector>
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="DocType" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="RefNbr" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="DocDate" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TotalQty" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TotalAmt" RenderEditorText="True" ></px:PXGridColumn>
	                                <px:PXGridColumn DataField="AccruedQty" RenderEditorText="True" ></px:PXGridColumn>
	                                <px:PXGridColumn DataField="AccruedAmt" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="TotalPPVAmt" RenderEditorText="True" ></px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" ></AutoSize>
                    ...
                    <px:PXGrid ID="gridLandedCosts" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" BorderStyle="None" AdjustPageSize="Auto">
                        <Levels>
                            <px:PXGridLevel DataMember="landedCosts" >
                                ...
                                <Columns>
	                                <px:PXGridColumn DataField="LCDocType" RenderEditorText="True" ></px:PXGridColumn>
	                                <px:PXGridColumn DataField="LCRefNbr" RenderEditorText="True" LinkCommand="ViewItem"></px:PXGridColumn>
                                    <px:PXGridColumn DataField="DocDate" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="Status" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="VendorID" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="LandedCostCodeID" RenderEditorText="True" ></px:PXGridColumn>
	                                <px:PXGridColumn DataField="CuryLineAmt" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="CuryID" RenderEditorText="True" ></px:PXGridColumn>
                                    <px:PXGridColumn DataField="APRefNbr" RenderEditorText="True" LinkCommand="ViewItem"></px:PXGridColumn>
	                                <px:PXGridColumn DataField="INRefNbr" RenderEditorText="True" LinkCommand="ViewItem"></px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" ></AutoSize>
                        <Mode AllowAddNew="False" AllowDelete="True" AllowUpdate="False" ></Mode>
                        <ActionBar>
							<Actions>
								<AddNew Enabled="False" ></AddNew>
			...
			<px:PXTabItem Text="Other">
				<Template>
					...
					<px:PXSelector ID="edInventoryRefNbr" runat="server" DataField="InventoryRefNbr" Enabled="False" AllowEdit="True" ></px:PXSelector>
					...
					<px:PXDateTimeEdit CommitChanges="True" ID="edInvoiceDate" runat="server" DataField="InvoiceDate" ></px:PXDateTimeEdit>
					<px:PXSelector ID="edSOOrderNbr" runat="server" DataField="SOOrderNbr" Enabled="False" AllowEdit="True" ></px:PXSelector>
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Intercompany Sale" LabelsWidth="SM" ControlSize="SM" ></px:PXLayoutRule>
                    <px:PXSelector ID="edIntercompanyShipmentNbr" runat="server" DataField="IntercompanyShipmentNbr" AllowEdit="True" Enabled="False" ></px:PXSelector>
                    <px:PXSelector ID="edIntercompanySOType" runat="server" DataField="IntercompanySOType" ></px:PXSelector>
                    <px:PXSelector ID="edIntercompanySONbr" runat="server" DataField="IntercompanySONbr" AllowEdit="True" Enabled="False" ></px:PXSelector>
                    <px:PXCheckBox ID="chkExcludeFromIntercompanyProc" runat="server" DataField="ExcludeFromIntercompanyProc" ></px:PXCheckBox>
				</Template>
			</px:PXTabItem></Items>
