...
public partial class Api_ServiceDescription : System.Web.UI.Page
{
	...
	void GetWsdl(TextWriter w)
	{
		...
		WsdlSchemaBuilder.WriteWsdl(w, u, typeof(ServiceGate));
	}
	...
	void RenderGraph(string id)
	{
		...
		catch 
		{
			...
			ServiceLocator.Current.GetInstance<IFormsAuthenticationService>().RedirectToLoginPage(Context.Request, Context.Response);
			return;
		}
