...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	...
	<px:PXFormView runat="server" ID="frmRTH" SkinID="" DataMember="ItemSettings">
		<Template>
			<px:PXNumberEdit runat="server" ID="edUsrSWKRTHCost" DataField="UsrSWKRTHCost" Width="104px" /></Template></px:PXFormView></Template>
                    </px:PXFormView>
                </Template>
            </px:PXTabItem>
