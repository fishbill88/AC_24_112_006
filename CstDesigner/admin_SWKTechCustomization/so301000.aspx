...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Order Summary"
        ...
        <Template>
            ...
            <px:PXTextEdit ID="edCustomerOrderNbr" runat="server" DataField="CustomerOrderNbr" CommitChanges="True" />
            ...
            <px:PXTextEdit ID="edOrderDesc" runat="server" DataField="OrderDesc" TextMode="MultiLine" Height="55" />
            ...
            <px:PXPanel ID="XX" runat="server" RenderStyle="Simple">
                ...
                <px:PXNumberEdit ID="edCuryDetailExtPriceTotal" runat="server" DataField="CuryDetailExtPriceTotal" Enabled="False" />
                <px:PXNumberEdit ID="edCuryLineDiscTotal" runat="server" DataField="CuryLineDiscTotal" Enabled="False" />
                <px:PXNumberEdit ID="edCuryDiscTot" runat="server" DataField="CuryDiscTot" CommitChanges="true" />
                <px:PXNumberEdit ID="edCuryFreightTot" runat="server" DataField="CuryFreightTot" Enabled="False" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	...
	<px:PXGridColumn DataField="ExtCost" Width="100" TextField="Extended Cost" />
